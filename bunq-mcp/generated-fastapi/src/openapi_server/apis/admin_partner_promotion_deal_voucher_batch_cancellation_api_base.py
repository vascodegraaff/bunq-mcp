...
class BaseAdminPartnerPromotionDealVoucherBatchCancellationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionDealVoucherBatchCancellationApi.subclasses = BaseAdminPartnerPromotionDealVoucherBatchCancellationApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_deal_voucher_batch_cancellation(
        ...
        admin_partner_promotion_deal_voucher_batch_cancellation: AdminPartnerPromotionDealVoucherBatchCancellation,
