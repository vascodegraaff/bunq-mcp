...
class BaseCommentRiskApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCommentRiskApi.subclasses = BaseCommentRiskApi.subclasses + (cls,)
    async def c_reate_comment_risk_for_user_transaction_monitoring_metadata(
        ...
        admin_comment_risk_user_transaction_monitoring_metadata: AdminCommentRiskUserTransactionMonitoringMetadata,
