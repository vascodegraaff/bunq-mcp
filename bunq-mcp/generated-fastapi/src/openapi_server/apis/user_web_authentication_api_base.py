...
class BaseUserWebAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserWebAuthenticationApi.subclasses = BaseUserWebAuthenticationApi.subclasses + (cls,)
    async def c_reate_user_web_authentication(
        ...
        user_web_authentication: UserWebAuthentication,
