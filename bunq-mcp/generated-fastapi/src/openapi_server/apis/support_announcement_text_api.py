...
from openapi_server.apis.support_announcement_text_api_base import BaseSupportAnnouncementTextApi
...
from openapi_server.models.support_announcement_text import SupportAnnouncementText
from openapi_server.models.support_announcement_text_create import SupportAnnouncementTextCreate
...
@router.post(
    "/support-announcement-text",
    responses={
        200: {"model": SupportAnnouncementTextCreate, "description": "The support announcement with a textual content. apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["support-announcement-text"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_support_announcement_text(
    ...
    support_announcement_text: SupportAnnouncementText = Body(None, description=""),
...
) -> SupportAnnouncementTextCreate:
    """The support announcement with a textual content. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseSupportAnnouncementTextApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSupportAnnouncementTextApi.subclasses[0]().c_reate_support_announcement_text(user_agent, x_bunq_client_authentication, support_announcement_text, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
