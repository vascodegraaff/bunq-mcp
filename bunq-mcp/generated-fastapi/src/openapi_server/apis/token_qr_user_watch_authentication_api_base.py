...
class BaseTokenQrUserWatchAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrUserWatchAuthenticationApi.subclasses = BaseTokenQrUserWatchAuthenticationApi.subclasses + (cls,)
    async def c_reate_token_qr_user_watch_authentication_for_user(
        ...
        token_qr_user_watch_authentication: TokenQrUserWatchAuthentication,
