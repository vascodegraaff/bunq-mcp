...
class BaseTokenQrCredentialPasswordIpRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrCredentialPasswordIpRequestApi.subclasses = BaseTokenQrCredentialPasswordIpRequestApi.subclasses + (cls,)
    async def c_reate_token_qr_credential_password_ip_request_for_user(
        ...
        token_qr_user_credential_password_ip_request: TokenQrUserCredentialPasswordIpRequest,
