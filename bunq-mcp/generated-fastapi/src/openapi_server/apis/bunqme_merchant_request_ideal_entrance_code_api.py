...
from openapi_server.apis.bunqme_merchant_request_ideal_entrance_code_api_base import BaseBunqmeMerchantRequestIdealEntranceCodeApi
...
from openapi_server.models.bunq_me_merchant_request_ideal_entrance_code import BunqMeMerchantRequestIdealEntranceCode
from openapi_server.models.bunq_me_merchant_request_ideal_entrance_code_create import BunqMeMerchantRequestIdealEntranceCodeCreate
...
@router.post(
    "/bunqme-merchant-request-ideal-entrance-code",
    responses={
        200: {"model": BunqMeMerchantRequestIdealEntranceCodeCreate, "description": "View to pass an entrance code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request-ideal-entrance-code"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bunqme_merchant_request_ideal_entrance_code(
    ...
    bunq_me_merchant_request_ideal_entrance_code: BunqMeMerchantRequestIdealEntranceCode = Body(None, description=""),
...
) -> BunqMeMerchantRequestIdealEntranceCodeCreate:
    """View to pass an entrance code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"""
    if not BaseBunqmeMerchantRequestIdealEntranceCodeApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestIdealEntranceCodeApi.subclasses[0]().c_reate_bunqme_merchant_request_ideal_entrance_code(user_agent, x_bunq_client_authentication, bunq_me_merchant_request_ideal_entrance_code, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
