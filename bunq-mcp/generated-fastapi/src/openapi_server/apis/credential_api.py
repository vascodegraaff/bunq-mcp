...
from openapi_server.apis.credential_api_base import BaseCredentialApi
...
from openapi_server.models.user_credential_create import UserCredentialCreate
...
@router.post(
    ...
    responses={
        200: {"model": UserCredentialCreate, "description": "Used to update credentials for a user. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE apiDeveloperPortal:CREATE"},
...
async def c_reate_credential_for_user(
    ...
    user_credential: UserCredential = Body(None, description=""),
    ...
    """Used to update credentials for a user. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE apiDeveloperPortal:CREATE"""
    if not BaseCredentialApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCredentialApi.subclasses[0]().c_reate_credential_for_user(userID, user_agent, x_bunq_client_authentication, user_credential, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
