...
class BaseAdminCompanyLegalDirectorApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminCompanyLegalDirectorApi.subclasses = BaseAdminCompanyLegalDirectorApi.subclasses + (cls,)
    async def c_reate_admin_company_legal_director_for_user_company(
        ...
        admin_company_legal_director: AdminCompanyLegalDirector,
