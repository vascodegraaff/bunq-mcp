...
from openapi_server.apis.payment_service_provider_credential_api_base import BasePaymentServiceProviderCredentialApi
...
from openapi_server.models.payment_service_provider_credential import PaymentServiceProviderCredential
from openapi_server.models.payment_service_provider_credential_create import PaymentServiceProviderCredentialCreate
from openapi_server.models.payment_service_provider_credential_read import PaymentServiceProviderCredentialRead
...
@router.post(
    ...
    responses={
        200: {"model": PaymentServiceProviderCredentialCreate, "description": "Register a Payment Service Provider and provide credentials apiPublic:READ/CREATE"},
...
async def c_reate_payment_service_provider_credential(
    ...
    payment_service_provider_credential: PaymentServiceProviderCredential = Body(None, description=""),
    ...
    """Register a Payment Service Provider and provide credentials apiPublic:READ/CREATE"""
    if not BasePaymentServiceProviderCredentialApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePaymentServiceProviderCredentialApi.subclasses[0]().c_reate_payment_service_provider_credential(user_agent, x_bunq_client_authentication, payment_service_provider_credential, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/payment-service-provider-credential/{itemId}",
    responses={
        200: {"model": PaymentServiceProviderCredentialRead, "description": "Register a Payment Service Provider and provide credentials apiPublic:READ/CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["payment-service-provider-credential"],
    summary="",
...
async def r_ead_payment_service_provider_credential(
    ...
    if not BasePaymentServiceProviderCredentialApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePaymentServiceProviderCredentialApi.subclasses[0]().r_ead_payment_service_provider_credential(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
