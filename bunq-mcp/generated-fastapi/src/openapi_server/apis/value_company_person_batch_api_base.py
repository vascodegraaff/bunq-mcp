...
class BaseValueCompanyPersonBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseValueCompanyPersonBatchApi.subclasses = BaseValueCompanyPersonBatchApi.subclasses + (cls,)
    async def c_reate_value_company_person_batch_for_user_review_check(
        ...
        user_review_value_company_person_batch: UserReviewValueCompanyPersonBatch,
