...
class BaseImpersonationRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseImpersonationRequestApi.subclasses = BaseImpersonationRequestApi.subclasses + (cls,)
    async def c_reate_impersonation_request_for_user(
        ...
        user_impersonation_request: UserImpersonationRequest,
