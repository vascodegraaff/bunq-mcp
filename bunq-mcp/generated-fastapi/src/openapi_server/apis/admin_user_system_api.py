...
from openapi_server.apis.admin_user_system_api_base import BaseAdminUserSystemApi
...
from openapi_server.models.admin_user_system_read import AdminUserSystemRead
...
@router.get(
    "/admin-user-system/{itemId}",
    responses={
        200: {"model": AdminUserSystemRead, "description": "Return a system user by id. apiAdmin:READ apiServiceInternal:READ"},
...
async def r_ead_admin_user_system(
    ...
    """Return a system user by id. apiAdmin:READ apiServiceInternal:READ"""
    if not BaseAdminUserSystemApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminUserSystemApi.subclasses[0]().r_ead_admin_user_system(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
