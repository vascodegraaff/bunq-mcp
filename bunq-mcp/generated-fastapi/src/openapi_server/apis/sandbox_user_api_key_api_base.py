...
class BaseSandboxUserApiKeyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSandboxUserApiKeyApi.subclasses = BaseSandboxUserApiKeyApi.subclasses + (cls,)
    async def c_reate_sandbox_user_api_key_for_user_developer_portal_user_profile(
        self,
        userID: StrictInt,
        developer-portal-user-profileID: StrictInt,
        ...
        sandbox_user_api_key: SandboxUserApiKey,
