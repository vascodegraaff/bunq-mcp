...
class BasePropertyPermissionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePropertyPermissionApi.subclasses = BasePropertyPermissionApi.subclasses + (cls,)
    async def c_reate_property_permission_for_user_admin_permission(
        self,
        userID: StrictInt,
        admin-permissionID: StrictInt,
        ...
        admin_property_permission: AdminPropertyPermission,
