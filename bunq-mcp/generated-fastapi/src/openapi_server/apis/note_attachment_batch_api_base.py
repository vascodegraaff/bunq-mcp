...
class BaseNoteAttachmentBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNoteAttachmentBatchApi.subclasses = BaseNoteAttachmentBatchApi.subclasses + (cls,)
    async def c_reate_note_attachment_batch_for_user(
        ...
        note_attachment_batch: NoteAttachmentBatch,
