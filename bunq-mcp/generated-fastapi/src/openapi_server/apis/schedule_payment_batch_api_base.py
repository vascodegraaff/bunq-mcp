...
class BaseSchedulePaymentBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSchedulePaymentBatchApi.subclasses = BaseSchedulePaymentBatchApi.subclasses + (cls,)
    async def c_reate_schedule_payment_batch_for_user_monetary_account(
        ...
        schedule_payment_batch: SchedulePaymentBatch,
