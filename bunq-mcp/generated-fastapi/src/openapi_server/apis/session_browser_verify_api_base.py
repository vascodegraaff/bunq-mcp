...
class BaseSessionBrowserVerifyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionBrowserVerifyApi.subclasses = BaseSessionBrowserVerifyApi.subclasses + (cls,)
    async def c_reate_session_browser_verify(
        ...
        session_browser_authentication_token_user: SessionBrowserAuthenticationTokenUser,
