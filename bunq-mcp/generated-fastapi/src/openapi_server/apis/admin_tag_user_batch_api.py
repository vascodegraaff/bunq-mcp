...
from openapi_server.apis.admin_tag_user_batch_api_base import BaseAdminTagUserBatchApi
...
from openapi_server.models.admin_tag_user_batch import AdminTagUserBatch
from openapi_server.models.admin_tag_user_batch_create import AdminTagUserBatchCreate
...
@router.post(
    ...
    responses={
        200: {"model": AdminTagUserBatchCreate, "description": "Assign a label to multiple users at once. apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-tag-user-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_tag_user_batch(
    ...
    admin_tag_user_batch: AdminTagUserBatch = Body(None, description=""),
...
) -> AdminTagUserBatchCreate:
    """Assign a label to multiple users at once. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseAdminTagUserBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminTagUserBatchApi.subclasses[0]().c_reate_admin_tag_user_batch(user_agent, x_bunq_client_authentication, admin_tag_user_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
