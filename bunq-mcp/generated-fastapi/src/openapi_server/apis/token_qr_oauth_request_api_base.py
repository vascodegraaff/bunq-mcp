...
class BaseTokenQrOauthRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrOauthRequestApi.subclasses = BaseTokenQrOauthRequestApi.subclasses + (cls,)
