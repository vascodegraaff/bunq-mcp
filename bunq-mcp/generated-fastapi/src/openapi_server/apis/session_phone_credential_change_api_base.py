...
class BaseSessionPhoneCredentialChangeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionPhoneCredentialChangeApi.subclasses = BaseSessionPhoneCredentialChangeApi.subclasses + (cls,)
    async def c_reate_session_phone_credential_change(
        ...
        session_phone_credential_change: SessionPhoneCredentialChange,
