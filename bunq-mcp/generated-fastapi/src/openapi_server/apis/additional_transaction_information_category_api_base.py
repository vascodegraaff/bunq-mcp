...
class BaseAdditionalTransactionInformationCategoryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdditionalTransactionInformationCategoryApi.subclasses = BaseAdditionalTransactionInformationCategoryApi.subclasses + (cls,)
