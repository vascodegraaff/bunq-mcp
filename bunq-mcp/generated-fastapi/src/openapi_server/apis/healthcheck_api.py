...
@router.get(
    "/healthcheck",
    responses={
        200: {"model": List[object], "description": "View for the government portal to healthcheck our API every 15 minutes. apiGovernment:LISTING"},
...
async def list_all_healthcheck(
    ...
    """View for the government portal to healthcheck our API every 15 minutes. apiGovernment:LISTING"""
    if not BaseHealthcheckApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseHealthcheckApi.subclasses[0]().list_all_healthcheck(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
