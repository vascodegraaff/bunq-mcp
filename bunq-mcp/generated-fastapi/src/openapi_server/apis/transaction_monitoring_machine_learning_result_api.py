...
from openapi_server.apis.transaction_monitoring_machine_learning_result_api_base import BaseTransactionMonitoringMachineLearningResultApi
...
from openapi_server.models.transaction_monitoring_machine_learning_result_listing import TransactionMonitoringMachineLearningResultListing
from openapi_server.models.transaction_monitoring_machine_learning_result_read import TransactionMonitoringMachineLearningResultRead
...
@router.get(
    "/transaction-monitoring-metadata/{transaction-monitoring-metadataID}/transaction-monitoring-machine-learning-result",
    responses={
        200: {"model": List[TransactionMonitoringMachineLearningResultListing], "description": "Used to view the transaction monitoring machine learning results apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transaction-monitoring-machine-learning-result"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_transaction_monitoring_machine_learning_result_for_transaction_monitoring_metadata(
...
) -> List[TransactionMonitoringMachineLearningResultListing]:
    """Used to view the transaction monitoring machine learning results apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"""
    if not BaseTransactionMonitoringMachineLearningResultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransactionMonitoringMachineLearningResultApi.subclasses[0]().list_all_transaction_monitoring_machine_learning_result_for_transaction_monitoring_metadata(transaction-monitoring-metadataID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/transaction-monitoring-metadata/{transaction-monitoring-metadataID}/transaction-monitoring-machine-learning-result/{itemId}",
    responses={
        200: {"model": TransactionMonitoringMachineLearningResultRead, "description": "Used to view the transaction monitoring machine learning results apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transaction-monitoring-machine-learning-result"],
    summary="",
...
async def r_ead_transaction_monitoring_machine_learning_result_for_transaction_monitoring_metadata(
    transaction-monitoring-metadataID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> TransactionMonitoringMachineLearningResultRead:
    """Used to view the transaction monitoring machine learning results apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"""
    if not BaseTransactionMonitoringMachineLearningResultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransactionMonitoringMachineLearningResultApi.subclasses[0]().r_ead_transaction_monitoring_machine_learning_result_for_transaction_monitoring_metadata(transaction-monitoring-metadataID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
