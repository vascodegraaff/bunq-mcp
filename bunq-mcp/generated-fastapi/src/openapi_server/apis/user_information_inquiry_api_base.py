...
class BaseUserInformationInquiryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserInformationInquiryApi.subclasses = BaseUserInformationInquiryApi.subclasses + (cls,)
    async def c_reate_user_information_inquiry_for_user(
        ...
        user_information_inquiry: UserInformationInquiry,
