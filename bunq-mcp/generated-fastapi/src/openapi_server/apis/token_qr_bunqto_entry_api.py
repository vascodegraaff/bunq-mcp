...
from openapi_server.apis.token_qr_bunqto_entry_api_base import BaseTokenQrBunqtoEntryApi
...
from openapi_server.models.token_qr_bunq_to_entry import TokenQrBunqToEntry
from openapi_server.models.token_qr_bunq_to_entry_create import TokenQrBunqToEntryCreate
...
@router.post(
    "/user/{userID}/token-qr-bunqto-entry",
    responses={
        200: {"model": TokenQrBunqToEntryCreate, "description": "Usage of this endpoint (by scanning a QR code) results in a bunq.to entry. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-bunqto-entry"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_bunqto_entry_for_user(
    ...
    token_qr_bunq_to_entry: TokenQrBunqToEntry = Body(None, description=""),
...
) -> TokenQrBunqToEntryCreate:
    """Usage of this endpoint (by scanning a QR code) results in a bunq.to entry. apiApp:CREATE"""
    if not BaseTokenQrBunqtoEntryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrBunqtoEntryApi.subclasses[0]().c_reate_token_qr_bunqto_entry_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_bunq_to_entry, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
