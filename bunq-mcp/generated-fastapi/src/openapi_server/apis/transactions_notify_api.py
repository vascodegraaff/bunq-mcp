...
from openapi_server.apis.transactions_notify_api_base import BaseTransactionsNotifyApi
...
from openapi_server.models.ideal_issuer_provider_transaction_notify import IdealIssuerProviderTransactionNotify
from openapi_server.models.ideal_issuer_provider_transaction_notify_create import IdealIssuerProviderTransactionNotifyCreate
...
@router.post(
    "/transactions/notify",
    responses={
        200: {"model": IdealIssuerProviderTransactionNotifyCreate, "description": "Endpoint used by iDEAL Access Point to inform us about iDEAL transactions. apiIdealIssuerProvider:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transactions/notify"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_transactions_notify(
    ...
    ideal_issuer_provider_transaction_notify: IdealIssuerProviderTransactionNotify = Body(None, description=""),
...
) -> IdealIssuerProviderTransactionNotifyCreate:
    """Endpoint used by iDEAL Access Point to inform us about iDEAL transactions. apiIdealIssuerProvider:CREATE"""
    if not BaseTransactionsNotifyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransactionsNotifyApi.subclasses[0]().c_reate_transactions_notify(user_agent, x_bunq_client_authentication, ideal_issuer_provider_transaction_notify, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
