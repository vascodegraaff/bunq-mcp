...
class BaseQualityAssuranceTestUserCompanyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQualityAssuranceTestUserCompanyApi.subclasses = BaseQualityAssuranceTestUserCompanyApi.subclasses + (cls,)
    async def c_reate_quality_assurance_test_user_company(
        ...
        quality_assurance_test_user_company: QualityAssuranceTestUserCompany,
