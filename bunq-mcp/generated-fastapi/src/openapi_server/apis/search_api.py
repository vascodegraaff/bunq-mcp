...
from openapi_server.models.search_read import SearchRead
...
@router.get(
    "/search/{itemId}",
    responses={
        200: {"model": SearchRead, "description": "Used to view search results. apiApp:READ"},
...
async def r_ead_search(
    ...
    """Used to view search results. apiApp:READ"""
    if not BaseSearchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSearchApi.subclasses[0]().r_ead_search(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
