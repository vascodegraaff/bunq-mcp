...
from openapi_server.apis.schedule_payment_batch_api_base import BaseSchedulePaymentBatchApi
...
from openapi_server.models.schedule_payment_batch import SchedulePaymentBatch
from openapi_server.models.schedule_payment_batch_create import SchedulePaymentBatchCreate
from openapi_server.models.schedule_payment_batch_read import SchedulePaymentBatchRead
from openapi_server.models.schedule_payment_batch_update import SchedulePaymentBatchUpdate
...
@router.post(
    ...
    responses={
        200: {"model": SchedulePaymentBatchCreate, "description": "Endpoint for schedule payment batches. apiApp:READ/CREATE/UPDATE/DELETE apiPublic:READ/CREATE/UPDATE/DELETE"},
...
async def c_reate_schedule_payment_batch_for_user_monetary_account(
    ...
    schedule_payment_batch: SchedulePaymentBatch = Body(None, description=""),
    ...
    """Endpoint for schedule payment batches. apiApp:READ/CREATE/UPDATE/DELETE apiPublic:READ/CREATE/UPDATE/DELETE"""
    if not BaseSchedulePaymentBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSchedulePaymentBatchApi.subclasses[0]().c_reate_schedule_payment_batch_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, schedule_payment_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-payment-batch/{itemId}",
    responses={
        200: {"model": object, "description": "Endpoint for schedule payment batches. apiApp:READ/CREATE/UPDATE/DELETE apiPublic:READ/CREATE/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-payment-batch"],
    summary="",
...
async def d_elete_schedule_payment_batch_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseSchedulePaymentBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSchedulePaymentBatchApi.subclasses[0]().d_elete_schedule_payment_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-payment-batch/{itemId}",
    responses={
        200: {"model": SchedulePaymentBatchRead, "description": "Endpoint for schedule payment batches. apiApp:READ/CREATE/UPDATE/DELETE apiPublic:READ/CREATE/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-payment-batch"],
    summary="",
...
async def r_ead_schedule_payment_batch_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseSchedulePaymentBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSchedulePaymentBatchApi.subclasses[0]().r_ead_schedule_payment_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-payment-batch/{itemId}",
    responses={
        200: {"model": SchedulePaymentBatchUpdate, "description": "Endpoint for schedule payment batches. apiApp:READ/CREATE/UPDATE/DELETE apiPublic:READ/CREATE/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-payment-batch"],
    summary="",
...
async def u_pdate_schedule_payment_batch_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseSchedulePaymentBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSchedulePaymentBatchApi.subclasses[0]().u_pdate_schedule_payment_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, schedule_payment_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
