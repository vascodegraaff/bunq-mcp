...
class BaseRelationUserRequestInvitorApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseRelationUserRequestInvitorApi.subclasses = BaseRelationUserRequestInvitorApi.subclasses + (cls,)
    async def c_reate_relation_user_request_invitor_for_user(
        ...
        relation_user_request_invitor: RelationUserRequestInvitor,
