...
class BaseGinmonAccountProofOfResidenceApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonAccountProofOfResidenceApi.subclasses = BaseGinmonAccountProofOfResidenceApi.subclasses + (cls,)
    async def c_reate_ginmon_account_proof_of_residence_for_user_ginmon_account(
        self,
        userID: StrictInt,
        ginmon-accountID: StrictInt,
        ...
        ginmon_account_proof_of_residence: GinmonAccountProofOfResidence,
