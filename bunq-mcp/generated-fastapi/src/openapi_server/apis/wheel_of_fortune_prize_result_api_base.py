...
from openapi_server.models.wheel_of_fortune_prize_result_listing import WheelOfFortunePrizeResultListing


class BaseWheelOfFortunePrizeResultApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseWheelOfFortunePrizeResultApi.subclasses = BaseWheelOfFortunePrizeResultApi.subclasses + (cls,)
    async def list_all_wheel_of_fortune_prize_result_for_user(
        self,
        userID: StrictInt,
    ...
    ) -> List[WheelOfFortunePrizeResultListing]:
        """Endpoint to view Wheel of Fortune prize result in current Wheel of Fortune round. apiApp:LISTING"""
        ...
