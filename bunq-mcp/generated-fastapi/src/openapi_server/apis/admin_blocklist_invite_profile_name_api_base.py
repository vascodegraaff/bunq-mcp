...
class BaseAdminBlocklistInviteProfileNameApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminBlocklistInviteProfileNameApi.subclasses = BaseAdminBlocklistInviteProfileNameApi.subclasses + (cls,)
    async def c_reate_admin_blocklist_invite_profile_name(
        ...
        admin_blocklist_invite_profile_name: AdminBlocklistInviteProfileName,
