...
class BaseLivingSituationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseLivingSituationApi.subclasses = BaseLivingSituationApi.subclasses + (cls,)
    async def c_reate_living_situation_for_user(
        ...
        user_person_living_situation: UserPersonLivingSituation,
