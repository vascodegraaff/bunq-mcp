...
class BaseInsightPreferenceMonetaryAccountApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInsightPreferenceMonetaryAccountApi.subclasses = BaseInsightPreferenceMonetaryAccountApi.subclasses + (cls,)
