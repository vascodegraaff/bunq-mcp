...
class BaseTransferwiseRecipientRequirementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransferwiseRecipientRequirementApi.subclasses = BaseTransferwiseRecipientRequirementApi.subclasses + (cls,)
    async def c_reate_transferwise_recipient_requirement_for_user_transferwise_quote(
        ...
        transferwise_account_requirement: TransferwiseAccountRequirement,
