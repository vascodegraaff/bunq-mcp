...
from openapi_server.apis.admin_report_api_base import BaseAdminReportApi
...
from openapi_server.models.admin_report_read import AdminReportRead
...
@router.get(
    "/user/{userID}/admin-report/{itemId}",
    responses={
        200: {"model": AdminReportRead, "description": "View endpoint for a report file. apiAdmin:READ apiServiceInternal:READ"},
...
async def r_ead_admin_report_for_user(
    ...
    """View endpoint for a report file. apiAdmin:READ apiServiceInternal:READ"""
    if not BaseAdminReportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminReportApi.subclasses[0]().r_ead_admin_report_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
