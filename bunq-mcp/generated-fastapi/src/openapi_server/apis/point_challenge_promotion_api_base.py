...
class BasePointChallengePromotionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePointChallengePromotionApi.subclasses = BasePointChallengePromotionApi.subclasses + (cls,)
    async def c_reate_point_challenge_promotion_for_user(
        ...
        point_challenge_promotion: PointChallengePromotion,
