...
from openapi_server.apis.input_api_base import BaseInputApi
...
from openapi_server.models.vonage_call_incoming_input import VonageCallIncomingInput
from openapi_server.models.vonage_call_incoming_input_create import VonageCallIncomingInputCreate
...
@router.post(
    "/vonage-call-incoming/{vonage-call-incomingID}/input",
    responses={
        200: {"model": VonageCallIncomingInputCreate, "description": "Process input given during an incoming call from Vonage. apiVonage:CREATE"},
...
async def c_reate_input_for_vonage_call_incoming(
    ...
    vonage_call_incoming_input: VonageCallIncomingInput = Body(None, description=""),
...
) -> VonageCallIncomingInputCreate:
    """Process input given during an incoming call from Vonage. apiVonage:CREATE"""
    if not BaseInputApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInputApi.subclasses[0]().c_reate_input_for_vonage_call_incoming(vonage-call-incomingID, user_agent, x_bunq_client_authentication, vonage_call_incoming_input, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
