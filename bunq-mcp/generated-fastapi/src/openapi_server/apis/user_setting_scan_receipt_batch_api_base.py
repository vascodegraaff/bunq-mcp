...
class BaseUserSettingScanReceiptBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingScanReceiptBatchApi.subclasses = BaseUserSettingScanReceiptBatchApi.subclasses + (cls,)
    async def c_reate_user_setting_scan_receipt_batch_for_user(
        ...
        user_setting_scan_receipt_batch: UserSettingScanReceiptBatch,
