...
class BaseMonetaryAccountBlockApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMonetaryAccountBlockApi.subclasses = BaseMonetaryAccountBlockApi.subclasses + (cls,)
    async def c_reate_monetary_account_block_for_user(
        ...
        admin_monetary_account_block: AdminMonetaryAccountBlock,
