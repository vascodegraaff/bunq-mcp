...
class BaseAdminPartnerPromotionPrizeVoucherBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionPrizeVoucherBatchApi.subclasses = BaseAdminPartnerPromotionPrizeVoucherBatchApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_prize_voucher_batch(
        ...
        admin_partner_promotion_prize_voucher_batch: AdminPartnerPromotionPrizeVoucherBatch,
