...
class BaseUserEmploymentStatusApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserEmploymentStatusApi.subclasses = BaseUserEmploymentStatusApi.subclasses + (cls,)
    async def c_reate_user_employment_status_for_user(
        ...
        user_employment_status: UserEmploymentStatus,
