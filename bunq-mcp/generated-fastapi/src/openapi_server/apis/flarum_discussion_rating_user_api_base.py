...
class BaseFlarumDiscussionRatingUserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseFlarumDiscussionRatingUserApi.subclasses = BaseFlarumDiscussionRatingUserApi.subclasses + (cls,)
    async def c_reate_flarum_discussion_rating_user(
        ...
        flarum_discussion_rating_public_user: FlarumDiscussionRatingPublicUser,
