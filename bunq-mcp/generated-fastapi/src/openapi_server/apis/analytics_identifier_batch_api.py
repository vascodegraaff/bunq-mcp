...
from openapi_server.apis.analytics_identifier_batch_api_base import BaseAnalyticsIdentifierBatchApi
...
from openapi_server.models.analytics_identifier_batch import AnalyticsIdentifierBatch
from openapi_server.models.analytics_identifier_batch_create import AnalyticsIdentifierBatchCreate
...
@router.post(
    "/user/{userID}/device/{deviceID}/analytics-identifier-batch",
    responses={
        200: {"model": AnalyticsIdentifierBatchCreate, "description": "Endpoint to manage analytics identifiers. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["analytics-identifier-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_analytics_identifier_batch_for_user_device(
    ...
    analytics_identifier_batch: AnalyticsIdentifierBatch = Body(None, description=""),
...
) -> AnalyticsIdentifierBatchCreate:
    """Endpoint to manage analytics identifiers. apiApp:CREATE"""
    if not BaseAnalyticsIdentifierBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAnalyticsIdentifierBatchApi.subclasses[0]().c_reate_analytics_identifier_batch_for_user_device(userID, deviceID, user_agent, x_bunq_client_authentication, analytics_identifier_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
