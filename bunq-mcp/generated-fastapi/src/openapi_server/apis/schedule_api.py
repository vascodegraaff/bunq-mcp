...
from openapi_server.apis.schedule_api_base import BaseScheduleApi
...
@router.get(
    ...
    responses={
        200: {"model": List[object], "description": "view for reading the scheduled definitions. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"},
...
async def list_all_schedule_for_user(
    ...
    if not BaseScheduleApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleApi.subclasses[0]().list_all_schedule_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule",
    responses={
        200: {"model": List[ScheduleListing], "description": "view for reading the scheduled definitions. apiAdmin:READ/LISTING apiApp:READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule"],
    summary="",
...
async def list_all_schedule_for_user_monetary_account(
    ...
    if not BaseScheduleApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleApi.subclasses[0]().list_all_schedule_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule/{itemId}",
    responses={
        200: {"model": ScheduleRead, "description": "view for reading the scheduled definitions. apiAdmin:READ/LISTING apiApp:READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule"],
    summary="",
...
async def r_ead_schedule_for_user_monetary_account(
    ...
    if not BaseScheduleApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleApi.subclasses[0]().r_ead_schedule_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
