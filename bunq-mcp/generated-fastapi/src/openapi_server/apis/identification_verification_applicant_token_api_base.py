...
class BaseIdentificationVerificationApplicantTokenApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdentificationVerificationApplicantTokenApi.subclasses = BaseIdentificationVerificationApplicantTokenApi.subclasses + (cls,)
    async def c_reate_identification_verification_applicant_token_for_user(
        ...
        user_identification_verification_applicant_token: UserIdentificationVerificationApplicantToken,
