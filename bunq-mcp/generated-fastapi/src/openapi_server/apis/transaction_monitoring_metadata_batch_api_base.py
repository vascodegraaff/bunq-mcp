...
class BaseTransactionMonitoringMetadataBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransactionMonitoringMetadataBatchApi.subclasses = BaseTransactionMonitoringMetadataBatchApi.subclasses + (cls,)
    async def c_reate_transaction_monitoring_metadata_batch(
        ...
        transaction_monitoring_metadata_batch: TransactionMonitoringMetadataBatch,
