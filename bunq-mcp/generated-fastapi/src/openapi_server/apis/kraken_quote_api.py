...
from openapi_server.apis.kraken_quote_api_base import BaseKrakenQuoteApi
...
from openapi_server.models.kraken_quote import KrakenQuote
from openapi_server.models.kraken_quote_create import KrakenQuoteCreate
from openapi_server.models.kraken_quote_read import KrakenQuoteRead
from openapi_server.models.kraken_quote_update import KrakenQuoteUpdate
...
@router.post(
    "/user/{userID}/kraken-account/{kraken-accountID}/kraken-quote",
    responses={
        200: {"model": KrakenQuoteCreate, "description": "Create Kraken Quote. apiApp:CREATE/READ/UPDATE"},
...
async def c_reate_kraken_quote_for_user_kraken_account(
    userID: StrictInt = Path(..., description=""),
    kraken-accountID: StrictInt = Path(..., description=""),
    ...
    kraken_quote: KrakenQuote = Body(None, description=""),
    ...
    """Create Kraken Quote. apiApp:CREATE/READ/UPDATE"""
    if not BaseKrakenQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseKrakenQuoteApi.subclasses[0]().c_reate_kraken_quote_for_user_kraken_account(userID, kraken-accountID, user_agent, x_bunq_client_authentication, kraken_quote, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/kraken-account/{kraken-accountID}/kraken-quote/{itemId}",
    responses={
        200: {"model": KrakenQuoteRead, "description": "Create Kraken Quote. apiApp:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["kraken-quote"],
    summary="",
...
async def r_ead_kraken_quote_for_user_kraken_account(
    userID: StrictInt = Path(..., description=""),
    kraken-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseKrakenQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseKrakenQuoteApi.subclasses[0]().r_ead_kraken_quote_for_user_kraken_account(userID, kraken-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/kraken-account/{kraken-accountID}/kraken-quote/{itemId}",
    responses={
        200: {"model": KrakenQuoteUpdate, "description": "Create Kraken Quote. apiApp:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["kraken-quote"],
    summary="",
...
async def u_pdate_kraken_quote_for_user_kraken_account(
    userID: StrictInt = Path(..., description=""),
    kraken-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseKrakenQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseKrakenQuoteApi.subclasses[0]().u_pdate_kraken_quote_for_user_kraken_account(userID, kraken-accountID, itemId, user_agent, x_bunq_client_authentication, kraken_quote, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
