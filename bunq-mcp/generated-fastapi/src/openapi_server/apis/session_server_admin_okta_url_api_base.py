...
class BaseSessionServerAdminOktaUrlApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionServerAdminOktaUrlApi.subclasses = BaseSessionServerAdminOktaUrlApi.subclasses + (cls,)
    async def c_reate_session_server_admin_okta_url(
        ...
        session_server_admin_okta_url: SessionServerAdminOktaUrl,
