...
class BaseBillingContractSubscriptionProductAvailabilityApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBillingContractSubscriptionProductAvailabilityApi.subclasses = BaseBillingContractSubscriptionProductAvailabilityApi.subclasses + (cls,)
