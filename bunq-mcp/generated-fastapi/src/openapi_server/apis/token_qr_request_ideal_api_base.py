...
class BaseTokenQrRequestIdealApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrRequestIdealApi.subclasses = BaseTokenQrRequestIdealApi.subclasses + (cls,)
    async def c_reate_token_qr_request_ideal_for_user(
        ...
        token_qr_request_ideal: TokenQrRequestIdeal,
