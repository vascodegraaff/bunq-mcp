...
class BaseAdminAdyenCheckoutMessageApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAdyenCheckoutMessageApi.subclasses = BaseAdminAdyenCheckoutMessageApi.subclasses + (cls,)
    async def u_pdate_admin_adyen_checkout_message(
        ...
        admin_adyen_checkout_message: AdminAdyenCheckoutMessage,
