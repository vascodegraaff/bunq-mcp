...
from openapi_server.apis.is_a_api_base import BaseIsAApi
...
from openapi_server.models.is_alias import IsAlias
from openapi_server.models.is_alias_create import IsAliasCreate
...
@router.post(
    "/device/{deviceID}/is-a",
    responses={
        200: {"model": IsAliasCreate, "description": "Checks whether an array of inputs is or is not a valid alias. Non-REST. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reateis_a_for_device(
    ...
    is_alias: IsAlias = Body(None, description=""),
    ...
    """Checks whether an array of inputs is or is not a valid alias. Non-REST. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseIsAApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIsAApi.subclasses[0]().c_reateis_a_for_device(deviceID, user_agent, x_bunq_client_authentication, is_alias, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
