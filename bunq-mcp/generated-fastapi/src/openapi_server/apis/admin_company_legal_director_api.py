...
from openapi_server.apis.admin_company_legal_director_api_base import BaseAdminCompanyLegalDirectorApi
...
from openapi_server.models.admin_company_legal_director import AdminCompanyLegalDirector
from openapi_server.models.admin_company_legal_director_create import AdminCompanyLegalDirectorCreate
...
@router.post(
    "/user-company/{user-companyID}/admin-company-legal-director",
    responses={
        200: {"model": AdminCompanyLegalDirectorCreate, "description": "Manage the company legal director details. apiAdmin:CREATE/DELETE apiServiceInternal:CREATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-company-legal-director"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_company_legal_director_for_user_company(
    ...
    admin_company_legal_director: AdminCompanyLegalDirector = Body(None, description=""),
...
) -> AdminCompanyLegalDirectorCreate:
    """Manage the company legal director details. apiAdmin:CREATE/DELETE apiServiceInternal:CREATE/DELETE"""
    if not BaseAdminCompanyLegalDirectorApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminCompanyLegalDirectorApi.subclasses[0]().c_reate_admin_company_legal_director_for_user_company(user-companyID, user_agent, x_bunq_client_authentication, admin_company_legal_director, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user-company/{user-companyID}/admin-company-legal-director/{itemId}",
    responses={
        200: {"model": object, "description": "Manage the company legal director details. apiAdmin:CREATE/DELETE apiServiceInternal:CREATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-company-legal-director"],
    summary="",
...
async def d_elete_admin_company_legal_director_for_user_company(
    user-companyID: StrictInt = Path(..., description=""),
    ...
    if not BaseAdminCompanyLegalDirectorApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminCompanyLegalDirectorApi.subclasses[0]().d_elete_admin_company_legal_director_for_user_company(user-companyID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
