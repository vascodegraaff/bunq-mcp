...
class BaseSessionRegistryRefreshApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionRegistryRefreshApi.subclasses = BaseSessionRegistryRefreshApi.subclasses + (cls,)
    async def c_reate_session_registry_refresh(
        ...
        session_registry_refresh: SessionRegistryRefresh,
