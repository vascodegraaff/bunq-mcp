...
class BaseUserSettingCommunicationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingCommunicationApi.subclasses = BaseUserSettingCommunicationApi.subclasses + (cls,)
    async def c_reate_user_setting_communication_for_user(
        ...
        user_setting_communication: UserSettingCommunication,
