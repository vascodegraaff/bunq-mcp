...
from openapi_server.apis.card_batch_replace_api_base import BaseCardBatchReplaceApi
...
from openapi_server.models.card_batch_replace import CardBatchReplace
from openapi_server.models.card_batch_replace_create import CardBatchReplaceCreate
...
@router.post(
    ...
    responses={
        200: {"model": CardBatchReplaceCreate, "description": "Used to replace multiple cards in a batch. apiPublic:CREATE"},
...
async def c_reate_card_batch_replace_for_user(
    ...
    card_batch_replace: CardBatchReplace = Body(None, description=""),
    ...
    """Used to replace multiple cards in a batch. apiPublic:CREATE"""
    if not BaseCardBatchReplaceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCardBatchReplaceApi.subclasses[0]().c_reate_card_batch_replace_for_user(userID, user_agent, x_bunq_client_authentication, card_batch_replace, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
