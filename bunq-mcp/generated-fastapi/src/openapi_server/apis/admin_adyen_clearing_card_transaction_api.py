...
from openapi_server.apis.admin_adyen_clearing_card_transaction_api_base import BaseAdminAdyenClearingCardTransactionApi
...
from openapi_server.models.admin_adyen_clearing_card_transaction import AdminAdyenClearingCardTransaction
from openapi_server.models.admin_adyen_clearing_card_transaction_update import AdminAdyenClearingCardTransactionUpdate
...
@router.put(
    "/admin-adyen-clearing-card-transaction/{itemId}",
    responses={
        200: {"model": AdminAdyenClearingCardTransactionUpdate, "description": "Manage Adyen Clearings. apiAdmin:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-adyen-clearing-card-transaction"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_admin_adyen_clearing_card_transaction(
    ...
    admin_adyen_clearing_card_transaction: AdminAdyenClearingCardTransaction = Body(None, description=""),
...
) -> AdminAdyenClearingCardTransactionUpdate:
    """Manage Adyen Clearings. apiAdmin:UPDATE"""
    if not BaseAdminAdyenClearingCardTransactionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminAdyenClearingCardTransactionApi.subclasses[0]().u_pdate_admin_adyen_clearing_card_transaction(itemId, user_agent, x_bunq_client_authentication, admin_adyen_clearing_card_transaction, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
