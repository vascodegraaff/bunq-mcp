...
class BaseMifidNationalClientIdentifierApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMifidNationalClientIdentifierApi.subclasses = BaseMifidNationalClientIdentifierApi.subclasses + (cls,)
    async def c_reate_mifid_national_client_identifier_for_user(
        ...
        mifid_national_client_identifier: MifidNationalClientIdentifier,
