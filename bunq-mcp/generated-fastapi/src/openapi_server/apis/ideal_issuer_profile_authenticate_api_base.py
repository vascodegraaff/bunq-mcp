...
class BaseIdealIssuerProfileAuthenticateApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdealIssuerProfileAuthenticateApi.subclasses = BaseIdealIssuerProfileAuthenticateApi.subclasses + (cls,)
    async def c_reate_ideal_issuer_profile_authenticate_for_user(
        ...
        ideal_issuer_profile_authentication: IdealIssuerProfileAuthentication,
