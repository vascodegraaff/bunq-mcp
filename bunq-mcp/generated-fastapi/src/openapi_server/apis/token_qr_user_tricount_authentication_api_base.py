...
class BaseTokenQrUserTricountAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrUserTricountAuthenticationApi.subclasses = BaseTokenQrUserTricountAuthenticationApi.subclasses + (cls,)
    async def c_reate_token_qr_user_tricount_authentication_for_user(
        ...
        token_qr_user_tricount_authentication: TokenQrUserTricountAuthentication,
