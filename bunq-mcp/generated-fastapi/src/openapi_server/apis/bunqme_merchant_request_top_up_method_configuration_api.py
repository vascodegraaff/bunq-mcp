...
from openapi_server.apis.bunqme_merchant_request_top_up_method_configuration_api_base import BaseBunqmeMerchantRequestTopUpMethodConfigurationApi
...
from openapi_server.models.bunq_me_merchant_request_top_up_method_configuration import BunqMeMerchantRequestTopUpMethodConfiguration
from openapi_server.models.bunq_me_merchant_request_top_up_method_configuration_create import BunqMeMerchantRequestTopUpMethodConfigurationCreate
...
@router.post(
    ...
    responses={
        200: {"model": BunqMeMerchantRequestTopUpMethodConfigurationCreate, "description": "List all the available top-up method configurations for bunq.me. apiBunqMe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request-top-up-method-configuration"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bunqme_merchant_request_top_up_method_configuration(
    ...
    bunq_me_merchant_request_top_up_method_configuration: BunqMeMerchantRequestTopUpMethodConfiguration = Body(None, description=""),
...
) -> BunqMeMerchantRequestTopUpMethodConfigurationCreate:
    """List all the available top-up method configurations for bunq.me. apiBunqMe:CREATE"""
    if not BaseBunqmeMerchantRequestTopUpMethodConfigurationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestTopUpMethodConfigurationApi.subclasses[0]().c_reate_bunqme_merchant_request_top_up_method_configuration(user_agent, x_bunq_client_authentication, bunq_me_merchant_request_top_up_method_configuration, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
