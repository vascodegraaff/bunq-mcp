...
from openapi_server.apis.export_zip_api_base import BaseExportZipApi
...
@router.get(
    "/user/{userID}/registry/{registryID}/export-zip",
    responses={
        200: {"model": List[object], "description": "Retrieve a ZIP file containing PDF+CSV exports of a registry apiAdmin:LISTING apiApp:LISTING"},
...
async def list_all_export_zip_for_user_registry(
    ...
    if not BaseExportZipApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExportZipApi.subclasses[0]().list_all_export_zip_for_user_registry(userID, registryID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
