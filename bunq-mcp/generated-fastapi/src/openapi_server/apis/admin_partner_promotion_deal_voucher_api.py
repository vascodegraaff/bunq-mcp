...
from openapi_server.apis.admin_partner_promotion_deal_voucher_api_base import BaseAdminPartnerPromotionDealVoucherApi
...
from openapi_server.models.admin_partner_promotion_deal_voucher import AdminPartnerPromotionDealVoucher
from openapi_server.models.admin_partner_promotion_deal_voucher_create import AdminPartnerPromotionDealVoucherCreate
...
@router.post(
    "/admin-partner-promotion-deal-voucher",
    responses={
        200: {"model": AdminPartnerPromotionDealVoucherCreate, "description": "Endpoint to create batch of vouchers. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-partner-promotion-deal-voucher"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_partner_promotion_deal_voucher(
    ...
    admin_partner_promotion_deal_voucher: AdminPartnerPromotionDealVoucher = Body(None, description=""),
...
) -> AdminPartnerPromotionDealVoucherCreate:
    """Endpoint to create batch of vouchers. apiAdmin:CREATE"""
    if not BaseAdminPartnerPromotionDealVoucherApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPartnerPromotionDealVoucherApi.subclasses[0]().c_reate_admin_partner_promotion_deal_voucher(user_agent, x_bunq_client_authentication, admin_partner_promotion_deal_voucher, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
