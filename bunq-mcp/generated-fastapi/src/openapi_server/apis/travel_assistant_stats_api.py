...
from openapi_server.apis.travel_assistant_stats_api_base import BaseTravelAssistantStatsApi
...
@router.get(
    "/user/{userID}/travel-assistant-stats",
    responses={
        200: {"model": List[List[str]], "description": "Travel Assistant statistics for a user. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["travel-assistant-stats"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_travel_assistant_stats_for_user(
    ...
    """Travel Assistant statistics for a user. apiApp:LISTING"""
    if not BaseTravelAssistantStatsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTravelAssistantStatsApi.subclasses[0]().list_all_travel_assistant_stats_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
