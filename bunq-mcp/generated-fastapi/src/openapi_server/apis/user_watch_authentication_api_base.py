...
class BaseUserWatchAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserWatchAuthenticationApi.subclasses = BaseUserWatchAuthenticationApi.subclasses + (cls,)
    async def c_reate_user_watch_authentication(
        ...
        user_watch_authentication: UserWatchAuthentication,
