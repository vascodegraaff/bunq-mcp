...
class BaseCheckoutMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCheckoutMerchantTransactionApi.subclasses = BaseCheckoutMerchantTransactionApi.subclasses + (cls,)
    async def c_reate_checkout_merchant_transaction_for_user_monetary_account(
        ...
        checkout_merchant_transaction: CheckoutMerchantTransaction,
