...
from openapi_server.apis.partner_signup_check24_api_base import BasePartnerSignupCheck24Api
...
@router.post(
    ...
    responses={
        200: {"model": PartnerSignupCheck24Create, "description": "Used to allow Check24 to create user&#39;s that signed up through their platform. apiCheck24:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["partner-signup-check24"],
    summary="",
...
async def c_reate_partner_signup_check24(
    ...
    partner_signup_check24: PartnerSignupCheck24 = Body(None, description=""),
    ...
    if not BasePartnerSignupCheck24Api.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePartnerSignupCheck24Api.subclasses[0]().c_reate_partner_signup_check24(user_agent, x_bunq_client_authentication, partner_signup_check24, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
