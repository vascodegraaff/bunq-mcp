...
class BaseAdminAdyenClearingCardTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAdyenClearingCardTransactionApi.subclasses = BaseAdminAdyenClearingCardTransactionApi.subclasses + (cls,)
    async def u_pdate_admin_adyen_clearing_card_transaction(
        ...
        admin_adyen_clearing_card_transaction: AdminAdyenClearingCardTransaction,
