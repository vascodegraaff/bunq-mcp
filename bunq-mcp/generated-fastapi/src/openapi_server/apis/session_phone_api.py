...
from openapi_server.apis.session_phone_api_base import BaseSessionPhoneApi
...
from openapi_server.models.session_phone import SessionPhone
from openapi_server.models.session_phone_create import SessionPhoneCreate
...
@router.post(
    "/session-phone",
    responses={
        200: {"model": SessionPhoneCreate, "description": "Used to log in a user with a phone. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_session_phone(
    ...
    session_phone: SessionPhone = Body(None, description=""),
    ...
    """Used to log in a user with a phone. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseSessionPhoneApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionPhoneApi.subclasses[0]().c_reate_session_phone(user_agent, x_bunq_client_authentication, session_phone, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
