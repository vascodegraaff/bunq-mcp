...
from openapi_server.apis.cost_disclosure_api_base import BaseCostDisclosureApi
...
from openapi_server.models.ginmon_cost_disclosure import GinmonCostDisclosure
from openapi_server.models.ginmon_cost_disclosure_create import GinmonCostDisclosureCreate
from openapi_server.models.ginmon_cost_disclosure_read import GinmonCostDisclosureRead
from openapi_server.models.ginmon_cost_disclosure_update import GinmonCostDisclosureUpdate
...
@router.post(
    "/user/{userID}/ginmon-account/{ginmon-accountID}/cost-disclosure",
    responses={
        200: {"model": GinmonCostDisclosureCreate, "description": "Endpoint for read/listing instruments for Ginmon. apiApp:CREATE/UPDATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["cost-disclosure"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_cost_disclosure_for_user_ginmon_account(
    userID: StrictInt = Path(..., description=""),
    ginmon-accountID: StrictInt = Path(..., description=""),
    ...
    ginmon_cost_disclosure: GinmonCostDisclosure = Body(None, description=""),
...
) -> GinmonCostDisclosureCreate:
    """Endpoint for read/listing instruments for Ginmon. apiApp:CREATE/UPDATE/READ"""
    if not BaseCostDisclosureApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCostDisclosureApi.subclasses[0]().c_reate_cost_disclosure_for_user_ginmon_account(userID, ginmon-accountID, user_agent, x_bunq_client_authentication, ginmon_cost_disclosure, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/ginmon-account/{ginmon-accountID}/cost-disclosure/{itemId}",
    responses={
        200: {"model": GinmonCostDisclosureRead, "description": "Endpoint for read/listing instruments for Ginmon. apiApp:CREATE/UPDATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["cost-disclosure"],
    summary="",
...
async def r_ead_cost_disclosure_for_user_ginmon_account(
    userID: StrictInt = Path(..., description=""),
    ginmon-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseCostDisclosureApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCostDisclosureApi.subclasses[0]().r_ead_cost_disclosure_for_user_ginmon_account(userID, ginmon-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/ginmon-account/{ginmon-accountID}/cost-disclosure/{itemId}",
    responses={
        200: {"model": GinmonCostDisclosureUpdate, "description": "Endpoint for read/listing instruments for Ginmon. apiApp:CREATE/UPDATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["cost-disclosure"],
    summary="",
...
async def u_pdate_cost_disclosure_for_user_ginmon_account(
    userID: StrictInt = Path(..., description=""),
    ginmon-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> GinmonCostDisclosureUpdate:
    """Endpoint for read/listing instruments for Ginmon. apiApp:CREATE/UPDATE/READ"""
    if not BaseCostDisclosureApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCostDisclosureApi.subclasses[0]().u_pdate_cost_disclosure_for_user_ginmon_account(userID, ginmon-accountID, itemId, user_agent, x_bunq_client_authentication, ginmon_cost_disclosure, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
