...
from openapi_server.apis.ideal_entrance_code_api_base import BaseIdealEntranceCodeApi
...
from openapi_server.models.ideal_entrance_code import IdealEntranceCode
from openapi_server.models.ideal_entrance_code_create import IdealEntranceCodeCreate
...
@router.post(
    "/ideal-entrance-code",
    responses={
        200: {"model": IdealEntranceCodeCreate, "description": "View to pass an entrance code, in which case the associated transaction status will be polled nearly immediately. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ideal-entrance-code"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_ideal_entrance_code(
    ...
    ideal_entrance_code: IdealEntranceCode = Body(None, description=""),
...
) -> IdealEntranceCodeCreate:
    """View to pass an entrance code, in which case the associated transaction status will be polled nearly immediately. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseIdealEntranceCodeApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIdealEntranceCodeApi.subclasses[0]().c_reate_ideal_entrance_code(user_agent, x_bunq_client_authentication, ideal_entrance_code, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
