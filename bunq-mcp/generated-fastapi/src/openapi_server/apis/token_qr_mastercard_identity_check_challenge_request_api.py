...
from openapi_server.apis.token_qr_mastercard_identity_check_challenge_request_api_base import BaseTokenQrMastercardIdentityCheckChallengeRequestApi
...
from openapi_server.models.token_qr_master_card_identity_check_challenge_request import TokenQrMasterCardIdentityCheckChallengeRequest
from openapi_server.models.token_qr_master_card_identity_check_challenge_request_create import TokenQrMasterCardIdentityCheckChallengeRequestCreate
...
@router.post(
    "/user/{userID}/token-qr-mastercard-identity-check-challenge-request",
    responses={
        200: {"model": TokenQrMasterCardIdentityCheckChallengeRequestCreate, "description": "Find a MasterCardIdentityCheckChallengeRequest by its token, possibly coming from a QR code. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-mastercard-identity-check-challenge-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_mastercard_identity_check_challenge_request_for_user(
    ...
    token_qr_master_card_identity_check_challenge_request: TokenQrMasterCardIdentityCheckChallengeRequest = Body(None, description=""),
...
) -> TokenQrMasterCardIdentityCheckChallengeRequestCreate:
    """Find a MasterCardIdentityCheckChallengeRequest by its token, possibly coming from a QR code. apiApp:CREATE"""
    if not BaseTokenQrMastercardIdentityCheckChallengeRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrMastercardIdentityCheckChallengeRequestApi.subclasses[0]().c_reate_token_qr_mastercard_identity_check_challenge_request_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_master_card_identity_check_challenge_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
