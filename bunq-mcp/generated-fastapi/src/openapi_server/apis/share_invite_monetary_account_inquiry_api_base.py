...
class BaseShareInviteMonetaryAccountInquiryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseShareInviteMonetaryAccountInquiryApi.subclasses = BaseShareInviteMonetaryAccountInquiryApi.subclasses + (cls,)
    async def c_reate_share_invite_monetary_account_inquiry_for_user_monetary_account(
        ...
        share_invite_monetary_account_inquiry: ShareInviteMonetaryAccountInquiry,
