...
from openapi_server.apis.needi_merchandise_order_api_base import BaseNeediMerchandiseOrderApi
...
from openapi_server.models.needi_merchandise_order import NeediMerchandiseOrder
from openapi_server.models.needi_merchandise_order_create import NeediMerchandiseOrderCreate
...
@router.post(
    "/needi-merchandise-order",
    responses={
        200: {"model": NeediMerchandiseOrderCreate, "description": "Endpoint to get merchandise order updates from needi. apiNeedi:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["needi-merchandise-order"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_needi_merchandise_order(
    ...
    needi_merchandise_order: NeediMerchandiseOrder = Body(None, description=""),
...
) -> NeediMerchandiseOrderCreate:
    """Endpoint to get merchandise order updates from needi. apiNeedi:CREATE"""
    if not BaseNeediMerchandiseOrderApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseNeediMerchandiseOrderApi.subclasses[0]().c_reate_needi_merchandise_order(user_agent, x_bunq_client_authentication, needi_merchandise_order, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
