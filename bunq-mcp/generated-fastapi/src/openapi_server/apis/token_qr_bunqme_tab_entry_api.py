...
from openapi_server.apis.token_qr_bunqme_tab_entry_api_base import BaseTokenQrBunqmeTabEntryApi
...
from openapi_server.models.token_qr_bunq_me_tab_entry import TokenQrBunqMeTabEntry
from openapi_server.models.token_qr_bunq_me_tab_entry_create import TokenQrBunqMeTabEntryCreate
...
@router.post(
    "/user/{userID}/token-qr-bunqme-tab-entry",
    responses={
        200: {"model": TokenQrBunqMeTabEntryCreate, "description": "Usage of this endpoint (by scanning a QR code) results in a bunq.me tab entry. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-bunqme-tab-entry"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_bunqme_tab_entry_for_user(
    ...
    token_qr_bunq_me_tab_entry: TokenQrBunqMeTabEntry = Body(None, description=""),
...
) -> TokenQrBunqMeTabEntryCreate:
    """Usage of this endpoint (by scanning a QR code) results in a bunq.me tab entry. apiApp:CREATE"""
    if not BaseTokenQrBunqmeTabEntryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrBunqmeTabEntryApi.subclasses[0]().c_reate_token_qr_bunqme_tab_entry_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_bunq_me_tab_entry, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
