...
from openapi_server.apis.paysafecash_transaction_webhook_api_base import BasePaysafecashTransactionWebhookApi
...
from openapi_server.models.paysafecash_transaction_confirmation import PaysafecashTransactionConfirmation
from openapi_server.models.paysafecash_transaction_confirmation_create import PaysafecashTransactionConfirmationCreate
...
@router.post(
    ...
    responses={
        200: {"model": PaysafecashTransactionConfirmationCreate, "description": "Used as a webhook for Paysafecash. apiPaysafe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["paysafecash-transaction-webhook"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_paysafecash_transaction_webhook(
    ...
    paysafecash_transaction_confirmation: PaysafecashTransactionConfirmation = Body(None, description=""),
...
) -> PaysafecashTransactionConfirmationCreate:
    """Used as a webhook for Paysafecash. apiPaysafe:CREATE"""
    if not BasePaysafecashTransactionWebhookApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePaysafecashTransactionWebhookApi.subclasses[0]().c_reate_paysafecash_transaction_webhook(user_agent, x_bunq_client_authentication, paysafecash_transaction_confirmation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
