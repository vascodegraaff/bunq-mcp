...
from openapi_server.apis.admin_ticket_email_api_base import BaseAdminTicketEmailApi
...
from openapi_server.models.admin_ticket_email import AdminTicketEmail
from openapi_server.models.admin_ticket_email_create import AdminTicketEmailCreate
...
@router.post(
    "/admin-ticket-email",
    responses={
        200: {"model": AdminTicketEmailCreate, "description": "The endpoint for creating email tickets apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-ticket-email"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_ticket_email(
    ...
    admin_ticket_email: AdminTicketEmail = Body(None, description=""),
...
) -> AdminTicketEmailCreate:
    """The endpoint for creating email tickets apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseAdminTicketEmailApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminTicketEmailApi.subclasses[0]().c_reate_admin_ticket_email(user_agent, x_bunq_client_authentication, admin_ticket_email, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
