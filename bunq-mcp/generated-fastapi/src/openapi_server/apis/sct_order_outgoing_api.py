...
from openapi_server.apis.sct_order_outgoing_api_base import BaseSctOrderOutgoingApi
...
from openapi_server.models.sct_order_outgoing_read import SctOrderOutgoingRead
...
@router.get(
    "/sct-order-outgoing/{itemId}",
    responses={
        200: {"model": SctOrderOutgoingRead, "description": "Endpoint used by the search API. apiAdmin:READ apiServiceInternal:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["sct-order-outgoing"],
    summary="",
    response_model_by_alias=True,
)
async def r_ead_sct_order_outgoing(
    ...
    if not BaseSctOrderOutgoingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSctOrderOutgoingApi.subclasses[0]().r_ead_sct_order_outgoing(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
