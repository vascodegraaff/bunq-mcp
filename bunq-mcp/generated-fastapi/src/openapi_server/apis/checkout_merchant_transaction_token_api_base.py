...
class BaseCheckoutMerchantTransactionTokenApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCheckoutMerchantTransactionTokenApi.subclasses = BaseCheckoutMerchantTransactionTokenApi.subclasses + (cls,)
    async def c_reate_checkout_merchant_transaction_token_for_user_monetary_account(
        ...
        checkout_merchant_transaction_token: CheckoutMerchantTransactionToken,
