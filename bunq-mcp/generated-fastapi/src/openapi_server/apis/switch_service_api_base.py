...
from openapi_server.models.bank_switch_service_netherlands_incoming import BankSwitchServiceNetherlandsIncoming
from openapi_server.models.bank_switch_service_netherlands_incoming_create import BankSwitchServiceNetherlandsIncomingCreate
from openapi_server.models.bank_switch_service_netherlands_incoming_listing import BankSwitchServiceNetherlandsIncomingListing
from openapi_server.models.bank_switch_service_netherlands_incoming_read import BankSwitchServiceNetherlandsIncomingRead
from openapi_server.models.bank_switch_service_netherlands_incoming_update import BankSwitchServiceNetherlandsIncomingUpdate
from openapi_server.models.create1brn400_response import CREATE1brn400Response


class BaseSwitchServiceApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSwitchServiceApi.subclasses = BaseSwitchServiceApi.subclasses + (cls,)
    async def c_reate_switch_service_for_user(
        self,
        userID: StrictInt,
        ...
        bank_switch_service_netherlands_incoming: BankSwitchServiceNetherlandsIncoming,
    ...
    ) -> BankSwitchServiceNetherlandsIncomingCreate:
        """Endpoint for using the Equens Bank Switch Service. apiAdmin:CREATE/READ/UPDATE/LISTING apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:CREATE/READ/UPDATE/LISTING"""
        ...


    async def list_all_switch_service_for_user(
        self,
        userID: StrictInt,
        user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")],
        x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")],
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> List[BankSwitchServiceNetherlandsIncomingListing]:
        """Endpoint for using the Equens Bank Switch Service. apiAdmin:CREATE/READ/UPDATE/LISTING apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:CREATE/READ/UPDATE/LISTING"""
        ...


    async def r_ead_switch_service_for_user(
        self,
        userID: StrictInt,
        itemId: StrictInt,
        user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")],
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> BankSwitchServiceNetherlandsIncomingRead:
        """Endpoint for using the Equens Bank Switch Service. apiAdmin:CREATE/READ/UPDATE/LISTING apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:CREATE/READ/UPDATE/LISTING"""
        ...


    async def u_pdate_switch_service_for_user(
        self,
        userID: StrictInt,
        itemId: StrictInt,
        user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")],
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> BankSwitchServiceNetherlandsIncomingUpdate:
        """Endpoint for using the Equens Bank Switch Service. apiAdmin:CREATE/READ/UPDATE/LISTING apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:CREATE/READ/UPDATE/LISTING"""
        ...
