...
from openapi_server.apis.whitelist_api_base import BaseWhitelistApi
...
@router.get(
    ...
    responses={
        200: {"model": List[object], "description": "Whitelist a Request so that when one comes in, it is automatically accepted. apiAdmin:READ/LISTING apiApp:READ/LISTING apiServiceInternal:READ/LISTING"},
...
async def list_all_whitelist_for_user(
    ...
    """Whitelist a Request so that when one comes in, it is automatically accepted. apiAdmin:READ/LISTING apiApp:READ/LISTING apiServiceInternal:READ/LISTING"""
    if not BaseWhitelistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWhitelistApi.subclasses[0]().list_all_whitelist_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/whitelist",
    responses={
        200: {"model": List[object], "description": "Whitelist a Request so that when one comes in, it is automatically accepted. apiApp:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["whitelist"],
    summary="",
...
async def list_all_whitelist_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    ...
    """Whitelist a Request so that when one comes in, it is automatically accepted. apiApp:READ/LISTING"""
    if not BaseWhitelistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWhitelistApi.subclasses[0]().list_all_whitelist_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/whitelist/{itemId}",
    responses={
        200: {"model": object, "description": "Whitelist a Request so that when one comes in, it is automatically accepted. apiAdmin:READ/LISTING apiApp:READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["whitelist"],
    summary="",
...
async def r_ead_whitelist_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseWhitelistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWhitelistApi.subclasses[0]().r_ead_whitelist_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/whitelist/{itemId}",
    responses={
        200: {"model": object, "description": "Whitelist a Request so that when one comes in, it is automatically accepted. apiApp:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["whitelist"],
    summary="",
...
async def r_ead_whitelist_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseWhitelistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWhitelistApi.subclasses[0]().r_ead_whitelist_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
