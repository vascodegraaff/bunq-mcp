...
class BaseFraudRegistryNetherlandsReportBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseFraudRegistryNetherlandsReportBatchApi.subclasses = BaseFraudRegistryNetherlandsReportBatchApi.subclasses + (cls,)
