...
from openapi_server.apis.price_public_api_base import BasePricePublicApi
...
from openapi_server.models.product_price_public_read import ProductPricePublicRead
...
@router.get(
    "/price-public/{itemId}",
    responses={
        200: {"model": ProductPricePublicRead, "description": "Used to view product public prices. apiAdmin:READ apiApp:READ apiServiceInternal:READ"},
...
async def r_ead_price_public(
    ...
    """Used to view product public prices. apiAdmin:READ apiApp:READ apiServiceInternal:READ"""
    if not BasePricePublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePricePublicApi.subclasses[0]().r_ead_price_public(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
