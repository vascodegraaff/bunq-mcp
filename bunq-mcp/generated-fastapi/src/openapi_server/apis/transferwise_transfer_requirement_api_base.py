...
class BaseTransferwiseTransferRequirementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransferwiseTransferRequirementApi.subclasses = BaseTransferwiseTransferRequirementApi.subclasses + (cls,)
    async def c_reate_transferwise_transfer_requirement_for_user_transferwise_quote(
        ...
        transferwise_transfer_requirement: TransferwiseTransferRequirement,
