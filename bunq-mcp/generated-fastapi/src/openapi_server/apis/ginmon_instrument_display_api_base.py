...
class BaseGinmonInstrumentDisplayApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonInstrumentDisplayApi.subclasses = BaseGinmonInstrumentDisplayApi.subclasses + (cls,)
    async def c_reate_ginmon_instrument_display(
        ...
        ginmon_instrument_display: GinmonInstrumentDisplay,
