...
class BaseBunqmeMerchantRequestSofortTransactionIdentifierApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestSofortTransactionIdentifierApi.subclasses = BaseBunqmeMerchantRequestSofortTransactionIdentifierApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request_sofort_transaction_identifier(
        ...
        bunq_me_merchant_request_sofort_transaction_identifier: BunqMeMerchantRequestSofortTransactionIdentifier,
