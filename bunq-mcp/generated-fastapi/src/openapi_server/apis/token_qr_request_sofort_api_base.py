...
class BaseTokenQrRequestSofortApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrRequestSofortApi.subclasses = BaseTokenQrRequestSofortApi.subclasses + (cls,)
    async def c_reate_token_qr_request_sofort_for_user(
        ...
        token_qr_request_sofort: TokenQrRequestSofort,
