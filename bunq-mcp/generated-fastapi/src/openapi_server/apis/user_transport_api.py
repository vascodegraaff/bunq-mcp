...
from openapi_server.apis.user_transport_api_base import BaseUserTransportApi
...
@router.post(
    "/user-transport",
    responses={
        200: {"model": UserTransportCreate, "description": "Public transport providers can create users through this endpoint. apiAdmin:READ/UPDATE apiPublic:CREATE/READ/LISTING apiServiceInternal:READ/UPDATE"},
...
async def c_reate_user_transport(
    ...
    user_transport: UserTransport = Body(None, description=""),
    ...
    if not BaseUserTransportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserTransportApi.subclasses[0]().c_reate_user_transport(user_agent, x_bunq_client_authentication, user_transport, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user-transport",
    responses={
        200: {"model": List[UserTransportListing], "description": "Public transport providers can create users through this endpoint. apiAdmin:READ/UPDATE apiPublic:CREATE/READ/LISTING apiServiceInternal:READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-transport"],
    summary="",
...
async def list_all_user_transport(
    ...
    if not BaseUserTransportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserTransportApi.subclasses[0]().list_all_user_transport(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user-transport/{itemId}",
    responses={
        200: {"model": UserTransportRead, "description": "Public transport providers can create users through this endpoint. apiAdmin:READ/UPDATE apiPublic:CREATE/READ/LISTING apiServiceInternal:READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-transport"],
    summary="",
...
async def r_ead_user_transport(
    ...
    if not BaseUserTransportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserTransportApi.subclasses[0]().r_ead_user_transport(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user-transport/{itemId}",
    responses={
        200: {"model": UserTransportUpdate, "description": "Public transport providers can create users through this endpoint. apiAdmin:READ/UPDATE apiPublic:CREATE/READ/LISTING apiServiceInternal:READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-transport"],
    summary="",
...
async def u_pdate_user_transport(
    ...
    if not BaseUserTransportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserTransportApi.subclasses[0]().u_pdate_user_transport(itemId, user_agent, x_bunq_client_authentication, user_transport, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
