...
class BaseUserSettingAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingAuthenticationApi.subclasses = BaseUserSettingAuthenticationApi.subclasses + (cls,)
    async def c_reate_user_setting_authentication_for_user(
        ...
        user_setting_authentication: UserSettingAuthentication,
