...
class BaseCommentPaymentInvestigationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCommentPaymentInvestigationApi.subclasses = BaseCommentPaymentInvestigationApi.subclasses + (cls,)
    async def c_reate_comment_payment_investigation_for_payment_investigation(
        self,
        payment-investigationID: StrictInt,
        ...
        admin_comment_payment_investigation: AdminCommentPaymentInvestigation,
