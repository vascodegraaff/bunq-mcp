...
from openapi_server.apis.transferwise_recipient_api_base import BaseTransferwiseRecipientApi
...
from openapi_server.models.transferwise_account_quote import TransferwiseAccountQuote
from openapi_server.models.transferwise_account_quote_create import TransferwiseAccountQuoteCreate
from openapi_server.models.transferwise_account_quote_listing import TransferwiseAccountQuoteListing
from openapi_server.models.transferwise_account_quote_read import TransferwiseAccountQuoteRead
...
@router.post(
    ...
    responses={
        200: {"model": TransferwiseAccountQuoteCreate, "description": "Used to manage recipient accounts with Transferwise. apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE"},
...
async def c_reate_transferwise_recipient_for_user_transferwise_quote(
    userID: StrictInt = Path(..., description=""),
    transferwise-quoteID: StrictInt = Path(..., description=""),
    ...
    transferwise_account_quote: TransferwiseAccountQuote = Body(None, description=""),
    ...
    """Used to manage recipient accounts with Transferwise. apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE"""
    if not BaseTransferwiseRecipientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransferwiseRecipientApi.subclasses[0]().c_reate_transferwise_recipient_for_user_transferwise_quote(userID, transferwise-quoteID, user_agent, x_bunq_client_authentication, transferwise_account_quote, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/transferwise-quote/{transferwise-quoteID}/transferwise-recipient/{itemId}",
    responses={
        200: {"model": object, "description": "Used to manage recipient accounts with Transferwise. apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transferwise-recipient"],
    summary="",
...
async def d_elete_transferwise_recipient_for_user_transferwise_quote(
    userID: StrictInt = Path(..., description=""),
    transferwise-quoteID: StrictInt = Path(..., description=""),
    ...
    if not BaseTransferwiseRecipientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransferwiseRecipientApi.subclasses[0]().d_elete_transferwise_recipient_for_user_transferwise_quote(userID, transferwise-quoteID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/transferwise-quote/{transferwise-quoteID}/transferwise-recipient",
    responses={
        200: {"model": List[TransferwiseAccountQuoteListing], "description": "Used to manage recipient accounts with Transferwise. apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transferwise-recipient"],
    summary="",
...
async def list_all_transferwise_recipient_for_user_transferwise_quote(
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[TransferwiseAccountQuoteListing]:
    """Used to manage recipient accounts with Transferwise. apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE"""
    if not BaseTransferwiseRecipientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransferwiseRecipientApi.subclasses[0]().list_all_transferwise_recipient_for_user_transferwise_quote(userID, transferwise-quoteID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/transferwise-quote/{transferwise-quoteID}/transferwise-recipient/{itemId}",
    responses={
        200: {"model": TransferwiseAccountQuoteRead, "description": "Used to manage recipient accounts with Transferwise. apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transferwise-recipient"],
    summary="",
...
async def r_ead_transferwise_recipient_for_user_transferwise_quote(
    userID: StrictInt = Path(..., description=""),
    transferwise-quoteID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseTransferwiseRecipientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransferwiseRecipientApi.subclasses[0]().r_ead_transferwise_recipient_for_user_transferwise_quote(userID, transferwise-quoteID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
