...
from openapi_server.apis.admin_attachment_api_base import BaseAdminAttachmentApi
...
from openapi_server.models.admin_attachment_conversation_create import AdminAttachmentConversationCreate
...
@router.post(
    "/user/{userID}/chat-conversation/{chat-conversationID}/admin-attachment",
    responses={
        200: {"model": AdminAttachmentConversationCreate, "description": "The attachment linked to a conversation&#39;s message. Attachments are submitted base64 encoded. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_admin_attachment_for_user_chat_conversation(
...
) -> AdminAttachmentConversationCreate:
    """The attachment linked to a conversation&#39;s message. Attachments are submitted base64 encoded. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseAdminAttachmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminAttachmentApi.subclasses[0]().c_reate_admin_attachment_for_user_chat_conversation(userID, chat-conversationID, user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
