...
class BaseMonetaryAccountInvestmentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMonetaryAccountInvestmentApi.subclasses = BaseMonetaryAccountInvestmentApi.subclasses + (cls,)
    async def c_reate_monetary_account_investment_for_user(
        ...
        monetary_account_investment: MonetaryAccountInvestment,
