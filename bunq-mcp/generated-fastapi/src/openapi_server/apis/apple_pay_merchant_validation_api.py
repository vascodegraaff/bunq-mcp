...
from openapi_server.apis.apple_pay_merchant_validation_api_base import BaseApplePayMerchantValidationApi
...
from openapi_server.models.apple_pay_merchant_validation import ApplePayMerchantValidation
from openapi_server.models.apple_pay_merchant_validation_create import ApplePayMerchantValidationCreate
...
@router.post(
    ...
    responses={
        200: {"model": ApplePayMerchantValidationCreate, "description": "Used to create a Apple Pay Merchant Validation Session object. apiBunqMe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["apple-pay-merchant-validation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_apple_pay_merchant_validation(
    ...
    apple_pay_merchant_validation: ApplePayMerchantValidation = Body(None, description=""),
...
) -> ApplePayMerchantValidationCreate:
    """Used to create a Apple Pay Merchant Validation Session object. apiBunqMe:CREATE"""
    if not BaseApplePayMerchantValidationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseApplePayMerchantValidationApi.subclasses[0]().c_reate_apple_pay_merchant_validation(user_agent, x_bunq_client_authentication, apple_pay_merchant_validation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
