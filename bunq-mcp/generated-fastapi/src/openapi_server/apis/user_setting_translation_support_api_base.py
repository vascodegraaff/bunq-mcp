...
class BaseUserSettingTranslationSupportApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingTranslationSupportApi.subclasses = BaseUserSettingTranslationSupportApi.subclasses + (cls,)
    async def c_reate_user_setting_translation_support_for_user(
        ...
        user_setting_translation_support: UserSettingTranslationSupport,
