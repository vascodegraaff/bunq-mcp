...
class BaseTravelInsurancePolicyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTravelInsurancePolicyApi.subclasses = BaseTravelInsurancePolicyApi.subclasses + (cls,)
    async def c_reate_travel_insurance_policy_for_user(
        ...
        travel_insurance_policy: TravelInsurancePolicy,
