...
class BaseInviteUserPersonalizedApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInviteUserPersonalizedApi.subclasses = BaseInviteUserPersonalizedApi.subclasses + (cls,)
    async def c_reate_invite_user_personalized_for_user(
        ...
        invite_user_personalized: InviteUserPersonalized,
