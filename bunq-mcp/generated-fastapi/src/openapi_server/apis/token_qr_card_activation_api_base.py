...
class BaseTokenQrCardActivationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrCardActivationApi.subclasses = BaseTokenQrCardActivationApi.subclasses + (cls,)
    async def c_reate_token_qr_card_activation_for_user(
        ...
        token_qr_card_activation: TokenQrCardActivation,
