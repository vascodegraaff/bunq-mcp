...
from openapi_server.models.card_replace import CardReplace
from openapi_server.models.card_replace_create import CardReplaceCreate


class BaseReplaceApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseReplaceApi.subclasses = BaseReplaceApi.subclasses + (cls,)
    async def c_reate_replace_for_user_card(
        self,
        userID: StrictInt,
        cardID: StrictInt,
