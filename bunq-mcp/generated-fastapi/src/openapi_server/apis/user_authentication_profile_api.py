...
from openapi_server.apis.user_authentication_profile_api_base import BaseUserAuthenticationProfileApi
...
from openapi_server.models.user_authentication_profile_listing import UserAuthenticationProfileListing
...
@router.get(
    "/user/{userID}/user-authentication-profile",
    responses={
        200: {"model": List[UserAuthenticationProfileListing], "description": "Returns the authentication profile of the user. apiApp:LISTING"},
...
async def list_all_user_authentication_profile_for_user(
...
) -> List[UserAuthenticationProfileListing]:
    """Returns the authentication profile of the user. apiApp:LISTING"""
    if not BaseUserAuthenticationProfileApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserAuthenticationProfileApi.subclasses[0]().list_all_user_authentication_profile_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
