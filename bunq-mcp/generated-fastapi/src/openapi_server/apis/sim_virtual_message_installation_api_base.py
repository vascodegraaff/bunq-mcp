...
class BaseSimVirtualMessageInstallationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSimVirtualMessageInstallationApi.subclasses = BaseSimVirtualMessageInstallationApi.subclasses + (cls,)
    async def c_reate_sim_virtual_message_installation(
        ...
        sim_virtual_message_installation: SimVirtualMessageInstallation,
