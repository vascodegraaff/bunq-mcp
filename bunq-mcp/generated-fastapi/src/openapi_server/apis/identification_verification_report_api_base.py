...
class BaseIdentificationVerificationReportApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdentificationVerificationReportApi.subclasses = BaseIdentificationVerificationReportApi.subclasses + (cls,)
