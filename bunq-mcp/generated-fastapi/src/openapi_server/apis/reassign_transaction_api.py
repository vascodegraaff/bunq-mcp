...
from openapi_server.apis.reassign_transaction_api_base import BaseReassignTransactionApi
...
from openapi_server.models.reassign_transaction import ReassignTransaction
from openapi_server.models.reassign_transaction_create import ReassignTransactionCreate
...
@router.post(
    "/user/{userID}/monetary-account/{monetary-accountID}/event/{eventID}/reassign-transaction",
    responses={
        200: {"model": ReassignTransactionCreate, "description": "Reassign transactions to another monetary account. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE apiQualityAssurance:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["reassign-transaction"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_reassign_transaction_for_user_monetary_account_event(
    ...
    reassign_transaction: ReassignTransaction = Body(None, description=""),
...
) -> ReassignTransactionCreate:
    """Reassign transactions to another monetary account. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE apiQualityAssurance:CREATE"""
    if not BaseReassignTransactionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseReassignTransactionApi.subclasses[0]().c_reate_reassign_transaction_for_user_monetary_account_event(userID, monetary-accountID, eventID, user_agent, x_bunq_client_authentication, reassign_transaction, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
