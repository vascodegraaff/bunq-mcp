...
class BaseSessionRegistryConfirmApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionRegistryConfirmApi.subclasses = BaseSessionRegistryConfirmApi.subclasses + (cls,)
    async def c_reate_session_registry_confirm(
        ...
        session_registry_confirm: SessionRegistryConfirm,
