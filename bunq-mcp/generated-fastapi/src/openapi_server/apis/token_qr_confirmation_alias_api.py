...
from openapi_server.apis.token_qr_confirmation_alias_api_base import BaseTokenQrConfirmationAliasApi
...
from openapi_server.models.token_qr_confirmation_alias import TokenQrConfirmationAlias
from openapi_server.models.token_qr_confirmation_alias_create import TokenQrConfirmationAliasCreate
...
@router.post(
    "/user/{userID}/token-qr-confirmation-alias",
    responses={
        200: {"model": TokenQrConfirmationAliasCreate, "description": "Usage of this endpoint (by scanning QR code) results to alias activation. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-confirmation-alias"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_confirmation_alias_for_user(
    ...
    token_qr_confirmation_alias: TokenQrConfirmationAlias = Body(None, description=""),
...
) -> TokenQrConfirmationAliasCreate:
    """Usage of this endpoint (by scanning QR code) results to alias activation. apiApp:CREATE"""
    if not BaseTokenQrConfirmationAliasApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrConfirmationAliasApi.subclasses[0]().c_reate_token_qr_confirmation_alias_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_confirmation_alias, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
