...
from openapi_server.apis.recording_transcription_api_base import BaseRecordingTranscriptionApi
...
from openapi_server.models.vonage_call_incoming_recording_transcription import VonageCallIncomingRecordingTranscription
from openapi_server.models.vonage_call_incoming_recording_transcription_create import VonageCallIncomingRecordingTranscriptionCreate
...
@router.post(
    "/vonage-call-incoming/{vonage-call-incomingID}/recording-transcription",
    responses={
        200: {"model": VonageCallIncomingRecordingTranscriptionCreate, "description": "Download and save the transcription of the recording from Vonage. apiVonage:CREATE"},
...
async def c_reate_recording_transcription_for_vonage_call_incoming(
    ...
    vonage_call_incoming_recording_transcription: VonageCallIncomingRecordingTranscription = Body(None, description=""),
...
) -> VonageCallIncomingRecordingTranscriptionCreate:
    """Download and save the transcription of the recording from Vonage. apiVonage:CREATE"""
    if not BaseRecordingTranscriptionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRecordingTranscriptionApi.subclasses[0]().c_reate_recording_transcription_for_vonage_call_incoming(vonage-call-incomingID, user_agent, x_bunq_client_authentication, vonage_call_incoming_recording_transcription, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
