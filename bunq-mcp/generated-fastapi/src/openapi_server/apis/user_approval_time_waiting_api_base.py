...
class BaseUserApprovalTimeWaitingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserApprovalTimeWaitingApi.subclasses = BaseUserApprovalTimeWaitingApi.subclasses + (cls,)
    async def c_reate_user_approval_time_waiting(
        ...
        user_approval_time_waiting: UserApprovalTimeWaiting,
