...
class BaseNotificationBadgeCategoryClearApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNotificationBadgeCategoryClearApi.subclasses = BaseNotificationBadgeCategoryClearApi.subclasses + (cls,)
    async def c_reate_notification_badge_category_clear_for_user(
        ...
        notification_badge_category_clear: NotificationBadgeCategoryClear,
