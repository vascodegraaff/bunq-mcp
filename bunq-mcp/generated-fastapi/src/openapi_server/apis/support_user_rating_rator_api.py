...
from openapi_server.apis.support_user_rating_rator_api_base import BaseSupportUserRatingRatorApi
...
from openapi_server.models.support_user_rating_rator import SupportUserRatingRator
from openapi_server.models.support_user_rating_rator_create import SupportUserRatingRatorCreate
...
@router.post(
    "/user/{userID}/ticket/{ticketID}/support-user-rating-rator",
    responses={
        200: {"model": SupportUserRatingRatorCreate, "description": "Endpoint for ratings in which the user is the one doing the rating. apiAdmin:LISTING/CREATE apiApp:LISTING/CREATE apiServiceInternal:LISTING/CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["support-user-rating-rator"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_support_user_rating_rator_for_user_ticket(
    ...
    support_user_rating_rator: SupportUserRatingRator = Body(None, description=""),
...
) -> SupportUserRatingRatorCreate:
    """Endpoint for ratings in which the user is the one doing the rating. apiAdmin:LISTING/CREATE apiApp:LISTING/CREATE apiServiceInternal:LISTING/CREATE"""
    if not BaseSupportUserRatingRatorApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSupportUserRatingRatorApi.subclasses[0]().c_reate_support_user_rating_rator_for_user_ticket(userID, ticketID, user_agent, x_bunq_client_authentication, support_user_rating_rator, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/support-user-rating-rator",
    responses={
        200: {"model": List[object], "description": "Endpoint for ratings in which the user is the one doing the rating. apiAdmin:LISTING apiApp:LISTING apiServiceInternal:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["support-user-rating-rator"],
    summary="",
...
async def list_all_support_user_rating_rator_for_user(
    userID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    cache_control: Annotated[Optional[StrictStr], Field(description="The standard HTTP Cache-Control header is required for all signed requests.")] = Header(None, description="The standard HTTP Cache-Control header is required for all signed requests."),
    ...
    """Endpoint for ratings in which the user is the one doing the rating. apiAdmin:LISTING apiApp:LISTING apiServiceInternal:LISTING"""
    if not BaseSupportUserRatingRatorApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSupportUserRatingRatorApi.subclasses[0]().list_all_support_user_rating_rator_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/ticket/{ticketID}/support-user-rating-rator",
    responses={
        200: {"model": List[object], "description": "Endpoint for ratings in which the user is the one doing the rating. apiAdmin:LISTING/CREATE apiApp:LISTING/CREATE apiServiceInternal:LISTING/CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["support-user-rating-rator"],
    summary="",
...
async def list_all_support_user_rating_rator_for_user_ticket(
    userID: StrictInt = Path(..., description=""),
    ticketID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    ...
    if not BaseSupportUserRatingRatorApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSupportUserRatingRatorApi.subclasses[0]().list_all_support_user_rating_rator_for_user_ticket(userID, ticketID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
