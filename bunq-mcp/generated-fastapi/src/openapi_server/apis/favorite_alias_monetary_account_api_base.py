...
class BaseFavoriteAliasMonetaryAccountApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseFavoriteAliasMonetaryAccountApi.subclasses = BaseFavoriteAliasMonetaryAccountApi.subclasses + (cls,)
    async def c_reate_favorite_alias_monetary_account_for_user(
        ...
        favorite_alias_monetary_account: FavoriteAliasMonetaryAccount,
