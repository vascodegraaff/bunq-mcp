...
class BaseAdminPointVoucherBatchCancellationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPointVoucherBatchCancellationApi.subclasses = BaseAdminPointVoucherBatchCancellationApi.subclasses + (cls,)
    async def c_reate_admin_point_voucher_batch_cancellation(
        ...
        admin_point_voucher_batch_cancellation: AdminPointVoucherBatchCancellation,
