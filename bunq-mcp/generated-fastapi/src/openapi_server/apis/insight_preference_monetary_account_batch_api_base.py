...
class BaseInsightPreferenceMonetaryAccountBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInsightPreferenceMonetaryAccountBatchApi.subclasses = BaseInsightPreferenceMonetaryAccountBatchApi.subclasses + (cls,)
    async def c_reate_insight_preference_monetary_account_batch_for_user(
        ...
        insight_preference_monetary_account_batch: InsightPreferenceMonetaryAccountBatch,
