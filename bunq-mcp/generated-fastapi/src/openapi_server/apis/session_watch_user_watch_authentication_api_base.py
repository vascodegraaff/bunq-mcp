...
class BaseSessionWatchUserWatchAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionWatchUserWatchAuthenticationApi.subclasses = BaseSessionWatchUserWatchAuthenticationApi.subclasses + (cls,)
    async def c_reate_session_watch_user_watch_authentication(
        ...
        session_watch_user_watch_authentication: SessionWatchUserWatchAuthentication,
