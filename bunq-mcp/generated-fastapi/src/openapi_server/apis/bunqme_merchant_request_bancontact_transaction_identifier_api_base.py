...
class BaseBunqmeMerchantRequestBancontactTransactionIdentifierApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestBancontactTransactionIdentifierApi.subclasses = BaseBunqmeMerchantRequestBancontactTransactionIdentifierApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request_bancontact_transaction_identifier(
        ...
        bunq_me_merchant_request_bancontact_transaction_identifier: BunqMeMerchantRequestBancontactTransactionIdentifier,
