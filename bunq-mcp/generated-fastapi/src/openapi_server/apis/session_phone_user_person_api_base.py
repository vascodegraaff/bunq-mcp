...
class BaseSessionPhoneUserPersonApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionPhoneUserPersonApi.subclasses = BaseSessionPhoneUserPersonApi.subclasses + (cls,)
    async def c_reate_session_phone_user_person(
        ...
        session_phone_user_person: SessionPhoneUserPerson,
