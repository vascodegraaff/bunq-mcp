...
class BaseGinmonSuggestedInstrumentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonSuggestedInstrumentApi.subclasses = BaseGinmonSuggestedInstrumentApi.subclasses + (cls,)
    async def c_reate_ginmon_suggested_instrument_for_user(
        ...
        ginmon_suggested_instrument: GinmonSuggestedInstrument,
