...
class BaseInsightPreferenceDateApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInsightPreferenceDateApi.subclasses = BaseInsightPreferenceDateApi.subclasses + (cls,)
    async def c_reate_insight_preference_date_for_user(
        ...
        insight_preference_date: InsightPreferenceDate,
