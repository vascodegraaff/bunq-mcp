...
from openapi_server.apis.unfreeze_api_base import BaseUnfreezeApi
...
from openapi_server.models.unfreeze_create import UnfreezeCreate
...
@router.post(
    ...
    responses={
        200: {"model": UnfreezeCreate, "description": "Used to unfreeze a user and their associated monetary accounts and cards. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_unfreeze_for_user(
    ...
    """Used to unfreeze a user and their associated monetary accounts and cards. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseUnfreezeApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUnfreezeApi.subclasses[0]().c_reate_unfreeze_for_user(userID, user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
