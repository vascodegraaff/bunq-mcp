...
from openapi_server.apis.terminal_session_api_base import BaseTerminalSessionApi
...
from openapi_server.models.adyen_terminal_session import AdyenTerminalSession
from openapi_server.models.adyen_terminal_session_create import AdyenTerminalSessionCreate
...
@router.post(
    "/user/{userID}/adyen-store/{adyen-storeID}/terminal-session",
    responses={
        200: {"model": AdyenTerminalSessionCreate, "description": "Authenticate a session with the Adyen apiApp:CREATE"},
...
async def c_reate_terminal_session_for_user_adyen_store(
    ...
    adyen_terminal_session: AdyenTerminalSession = Body(None, description=""),
...
) -> AdyenTerminalSessionCreate:
    """Authenticate a session with the Adyen apiApp:CREATE"""
    if not BaseTerminalSessionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTerminalSessionApi.subclasses[0]().c_reate_terminal_session_for_user_adyen_store(userID, adyen-storeID, user_agent, x_bunq_client_authentication, adyen_terminal_session, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
