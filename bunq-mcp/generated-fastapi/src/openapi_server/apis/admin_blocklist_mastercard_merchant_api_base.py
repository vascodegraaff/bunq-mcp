...
class BaseAdminBlocklistMastercardMerchantApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminBlocklistMastercardMerchantApi.subclasses = BaseAdminBlocklistMastercardMerchantApi.subclasses + (cls,)
    async def c_reate_admin_blocklist_mastercard_merchant(
        ...
        admin_blocklist_master_card_merchant: AdminBlocklistMasterCardMerchant,
