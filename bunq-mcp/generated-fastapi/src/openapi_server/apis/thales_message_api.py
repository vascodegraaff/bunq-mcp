...
from openapi_server.apis.thales_message_api_base import BaseThalesMessageApi
...
from openapi_server.models.thales_message import ThalesMessage
from openapi_server.models.thales_message_create import ThalesMessageCreate
...
@router.post(
    "/thales-message",
    responses={
        200: {"model": ThalesMessageCreate, "description": "Gets webhook messages from Thales. apiThales:CREATE"},
...
async def c_reate_thales_message(
    ...
    thales_message: ThalesMessage = Body(None, description=""),
    ...
    """Gets webhook messages from Thales. apiThales:CREATE"""
    if not BaseThalesMessageApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseThalesMessageApi.subclasses[0]().c_reate_thales_message(user_agent, x_bunq_client_authentication, thales_message, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
