...
from openapi_server.apis.kraken_fee_discount_subscription_api_base import BaseKrakenFeeDiscountSubscriptionApi
...
from openapi_server.models.kraken_fee_discount_subscription_listing import KrakenFeeDiscountSubscriptionListing
...
@router.get(
    "/kraken-fee-discount-subscription",
    responses={
        200: {"model": List[KrakenFeeDiscountSubscriptionListing], "description": "Kraken fees. apiAdmin:LISTING apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["kraken-fee-discount-subscription"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_kraken_fee_discount_subscription(
...
) -> List[KrakenFeeDiscountSubscriptionListing]:
    """Kraken fees. apiAdmin:LISTING apiApp:LISTING"""
    if not BaseKrakenFeeDiscountSubscriptionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseKrakenFeeDiscountSubscriptionApi.subclasses[0]().list_all_kraken_fee_discount_subscription(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
