...
from openapi_server.models.translink_trip_listing import TranslinkTripListing
from openapi_server.models.translink_trip_read import TranslinkTripRead


class BaseTranslinkTripApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTranslinkTripApi.subclasses = BaseTranslinkTripApi.subclasses + (cls,)
    async def list_all_translink_trip_for_card(
        self,
        cardID: StrictInt,
    ...
    ) -> List[TranslinkTripListing]:
        """Used to retrieve translink trips for a specific card apiApp:READ/LISTING"""
        ...


    async def r_ead_translink_trip_for_card(
        self,
        cardID: StrictInt,
        itemId: StrictInt,
        user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")],
