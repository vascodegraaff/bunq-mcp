...
from openapi_server.apis.value_text_api_base import BaseValueTextApi
...
from openapi_server.models.user_review_value_text import UserReviewValueText
from openapi_server.models.user_review_value_text_update import UserReviewValueTextUpdate
...
@router.put(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-text/{itemId}",
    responses={
        200: {"model": UserReviewValueTextUpdate, "description": "Endpoint for updating UserReviewValueText. apiApp:UPDATE"},
...
async def u_pdate_value_text_for_user_review_check(
    ...
    user_review_value_text: UserReviewValueText = Body(None, description=""),
...
) -> UserReviewValueTextUpdate:
    """Endpoint for updating UserReviewValueText. apiApp:UPDATE"""
    if not BaseValueTextApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueTextApi.subclasses[0]().u_pdate_value_text_for_user_review_check(userID, reviewID, checkID, itemId, user_agent, x_bunq_client_authentication, user_review_value_text, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
