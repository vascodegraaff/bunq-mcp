...
class BaseSofortIssuerTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSofortIssuerTransactionApi.subclasses = BaseSofortIssuerTransactionApi.subclasses + (cls,)
    async def c_reate_sofort_issuer_transaction(
        ...
        sofort_issuer_transaction: SofortIssuerTransaction,
