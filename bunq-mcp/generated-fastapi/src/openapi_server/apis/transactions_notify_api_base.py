...
class BaseTransactionsNotifyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransactionsNotifyApi.subclasses = BaseTransactionsNotifyApi.subclasses + (cls,)
    async def c_reate_transactions_notify(
        ...
        ideal_issuer_provider_transaction_notify: IdealIssuerProviderTransactionNotify,
