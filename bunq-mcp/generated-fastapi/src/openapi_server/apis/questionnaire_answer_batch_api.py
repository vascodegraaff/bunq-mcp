...
from openapi_server.apis.questionnaire_answer_batch_api_base import BaseQuestionnaireAnswerBatchApi
...
from openapi_server.models.birdee_customer_questionnaire_answer_batch import BirdeeCustomerQuestionnaireAnswerBatch
from openapi_server.models.birdee_customer_questionnaire_answer_batch_create import BirdeeCustomerQuestionnaireAnswerBatchCreate
...
@router.post(
    "/user/{userID}/birdee-customer/{birdee-customerID}/questionnaire-answer-batch",
    responses={
        200: {"model": BirdeeCustomerQuestionnaireAnswerBatchCreate, "description": "Endpoint to answer questions from Birdee. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["questionnaire-answer-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_questionnaire_answer_batch_for_user_birdee_customer(
    ...
    birdee_customer_questionnaire_answer_batch: BirdeeCustomerQuestionnaireAnswerBatch = Body(None, description=""),
...
) -> BirdeeCustomerQuestionnaireAnswerBatchCreate:
    """Endpoint to answer questions from Birdee. apiApp:CREATE"""
    if not BaseQuestionnaireAnswerBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQuestionnaireAnswerBatchApi.subclasses[0]().c_reate_questionnaire_answer_batch_for_user_birdee_customer(userID, birdee-customerID, user_agent, x_bunq_client_authentication, birdee_customer_questionnaire_answer_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
