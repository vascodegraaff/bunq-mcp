...
from openapi_server.apis.process_definition_api_base import BaseProcessDefinitionApi
...
@router.post(
    "/process-definition",
    responses={
        200: {"model": ProcessDefinitionCreate, "description": "View for bunq processes. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING apiProcess:CREATE/READ/UPDATE/LISTING"},
...
async def c_reate_process_definition(
    ...
    process_definition: ProcessDefinition = Body(None, description=""),
    ...
    if not BaseProcessDefinitionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessDefinitionApi.subclasses[0]().c_reate_process_definition(user_agent, x_bunq_client_authentication, process_definition, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/process-definition",
    responses={
        200: {"model": List[ProcessDefinitionListing], "description": "View for bunq processes. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING apiProcess:CREATE/READ/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["process-definition"],
    summary="",
...
async def list_all_process_definition(
    ...
    if not BaseProcessDefinitionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessDefinitionApi.subclasses[0]().list_all_process_definition(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/process-definition/{itemId}",
    responses={
        200: {"model": ProcessDefinitionRead, "description": "View for bunq processes. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING apiProcess:CREATE/READ/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["process-definition"],
    summary="",
...
async def r_ead_process_definition(
    ...
    if not BaseProcessDefinitionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessDefinitionApi.subclasses[0]().r_ead_process_definition(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/process-definition/{itemId}",
    responses={
        200: {"model": ProcessDefinitionUpdate, "description": "View for bunq processes. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING apiProcess:CREATE/READ/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["process-definition"],
    summary="",
...
async def u_pdate_process_definition(
    ...
    if not BaseProcessDefinitionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessDefinitionApi.subclasses[0]().u_pdate_process_definition(itemId, user_agent, x_bunq_client_authentication, process_definition, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
