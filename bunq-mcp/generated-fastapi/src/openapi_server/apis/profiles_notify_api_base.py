...
class BaseProfilesNotifyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseProfilesNotifyApi.subclasses = BaseProfilesNotifyApi.subclasses + (cls,)
    async def c_reate_profiles_notify(
        ...
        ideal_issuer_provider_profile_notify: IdealIssuerProviderProfileNotify,
