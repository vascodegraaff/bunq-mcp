...
from openapi_server.apis.additional_transaction_information_category_user_defined_api_base import BaseAdditionalTransactionInformationCategoryUserDefinedApi
...
from openapi_server.models.additional_transaction_information_category_user_defined import AdditionalTransactionInformationCategoryUserDefined
from openapi_server.models.additional_transaction_information_category_user_defined_create import AdditionalTransactionInformationCategoryUserDefinedCreate
...
@router.post(
    ...
    responses={
        200: {"model": AdditionalTransactionInformationCategoryUserDefinedCreate, "description": "Manage user-defined categories. apiApp:CREATE apiPublic:CREATE"},
...
async def c_reate_additional_transaction_information_category_user_defined_for_user(
    ...
    additional_transaction_information_category_user_defined: AdditionalTransactionInformationCategoryUserDefined = Body(None, description=""),
    ...
    """Manage user-defined categories. apiApp:CREATE apiPublic:CREATE"""
    if not BaseAdditionalTransactionInformationCategoryUserDefinedApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdditionalTransactionInformationCategoryUserDefinedApi.subclasses[0]().c_reate_additional_transaction_information_category_user_defined_for_user(userID, user_agent, x_bunq_client_authentication, additional_transaction_information_category_user_defined, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
