...
from openapi_server.apis.primary_account_number_api_base import BasePrimaryAccountNumberApi
...
from openapi_server.models.card_primary_account_number_create import CardPrimaryAccountNumberCreate
...
@router.post(
    ...
    responses={
        200: {"model": CardPrimaryAccountNumberCreate, "description": "View for getting the PAN of the card. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE apiTranslink:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["primary-account-number"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_primary_account_number_for_user_card(
    ...
    card_primary_account_number: CardPrimaryAccountNumber = Body(None, description=""),
...
) -> CardPrimaryAccountNumberCreate:
    """View for getting the PAN of the card. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE apiTranslink:CREATE"""
    if not BasePrimaryAccountNumberApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePrimaryAccountNumberApi.subclasses[0]().c_reate_primary_account_number_for_user_card(userID, cardID, user_agent, x_bunq_client_authentication, card_primary_account_number, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
