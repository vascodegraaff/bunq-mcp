...
class BaseTransactionRestrictionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransactionRestrictionApi.subclasses = BaseTransactionRestrictionApi.subclasses + (cls,)
    async def c_reate_transaction_restriction_for_user(
        ...
        transaction_restriction: TransactionRestriction,
