...
from openapi_server.apis.session_reset_confirmation_api_base import BaseSessionResetConfirmationApi
...
from openapi_server.models.session_reset_confirmation import SessionResetConfirmation
from openapi_server.models.session_reset_confirmation_create import SessionResetConfirmationCreate
...
@router.post(
    ...
    responses={
        200: {"model": SessionResetConfirmationCreate, "description": "Used by the user to confirm the pin reset request. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["session-reset-confirmation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_session_reset_confirmation(
    ...
    session_reset_confirmation: SessionResetConfirmation = Body(None, description=""),
...
) -> SessionResetConfirmationCreate:
    """Used by the user to confirm the pin reset request. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseSessionResetConfirmationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionResetConfirmationApi.subclasses[0]().c_reate_session_reset_confirmation(user_agent, x_bunq_client_authentication, session_reset_confirmation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
