...
from openapi_server.apis.push_message_read_category_api_base import BasePushMessageReadCategoryApi
...
from openapi_server.models.push_message_read_category import PushMessageReadCategory
from openapi_server.models.push_message_read_category_create import PushMessageReadCategoryCreate
...
@router.post(
    "/user/{userID}/push-message-read-category",
    responses={
        200: {"model": PushMessageReadCategoryCreate, "description": "Mark the push messages as read based on their category. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["push-message-read-category"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_push_message_read_category_for_user(
    ...
    push_message_read_category: PushMessageReadCategory = Body(None, description=""),
...
) -> PushMessageReadCategoryCreate:
    """Mark the push messages as read based on their category. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BasePushMessageReadCategoryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePushMessageReadCategoryApi.subclasses[0]().c_reate_push_message_read_category_for_user(userID, user_agent, x_bunq_client_authentication, push_message_read_category, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
