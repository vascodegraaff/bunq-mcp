...
from openapi_server.apis.vonage_call_incoming_api_base import BaseVonageCallIncomingApi
...
from openapi_server.models.vonage_call_incoming import VonageCallIncoming
from openapi_server.models.vonage_call_incoming_create import VonageCallIncomingCreate
...
@router.post(
    ...
    responses={
        200: {"model": VonageCallIncomingCreate, "description": "Process incoming calls from Vonage. apiVonage:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["vonage-call-incoming"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_vonage_call_incoming(
    ...
    vonage_call_incoming: VonageCallIncoming = Body(None, description=""),
...
) -> VonageCallIncomingCreate:
    """Process incoming calls from Vonage. apiVonage:CREATE/READ"""
    if not BaseVonageCallIncomingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseVonageCallIncomingApi.subclasses[0]().c_reate_vonage_call_incoming(user_agent, x_bunq_client_authentication, vonage_call_incoming, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/vonage-call-incoming/{itemId}",
    responses={
        200: {"model": object, "description": "Process incoming calls from Vonage. apiVonage:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["vonage-call-incoming"],
    summary="",
...
async def r_ead_vonage_call_incoming(
    ...
    if not BaseVonageCallIncomingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseVonageCallIncomingApi.subclasses[0]().r_ead_vonage_call_incoming(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
