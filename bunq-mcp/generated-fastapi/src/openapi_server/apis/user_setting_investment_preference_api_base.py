...
class BaseUserSettingInvestmentPreferenceApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingInvestmentPreferenceApi.subclasses = BaseUserSettingInvestmentPreferenceApi.subclasses + (cls,)
    async def c_reate_user_setting_investment_preference_for_user(
        ...
        user_setting_investment_preference: UserSettingInvestmentPreference,
