...
class BaseTransferwiseTransferApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransferwiseTransferApi.subclasses = BaseTransferwiseTransferApi.subclasses + (cls,)
    async def c_reate_transferwise_transfer_for_user_transferwise_quote(
        ...
        transferwise_transfer: TransferwiseTransfer,
