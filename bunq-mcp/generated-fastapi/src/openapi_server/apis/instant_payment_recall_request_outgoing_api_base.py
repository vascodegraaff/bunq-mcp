...
class BaseInstantPaymentRecallRequestOutgoingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInstantPaymentRecallRequestOutgoingApi.subclasses = BaseInstantPaymentRecallRequestOutgoingApi.subclasses + (cls,)
    async def c_reate_instant_payment_recall_request_outgoing(
        ...
        instant_payment_recall_request_outgoing: InstantPaymentRecallRequestOutgoing,
