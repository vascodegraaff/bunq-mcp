...
class BaseValueTransactionDocumentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseValueTransactionDocumentApi.subclasses = BaseValueTransactionDocumentApi.subclasses + (cls,)
    async def u_pdate_value_transaction_document_for_user_review_check(
        ...
        user_review_value_transaction_document: UserReviewValueTransactionDocument,
