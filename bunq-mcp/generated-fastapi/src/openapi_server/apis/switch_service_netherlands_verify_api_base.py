...
class BaseSwitchServiceNetherlandsVerifyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSwitchServiceNetherlandsVerifyApi.subclasses = BaseSwitchServiceNetherlandsVerifyApi.subclasses + (cls,)
    async def c_reate_switch_service_netherlands_verify(
        ...
        bank_switch_service_netherlands_verify: BankSwitchServiceNetherlandsVerify,
