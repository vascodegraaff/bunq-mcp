...
from openapi_server.apis.vonage_language_translation_available_api_base import BaseVonageLanguageTranslationAvailableApi
...
from openapi_server.models.vonage_call_incoming_language_translation_available_listing import VonageCallIncomingLanguageTranslationAvailableListing
...
@router.get(
    "/vonage-language-translation-available",
    responses={
        200: {"model": List[VonageCallIncomingLanguageTranslationAvailableListing], "description": "Get all supported language for translation in Vonage. apiAdmin:LISTING apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["vonage-language-translation-available"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_vonage_language_translation_available(
...
) -> List[VonageCallIncomingLanguageTranslationAvailableListing]:
    """Get all supported language for translation in Vonage. apiAdmin:LISTING apiApp:LISTING"""
    if not BaseVonageLanguageTranslationAvailableApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseVonageLanguageTranslationAvailableApi.subclasses[0]().list_all_vonage_language_translation_available(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
