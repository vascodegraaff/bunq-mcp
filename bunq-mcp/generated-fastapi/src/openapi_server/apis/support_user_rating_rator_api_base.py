...
class BaseSupportUserRatingRatorApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSupportUserRatingRatorApi.subclasses = BaseSupportUserRatingRatorApi.subclasses + (cls,)
    async def c_reate_support_user_rating_rator_for_user_ticket(
        ...
        support_user_rating_rator: SupportUserRatingRator,
