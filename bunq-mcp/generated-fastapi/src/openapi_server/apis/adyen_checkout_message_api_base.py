...
class BaseAdyenCheckoutMessageApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdyenCheckoutMessageApi.subclasses = BaseAdyenCheckoutMessageApi.subclasses + (cls,)
    async def c_reate_adyen_checkout_message(
        ...
        adyen_checkout_message: AdyenCheckoutMessage,
