...
class BaseUserSettingAvatarPreferenceApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingAvatarPreferenceApi.subclasses = BaseUserSettingAvatarPreferenceApi.subclasses + (cls,)
    async def c_reate_user_setting_avatar_preference_for_user(
        ...
        user_setting_avatar_preference: UserSettingAvatarPreference,
