...
class BaseNotificationFilterPushApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNotificationFilterPushApi.subclasses = BaseNotificationFilterPushApi.subclasses + (cls,)
    async def c_reate_notification_filter_push_for_user(
        ...
        notification_filter_push: NotificationFilterPush,
