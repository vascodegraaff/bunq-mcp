...
class BaseGinmonAccountAgreementDocumentRequirementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonAccountAgreementDocumentRequirementApi.subclasses = BaseGinmonAccountAgreementDocumentRequirementApi.subclasses + (cls,)
