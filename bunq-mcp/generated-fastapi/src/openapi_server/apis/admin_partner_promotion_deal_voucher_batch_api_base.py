...
class BaseAdminPartnerPromotionDealVoucherBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionDealVoucherBatchApi.subclasses = BaseAdminPartnerPromotionDealVoucherBatchApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_deal_voucher_batch(
        ...
        admin_partner_promotion_deal_voucher_batch: AdminPartnerPromotionDealVoucherBatch,
