...
from openapi_server.apis.insights_search_api_base import BaseInsightsSearchApi
...
from openapi_server.models.insight_event_listing import InsightEventListing
...
@router.get(
    ...
    responses={
        200: {"model": List[InsightEventListing], "description": "Used to get events based on time and insight category. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"},
...
) -> List[InsightEventListing]:
    """Used to get events based on time and insight category. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"""
    if not BaseInsightsSearchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInsightsSearchApi.subclasses[0]().list_all_insights_search_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
