...
from openapi_server.apis.ticket_api_base import BaseTicketApi
...
from openapi_server.models.ticket_create import TicketCreate
from openapi_server.models.ticket_listing import TicketListing
from openapi_server.models.ticket_read import TicketRead
from openapi_server.models.ticket_update import TicketUpdate
...
@router.post(
    "/user/{userID}/ticket",
    responses={
        200: {"model": TicketCreate, "description": "Endpoint for getting all tickets. apiAdmin:READ apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:READ"},
...
async def c_reate_ticket_for_user(
    ...
    ticket: Ticket = Body(None, description=""),
    ...
    """Endpoint for getting all tickets. apiAdmin:READ apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:READ"""
    if not BaseTicketApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTicketApi.subclasses[0]().c_reate_ticket_for_user(userID, user_agent, x_bunq_client_authentication, ticket, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/ticket",
    responses={
        200: {"model": List[TicketListing], "description": "Endpoint for getting all tickets. apiAdmin:READ apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ticket"],
    summary="",
...
async def list_all_ticket_for_user(
    userID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    cache_control: Annotated[Optional[StrictStr], Field(description="The standard HTTP Cache-Control header is required for all signed requests.")] = Header(None, description="The standard HTTP Cache-Control header is required for all signed requests."),
    ...
    if not BaseTicketApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTicketApi.subclasses[0]().list_all_ticket_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/ticket/{itemId}",
    responses={
        200: {"model": TicketRead, "description": "Endpoint for getting all tickets. apiAdmin:READ apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ticket"],
    summary="",
...
async def r_ead_ticket_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseTicketApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTicketApi.subclasses[0]().r_ead_ticket_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/ticket/{itemId}",
    responses={
        200: {"model": TicketUpdate, "description": "Endpoint for getting all tickets. apiAdmin:READ apiApp:CREATE/READ/UPDATE/LISTING apiServiceInternal:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ticket"],
    summary="",
...
async def u_pdate_ticket_for_user(
    userID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    ...
    if not BaseTicketApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTicketApi.subclasses[0]().u_pdate_ticket_for_user(userID, itemId, user_agent, x_bunq_client_authentication, ticket, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
