...
class BaseMifidNationalClientIdentifierRequirementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMifidNationalClientIdentifierRequirementApi.subclasses = BaseMifidNationalClientIdentifierRequirementApi.subclasses + (cls,)
