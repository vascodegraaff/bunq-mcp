...
class BaseAdminContractSubscriptionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminContractSubscriptionApi.subclasses = BaseAdminContractSubscriptionApi.subclasses + (cls,)
    async def c_reate_admin_contract_subscription_for_user(
        ...
        admin_contract_subscription: AdminContractSubscription,
