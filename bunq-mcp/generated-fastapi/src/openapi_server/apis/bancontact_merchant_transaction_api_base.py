...
class BaseBancontactMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBancontactMerchantTransactionApi.subclasses = BaseBancontactMerchantTransactionApi.subclasses + (cls,)
    async def c_reate_bancontact_merchant_transaction_for_user_monetary_account(
        ...
        bancontact_merchant_transaction: BancontactMerchantTransaction,
