...
class BaseSavingsAutoSaveRoundToApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSavingsAutoSaveRoundToApi.subclasses = BaseSavingsAutoSaveRoundToApi.subclasses + (cls,)
    async def c_reate_savings_auto_save_round_to_for_user(
        ...
        savings_auto_save_round_to: SavingsAutoSaveRoundTo,
