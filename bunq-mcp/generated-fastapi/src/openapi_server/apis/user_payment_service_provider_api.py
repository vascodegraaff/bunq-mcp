...
from openapi_server.apis.user_payment_service_provider_api_base import BaseUserPaymentServiceProviderApi
...
from openapi_server.models.user_payment_service_provider_read import UserPaymentServiceProviderRead
...
@router.get(
    ...
    responses={
        200: {"model": UserPaymentServiceProviderRead, "description": "Used to view UserPaymentServiceProvider for session creation. apiApp:READ apiPublic:READ"},
...
async def r_ead_user_payment_service_provider(
    ...
    """Used to view UserPaymentServiceProvider for session creation. apiApp:READ apiPublic:READ"""
    if not BaseUserPaymentServiceProviderApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserPaymentServiceProviderApi.subclasses[0]().r_ead_user_payment_service_provider(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
