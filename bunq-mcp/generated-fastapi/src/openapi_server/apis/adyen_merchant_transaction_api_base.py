...
class BaseAdyenMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdyenMerchantTransactionApi.subclasses = BaseAdyenMerchantTransactionApi.subclasses + (cls,)
    async def c_reate_adyen_merchant_transaction_for_user_monetary_account(
        ...
        adyen_merchant_transaction: AdyenMerchantTransaction,
