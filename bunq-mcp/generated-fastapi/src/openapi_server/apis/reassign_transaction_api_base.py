...
class BaseReassignTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseReassignTransactionApi.subclasses = BaseReassignTransactionApi.subclasses + (cls,)
    async def c_reate_reassign_transaction_for_user_monetary_account_event(
        ...
        reassign_transaction: ReassignTransaction,
