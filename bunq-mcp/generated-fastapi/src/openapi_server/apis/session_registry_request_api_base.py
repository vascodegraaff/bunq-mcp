...
class BaseSessionRegistryRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionRegistryRequestApi.subclasses = BaseSessionRegistryRequestApi.subclasses + (cls,)
    async def c_reate_session_registry_request(
        ...
        session_registry_request: SessionRegistryRequest,
