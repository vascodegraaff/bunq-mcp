...
class BasePaymentDelayedOutgoingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePaymentDelayedOutgoingApi.subclasses = BasePaymentDelayedOutgoingApi.subclasses + (cls,)
    async def u_pdate_payment_delayed_outgoing_for_user_monetary_account(
        ...
        payment_delayed_outgoing: PaymentDelayedOutgoing,
