...
from openapi_server.apis.adyen_checkout_message_api_base import BaseAdyenCheckoutMessageApi
...
from openapi_server.models.adyen_checkout_message import AdyenCheckoutMessage
from openapi_server.models.adyen_checkout_message_create import AdyenCheckoutMessageCreate
...
@router.post(
    "/adyen-checkout-message",
    responses={
        200: {"model": AdyenCheckoutMessageCreate, "description": "Receives messages from Adyen Checkout API. apiAdyen:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["adyen-checkout-message"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_adyen_checkout_message(
    ...
    adyen_checkout_message: AdyenCheckoutMessage = Body(None, description=""),
...
) -> AdyenCheckoutMessageCreate:
    """Receives messages from Adyen Checkout API. apiAdyen:CREATE"""
    if not BaseAdyenCheckoutMessageApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdyenCheckoutMessageApi.subclasses[0]().c_reate_adyen_checkout_message(user_agent, x_bunq_client_authentication, adyen_checkout_message, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
