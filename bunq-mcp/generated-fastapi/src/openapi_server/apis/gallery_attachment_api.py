...
from openapi_server.apis.gallery_attachment_api_base import BaseGalleryAttachmentApi
...
@router.post(
    ...
    responses={
        200: {"model": RegistryGalleryAttachmentCreate, "description": "This call is used to upload an photo that is accessible by all members of a registry. apiAdmin:CREATE/DELETE/LISTING apiApp:CREATE/DELETE/LISTING apiServiceInternal:CREATE/DELETE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["gallery-attachment"],
    summary="",
...
async def c_reate_gallery_attachment_for_user_registry(
    ...
    registry_gallery_attachment: RegistryGalleryAttachment = Body(None, description=""),
    ...
    if not BaseGalleryAttachmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGalleryAttachmentApi.subclasses[0]().c_reate_gallery_attachment_for_user_registry(userID, registryID, user_agent, x_bunq_client_authentication, registry_gallery_attachment, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/registry/{registryID}/gallery-attachment/{itemId}",
    responses={
        200: {"model": object, "description": "This call is used to upload an photo that is accessible by all members of a registry. apiAdmin:CREATE/DELETE/LISTING apiApp:CREATE/DELETE/LISTING apiServiceInternal:CREATE/DELETE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["gallery-attachment"],
    summary="",
...
async def d_elete_gallery_attachment_for_user_registry(
    ...
    if not BaseGalleryAttachmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGalleryAttachmentApi.subclasses[0]().d_elete_gallery_attachment_for_user_registry(userID, registryID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/registry/{registryID}/gallery-attachment",
    responses={
        200: {"model": List[RegistryGalleryAttachmentListing], "description": "This call is used to upload an photo that is accessible by all members of a registry. apiAdmin:CREATE/DELETE/LISTING apiApp:CREATE/DELETE/LISTING apiServiceInternal:CREATE/DELETE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["gallery-attachment"],
    summary="",
...
async def list_all_gallery_attachment_for_user_registry(
    ...
    if not BaseGalleryAttachmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGalleryAttachmentApi.subclasses[0]().list_all_gallery_attachment_for_user_registry(userID, registryID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
