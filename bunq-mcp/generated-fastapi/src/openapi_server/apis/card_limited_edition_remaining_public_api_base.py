...
class BaseCardLimitedEditionRemainingPublicApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCardLimitedEditionRemainingPublicApi.subclasses = BaseCardLimitedEditionRemainingPublicApi.subclasses + (cls,)
