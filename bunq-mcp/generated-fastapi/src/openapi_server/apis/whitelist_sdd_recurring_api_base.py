...
class BaseWhitelistSddRecurringApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseWhitelistSddRecurringApi.subclasses = BaseWhitelistSddRecurringApi.subclasses + (cls,)
    async def c_reate_whitelist_sdd_recurring_for_user(
        ...
        whitelist_sdd_recurring: WhitelistSddRecurring,
