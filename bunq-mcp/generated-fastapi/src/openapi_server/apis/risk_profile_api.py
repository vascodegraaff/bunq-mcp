...
from openapi_server.apis.risk_profile_api_base import BaseRiskProfileApi
...
from openapi_server.models.risk_profile_user_listing import RiskProfileUserListing
...
@router.get(
    ...
    responses={
        200: {"model": List[RiskProfileUserListing], "description": "Risk profiles. apiAdmin:LISTING apiServiceInternal:LISTING"},
...
async def list_all_risk_profile_for_user(
...
) -> List[RiskProfileUserListing]:
    """Risk profiles. apiAdmin:LISTING apiServiceInternal:LISTING"""
    if not BaseRiskProfileApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRiskProfileApi.subclasses[0]().list_all_risk_profile_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
