...
from openapi_server.apis.token_bunq_api_base import BaseTokenBunqApi
...
from openapi_server.models.oauth_token_bunq import OauthTokenBunq
from openapi_server.models.oauth_token_bunq_create import OauthTokenBunqCreate
...
@router.post(
    "/token-bunq",
    responses={
        200: {"model": OauthTokenBunqCreate, "description": "Used to get API keys from Authorization Codes without the Client Secret. apiOauth:CREATE"},
...
async def c_reate_token_bunq(
    ...
    oauth_token_bunq: OauthTokenBunq = Body(None, description=""),
...
) -> OauthTokenBunqCreate:
    """Used to get API keys from Authorization Codes without the Client Secret. apiOauth:CREATE"""
    if not BaseTokenBunqApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenBunqApi.subclasses[0]().c_reate_token_bunq(user_agent, x_bunq_client_authentication, oauth_token_bunq, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
