...
class BaseUserSettingOverchargeWarningApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingOverchargeWarningApi.subclasses = BaseUserSettingOverchargeWarningApi.subclasses + (cls,)
    async def c_reate_user_setting_overcharge_warning_for_user(
        ...
        user_setting_overcharge_warning: UserSettingOverchargeWarning,
