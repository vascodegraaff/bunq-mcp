...
from openapi_server.apis.value_identification_document_api_base import BaseValueIdentificationDocumentApi
...
from openapi_server.models.user_review_value_identification_document import UserReviewValueIdentificationDocument
from openapi_server.models.user_review_value_identification_document_create import UserReviewValueIdentificationDocumentCreate
from openapi_server.models.user_review_value_identification_document_update import UserReviewValueIdentificationDocumentUpdate
...
@router.post(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-identification-document",
    responses={
        200: {"model": UserReviewValueIdentificationDocumentCreate, "description": "Value for updating UserReviewValueIdentificationDocument. apiAdmin:CREATE/UPDATE apiApp:UPDATE apiServiceInternal:CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["value-identification-document"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_value_identification_document_for_user_review_check(
    ...
    user_review_value_identification_document: UserReviewValueIdentificationDocument = Body(None, description=""),
...
) -> UserReviewValueIdentificationDocumentCreate:
    """Value for updating UserReviewValueIdentificationDocument. apiAdmin:CREATE/UPDATE apiApp:UPDATE apiServiceInternal:CREATE/UPDATE"""
    if not BaseValueIdentificationDocumentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueIdentificationDocumentApi.subclasses[0]().c_reate_value_identification_document_for_user_review_check(userID, reviewID, checkID, user_agent, x_bunq_client_authentication, user_review_value_identification_document, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-identification-document/{itemId}",
    responses={
        200: {"model": UserReviewValueIdentificationDocumentUpdate, "description": "Value for updating UserReviewValueIdentificationDocument. apiAdmin:CREATE/UPDATE apiApp:UPDATE apiServiceInternal:CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["value-identification-document"],
    summary="",
...
async def u_pdate_value_identification_document_for_user_review_check(
    userID: StrictInt = Path(..., description=""),
    reviewID: StrictInt = Path(..., description=""),
    checkID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> UserReviewValueIdentificationDocumentUpdate:
    """Value for updating UserReviewValueIdentificationDocument. apiAdmin:CREATE/UPDATE apiApp:UPDATE apiServiceInternal:CREATE/UPDATE"""
    if not BaseValueIdentificationDocumentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueIdentificationDocumentApi.subclasses[0]().u_pdate_value_identification_document_for_user_review_check(userID, reviewID, checkID, itemId, user_agent, x_bunq_client_authentication, user_review_value_identification_document, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
