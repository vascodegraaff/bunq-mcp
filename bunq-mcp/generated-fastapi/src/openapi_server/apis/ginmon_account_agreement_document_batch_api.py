...
from openapi_server.apis.ginmon_account_agreement_document_batch_api_base import BaseGinmonAccountAgreementDocumentBatchApi
...
from openapi_server.models.ginmon_account_agreement_document_batch import GinmonAccountAgreementDocumentBatch
from openapi_server.models.ginmon_account_agreement_document_batch_create import GinmonAccountAgreementDocumentBatchCreate
...
@router.post(
    "/user/{userID}/ginmon-account-agreement-document-batch",
    responses={
        200: {"model": GinmonAccountAgreementDocumentBatchCreate, "description": "Used to retrieve the requirements for opening a Ginmon Account. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ginmon-account-agreement-document-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_ginmon_account_agreement_document_batch_for_user(
    ...
    ginmon_account_agreement_document_batch: GinmonAccountAgreementDocumentBatch = Body(None, description=""),
...
) -> GinmonAccountAgreementDocumentBatchCreate:
    """Used to retrieve the requirements for opening a Ginmon Account. apiApp:CREATE"""
    if not BaseGinmonAccountAgreementDocumentBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGinmonAccountAgreementDocumentBatchApi.subclasses[0]().c_reate_ginmon_account_agreement_document_batch_for_user(userID, user_agent, x_bunq_client_authentication, ginmon_account_agreement_document_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
