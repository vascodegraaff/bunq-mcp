...
from openapi_server.apis.token_qr_card_activation_api_base import BaseTokenQrCardActivationApi
...
from openapi_server.models.token_qr_card_activation import TokenQrCardActivation
from openapi_server.models.token_qr_card_activation_create import TokenQrCardActivationCreate
...
@router.post(
    "/user/{userID}/token-qr-card-activation",
    responses={
        200: {"model": TokenQrCardActivationCreate, "description": "Usage of this endpoint (by scanning a QR code) returns the card to be activated. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-card-activation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_card_activation_for_user(
    ...
    token_qr_card_activation: TokenQrCardActivation = Body(None, description=""),
...
) -> TokenQrCardActivationCreate:
    """Usage of this endpoint (by scanning a QR code) returns the card to be activated. apiApp:CREATE"""
    if not BaseTokenQrCardActivationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrCardActivationApi.subclasses[0]().c_reate_token_qr_card_activation_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_card_activation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
