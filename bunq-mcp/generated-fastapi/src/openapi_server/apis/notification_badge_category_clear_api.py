...
from openapi_server.apis.notification_badge_category_clear_api_base import BaseNotificationBadgeCategoryClearApi
...
from openapi_server.models.notification_badge_category_clear import NotificationBadgeCategoryClear
from openapi_server.models.notification_badge_category_clear_create import NotificationBadgeCategoryClearCreate
...
@router.post(
    "/user/{userID}/notification-badge-category-clear",
    responses={
        200: {"model": NotificationBadgeCategoryClearCreate, "description": "To clear notification for specific events. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["notification-badge-category-clear"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_notification_badge_category_clear_for_user(
    ...
    notification_badge_category_clear: NotificationBadgeCategoryClear = Body(None, description=""),
...
) -> NotificationBadgeCategoryClearCreate:
    """To clear notification for specific events. apiApp:CREATE"""
    if not BaseNotificationBadgeCategoryClearApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseNotificationBadgeCategoryClearApi.subclasses[0]().c_reate_notification_badge_category_clear_for_user(userID, user_agent, x_bunq_client_authentication, notification_badge_category_clear, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
