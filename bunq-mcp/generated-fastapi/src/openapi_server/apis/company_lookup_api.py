...
from openapi_server.apis.company_lookup_api_base import BaseCompanyLookupApi
...
@router.post(
    "/company-lookup",
    responses={
        200: {"model": CompanyLookupCreate, "description": "Get detailed comapny information by chamber of commerce number. apiApp:LISTING/CREATE"},
...
async def c_reate_company_lookup(
    ...
    company_lookup: CompanyLookup = Body(None, description=""),
    ...
    if not BaseCompanyLookupApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyLookupApi.subclasses[0]().c_reate_company_lookup(user_agent, x_bunq_client_authentication, company_lookup, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/company-lookup",
    responses={
        200: {"model": List[CompanyLookupListing], "description": "Get detailed comapny information by chamber of commerce number. apiApp:LISTING/CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["company-lookup"],
    summary="",
...
async def list_all_company_lookup(
    ...
    if not BaseCompanyLookupApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyLookupApi.subclasses[0]().list_all_company_lookup(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user-company/{user-companyID}/company-lookup",
    responses={
        200: {"model": List[CompanyLookupUserListing], "description": "Get company lookup result by user. apiAdmin:LISTING apiServiceInternal:LISTING apiRetool:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["company-lookup"],
    summary="",
...
async def list_all_company_lookup_for_user_company(
    ...
    if not BaseCompanyLookupApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyLookupApi.subclasses[0]().list_all_company_lookup_for_user_company(user-companyID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
