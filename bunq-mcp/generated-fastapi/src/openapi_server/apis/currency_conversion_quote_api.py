...
from openapi_server.apis.currency_conversion_quote_api_base import BaseCurrencyConversionQuoteApi
...
from openapi_server.models.currency_conversion_quote import CurrencyConversionQuote
from openapi_server.models.currency_conversion_quote_create import CurrencyConversionQuoteCreate
from openapi_server.models.currency_conversion_quote_read import CurrencyConversionQuoteRead
from openapi_server.models.currency_conversion_quote_update import CurrencyConversionQuoteUpdate
...
@router.post(
    ...
    responses={
        200: {"model": CurrencyConversionQuoteCreate, "description": "Endpoint to create a quote for currency conversions. apiApp:CREATE/READ/UPDATE apiPublic:CREATE/READ/UPDATE"},
...
async def c_reate_currency_conversion_quote_for_user_monetary_account(
    ...
    currency_conversion_quote: CurrencyConversionQuote = Body(None, description=""),
    ...
    """Endpoint to create a quote for currency conversions. apiApp:CREATE/READ/UPDATE apiPublic:CREATE/READ/UPDATE"""
    if not BaseCurrencyConversionQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCurrencyConversionQuoteApi.subclasses[0]().c_reate_currency_conversion_quote_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, currency_conversion_quote, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/currency-conversion-quote/{itemId}",
    responses={
        200: {"model": CurrencyConversionQuoteRead, "description": "Endpoint to create a quote for currency conversions. apiApp:CREATE/READ/UPDATE apiPublic:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["currency-conversion-quote"],
    summary="",
...
async def r_ead_currency_conversion_quote_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseCurrencyConversionQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCurrencyConversionQuoteApi.subclasses[0]().r_ead_currency_conversion_quote_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/monetary-account/{monetary-accountID}/currency-conversion-quote/{itemId}",
    responses={
        200: {"model": CurrencyConversionQuoteUpdate, "description": "Endpoint to create a quote for currency conversions. apiApp:CREATE/READ/UPDATE apiPublic:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["currency-conversion-quote"],
    summary="",
...
async def u_pdate_currency_conversion_quote_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseCurrencyConversionQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCurrencyConversionQuoteApi.subclasses[0]().u_pdate_currency_conversion_quote_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, currency_conversion_quote, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
