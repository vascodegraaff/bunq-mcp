...
class BaseTicketMessageTimeWaitingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTicketMessageTimeWaitingApi.subclasses = BaseTicketMessageTimeWaitingApi.subclasses + (cls,)
    async def c_reate_ticket_message_time_waiting(
        ...
        ticket_message_time_waiting: TicketMessageTimeWaiting,
