...
from openapi_server.apis.invoice_api_base import BaseInvoiceApi
...
from openapi_server.models.invoice_by_user_listing import InvoiceByUserListing
from openapi_server.models.invoice_by_user_read import InvoiceByUserRead
from openapi_server.models.invoice_listing import InvoiceListing
from openapi_server.models.invoice_read import InvoiceRead
...
@router.get(
    "/user/{userID}/invoice",
    responses={
        200: {"model": List[InvoiceByUserListing], "description": "Used to list bunq invoices by user. apiAdmin:LISTING/READ apiApp:LISTING/READ apiPublic:LISTING/READ apiServiceInternal:LISTING/READ"},
...
) -> List[InvoiceByUserListing]:
    """Used to list bunq invoices by user. apiAdmin:LISTING/READ apiApp:LISTING/READ apiPublic:LISTING/READ apiServiceInternal:LISTING/READ"""
    if not BaseInvoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInvoiceApi.subclasses[0]().list_all_invoice_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/invoice",
    responses={
        200: {"model": List[InvoiceListing], "description": "Used to view a bunq invoice. apiAdmin:LISTING/READ apiApp:LISTING/READ apiPublic:LISTING/READ apiServiceInternal:LISTING/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["invoice"],
    summary="",
...
async def list_all_invoice_for_user_monetary_account(
    ...
    """Used to view a bunq invoice. apiAdmin:LISTING/READ apiApp:LISTING/READ apiPublic:LISTING/READ apiServiceInternal:LISTING/READ"""
    if not BaseInvoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInvoiceApi.subclasses[0]().list_all_invoice_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/invoice/{itemId}",
    responses={
        200: {"model": InvoiceByUserRead, "description": "Used to list bunq invoices by user. apiAdmin:LISTING/READ apiApp:LISTING/READ apiPublic:LISTING/READ apiServiceInternal:LISTING/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["invoice"],
    summary="",
...
async def r_ead_invoice_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseInvoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInvoiceApi.subclasses[0]().r_ead_invoice_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/invoice/{itemId}",
    responses={
        200: {"model": InvoiceRead, "description": "Used to view a bunq invoice. apiAdmin:LISTING/READ apiApp:LISTING/READ apiPublic:LISTING/READ apiServiceInternal:LISTING/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["invoice"],
    summary="",
...
async def r_ead_invoice_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseInvoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInvoiceApi.subclasses[0]().r_ead_invoice_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
