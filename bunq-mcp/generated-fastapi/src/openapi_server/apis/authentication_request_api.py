...
from openapi_server.apis.authentication_request_api_base import BaseAuthenticationRequestApi
...
from openapi_server.models.master_card_identity_check_authentication_request import MasterCardIdentityCheckAuthenticationRequest
from openapi_server.models.master_card_identity_check_authentication_request_create import MasterCardIdentityCheckAuthenticationRequestCreate
...
@router.post(
    ...
    responses={
        200: {"model": MasterCardIdentityCheckAuthenticationRequestCreate, "description": "Endpoint for merchants to send an authentication request through the MasterCard Directory Server. apiMasterCardIdentityCheck:CREATE"},
...
async def c_reate_authentication_request(
    ...
    master_card_identity_check_authentication_request: MasterCardIdentityCheckAuthenticationRequest = Body(None, description=""),
...
) -> MasterCardIdentityCheckAuthenticationRequestCreate:
    """Endpoint for merchants to send an authentication request through the MasterCard Directory Server. apiMasterCardIdentityCheck:CREATE"""
    if not BaseAuthenticationRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAuthenticationRequestApi.subclasses[0]().c_reate_authentication_request(user_agent, x_bunq_client_authentication, master_card_identity_check_authentication_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
