...
class BaseSupportConversationExternalApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSupportConversationExternalApi.subclasses = BaseSupportConversationExternalApi.subclasses + (cls,)
    async def c_reate_support_conversation_external_for_user(
        ...
        chat_conversation_support_external: ChatConversationSupportExternal,
