...
class BaseFreezePaymentClosureApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseFreezePaymentClosureApi.subclasses = BaseFreezePaymentClosureApi.subclasses + (cls,)
    async def c_reate_freeze_payment_closure_for_user(
        ...
        freeze_user_payment_closure: FreezeUserPaymentClosure,
