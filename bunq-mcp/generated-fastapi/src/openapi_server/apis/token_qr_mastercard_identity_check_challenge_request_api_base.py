...
class BaseTokenQrMastercardIdentityCheckChallengeRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrMastercardIdentityCheckChallengeRequestApi.subclasses = BaseTokenQrMastercardIdentityCheckChallengeRequestApi.subclasses + (cls,)
    async def c_reate_token_qr_mastercard_identity_check_challenge_request_for_user(
        ...
        token_qr_master_card_identity_check_challenge_request: TokenQrMasterCardIdentityCheckChallengeRequest,
