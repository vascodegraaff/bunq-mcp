...
class BaseBunqmeMerchantRequestCheckoutSessionIdentifierApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestCheckoutSessionIdentifierApi.subclasses = BaseBunqmeMerchantRequestCheckoutSessionIdentifierApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request_checkout_session_identifier(
        ...
        bunq_me_merchant_request_checkout_session_identifier: BunqMeMerchantRequestCheckoutSessionIdentifier,
