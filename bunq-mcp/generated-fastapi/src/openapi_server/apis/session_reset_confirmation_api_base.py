...
class BaseSessionResetConfirmationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionResetConfirmationApi.subclasses = BaseSessionResetConfirmationApi.subclasses + (cls,)
    async def c_reate_session_reset_confirmation(
        ...
        session_reset_confirmation: SessionResetConfirmation,
