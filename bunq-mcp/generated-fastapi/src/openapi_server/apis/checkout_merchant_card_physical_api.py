...
from openapi_server.apis.checkout_merchant_card_physical_api_base import BaseCheckoutMerchantCardPhysicalApi
...
@router.post(
    "/user/{userID}/checkout-merchant-card-physical",
    responses={
        200: {"model": CheckoutMerchantCardPhysicalCreate, "description": "Used to manage physical cards to be used for card top up. apiApp:CREATE/UPDATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["checkout-merchant-card-physical"],
    summary="",
...
async def c_reate_checkout_merchant_card_physical_for_user(
    ...
    checkout_merchant_card_physical: CheckoutMerchantCardPhysical = Body(None, description=""),
    ...
    if not BaseCheckoutMerchantCardPhysicalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCheckoutMerchantCardPhysicalApi.subclasses[0]().c_reate_checkout_merchant_card_physical_for_user(userID, user_agent, x_bunq_client_authentication, checkout_merchant_card_physical, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/checkout-merchant-card-physical/{itemId}",
    responses={
        200: {"model": object, "description": "Used to manage physical cards to be used for card top up. apiApp:CREATE/UPDATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["checkout-merchant-card-physical"],
    summary="",
...
async def d_elete_checkout_merchant_card_physical_for_user(
    ...
    if not BaseCheckoutMerchantCardPhysicalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCheckoutMerchantCardPhysicalApi.subclasses[0]().d_elete_checkout_merchant_card_physical_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/checkout-merchant-card-physical",
    responses={
        200: {"model": List[CheckoutMerchantCardPhysicalListing], "description": "Used to manage physical cards to be used for card top up. apiApp:CREATE/UPDATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["checkout-merchant-card-physical"],
    summary="",
...
async def list_all_checkout_merchant_card_physical_for_user(
    ...
    if not BaseCheckoutMerchantCardPhysicalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCheckoutMerchantCardPhysicalApi.subclasses[0]().list_all_checkout_merchant_card_physical_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/checkout-merchant-card-physical/{itemId}",
    responses={
        200: {"model": CheckoutMerchantCardPhysicalRead, "description": "Used to manage physical cards to be used for card top up. apiApp:CREATE/UPDATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["checkout-merchant-card-physical"],
    summary="",
...
async def r_ead_checkout_merchant_card_physical_for_user(
    ...
    if not BaseCheckoutMerchantCardPhysicalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCheckoutMerchantCardPhysicalApi.subclasses[0]().r_ead_checkout_merchant_card_physical_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/checkout-merchant-card-physical/{itemId}",
    responses={
        200: {"model": CheckoutMerchantCardPhysicalUpdate, "description": "Used to manage physical cards to be used for card top up. apiApp:CREATE/UPDATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["checkout-merchant-card-physical"],
    summary="",
...
async def u_pdate_checkout_merchant_card_physical_for_user(
    ...
    if not BaseCheckoutMerchantCardPhysicalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCheckoutMerchantCardPhysicalApi.subclasses[0]().u_pdate_checkout_merchant_card_physical_for_user(userID, itemId, user_agent, x_bunq_client_authentication, checkout_merchant_card_physical, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
