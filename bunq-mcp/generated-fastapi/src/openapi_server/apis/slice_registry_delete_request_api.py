...
from openapi_server.apis.slice_registry_delete_request_api_base import BaseSliceRegistryDeleteRequestApi
...
from openapi_server.models.slice_registry_delete_request import SliceRegistryDeleteRequest
from openapi_server.models.slice_registry_delete_request_create import SliceRegistryDeleteRequestCreate
...
@router.post(
    ...
    responses={
        200: {"model": SliceRegistryDeleteRequestCreate, "description": "Used to process Registry(Tricount) delete requests from apps. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["slice-registry-delete-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_slice_registry_delete_request_for_user(
    ...
    slice_registry_delete_request: SliceRegistryDeleteRequest = Body(None, description=""),
...
) -> SliceRegistryDeleteRequestCreate:
    """Used to process Registry(Tricount) delete requests from apps. apiApp:CREATE"""
    if not BaseSliceRegistryDeleteRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSliceRegistryDeleteRequestApi.subclasses[0]().c_reate_slice_registry_delete_request_for_user(userID, user_agent, x_bunq_client_authentication, slice_registry_delete_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
