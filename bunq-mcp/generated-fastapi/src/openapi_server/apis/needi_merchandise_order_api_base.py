...
class BaseNeediMerchandiseOrderApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNeediMerchandiseOrderApi.subclasses = BaseNeediMerchandiseOrderApi.subclasses + (cls,)
    async def c_reate_needi_merchandise_order(
        ...
        needi_merchandise_order: NeediMerchandiseOrder,
