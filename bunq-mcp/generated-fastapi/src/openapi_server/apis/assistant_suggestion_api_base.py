...
class BaseAssistantSuggestionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAssistantSuggestionApi.subclasses = BaseAssistantSuggestionApi.subclasses + (cls,)
    async def c_reate_assistant_suggestion_for_user_assistant(
        ...
        assistant_suggestion: AssistantSuggestion,
