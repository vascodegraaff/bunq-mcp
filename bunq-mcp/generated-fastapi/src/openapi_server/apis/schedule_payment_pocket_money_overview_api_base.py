...
class BaseSchedulePaymentPocketMoneyOverviewApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSchedulePaymentPocketMoneyOverviewApi.subclasses = BaseSchedulePaymentPocketMoneyOverviewApi.subclasses + (cls,)
