...
class BaseScheduleRequestInquiryBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseScheduleRequestInquiryBatchApi.subclasses = BaseScheduleRequestInquiryBatchApi.subclasses + (cls,)
    async def c_reate_schedule_request_inquiry_batch_for_user_monetary_account(
        ...
        schedule_request_inquiry_batch: ScheduleRequestInquiryBatch,
