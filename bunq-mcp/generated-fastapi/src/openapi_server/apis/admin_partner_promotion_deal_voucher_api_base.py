...
class BaseAdminPartnerPromotionDealVoucherApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionDealVoucherApi.subclasses = BaseAdminPartnerPromotionDealVoucherApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_deal_voucher(
        ...
        admin_partner_promotion_deal_voucher: AdminPartnerPromotionDealVoucher,
