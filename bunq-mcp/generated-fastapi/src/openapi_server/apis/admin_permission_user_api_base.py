...
class BaseAdminPermissionUserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPermissionUserApi.subclasses = BaseAdminPermissionUserApi.subclasses + (cls,)
    async def c_reate_admin_permission_user_for_user(
        ...
        admin_permission_user: AdminPermissionUser,
