...
class BaseTokenQrConfirmationAliasApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrConfirmationAliasApi.subclasses = BaseTokenQrConfirmationAliasApi.subclasses + (cls,)
    async def c_reate_token_qr_confirmation_alias_for_user(
        ...
        token_qr_confirmation_alias: TokenQrConfirmationAlias,
