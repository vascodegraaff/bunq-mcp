...
from openapi_server.apis.invite_user_personalized_web_api_base import BaseInviteUserPersonalizedWebApi
...
from openapi_server.models.invite_user_personalized_web import InviteUserPersonalizedWeb
from openapi_server.models.invite_user_personalized_web_update import InviteUserPersonalizedWebUpdate
...
@router.put(
    "/user/{userID}/invite-user-personalized-web/{itemId}",
    responses={
        200: {"model": InviteUserPersonalizedWebUpdate, "description": "Endpoint for updating invites using bunq Web. apiApp:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["invite-user-personalized-web"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_invite_user_personalized_web_for_user(
    ...
    invite_user_personalized_web: InviteUserPersonalizedWeb = Body(None, description=""),
...
) -> InviteUserPersonalizedWebUpdate:
    """Endpoint for updating invites using bunq Web. apiApp:UPDATE"""
    if not BaseInviteUserPersonalizedWebApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInviteUserPersonalizedWebApi.subclasses[0]().u_pdate_invite_user_personalized_web_for_user(userID, itemId, user_agent, x_bunq_client_authentication, invite_user_personalized_web, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
