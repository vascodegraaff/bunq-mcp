...
from openapi_server.apis.value_checklist_api_base import BaseValueChecklistApi
...
from openapi_server.models.user_review_value_checklist import UserReviewValueChecklist
from openapi_server.models.user_review_value_checklist_update import UserReviewValueChecklistUpdate
...
@router.put(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-checklist/{itemId}",
    responses={
        200: {"model": UserReviewValueChecklistUpdate, "description": "Endpoint for updating UserReviewValueChecklist. apiApp:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["value-checklist"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_value_checklist_for_user_review_check(
    ...
    user_review_value_checklist: UserReviewValueChecklist = Body(None, description=""),
...
) -> UserReviewValueChecklistUpdate:
    """Endpoint for updating UserReviewValueChecklist. apiApp:UPDATE"""
    if not BaseValueChecklistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueChecklistApi.subclasses[0]().u_pdate_value_checklist_for_user_review_check(userID, reviewID, checkID, itemId, user_agent, x_bunq_client_authentication, user_review_value_checklist, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
