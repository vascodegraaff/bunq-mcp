...
from openapi_server.apis.request_inquiry_batch_api_base import BaseRequestInquiryBatchApi
...
@router.post(
    ...
    responses={
        200: {"model": RequestInquiryBatchCreate, "description": "Create a batch of requests for payment, or show the request batches of a monetary account. apiAdmin:READ/LISTING apiApp:CREATE/UPDATE/READ/LISTING apiPublic:CREATE/UPDATE/READ/LISTING apiServiceInternal:READ/LISTING"},
...
async def c_reate_request_inquiry_batch_for_user_monetary_account(
    ...
    request_inquiry_batch: RequestInquiryBatch = Body(None, description=""),
    ...
    if not BaseRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryBatchApi.subclasses[0]().c_reate_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, request_inquiry_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/request-inquiry-batch",
    responses={
        200: {"model": List[RequestInquiryBatchListing], "description": "Create a batch of requests for payment, or show the request batches of a monetary account. apiAdmin:READ/LISTING apiApp:CREATE/UPDATE/READ/LISTING apiPublic:CREATE/UPDATE/READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry-batch"],
    summary="",
...
async def list_all_request_inquiry_batch_for_user_monetary_account(
    ...
    if not BaseRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryBatchApi.subclasses[0]().list_all_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/request-inquiry-batch/{itemId}",
    responses={
        200: {"model": RequestInquiryBatchRead, "description": "Create a batch of requests for payment, or show the request batches of a monetary account. apiAdmin:READ/LISTING apiApp:CREATE/UPDATE/READ/LISTING apiPublic:CREATE/UPDATE/READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry-batch"],
    summary="",
...
async def r_ead_request_inquiry_batch_for_user_monetary_account(
    ...
    if not BaseRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryBatchApi.subclasses[0]().r_ead_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/monetary-account/{monetary-accountID}/request-inquiry-batch/{itemId}",
    responses={
        200: {"model": RequestInquiryBatchUpdate, "description": "Create a batch of requests for payment, or show the request batches of a monetary account. apiAdmin:READ/LISTING apiApp:CREATE/UPDATE/READ/LISTING apiPublic:CREATE/UPDATE/READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry-batch"],
    summary="",
...
async def u_pdate_request_inquiry_batch_for_user_monetary_account(
    ...
    if not BaseRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryBatchApi.subclasses[0]().u_pdate_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, request_inquiry_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
