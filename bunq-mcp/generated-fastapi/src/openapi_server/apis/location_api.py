...
from openapi_server.models.device_location import DeviceLocation
from openapi_server.models.device_location_create import DeviceLocationCreate
...
@router.post(
    ...
    responses={
        200: {"model": DeviceLocationCreate, "description": "Create updates on the location of the device. These are never stored, merely used for detecting changes. apiApp:CREATE"},
...
async def c_reate_location_for_device(
    ...
    device_location: DeviceLocation = Body(None, description=""),
    ...
    """Create updates on the location of the device. These are never stored, merely used for detecting changes. apiApp:CREATE"""
    if not BaseLocationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseLocationApi.subclasses[0]().c_reate_location_for_device(deviceID, user_agent, x_bunq_client_authentication, device_location, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
