...
class BaseSessionRegistrySocialApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionRegistrySocialApi.subclasses = BaseSessionRegistrySocialApi.subclasses + (cls,)
    async def c_reate_session_registry_social(
        ...
        session_registry_social: SessionRegistrySocial,
