...
class BaseTransactionMonitoringMachineLearningResultApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransactionMonitoringMachineLearningResultApi.subclasses = BaseTransactionMonitoringMachineLearningResultApi.subclasses + (cls,)
    async def list_all_transaction_monitoring_machine_learning_result_for_transaction_monitoring_metadata(
        self,
        transaction-monitoring-metadataID: StrictInt,
