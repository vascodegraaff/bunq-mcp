...
from openapi_server.apis.session_browser_api_base import BaseSessionBrowserApi
...
from openapi_server.models.session_browser import SessionBrowser
from openapi_server.models.session_browser_create import SessionBrowserCreate
...
@router.post(
    "/session-browser",
    responses={
        200: {"model": SessionBrowserCreate, "description": "Used to log in a user with a browser. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_session_browser(
    ...
    session_browser: SessionBrowser = Body(None, description=""),
...
) -> SessionBrowserCreate:
    """Used to log in a user with a browser. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseSessionBrowserApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionBrowserApi.subclasses[0]().c_reate_session_browser(user_agent, x_bunq_client_authentication, session_browser, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
