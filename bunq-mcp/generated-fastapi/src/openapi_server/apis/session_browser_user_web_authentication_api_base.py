...
class BaseSessionBrowserUserWebAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionBrowserUserWebAuthenticationApi.subclasses = BaseSessionBrowserUserWebAuthenticationApi.subclasses + (cls,)
    async def c_reate_session_browser_user_web_authentication(
        ...
        session_browser_user_web_authentication: SessionBrowserUserWebAuthentication,
