...
from openapi_server.apis.adyen_card_transaction_available_api_base import BaseAdyenCardTransactionAvailableApi
...
from openapi_server.models.adyen_card_transaction_available_listing import AdyenCardTransactionAvailableListing
...
@router.get(
    "/user/{userID}/adyen-card-transaction-available",
    responses={
        200: {"model": List[AdyenCardTransactionAvailableListing], "description": "To determine whether Adyen is available for you and your companies. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["adyen-card-transaction-available"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_adyen_card_transaction_available_for_user(
...
) -> List[AdyenCardTransactionAvailableListing]:
    """To determine whether Adyen is available for you and your companies. apiApp:LISTING"""
    if not BaseAdyenCardTransactionAvailableApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdyenCardTransactionAvailableApi.subclasses[0]().list_all_adyen_card_transaction_available_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
