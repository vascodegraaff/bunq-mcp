...
class BaseUserSettingContactPhonebookSignupApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingContactPhonebookSignupApi.subclasses = BaseUserSettingContactPhonebookSignupApi.subclasses + (cls,)
    async def c_reate_user_setting_contact_phonebook_signup_for_user(
        ...
        user_setting_contact_phonebook_signup: UserSettingContactPhonebookSignup,
