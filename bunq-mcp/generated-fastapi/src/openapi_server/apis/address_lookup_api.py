...
from openapi_server.apis.address_lookup_api_base import BaseAddressLookupApi
...
from openapi_server.models.address_lookup import AddressLookup
from openapi_server.models.address_lookup_create import AddressLookupCreate
...
@router.post(
    "/address-lookup",
    responses={
        200: {"model": AddressLookupCreate, "description": "View endpoint for the user main address. apiApp:CREATE"},
...
async def c_reate_address_lookup(
    ...
    address_lookup: AddressLookup = Body(None, description=""),
    ...
    """View endpoint for the user main address. apiApp:CREATE"""
    if not BaseAddressLookupApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAddressLookupApi.subclasses[0]().c_reate_address_lookup(user_agent, x_bunq_client_authentication, address_lookup, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
