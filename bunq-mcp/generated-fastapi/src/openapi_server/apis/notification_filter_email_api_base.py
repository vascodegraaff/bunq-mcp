...
class BaseNotificationFilterEmailApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNotificationFilterEmailApi.subclasses = BaseNotificationFilterEmailApi.subclasses + (cls,)
    async def c_reate_notification_filter_email_for_user(
        ...
        notification_filter_email: NotificationFilterEmail,
