...
from openapi_server.apis.admin_adyen_clearing_merchant_transaction_api_base import BaseAdminAdyenClearingMerchantTransactionApi
...
from openapi_server.models.admin_adyen_clearing_merchant_transaction import AdminAdyenClearingMerchantTransaction
from openapi_server.models.admin_adyen_clearing_merchant_transaction_update import AdminAdyenClearingMerchantTransactionUpdate
...
@router.put(
    "/admin-adyen-clearing-merchant-transaction/{itemId}",
    responses={
        200: {"model": AdminAdyenClearingMerchantTransactionUpdate, "description": "Manage Adyen Merchant Clearings. apiAdmin:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-adyen-clearing-merchant-transaction"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_admin_adyen_clearing_merchant_transaction(
    ...
    admin_adyen_clearing_merchant_transaction: AdminAdyenClearingMerchantTransaction = Body(None, description=""),
...
) -> AdminAdyenClearingMerchantTransactionUpdate:
    """Manage Adyen Merchant Clearings. apiAdmin:UPDATE"""
    if not BaseAdminAdyenClearingMerchantTransactionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminAdyenClearingMerchantTransactionApi.subclasses[0]().u_pdate_admin_adyen_clearing_merchant_transaction(itemId, user_agent, x_bunq_client_authentication, admin_adyen_clearing_merchant_transaction, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
