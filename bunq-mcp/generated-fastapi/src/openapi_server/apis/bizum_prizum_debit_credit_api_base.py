...
from openapi_server.models.bizum_prizum_debit_credit_create import BizumPrizumDebitCreditCreate
from openapi_server.models.create1brn400_response import CREATE1brn400Response


class BaseBizumPrizumDebitCreditApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBizumPrizumDebitCreditApi.subclasses = BaseBizumPrizumDebitCreditApi.subclasses + (cls,)
    async def c_reate_bizum_prizum_debit_credit(
        self,
    ...
    ) -> BizumPrizumDebitCreditCreate:
        """Endpoint for receiving Bizum transfers between two bunq users via the Prizum protocol. apiBizum:CREATE"""
        ...
