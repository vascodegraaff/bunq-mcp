...
from openapi_server.apis.challenge_request_browser_api_base import BaseChallengeRequestBrowserApi
...
from openapi_server.models.master_card_identity_check_challenge_request_browser import MasterCardIdentityCheckChallengeRequestBrowser
from openapi_server.models.master_card_identity_check_challenge_request_browser_create import MasterCardIdentityCheckChallengeRequestBrowserCreate
...
@router.post(
    ...
    responses={
        200: {"model": MasterCardIdentityCheckChallengeRequestBrowserCreate, "description": "Endpoint for merchants to send a challenge request through the browser. apiMasterCardIdentityCheck:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["challenge-request-browser"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_challenge_request_browser(
    ...
    master_card_identity_check_challenge_request_browser: MasterCardIdentityCheckChallengeRequestBrowser = Body(None, description=""),
...
) -> MasterCardIdentityCheckChallengeRequestBrowserCreate:
    """Endpoint for merchants to send a challenge request through the browser. apiMasterCardIdentityCheck:CREATE"""
    if not BaseChallengeRequestBrowserApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseChallengeRequestBrowserApi.subclasses[0]().c_reate_challenge_request_browser(user_agent, x_bunq_client_authentication, master_card_identity_check_challenge_request_browser, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
