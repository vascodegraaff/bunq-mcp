...
from openapi_server.apis.ginmon_auto_save_entry_api_base import BaseGinmonAutoSaveEntryApi
...
from openapi_server.models.ginmon_auto_save_entry_listing import GinmonAutoSaveEntryListing
...
@router.get(
    "/user/{userID}/ginmon-auto-save-entry",
    responses={
        200: {"model": List[GinmonAutoSaveEntryListing], "description": "This view returns the GinmonAutoSaveEntryModel. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ginmon-auto-save-entry"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_ginmon_auto_save_entry_for_user(
...
) -> List[GinmonAutoSaveEntryListing]:
    """This view returns the GinmonAutoSaveEntryModel. apiApp:LISTING"""
    if not BaseGinmonAutoSaveEntryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGinmonAutoSaveEntryApi.subclasses[0]().list_all_ginmon_auto_save_entry_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
