...
from openapi_server.apis.schedule_request_inquiry_batch_api_base import BaseScheduleRequestInquiryBatchApi
...
from openapi_server.models.schedule_request_inquiry_batch import ScheduleRequestInquiryBatch
from openapi_server.models.schedule_request_inquiry_batch_create import ScheduleRequestInquiryBatchCreate
from openapi_server.models.schedule_request_inquiry_batch_read import ScheduleRequestInquiryBatchRead
from openapi_server.models.schedule_request_inquiry_batch_update import ScheduleRequestInquiryBatchUpdate
...
@router.post(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-request-inquiry-batch",
    responses={
        200: {"model": ScheduleRequestInquiryBatchCreate, "description": "Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-request-inquiry-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_schedule_request_inquiry_batch_for_user_monetary_account(
    ...
    schedule_request_inquiry_batch: ScheduleRequestInquiryBatch = Body(None, description=""),
...
) -> ScheduleRequestInquiryBatchCreate:
    """Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"""
    if not BaseScheduleRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleRequestInquiryBatchApi.subclasses[0]().c_reate_schedule_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, schedule_request_inquiry_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-request-inquiry-batch/{itemId}",
    responses={
        200: {"model": object, "description": "Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-request-inquiry-batch"],
    summary="",
...
async def d_elete_schedule_request_inquiry_batch_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseScheduleRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleRequestInquiryBatchApi.subclasses[0]().d_elete_schedule_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-request-inquiry-batch/{itemId}",
    responses={
        200: {"model": ScheduleRequestInquiryBatchRead, "description": "Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-request-inquiry-batch"],
    summary="",
...
async def r_ead_schedule_request_inquiry_batch_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> ScheduleRequestInquiryBatchRead:
    """Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"""
    if not BaseScheduleRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleRequestInquiryBatchApi.subclasses[0]().r_ead_schedule_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/monetary-account/{monetary-accountID}/schedule-request-inquiry-batch/{itemId}",
    responses={
        200: {"model": ScheduleRequestInquiryBatchUpdate, "description": "Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["schedule-request-inquiry-batch"],
    summary="",
...
async def u_pdate_schedule_request_inquiry_batch_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> ScheduleRequestInquiryBatchUpdate:
    """Used to schedule request inquiry batches. apiApp:CREATE/READ/UPDATE/DELETE"""
    if not BaseScheduleRequestInquiryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScheduleRequestInquiryBatchApi.subclasses[0]().u_pdate_schedule_request_inquiry_batch_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, schedule_request_inquiry_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
