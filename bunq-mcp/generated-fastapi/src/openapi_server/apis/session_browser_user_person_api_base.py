...
class BaseSessionBrowserUserPersonApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionBrowserUserPersonApi.subclasses = BaseSessionBrowserUserPersonApi.subclasses + (cls,)
    async def c_reate_session_browser_user_person(
        ...
        session_browser_user_person: SessionBrowserUserPerson,
