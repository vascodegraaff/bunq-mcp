...
class BaseAdminPermissionEndpointUserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPermissionEndpointUserApi.subclasses = BaseAdminPermissionEndpointUserApi.subclasses + (cls,)
    async def c_reate_admin_permission_endpoint_user_for_user(
        ...
        admin_permission_endpoint_user: AdminPermissionEndpointUser,
