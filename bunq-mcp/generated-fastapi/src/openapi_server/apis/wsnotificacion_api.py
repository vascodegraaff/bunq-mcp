...
from openapi_server.apis.wsnotificacion_api_base import BaseWsnotificacionApi
...
from openapi_server.models.bizum_notification_create import BizumNotificationCreate
...
@router.post(
    "/wsnotificacion",
    responses={
        200: {"model": BizumNotificationCreate, "description": "Endpoint for receiving Bizum notifications. apiBizum:CREATE"},
...
async def c_reate_wsnotificacion(
...
) -> BizumNotificationCreate:
    """Endpoint for receiving Bizum notifications. apiBizum:CREATE"""
    if not BaseWsnotificacionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWsnotificacionApi.subclasses[0]().c_reate_wsnotificacion(user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
