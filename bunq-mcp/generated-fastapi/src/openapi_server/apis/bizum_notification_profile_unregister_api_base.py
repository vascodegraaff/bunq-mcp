...
class BaseBizumNotificationProfileUnregisterApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBizumNotificationProfileUnregisterApi.subclasses = BaseBizumNotificationProfileUnregisterApi.subclasses + (cls,)
