...
class BaseOpvragenNawApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseOpvragenNawApi.subclasses = BaseOpvragenNawApi.subclasses + (cls,)
    async def c_reate_opvragen_naw(
        ...
        government_referral_portal_external_search_by_user_data: GovernmentReferralPortalExternalSearchByUserData,
