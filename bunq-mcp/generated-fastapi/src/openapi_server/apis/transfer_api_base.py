...
from openapi_server.models.ticket_transfer import TicketTransfer
from openapi_server.models.ticket_transfer_listing import TicketTransferListing
from openapi_server.models.ticket_transfer_update import TicketTransferUpdate
...
class BaseTransferApi:
    ...
    async def list_all_transfer_for_user_ticket(
        self,
        userID: StrictInt,
        ticketID: StrictInt,
    ...
    ) -> List[TicketTransferListing]:
        """Endpoint for transferring tickets for users account from admin. apiAdmin:UPDATE/LISTING"""
        ...


    async def u_pdate_transfer_for_user_ticket(
        self,
        userID: StrictInt,
        ticketID: StrictInt,
        itemId: StrictInt,
