...
from openapi_server.apis.pdf_content_api_base import BasePdfContentApi
...
@router.get(
    ...
    responses={
        200: {"model": List[object], "description": "Get a PDF export of an invoice. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"},
...
async def list_all_pdf_content_for_user_invoice(
    ...
    """Get a PDF export of an invoice. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"""
    if not BasePdfContentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePdfContentApi.subclasses[0]().list_all_pdf_content_for_user_invoice(userID, invoiceID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
