...
class BaseTokenQrBunqmeFundraiserProfileEntryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrBunqmeFundraiserProfileEntryApi.subclasses = BaseTokenQrBunqmeFundraiserProfileEntryApi.subclasses + (cls,)
    async def c_reate_token_qr_bunqme_fundraiser_profile_entry_for_user(
        ...
        token_qr_bunq_me_fundraiser_profile_entry: TokenQrBunqMeFundraiserProfileEntry,
