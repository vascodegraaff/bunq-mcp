...
from openapi_server.apis.address_main_api_base import BaseAddressMainApi
...
from openapi_server.models.address_user_main import AddressUserMain
from openapi_server.models.address_user_main_create import AddressUserMainCreate
from openapi_server.models.address_user_main_read import AddressUserMainRead
...
@router.post(
    "/user/{userID}/address-main",
    responses={
        200: {"model": AddressUserMainCreate, "description": "View endpoint for the user main address. apiApp:CREATE/READ"},
...
async def c_reate_address_main_for_user(
    ...
    address_user_main: AddressUserMain = Body(None, description=""),
...
) -> AddressUserMainCreate:
    """View endpoint for the user main address. apiApp:CREATE/READ"""
    if not BaseAddressMainApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAddressMainApi.subclasses[0]().c_reate_address_main_for_user(userID, user_agent, x_bunq_client_authentication, address_user_main, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/address-main/{itemId}",
    responses={
        200: {"model": AddressUserMainRead, "description": "View endpoint for the user main address. apiApp:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["address-main"],
    summary="",
...
async def r_ead_address_main_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseAddressMainApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAddressMainApi.subclasses[0]().r_ead_address_main_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
