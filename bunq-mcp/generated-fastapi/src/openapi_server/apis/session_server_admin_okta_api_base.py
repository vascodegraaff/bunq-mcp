...
class BaseSessionServerAdminOktaApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionServerAdminOktaApi.subclasses = BaseSessionServerAdminOktaApi.subclasses + (cls,)
    async def c_reate_session_server_admin_okta(
        ...
        session_server_admin_okta: SessionServerAdminOkta,
