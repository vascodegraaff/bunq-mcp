...
class BaseIdealIssuerTransactionClaimApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdealIssuerTransactionClaimApi.subclasses = BaseIdealIssuerTransactionClaimApi.subclasses + (cls,)
    async def c_reate_ideal_issuer_transaction_claim_for_user(
        ...
        ideal_issuer_transaction_claim: IdealIssuerTransactionClaim,
