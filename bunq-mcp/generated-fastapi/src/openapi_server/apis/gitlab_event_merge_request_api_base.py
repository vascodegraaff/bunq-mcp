...
class BaseGitlabEventMergeRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGitlabEventMergeRequestApi.subclasses = BaseGitlabEventMergeRequestApi.subclasses + (cls,)
    async def c_reate_gitlab_event_merge_request(
        ...
        gitlab_event_merge_request: GitlabEventMergeRequest,
