...
class BaseValueIdentificationDocumentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseValueIdentificationDocumentApi.subclasses = BaseValueIdentificationDocumentApi.subclasses + (cls,)
    async def c_reate_value_identification_document_for_user_review_check(
        ...
        user_review_value_identification_document: UserReviewValueIdentificationDocument,
