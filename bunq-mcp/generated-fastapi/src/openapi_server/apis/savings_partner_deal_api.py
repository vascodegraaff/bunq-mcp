...
from openapi_server.apis.savings_partner_deal_api_base import BaseSavingsPartnerDealApi
...
from openapi_server.models.savings_partner_deal_listing import SavingsPartnerDealListing
...
@router.get(
    "/user/{userID}/savings-partner-deal",
    responses={
        200: {"model": List[SavingsPartnerDealListing], "description": "Endpoint for partner deals. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["savings-partner-deal"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_savings_partner_deal_for_user(
...
) -> List[SavingsPartnerDealListing]:
    """Endpoint for partner deals. apiApp:LISTING"""
    if not BaseSavingsPartnerDealApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSavingsPartnerDealApi.subclasses[0]().list_all_savings_partner_deal_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
