...
class BasePaymentServiceProviderCredentialApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePaymentServiceProviderCredentialApi.subclasses = BasePaymentServiceProviderCredentialApi.subclasses + (cls,)
    async def c_reate_payment_service_provider_credential(
        ...
        payment_service_provider_credential: PaymentServiceProviderCredential,
