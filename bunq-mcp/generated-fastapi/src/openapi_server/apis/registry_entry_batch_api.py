...
from openapi_server.apis.registry_entry_batch_api_base import BaseRegistryEntryBatchApi
...
from openapi_server.models.registry_entry_batch import RegistryEntryBatch
from openapi_server.models.registry_entry_batch_create import RegistryEntryBatchCreate
...
@router.post(
    "/user/{userID}/registry/{registryID}/registry-entry-batch",
    responses={
        200: {"model": RegistryEntryBatchCreate, "description": "Endpoint to create a batch of registry entries. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["registry-entry-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_registry_entry_batch_for_user_registry(
    ...
    registry_entry_batch: RegistryEntryBatch = Body(None, description=""),
...
) -> RegistryEntryBatchCreate:
    """Endpoint to create a batch of registry entries. apiApp:CREATE"""
    if not BaseRegistryEntryBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRegistryEntryBatchApi.subclasses[0]().c_reate_registry_entry_batch_for_user_registry(userID, registryID, user_agent, x_bunq_client_authentication, registry_entry_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
