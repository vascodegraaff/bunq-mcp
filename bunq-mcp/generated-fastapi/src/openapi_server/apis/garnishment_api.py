...
from openapi_server.apis.garnishment_api_base import BaseGarnishmentApi
...
from openapi_server.models.garnishment import Garnishment
from openapi_server.models.garnishment_create import GarnishmentCreate
...
@router.post(
    "/user/{userID}/garnishment",
    responses={
        200: {"model": GarnishmentCreate, "description": "Set person as being under garnishment apiAdmin:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_garnishment_for_user(
    ...
    garnishment: Garnishment = Body(None, description=""),
    ...
    """Set person as being under garnishment apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseGarnishmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGarnishmentApi.subclasses[0]().c_reate_garnishment_for_user(userID, user_agent, x_bunq_client_authentication, garnishment, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
