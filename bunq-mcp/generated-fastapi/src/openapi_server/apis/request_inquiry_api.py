...
from openapi_server.apis.request_inquiry_api_base import BaseRequestInquiryApi
...
@router.post(
    ...
    responses={
        200: {"model": RequestInquiryCreate, "description": "RequestInquiry, aka &#39;RFP&#39; (Request for Payment), is one of the innovative features that bunq offers. To request payment from another bunq account a new Request Inquiry is created. As with payments you can add attachments to a RFP. Requests for Payment are the foundation for a number of consumer features like &#39;Split the bill&#39; and &#39;Request forwarding&#39;. We invite you to invent your own based on the bunq api! apiAdmin:LISTING/READ apiApp:CREATE/UPDATE/LISTING/READ apiPublic:CREATE/UPDATE/LISTING/READ apiServiceInternal:LISTING/READ apiTranslink:CREATE/UPDATE/LISTING/READ"},
...
async def c_reate_request_inquiry_for_user_monetary_account(
    ...
    request_inquiry: RequestInquiry = Body(None, description=""),
    ...
    if not BaseRequestInquiryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryApi.subclasses[0]().c_reate_request_inquiry_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, request_inquiry, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/request-inquiry",
    responses={
        200: {"model": List[RequestInquiryUserListing], "description": "Endpoint for listing request inquiries for a user. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry"],
    summary="",
...
async def list_all_request_inquiry_for_user(
    ...
    if not BaseRequestInquiryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryApi.subclasses[0]().list_all_request_inquiry_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/request-inquiry",
    responses={
        200: {"model": List[RequestInquiryListing], "description": "RequestInquiry, aka &#39;RFP&#39; (Request for Payment), is one of the innovative features that bunq offers. To request payment from another bunq account a new Request Inquiry is created. As with payments you can add attachments to a RFP. Requests for Payment are the foundation for a number of consumer features like &#39;Split the bill&#39; and &#39;Request forwarding&#39;. We invite you to invent your own based on the bunq api! apiAdmin:LISTING/READ apiApp:CREATE/UPDATE/LISTING/READ apiPublic:CREATE/UPDATE/LISTING/READ apiServiceInternal:LISTING/READ apiTranslink:CREATE/UPDATE/LISTING/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry"],
    summary="",
...
async def list_all_request_inquiry_for_user_monetary_account(
    ...
    if not BaseRequestInquiryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryApi.subclasses[0]().list_all_request_inquiry_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/request-inquiry/{itemId}",
    responses={
        200: {"model": RequestInquiryRead, "description": "RequestInquiry, aka &#39;RFP&#39; (Request for Payment), is one of the innovative features that bunq offers. To request payment from another bunq account a new Request Inquiry is created. As with payments you can add attachments to a RFP. Requests for Payment are the foundation for a number of consumer features like &#39;Split the bill&#39; and &#39;Request forwarding&#39;. We invite you to invent your own based on the bunq api! apiAdmin:LISTING/READ apiApp:CREATE/UPDATE/LISTING/READ apiPublic:CREATE/UPDATE/LISTING/READ apiServiceInternal:LISTING/READ apiTranslink:CREATE/UPDATE/LISTING/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry"],
    summary="",
...
async def r_ead_request_inquiry_for_user_monetary_account(
    ...
    if not BaseRequestInquiryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryApi.subclasses[0]().r_ead_request_inquiry_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/monetary-account/{monetary-accountID}/request-inquiry/{itemId}",
    responses={
        200: {"model": RequestInquiryUpdate, "description": "RequestInquiry, aka &#39;RFP&#39; (Request for Payment), is one of the innovative features that bunq offers. To request payment from another bunq account a new Request Inquiry is created. As with payments you can add attachments to a RFP. Requests for Payment are the foundation for a number of consumer features like &#39;Split the bill&#39; and &#39;Request forwarding&#39;. We invite you to invent your own based on the bunq api! apiAdmin:LISTING/READ apiApp:CREATE/UPDATE/LISTING/READ apiPublic:CREATE/UPDATE/LISTING/READ apiServiceInternal:LISTING/READ apiTranslink:CREATE/UPDATE/LISTING/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["request-inquiry"],
    summary="",
...
async def u_pdate_request_inquiry_for_user_monetary_account(
    ...
    if not BaseRequestInquiryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRequestInquiryApi.subclasses[0]().u_pdate_request_inquiry_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, request_inquiry, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
