...
class BaseTransferwiseRecipientApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransferwiseRecipientApi.subclasses = BaseTransferwiseRecipientApi.subclasses + (cls,)
    async def c_reate_transferwise_recipient_for_user_transferwise_quote(
        self,
        userID: StrictInt,
        transferwise-quoteID: StrictInt,
        ...
        transferwise_account_quote: TransferwiseAccountQuote,
