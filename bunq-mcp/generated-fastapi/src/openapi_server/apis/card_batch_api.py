...
from openapi_server.apis.card_batch_api_base import BaseCardBatchApi
...
from openapi_server.models.card_batch import CardBatch
from openapi_server.models.card_batch_create import CardBatchCreate
...
@router.post(
    ...
    responses={
        200: {"model": CardBatchCreate, "description": "Used to update multiple cards in a batch. apiApp:CREATE apiPublic:CREATE"},
...
async def c_reate_card_batch_for_user(
    ...
    card_batch: CardBatch = Body(None, description=""),
    ...
    """Used to update multiple cards in a batch. apiApp:CREATE apiPublic:CREATE"""
    if not BaseCardBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCardBatchApi.subclasses[0]().c_reate_card_batch_for_user(userID, user_agent, x_bunq_client_authentication, card_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
