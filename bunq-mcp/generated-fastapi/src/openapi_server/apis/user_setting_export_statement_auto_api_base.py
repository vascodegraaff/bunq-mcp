...
class BaseUserSettingExportStatementAutoApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingExportStatementAutoApi.subclasses = BaseUserSettingExportStatementAutoApi.subclasses + (cls,)
    async def c_reate_user_setting_export_statement_auto_for_user(
        ...
        user_setting_export_statement_auto: UserSettingExportStatementAuto,
