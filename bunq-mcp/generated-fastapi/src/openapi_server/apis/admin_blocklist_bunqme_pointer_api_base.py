...
class BaseAdminBlocklistBunqmePointerApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminBlocklistBunqmePointerApi.subclasses = BaseAdminBlocklistBunqmePointerApi.subclasses + (cls,)
    async def c_reate_admin_blocklist_bunqme_pointer(
        ...
        admin_blocklist_bunq_me_pointer: AdminBlocklistBunqMePointer,
