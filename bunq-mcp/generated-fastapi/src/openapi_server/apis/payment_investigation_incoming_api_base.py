...
class BasePaymentInvestigationIncomingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePaymentInvestigationIncomingApi.subclasses = BasePaymentInvestigationIncomingApi.subclasses + (cls,)
    async def c_reate_payment_investigation_incoming_for_user(
        ...
        payment_investigation_incoming: PaymentInvestigationIncoming,
