...
from openapi_server.apis.point_voucher_api_base import BasePointVoucherApi
...
from openapi_server.models.point_voucher_listing import PointVoucherListing
...
@router.get(
    "/user/{userID}/point-voucher",
    responses={
        200: {"model": List[PointVoucherListing], "description": "Endpoint to retrieve point voucher. apiAdmin:LISTING apiApp:LISTING"},
...
async def list_all_point_voucher_for_user(
...
) -> List[PointVoucherListing]:
    """Endpoint to retrieve point voucher. apiAdmin:LISTING apiApp:LISTING"""
    if not BasePointVoucherApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePointVoucherApi.subclasses[0]().list_all_point_voucher_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
