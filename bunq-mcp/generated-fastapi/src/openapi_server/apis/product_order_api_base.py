...
class BaseProductOrderApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseProductOrderApi.subclasses = BaseProductOrderApi.subclasses + (cls,)
    async def c_reate_product_order_for_user_sim_virtual(
        self,
        userID: StrictInt,
        sim-virtualID: StrictInt,
        ...
        sim_virtual_product_order: SimVirtualProductOrder,
