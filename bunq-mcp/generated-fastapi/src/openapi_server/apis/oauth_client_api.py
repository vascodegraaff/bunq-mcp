...
from openapi_server.apis.oauth_client_api_base import BaseOauthClientApi
...
from openapi_server.models.oauth_client import OauthClient
from openapi_server.models.oauth_client_create import OauthClientCreate
from openapi_server.models.oauth_client_listing import OauthClientListing
from openapi_server.models.oauth_client_read import OauthClientRead
from openapi_server.models.oauth_client_update import OauthClientUpdate
...
@router.post(
    ...
    responses={
        200: {"model": OauthClientCreate, "description": "Used for managing OAuth Clients. apiAdmin:READ/CREATE/UPDATE/LISTING apiApp:READ/CREATE/UPDATE/LISTING apiPublic:READ/CREATE/UPDATE/LISTING apiServiceInternal:READ/CREATE/UPDATE/LISTING apiTranslink:READ/CREATE/UPDATE/LISTING apiDeveloperPortal:READ/CREATE/UPDATE/LISTING"},
...
async def c_reate_oauth_client_for_user(
    ...
    oauth_client: OauthClient = Body(None, description=""),
    ...
    """Used for managing OAuth Clients. apiAdmin:READ/CREATE/UPDATE/LISTING apiApp:READ/CREATE/UPDATE/LISTING apiPublic:READ/CREATE/UPDATE/LISTING apiServiceInternal:READ/CREATE/UPDATE/LISTING apiTranslink:READ/CREATE/UPDATE/LISTING apiDeveloperPortal:READ/CREATE/UPDATE/LISTING"""
    if not BaseOauthClientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOauthClientApi.subclasses[0]().c_reate_oauth_client_for_user(userID, user_agent, x_bunq_client_authentication, oauth_client, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/oauth-client",
    responses={
        200: {"model": List[OauthClientListing], "description": "Used for managing OAuth Clients. apiAdmin:READ/CREATE/UPDATE/LISTING apiApp:READ/CREATE/UPDATE/LISTING apiPublic:READ/CREATE/UPDATE/LISTING apiServiceInternal:READ/CREATE/UPDATE/LISTING apiTranslink:READ/CREATE/UPDATE/LISTING apiDeveloperPortal:READ/CREATE/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["oauth-client"],
    summary="",
...
async def list_all_oauth_client_for_user(
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[OauthClientListing]:
    """Used for managing OAuth Clients. apiAdmin:READ/CREATE/UPDATE/LISTING apiApp:READ/CREATE/UPDATE/LISTING apiPublic:READ/CREATE/UPDATE/LISTING apiServiceInternal:READ/CREATE/UPDATE/LISTING apiTranslink:READ/CREATE/UPDATE/LISTING apiDeveloperPortal:READ/CREATE/UPDATE/LISTING"""
    if not BaseOauthClientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOauthClientApi.subclasses[0]().list_all_oauth_client_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/oauth-client/{itemId}",
    responses={
        200: {"model": OauthClientRead, "description": "Used for managing OAuth Clients. apiAdmin:READ/CREATE/UPDATE/LISTING apiApp:READ/CREATE/UPDATE/LISTING apiPublic:READ/CREATE/UPDATE/LISTING apiServiceInternal:READ/CREATE/UPDATE/LISTING apiTranslink:READ/CREATE/UPDATE/LISTING apiDeveloperPortal:READ/CREATE/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["oauth-client"],
    summary="",
...
async def r_ead_oauth_client_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseOauthClientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOauthClientApi.subclasses[0]().r_ead_oauth_client_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
...
async def u_pdate_oauth_client_for_user(
    userID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    ...
    if not BaseOauthClientApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOauthClientApi.subclasses[0]().u_pdate_oauth_client_for_user(userID, itemId, user_agent, x_bunq_client_authentication, oauth_client, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
