...
class BaseTokenConfirmationLoginTokenApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenConfirmationLoginTokenApi.subclasses = BaseTokenConfirmationLoginTokenApi.subclasses + (cls,)
    async def c_reate_token_confirmation_login_token(
        ...
        token_confirmation_login_token: TokenConfirmationLoginToken,
