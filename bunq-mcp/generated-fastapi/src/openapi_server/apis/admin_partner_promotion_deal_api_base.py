...
class BaseAdminPartnerPromotionDealApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionDealApi.subclasses = BaseAdminPartnerPromotionDealApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_deal(
        ...
        admin_partner_promotion_deal: AdminPartnerPromotionDeal,
