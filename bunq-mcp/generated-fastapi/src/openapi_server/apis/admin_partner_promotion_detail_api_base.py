...
class BaseAdminPartnerPromotionDetailApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionDetailApi.subclasses = BaseAdminPartnerPromotionDetailApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_detail_for_admin_partner_promotion_deal(
        self,
        admin-partner-promotion-dealID: StrictInt,
        ...
        admin_partner_promotion_detail: AdminPartnerPromotionDetail,
