...
from openapi_server.apis.feature_support_api_base import BaseFeatureSupportApi
...
from openapi_server.models.device_feature_support import DeviceFeatureSupport
from openapi_server.models.device_feature_support_create import DeviceFeatureSupportCreate
...
@router.post(
    "/device/{deviceID}/feature-support",
    responses={
        200: {"model": DeviceFeatureSupportCreate, "description": "Set the features supported for this device. apiApp:CREATE apiDeveloperPortal:CREATE"},
...
async def c_reate_feature_support_for_device(
    ...
    device_feature_support: DeviceFeatureSupport = Body(None, description=""),
...
) -> DeviceFeatureSupportCreate:
    """Set the features supported for this device. apiApp:CREATE apiDeveloperPortal:CREATE"""
    if not BaseFeatureSupportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFeatureSupportApi.subclasses[0]().c_reate_feature_support_for_device(deviceID, user_agent, x_bunq_client_authentication, device_feature_support, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
