...
class BaseAdminAssistantConversationEscalationExpertiseApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAssistantConversationEscalationExpertiseApi.subclasses = BaseAdminAssistantConversationEscalationExpertiseApi.subclasses + (cls,)
    async def c_reate_admin_assistant_conversation_escalation_expertise_for_user(
        ...
        admin_assistant_conversation_escalation_expertise: AdminAssistantConversationEscalationExpertise,
