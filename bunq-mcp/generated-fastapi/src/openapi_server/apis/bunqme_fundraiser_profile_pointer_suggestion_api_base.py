...
class BaseBunqmeFundraiserProfilePointerSuggestionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeFundraiserProfilePointerSuggestionApi.subclasses = BaseBunqmeFundraiserProfilePointerSuggestionApi.subclasses + (cls,)
