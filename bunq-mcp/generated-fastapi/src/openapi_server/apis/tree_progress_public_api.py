...
from openapi_server.apis.tree_progress_public_api_base import BaseTreeProgressPublicApi
...
from openapi_server.models.tree_progress_public import TreeProgressPublic
from openapi_server.models.tree_progress_public_create import TreeProgressPublicCreate
...
@router.post(
    ...
    responses={
        200: {"model": TreeProgressPublicCreate, "description": "See how many trees this user has planted. apiWidget:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["tree-progress-public"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_tree_progress_public(
    ...
    tree_progress_public: TreeProgressPublic = Body(None, description=""),
...
) -> TreeProgressPublicCreate:
    """See how many trees this user has planted. apiWidget:CREATE"""
    if not BaseTreeProgressPublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTreeProgressPublicApi.subclasses[0]().c_reate_tree_progress_public(user_agent, x_bunq_client_authentication, tree_progress_public, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
