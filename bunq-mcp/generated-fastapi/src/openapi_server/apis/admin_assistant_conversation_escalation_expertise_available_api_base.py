...
class BaseAdminAssistantConversationEscalationExpertiseAvailableApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAssistantConversationEscalationExpertiseAvailableApi.subclasses = BaseAdminAssistantConversationEscalationExpertiseAvailableApi.subclasses + (cls,)
