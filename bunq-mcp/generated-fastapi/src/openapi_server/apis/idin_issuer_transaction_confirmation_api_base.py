...
class BaseIdinIssuerTransactionConfirmationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdinIssuerTransactionConfirmationApi.subclasses = BaseIdinIssuerTransactionConfirmationApi.subclasses + (cls,)
    async def c_reate_idin_issuer_transaction_confirmation_for_user(
        ...
        idin_issuer_transaction_confirmation: IdinIssuerTransactionConfirmation,
