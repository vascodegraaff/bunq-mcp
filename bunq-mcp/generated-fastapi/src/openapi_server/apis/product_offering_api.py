...
from openapi_server.apis.product_offering_api_base import BaseProductOfferingApi
...
from openapi_server.models.sim_virtual_product_offering_listing import SimVirtualProductOfferingListing
...
@router.get(
    "/user/{userID}/sim-virtual/{sim-virtualID}/product-offering",
    responses={
        200: {"model": List[SimVirtualProductOfferingListing], "description": "Endpoint to retrieve and list eSIM product offerings provided by our affiliate 1Global. apiAdmin:LISTING apiApp:LISTING apiServiceInternal:LISTING"},
...
async def list_all_product_offering_for_user_sim_virtual(
...
) -> List[SimVirtualProductOfferingListing]:
    """Endpoint to retrieve and list eSIM product offerings provided by our affiliate 1Global. apiAdmin:LISTING apiApp:LISTING apiServiceInternal:LISTING"""
    if not BaseProductOfferingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProductOfferingApi.subclasses[0]().list_all_product_offering_for_user_sim_virtual(userID, sim-virtualID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
