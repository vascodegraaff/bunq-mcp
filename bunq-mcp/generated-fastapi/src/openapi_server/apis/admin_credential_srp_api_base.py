...
class BaseAdminCredentialSrpApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminCredentialSrpApi.subclasses = BaseAdminCredentialSrpApi.subclasses + (cls,)
    async def c_reate_admin_credential_srp_for_user(
        ...
        admin_user_credential_srp: AdminUserCredentialSrp,
