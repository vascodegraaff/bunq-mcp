...
class BaseTokenQrUserWebAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrUserWebAuthenticationApi.subclasses = BaseTokenQrUserWebAuthenticationApi.subclasses + (cls,)
    async def c_reate_token_qr_user_web_authentication_for_user(
        ...
        token_qr_user_web_authentication: TokenQrUserWebAuthentication,
