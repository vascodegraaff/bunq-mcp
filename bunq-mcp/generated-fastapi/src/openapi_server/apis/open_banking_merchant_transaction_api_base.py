...
class BaseOpenBankingMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseOpenBankingMerchantTransactionApi.subclasses = BaseOpenBankingMerchantTransactionApi.subclasses + (cls,)
    async def c_reate_open_banking_merchant_transaction_for_user_monetary_account(
        ...
        open_banking_merchant_transaction: OpenBankingMerchantTransaction,
