...
from openapi_server.apis.opvragen_naw_api_base import BaseOpvragenNawApi
...
from openapi_server.models.government_referral_portal_external_search_by_user_data import GovernmentReferralPortalExternalSearchByUserData
from openapi_server.models.government_referral_portal_external_search_by_user_data_create import GovernmentReferralPortalExternalSearchByUserDataCreate
...
@router.post(
    "/opvragen-naw",
    responses={
        200: {"model": GovernmentReferralPortalExternalSearchByUserDataCreate, "description": "View for retrieving user information. Should only be used by the government. apiGovernment:CREATE"},
...
async def c_reate_opvragen_naw(
    ...
    government_referral_portal_external_search_by_user_data: GovernmentReferralPortalExternalSearchByUserData = Body(None, description=""),
...
) -> GovernmentReferralPortalExternalSearchByUserDataCreate:
    """View for retrieving user information. Should only be used by the government. apiGovernment:CREATE"""
    if not BaseOpvragenNawApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOpvragenNawApi.subclasses[0]().c_reate_opvragen_naw(user_agent, x_bunq_client_authentication, government_referral_portal_external_search_by_user_data, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
