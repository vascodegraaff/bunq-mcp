...
class BaseActivityMapPlaceSuggestionFeedbackApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseActivityMapPlaceSuggestionFeedbackApi.subclasses = BaseActivityMapPlaceSuggestionFeedbackApi.subclasses + (cls,)
    async def c_reate_activity_map_place_suggestion_feedback_for_user(
        ...
        activity_map_place_suggestion_feedback: ActivityMapPlaceSuggestionFeedback,
