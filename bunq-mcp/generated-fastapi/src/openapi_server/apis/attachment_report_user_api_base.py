...
class BaseAttachmentReportUserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAttachmentReportUserApi.subclasses = BaseAttachmentReportUserApi.subclasses + (cls,)
    async def c_reate_attachment_report_user_for_user(
        ...
        attachment_report_user: AttachmentReportUser,
