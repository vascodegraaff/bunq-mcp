...
class BaseCompanyRiskInformationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCompanyRiskInformationApi.subclasses = BaseCompanyRiskInformationApi.subclasses + (cls,)
    async def c_reate_company_risk_information_for_user_company(
        self,
        user-companyID: StrictInt,
        ...
        company_risk_information: CompanyRiskInformation,
