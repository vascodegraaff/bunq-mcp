...
class BaseFailBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseFailBatchApi.subclasses = BaseFailBatchApi.subclasses + (cls,)
    async def c_reate_fail_batch_for_user_identity_verification_report(
        ...
        identity_verification_report_fail_batch: IdentityVerificationReportFailBatch,
