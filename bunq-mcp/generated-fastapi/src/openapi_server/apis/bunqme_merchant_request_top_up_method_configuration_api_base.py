...
class BaseBunqmeMerchantRequestTopUpMethodConfigurationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestTopUpMethodConfigurationApi.subclasses = BaseBunqmeMerchantRequestTopUpMethodConfigurationApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request_top_up_method_configuration(
        ...
        bunq_me_merchant_request_top_up_method_configuration: BunqMeMerchantRequestTopUpMethodConfiguration,
