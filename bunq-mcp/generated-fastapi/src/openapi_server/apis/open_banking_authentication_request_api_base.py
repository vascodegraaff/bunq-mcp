...
class BaseOpenBankingAuthenticationRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseOpenBankingAuthenticationRequestApi.subclasses = BaseOpenBankingAuthenticationRequestApi.subclasses + (cls,)
    async def c_reate_open_banking_authentication_request_for_user(
        ...
        open_banking_authentication_request: OpenBankingAuthenticationRequest,
