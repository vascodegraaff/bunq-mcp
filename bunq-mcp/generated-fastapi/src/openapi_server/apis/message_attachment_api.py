...
from openapi_server.apis.message_attachment_api_base import BaseMessageAttachmentApi
...
from openapi_server.models.chat_message_attachment import ChatMessageAttachment
from openapi_server.models.chat_message_attachment_create import ChatMessageAttachmentCreate
...
@router.post(
    ...
    responses={
        200: {"model": ChatMessageAttachmentCreate, "description": "Create new messages holding file attachments. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_message_attachment_for_user_chat_conversation(
    ...
    chat_message_attachment: ChatMessageAttachment = Body(None, description=""),
    ...
    if not BaseMessageAttachmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMessageAttachmentApi.subclasses[0]().c_reate_message_attachment_for_user_chat_conversation(userID, chat-conversationID, user_agent, x_bunq_client_authentication, chat_message_attachment, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
