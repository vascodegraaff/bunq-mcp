...
from openapi_server.apis.vonage_phone_support_emergency_agent_assignment_api_base import BaseVonagePhoneSupportEmergencyAgentAssignmentApi
...
from openapi_server.models.vonage_call_incoming_phone_support_emergency_agent_assignment_create import VonageCallIncomingPhoneSupportEmergencyAgentAssignmentCreate
...
@router.post(
    "/user/{userID}/vonage-phone-support-emergency-agent-assignment",
    responses={
        200: {"model": VonageCallIncomingPhoneSupportEmergencyAgentAssignmentCreate, "description": "Process incoming fraud hotline conversation from Vonage. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["vonage-phone-support-emergency-agent-assignment"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_vonage_phone_support_emergency_agent_assignment_for_user(
...
) -> VonageCallIncomingPhoneSupportEmergencyAgentAssignmentCreate:
    """Process incoming fraud hotline conversation from Vonage. apiAdmin:CREATE"""
    if not BaseVonagePhoneSupportEmergencyAgentAssignmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseVonagePhoneSupportEmergencyAgentAssignmentApi.subclasses[0]().c_reate_vonage_phone_support_emergency_agent_assignment_for_user(userID, user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
