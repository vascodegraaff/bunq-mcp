...
class BaseOpenBankingIdentityVerificationTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseOpenBankingIdentityVerificationTransactionApi.subclasses = BaseOpenBankingIdentityVerificationTransactionApi.subclasses + (cls,)
    async def c_reate_open_banking_identity_verification_transaction_for_user_monetary_account(
        ...
        open_banking_identity_verification_transaction: OpenBankingIdentityVerificationTransaction,
