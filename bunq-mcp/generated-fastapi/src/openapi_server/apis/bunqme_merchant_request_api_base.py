...
class BaseBunqmeMerchantRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestApi.subclasses = BaseBunqmeMerchantRequestApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request(
        ...
        bunq_me_merchant_request: BunqMeMerchantRequest,
