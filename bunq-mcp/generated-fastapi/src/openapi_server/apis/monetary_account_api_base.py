...
class BaseMonetaryAccountApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMonetaryAccountApi.subclasses = BaseMonetaryAccountApi.subclasses + (cls,)
    async def c_reate_monetary_account_for_user_ideal_issuer_profile(
        self,
        userID: StrictInt,
        ideal-issuer-profileID: StrictInt,
        ...
        ideal_issuer_profile_monetary_account: IdealIssuerProfileMonetaryAccount,
