...
class BaseCompanyChamberOfCommerceExcerptActivityDescriptionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCompanyChamberOfCommerceExcerptActivityDescriptionApi.subclasses = BaseCompanyChamberOfCommerceExcerptActivityDescriptionApi.subclasses + (cls,)
