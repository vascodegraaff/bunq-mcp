...
class BaseTokenQrIdinIssuerClaimUserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrIdinIssuerClaimUserApi.subclasses = BaseTokenQrIdinIssuerClaimUserApi.subclasses + (cls,)
    async def c_reate_token_qr_idin_issuer_claim_user_for_user(
        ...
        token_qr_idin_issuer_claim: TokenQrIdinIssuerClaim,
