...
class BaseTaxResidentExemptionTemporaryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTaxResidentExemptionTemporaryApi.subclasses = BaseTaxResidentExemptionTemporaryApi.subclasses + (cls,)
    async def c_reate_tax_resident_exemption_temporary_for_user(
        ...
        tax_resident_exemption_temporary: TaxResidentExemptionTemporary,
