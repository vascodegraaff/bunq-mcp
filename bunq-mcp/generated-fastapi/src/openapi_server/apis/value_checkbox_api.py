...
from openapi_server.apis.value_checkbox_api_base import BaseValueCheckboxApi
...
from openapi_server.models.user_review_value_checkbox import UserReviewValueCheckbox
from openapi_server.models.user_review_value_checkbox_update import UserReviewValueCheckboxUpdate
...
@router.put(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-checkbox/{itemId}",
    responses={
        200: {"model": UserReviewValueCheckboxUpdate, "description": "Endpoint for updating UserReviewValueCheckbox. apiApp:UPDATE"},
...
async def u_pdate_value_checkbox_for_user_review_check(
    ...
    user_review_value_checkbox: UserReviewValueCheckbox = Body(None, description=""),
...
) -> UserReviewValueCheckboxUpdate:
    """Endpoint for updating UserReviewValueCheckbox. apiApp:UPDATE"""
    if not BaseValueCheckboxApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueCheckboxApi.subclasses[0]().u_pdate_value_checkbox_for_user_review_check(userID, reviewID, checkID, itemId, user_agent, x_bunq_client_authentication, user_review_value_checkbox, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
