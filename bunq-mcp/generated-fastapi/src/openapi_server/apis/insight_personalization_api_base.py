...
class BaseInsightPersonalizationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInsightPersonalizationApi.subclasses = BaseInsightPersonalizationApi.subclasses + (cls,)
    async def c_reate_insight_personalization_for_user_event(
        ...
        insight_personalization: InsightPersonalization,
