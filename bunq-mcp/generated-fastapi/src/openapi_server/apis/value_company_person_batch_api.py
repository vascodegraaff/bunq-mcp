...
from openapi_server.apis.value_company_person_batch_api_base import BaseValueCompanyPersonBatchApi
...
from openapi_server.models.user_review_value_company_person_batch import UserReviewValueCompanyPersonBatch
from openapi_server.models.user_review_value_company_person_batch_create import UserReviewValueCompanyPersonBatchCreate
...
@router.post(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-company-person-batch",
    responses={
        200: {"model": UserReviewValueCompanyPersonBatchCreate, "description": "Used to create multiple company person review values at once. apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["value-company-person-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_value_company_person_batch_for_user_review_check(
    ...
    user_review_value_company_person_batch: UserReviewValueCompanyPersonBatch = Body(None, description=""),
...
) -> UserReviewValueCompanyPersonBatchCreate:
    """Used to create multiple company person review values at once. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseValueCompanyPersonBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueCompanyPersonBatchApi.subclasses[0]().c_reate_value_company_person_batch_for_user_review_check(userID, reviewID, checkID, user_agent, x_bunq_client_authentication, user_review_value_company_person_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
