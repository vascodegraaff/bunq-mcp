...
class BaseCompanyEmployeeExportApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCompanyEmployeeExportApi.subclasses = BaseCompanyEmployeeExportApi.subclasses + (cls,)
    async def c_reate_company_employee_export_for_user(
        ...
        company_employee_export: CompanyEmployeeExport,
