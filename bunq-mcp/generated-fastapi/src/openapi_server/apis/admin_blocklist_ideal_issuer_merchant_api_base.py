...
class BaseAdminBlocklistIdealIssuerMerchantApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminBlocklistIdealIssuerMerchantApi.subclasses = BaseAdminBlocklistIdealIssuerMerchantApi.subclasses + (cls,)
    async def c_reate_admin_blocklist_ideal_issuer_merchant(
        ...
        admin_blocklist_ideal_issuer_merchant: AdminBlocklistIdealIssuerMerchant,
