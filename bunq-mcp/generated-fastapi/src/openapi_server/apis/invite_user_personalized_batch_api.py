...
from openapi_server.apis.invite_user_personalized_batch_api_base import BaseInviteUserPersonalizedBatchApi
...
from openapi_server.models.invite_user_personalized_batch import InviteUserPersonalizedBatch
from openapi_server.models.invite_user_personalized_batch_create import InviteUserPersonalizedBatchCreate
...
@router.post(
    "/user/{userID}/invite-user-personalized-batch",
    responses={
        200: {"model": InviteUserPersonalizedBatchCreate, "description": "Used for bulk user invite. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["invite-user-personalized-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_invite_user_personalized_batch_for_user(
    ...
    invite_user_personalized_batch: InviteUserPersonalizedBatch = Body(None, description=""),
...
) -> InviteUserPersonalizedBatchCreate:
    """Used for bulk user invite. apiApp:CREATE"""
    if not BaseInviteUserPersonalizedBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInviteUserPersonalizedBatchApi.subclasses[0]().c_reate_invite_user_personalized_batch_for_user(userID, user_agent, x_bunq_client_authentication, invite_user_personalized_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
