...
class BaseWheelOfFortunePointApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseWheelOfFortunePointApi.subclasses = BaseWheelOfFortunePointApi.subclasses + (cls,)
    async def c_reate_wheel_of_fortune_point_for_user(
        ...
        wheel_of_fortune_point: WheelOfFortunePoint,
