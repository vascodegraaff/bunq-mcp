...
from openapi_server.apis.process_instance_api_base import BaseProcessInstanceApi
...
from openapi_server.models.process_instance import ProcessInstance
from openapi_server.models.process_instance_create import ProcessInstanceCreate
from openapi_server.models.process_instance_read import ProcessInstanceRead
from openapi_server.models.process_instance_update import ProcessInstanceUpdate
...
@router.post(
    "/process-instance",
    responses={
        200: {"model": ProcessInstanceCreate, "description": "View for process instances. apiAdmin:CREATE/READ/UPDATE apiServiceInternal:CREATE/READ/UPDATE apiProcess:CREATE/READ/UPDATE"},
...
async def c_reate_process_instance(
    ...
    process_instance: ProcessInstance = Body(None, description=""),
    ...
    """View for process instances. apiAdmin:CREATE/READ/UPDATE apiServiceInternal:CREATE/READ/UPDATE apiProcess:CREATE/READ/UPDATE"""
    if not BaseProcessInstanceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessInstanceApi.subclasses[0]().c_reate_process_instance(user_agent, x_bunq_client_authentication, process_instance, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/process-instance/{itemId}",
    responses={
        200: {"model": ProcessInstanceRead, "description": "View for process instances. apiAdmin:CREATE/READ/UPDATE apiServiceInternal:CREATE/READ/UPDATE apiProcess:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["process-instance"],
    summary="",
...
async def r_ead_process_instance(
    ...
    if not BaseProcessInstanceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessInstanceApi.subclasses[0]().r_ead_process_instance(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/process-instance/{itemId}",
    responses={
        200: {"model": ProcessInstanceUpdate, "description": "View for process instances. apiAdmin:CREATE/READ/UPDATE apiServiceInternal:CREATE/READ/UPDATE apiProcess:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["process-instance"],
    summary="",
...
async def u_pdate_process_instance(
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    process_instance: ProcessInstance = Body(None, description=""),
    ...
    if not BaseProcessInstanceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProcessInstanceApi.subclasses[0]().u_pdate_process_instance(itemId, user_agent, x_bunq_client_authentication, process_instance, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
