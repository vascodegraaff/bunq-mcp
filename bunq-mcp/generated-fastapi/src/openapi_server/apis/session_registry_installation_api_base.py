...
class BaseSessionRegistryInstallationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionRegistryInstallationApi.subclasses = BaseSessionRegistryInstallationApi.subclasses + (cls,)
    async def c_reate_session_registry_installation(
        ...
        session_registry_installation: SessionRegistryInstallation,
