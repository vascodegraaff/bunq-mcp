...
class BaseAnalyticsIdentifierBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAnalyticsIdentifierBatchApi.subclasses = BaseAnalyticsIdentifierBatchApi.subclasses + (cls,)
    async def c_reate_analytics_identifier_batch_for_user_device(
        ...
        analytics_identifier_batch: AnalyticsIdentifierBatch,
