...
from openapi_server.models.support_access_request_monetary_account import SupportAccessRequestMonetaryAccount
from openapi_server.models.support_access_request_monetary_account_create import SupportAccessRequestMonetaryAccountCreate
from openapi_server.models.support_access_request_monetary_account_listing import SupportAccessRequestMonetaryAccountListing
from openapi_server.models.support_access_request_monetary_account_read import SupportAccessRequestMonetaryAccountRead


class BaseSupportAccessRequestMonetaryAccountApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSupportAccessRequestMonetaryAccountApi.subclasses = BaseSupportAccessRequestMonetaryAccountApi.subclasses + (cls,)
    async def c_reate_support_access_request_monetary_account_for_user_ticket(
        self,
        userID: StrictInt,
        ticketID: StrictInt,
        ...
        support_access_request_monetary_account: SupportAccessRequestMonetaryAccount,
    ...
    ) -> SupportAccessRequestMonetaryAccountCreate:
        """Request access to one of the user&#39;s monetary accounts. apiAdmin:CREATE/DELETE/LISTING/READ apiApp:CREATE/DELETE/LISTING/READ apiServiceInternal:CREATE/DELETE/LISTING/READ"""
        ...


    async def d_elete_support_access_request_monetary_account_for_user_ticket(
        self,
        userID: StrictInt,
        ticketID: StrictInt,
        itemId: StrictInt,
    ...
    async def list_all_support_access_request_monetary_account_for_user_ticket(
        self,
        userID: StrictInt,
        ticketID: StrictInt,
        user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")],
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> List[SupportAccessRequestMonetaryAccountListing]:
        """Request access to one of the user&#39;s monetary accounts. apiAdmin:CREATE/DELETE/LISTING/READ apiApp:CREATE/DELETE/LISTING/READ apiServiceInternal:CREATE/DELETE/LISTING/READ"""
        ...


    async def r_ead_support_access_request_monetary_account_for_user_ticket(
        self,
        userID: StrictInt,
        ticketID: StrictInt,
        itemId: StrictInt,
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> SupportAccessRequestMonetaryAccountRead:
        """Request access to one of the user&#39;s monetary accounts. apiAdmin:CREATE/DELETE/LISTING/READ apiApp:CREATE/DELETE/LISTING/READ apiServiceInternal:CREATE/DELETE/LISTING/READ"""
        ...
