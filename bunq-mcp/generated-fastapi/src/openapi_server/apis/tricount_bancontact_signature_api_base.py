...
class BaseTricountBancontactSignatureApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTricountBancontactSignatureApi.subclasses = BaseTricountBancontactSignatureApi.subclasses + (cls,)
    async def c_reate_tricount_bancontact_signature(
        ...
        tricount_bancontact_signature: TricountBancontactSignature,
