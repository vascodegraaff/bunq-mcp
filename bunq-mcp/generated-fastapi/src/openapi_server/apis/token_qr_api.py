...
from openapi_server.apis.token_qr_api_base import BaseTokenQrApi
...
from openapi_server.models.token_qr_read import TokenQrRead
...
@router.get(
    "/token-qr/{itemId}",
    responses={
        200: {"model": TokenQrRead, "description": "Get a QR code. apiApp:READ apiQr:READ"},
...
async def r_ead_token_qr(
    ...
    """Get a QR code. apiApp:READ apiQr:READ"""
    if not BaseTokenQrApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrApi.subclasses[0]().r_ead_token_qr(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
