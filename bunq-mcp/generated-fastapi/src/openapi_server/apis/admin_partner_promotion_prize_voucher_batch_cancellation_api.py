...
from openapi_server.apis.admin_partner_promotion_prize_voucher_batch_cancellation_api_base import BaseAdminPartnerPromotionPrizeVoucherBatchCancellationApi
...
from openapi_server.models.admin_partner_promotion_prize_voucher_batch_cancellation import AdminPartnerPromotionPrizeVoucherBatchCancellation
from openapi_server.models.admin_partner_promotion_prize_voucher_batch_cancellation_create import AdminPartnerPromotionPrizeVoucherBatchCancellationCreate
...
@router.post(
    "/admin-partner-promotion-prize-voucher-batch-cancellation",
    responses={
        200: {"model": AdminPartnerPromotionPrizeVoucherBatchCancellationCreate, "description": "Endpoint to cancel batch of vouchers. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-partner-promotion-prize-voucher-batch-cancellation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_partner_promotion_prize_voucher_batch_cancellation(
    ...
    admin_partner_promotion_prize_voucher_batch_cancellation: AdminPartnerPromotionPrizeVoucherBatchCancellation = Body(None, description=""),
...
) -> AdminPartnerPromotionPrizeVoucherBatchCancellationCreate:
    """Endpoint to cancel batch of vouchers. apiAdmin:CREATE"""
    if not BaseAdminPartnerPromotionPrizeVoucherBatchCancellationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPartnerPromotionPrizeVoucherBatchCancellationApi.subclasses[0]().c_reate_admin_partner_promotion_prize_voucher_batch_cancellation(user_agent, x_bunq_client_authentication, admin_partner_promotion_prize_voucher_batch_cancellation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
