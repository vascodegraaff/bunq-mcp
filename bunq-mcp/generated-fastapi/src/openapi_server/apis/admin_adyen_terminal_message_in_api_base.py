...
class BaseAdminAdyenTerminalMessageInApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAdyenTerminalMessageInApi.subclasses = BaseAdminAdyenTerminalMessageInApi.subclasses + (cls,)
    async def u_pdate_admin_adyen_terminal_message_in(
        ...
        admin_adyen_terminal_message_in: AdminAdyenTerminalMessageIn,
