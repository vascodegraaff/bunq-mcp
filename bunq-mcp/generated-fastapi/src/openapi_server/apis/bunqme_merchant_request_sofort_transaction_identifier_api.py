...
from openapi_server.apis.bunqme_merchant_request_sofort_transaction_identifier_api_base import BaseBunqmeMerchantRequestSofortTransactionIdentifierApi
...
from openapi_server.models.bunq_me_merchant_request_sofort_transaction_identifier import BunqMeMerchantRequestSofortTransactionIdentifier
from openapi_server.models.bunq_me_merchant_request_sofort_transaction_identifier_create import BunqMeMerchantRequestSofortTransactionIdentifierCreate
...
@router.post(
    "/bunqme-merchant-request-sofort-transaction-identifier",
    responses={
        200: {"model": BunqMeMerchantRequestSofortTransactionIdentifierCreate, "description": "View to pass an transaction identifier code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request-sofort-transaction-identifier"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bunqme_merchant_request_sofort_transaction_identifier(
    ...
    bunq_me_merchant_request_sofort_transaction_identifier: BunqMeMerchantRequestSofortTransactionIdentifier = Body(None, description=""),
...
) -> BunqMeMerchantRequestSofortTransactionIdentifierCreate:
    ...
    if not BaseBunqmeMerchantRequestSofortTransactionIdentifierApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestSofortTransactionIdentifierApi.subclasses[0]().c_reate_bunqme_merchant_request_sofort_transaction_identifier(user_agent, x_bunq_client_authentication, bunq_me_merchant_request_sofort_transaction_identifier, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
