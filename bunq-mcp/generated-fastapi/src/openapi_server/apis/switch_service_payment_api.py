...
from openapi_server.apis.switch_service_payment_api_base import BaseSwitchServicePaymentApi
...
from openapi_server.models.bank_switch_service_netherlands_incoming_payment_read import BankSwitchServiceNetherlandsIncomingPaymentRead
...
@router.get(
    ...
    responses={
        200: {"model": BankSwitchServiceNetherlandsIncomingPaymentRead, "description": "An incoming payment made towards an account of an external bank and redirected to a bunq account via switch service. apiApp:READ apiPublic:READ"},
...
async def r_ead_switch_service_payment_for_user_monetary_account(
    ...
    """An incoming payment made towards an account of an external bank and redirected to a bunq account via switch service. apiApp:READ apiPublic:READ"""
    if not BaseSwitchServicePaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSwitchServicePaymentApi.subclasses[0]().r_ead_switch_service_payment_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
