...
from openapi_server.apis.bunqme_fundraiser_profile_entry_api_base import BaseBunqmeFundraiserProfileEntryApi
...
from openapi_server.models.bunq_me_fundraiser_profile_entry_read import BunqMeFundraiserProfileEntryRead
...
@router.get(
    "/bunqme-fundraiser-profile-entry/{itemId}",
    responses={
        200: {"model": BunqMeFundraiserProfileEntryRead, "description": "payment to a bunq.me public profile. apiApp:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-fundraiser-profile-entry"],
    summary="",
    response_model_by_alias=True,
)
async def r_ead_bunqme_fundraiser_profile_entry(
    ...
    """payment to a bunq.me public profile. apiApp:READ"""
    if not BaseBunqmeFundraiserProfileEntryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeFundraiserProfileEntryApi.subclasses[0]().r_ead_bunqme_fundraiser_profile_entry(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
