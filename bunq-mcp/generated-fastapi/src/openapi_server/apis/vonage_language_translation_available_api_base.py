...
class BaseVonageLanguageTranslationAvailableApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseVonageLanguageTranslationAvailableApi.subclasses = BaseVonageLanguageTranslationAvailableApi.subclasses + (cls,)
