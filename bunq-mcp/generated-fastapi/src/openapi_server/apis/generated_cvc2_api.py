...
from openapi_server.apis.generated_cvc2_api_base import BaseGeneratedCvc2Api
...
from openapi_server.models.card_generated_cvc2 import CardGeneratedCvc2
from openapi_server.models.card_generated_cvc2_create import CardGeneratedCvc2Create
from openapi_server.models.card_generated_cvc2_listing import CardGeneratedCvc2Listing
from openapi_server.models.card_generated_cvc2_read import CardGeneratedCvc2Read
from openapi_server.models.card_generated_cvc2_update import CardGeneratedCvc2Update
...
@router.post(
    ...
    responses={
        200: {"model": CardGeneratedCvc2Create, "description": "Endpoint for generating and retrieving a new CVC2 code. apiApp:CREATE/READ/UPDATE/LISTING apiPublic:CREATE/READ/UPDATE/LISTING"},
...
async def c_reate_generated_cvc2_for_user_card(
    ...
    card_generated_cvc2: CardGeneratedCvc2 = Body(None, description=""),
    ...
    if not BaseGeneratedCvc2Api.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGeneratedCvc2Api.subclasses[0]().c_reate_generated_cvc2_for_user_card(userID, cardID, user_agent, x_bunq_client_authentication, card_generated_cvc2, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/card/{cardID}/generated-cvc2",
    responses={
        200: {"model": List[CardGeneratedCvc2Listing], "description": "Endpoint for generating and retrieving a new CVC2 code. apiApp:CREATE/READ/UPDATE/LISTING apiPublic:CREATE/READ/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["generated-cvc2"],
    summary="",
...
async def list_all_generated_cvc2_for_user_card(
    userID: StrictInt = Path(..., description=""),
    cardID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[CardGeneratedCvc2Listing]:
    """Get all generated CVC2 codes for a card."""
    if not BaseGeneratedCvc2Api.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGeneratedCvc2Api.subclasses[0]().list_all_generated_cvc2_for_user_card(userID, cardID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/card/{cardID}/generated-cvc2/{itemId}",
    responses={
        200: {"model": CardGeneratedCvc2Read, "description": "Endpoint for generating and retrieving a new CVC2 code. apiApp:CREATE/READ/UPDATE/LISTING apiPublic:CREATE/READ/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["generated-cvc2"],
    summary="",
...
async def r_ead_generated_cvc2_for_user_card(
    userID: StrictInt = Path(..., description=""),
    cardID: StrictInt = Path(..., description=""),
    ...
    if not BaseGeneratedCvc2Api.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGeneratedCvc2Api.subclasses[0]().r_ead_generated_cvc2_for_user_card(userID, cardID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/card/{cardID}/generated-cvc2/{itemId}",
    responses={
        200: {"model": CardGeneratedCvc2Update, "description": "Endpoint for generating and retrieving a new CVC2 code. apiApp:CREATE/READ/UPDATE/LISTING apiPublic:CREATE/READ/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["generated-cvc2"],
    summary="",
...
async def u_pdate_generated_cvc2_for_user_card(
    userID: StrictInt = Path(..., description=""),
    cardID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    """Endpoint for generating and retrieving a new CVC2 code. apiApp:CREATE/READ/UPDATE/LISTING apiPublic:CREATE/READ/UPDATE/LISTING"""
    if not BaseGeneratedCvc2Api.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGeneratedCvc2Api.subclasses[0]().u_pdate_generated_cvc2_for_user_card(userID, cardID, itemId, user_agent, x_bunq_client_authentication, card_generated_cvc2, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
