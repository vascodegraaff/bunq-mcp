...
from openapi_server.apis.token_qr_invite_api_base import BaseTokenQrInviteApi
...
from openapi_server.models.token_qr_invite import TokenQrInvite
from openapi_server.models.token_qr_invite_create import TokenQrInviteCreate
...
@router.post(
    "/user/{userID}/token-qr-invite",
    responses={
        200: {"model": TokenQrInviteCreate, "description": "Usage of this endpoint (by scanning a QR code) results in creating a token for the user. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-invite"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_invite_for_user(
    ...
    token_qr_invite: TokenQrInvite = Body(None, description=""),
    ...
    if not BaseTokenQrInviteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrInviteApi.subclasses[0]().c_reate_token_qr_invite_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_invite, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
