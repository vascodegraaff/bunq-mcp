...
from openapi_server.apis.proprietary_information_api_base import BaseProprietaryInformationApi
...
from openapi_server.models.master_card_identity_check_proprietary_information import MasterCardIdentityCheckProprietaryInformation
from openapi_server.models.master_card_identity_check_proprietary_information_create import MasterCardIdentityCheckProprietaryInformationCreate
...
@router.post(
    ...
    responses={
        200: {"model": MasterCardIdentityCheckProprietaryInformationCreate, "description": "Endpoint for TESTING to send a browser behaviour of a challenge request. apiMasterCardIdentityCheck:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["proprietary-information"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_proprietary_information(
    ...
    master_card_identity_check_proprietary_information: MasterCardIdentityCheckProprietaryInformation = Body(None, description=""),
...
) -> MasterCardIdentityCheckProprietaryInformationCreate:
    """Endpoint for TESTING to send a browser behaviour of a challenge request. apiMasterCardIdentityCheck:CREATE"""
    if not BaseProprietaryInformationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProprietaryInformationApi.subclasses[0]().c_reate_proprietary_information(user_agent, x_bunq_client_authentication, master_card_identity_check_proprietary_information, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
