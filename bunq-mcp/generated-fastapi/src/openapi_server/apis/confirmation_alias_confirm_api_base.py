...
class BaseConfirmationAliasConfirmApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseConfirmationAliasConfirmApi.subclasses = BaseConfirmationAliasConfirmApi.subclasses + (cls,)
    async def c_reate_confirmation_alias_confirm(
        ...
        confirmation_alias_confirm: ConfirmationAliasConfirm,
