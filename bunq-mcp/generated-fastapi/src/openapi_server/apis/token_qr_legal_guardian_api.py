...
from openapi_server.apis.token_qr_legal_guardian_api_base import BaseTokenQrLegalGuardianApi
...
from openapi_server.models.token_qr_user_legal_guardian import TokenQrUserLegalGuardian
from openapi_server.models.token_qr_user_legal_guardian_create import TokenQrUserLegalGuardianCreate
...
@router.post(
    "/token-qr-legal-guardian",
    responses={
        200: {"model": TokenQrUserLegalGuardianCreate, "description": "Using this call a legal guardian can approve a minor through his QR code. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-legal-guardian"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_legal_guardian(
    ...
    token_qr_user_legal_guardian: TokenQrUserLegalGuardian = Body(None, description=""),
...
) -> TokenQrUserLegalGuardianCreate:
    """Approva a minor through his QR code."""
    if not BaseTokenQrLegalGuardianApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrLegalGuardianApi.subclasses[0]().c_reate_token_qr_legal_guardian(user_agent, x_bunq_client_authentication, token_qr_user_legal_guardian, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
