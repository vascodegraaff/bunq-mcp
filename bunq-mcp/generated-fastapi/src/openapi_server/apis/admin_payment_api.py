...
from openapi_server.apis.admin_payment_api_base import BaseAdminPaymentApi
...
from openapi_server.models.admin_payment_listing import AdminPaymentListing
from openapi_server.models.admin_payment_read import AdminPaymentRead
from openapi_server.models.admin_payment_user_listing import AdminPaymentUserListing
from openapi_server.models.admin_payment_user_monetary_account_read import AdminPaymentUserMonetaryAccountRead
...
@router.get(
    "/admin-payment",
    responses={
        200: {"model": List[AdminPaymentListing], "description": "Admin view for mutation models. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"},
...
async def list_all_admin_payment(
...
) -> List[AdminPaymentListing]:
    """Admin view for mutation models. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"""
    if not BaseAdminPaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPaymentApi.subclasses[0]().list_all_admin_payment(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/admin-payment",
    responses={
        200: {"model": List[AdminPaymentUserListing], "description": "Admin view for mutation models. apiAdmin:LISTING apiServiceInternal:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-payment"],
    summary="",
...
async def list_all_admin_payment_for_user(
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[AdminPaymentUserListing]:
    """Admin view for mutation models. apiAdmin:LISTING apiServiceInternal:LISTING"""
    if not BaseAdminPaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPaymentApi.subclasses[0]().list_all_admin_payment_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/admin-payment/{itemId}",
    responses={
        200: {"model": AdminPaymentRead, "description": "Admin view for mutation models. apiAdmin:READ/LISTING apiServiceInternal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-payment"],
    summary="",
...
async def r_ead_admin_payment(
    ...
    if not BaseAdminPaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPaymentApi.subclasses[0]().r_ead_admin_payment(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/admin-payment/{itemId}",
    responses={
        200: {"model": AdminPaymentUserMonetaryAccountRead, "description": "Admin view for mutation models. apiAdmin:READ apiServiceInternal:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-payment"],
    summary="",
...
async def r_ead_admin_payment_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> AdminPaymentUserMonetaryAccountRead:
    """Admin view for mutation models. apiAdmin:READ apiServiceInternal:READ"""
    if not BaseAdminPaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPaymentApi.subclasses[0]().r_ead_admin_payment_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
