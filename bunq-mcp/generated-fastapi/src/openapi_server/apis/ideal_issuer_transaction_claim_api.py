...
from openapi_server.apis.ideal_issuer_transaction_claim_api_base import BaseIdealIssuerTransactionClaimApi
...
from openapi_server.models.ideal_issuer_transaction_claim import IdealIssuerTransactionClaim
from openapi_server.models.ideal_issuer_transaction_claim_create import IdealIssuerTransactionClaimCreate
...
@router.post(
    "/user/{userID}/ideal-issuer-transaction-claim",
    responses={
        200: {"model": IdealIssuerTransactionClaimCreate, "description": "Endpoint for Ideal Issuer Transaction apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["ideal-issuer-transaction-claim"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_ideal_issuer_transaction_claim_for_user(
    ...
    ideal_issuer_transaction_claim: IdealIssuerTransactionClaim = Body(None, description=""),
...
) -> IdealIssuerTransactionClaimCreate:
    """Endpoint for Ideal Issuer Transaction apiApp:CREATE"""
    if not BaseIdealIssuerTransactionClaimApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIdealIssuerTransactionClaimApi.subclasses[0]().c_reate_ideal_issuer_transaction_claim_for_user(userID, user_agent, x_bunq_client_authentication, ideal_issuer_transaction_claim, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
