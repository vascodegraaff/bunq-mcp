...
class BaseTransactionMonitoringMachineLearningFeatureMapApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransactionMonitoringMachineLearningFeatureMapApi.subclasses = BaseTransactionMonitoringMachineLearningFeatureMapApi.subclasses + (cls,)
