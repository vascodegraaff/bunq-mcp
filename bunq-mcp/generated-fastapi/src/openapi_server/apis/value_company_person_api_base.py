...
class BaseValueCompanyPersonApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseValueCompanyPersonApi.subclasses = BaseValueCompanyPersonApi.subclasses + (cls,)
    async def c_reate_value_company_person_for_user_review_check(
        ...
        user_review_value_company_person: UserReviewValueCompanyPerson,
