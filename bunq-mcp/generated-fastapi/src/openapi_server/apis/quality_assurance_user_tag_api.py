...
from openapi_server.apis.quality_assurance_user_tag_api_base import BaseQualityAssuranceUserTagApi
...
from openapi_server.models.quality_assurance_user_tag import QualityAssuranceUserTag
from openapi_server.models.quality_assurance_user_tag_create import QualityAssuranceUserTagCreate
...
@router.post(
    "/user/{userID}/quality-assurance-user-tag",
    responses={
        200: {"model": QualityAssuranceUserTagCreate, "description": "Create tags for users, for Quality Assurance purposes. apiQualityAssurance:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["quality-assurance-user-tag"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_quality_assurance_user_tag_for_user(
    ...
    quality_assurance_user_tag: QualityAssuranceUserTag = Body(None, description=""),
...
) -> QualityAssuranceUserTagCreate:
    """Create tags for users, for Quality Assurance purposes. apiQualityAssurance:CREATE"""
    if not BaseQualityAssuranceUserTagApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQualityAssuranceUserTagApi.subclasses[0]().c_reate_quality_assurance_user_tag_for_user(userID, user_agent, x_bunq_client_authentication, quality_assurance_user_tag, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
