...
class BaseAdminPartnerPromotionCategoryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionCategoryApi.subclasses = BaseAdminPartnerPromotionCategoryApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_category(
        ...
        admin_partner_promotion_category: AdminPartnerPromotionCategory,
