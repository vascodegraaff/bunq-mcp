...
class BaseTaxResidentExemptionPermanentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTaxResidentExemptionPermanentApi.subclasses = BaseTaxResidentExemptionPermanentApi.subclasses + (cls,)
    async def c_reate_tax_resident_exemption_permanent_for_user(
        ...
        tax_resident_exemption_permanent: TaxResidentExemptionPermanent,
