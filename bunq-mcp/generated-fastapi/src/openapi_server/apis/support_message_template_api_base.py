...
class BaseSupportMessageTemplateApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSupportMessageTemplateApi.subclasses = BaseSupportMessageTemplateApi.subclasses + (cls,)
    async def c_reate_support_message_template(
        ...
        support_message_template: SupportMessageTemplate,
