...
class BasePartnerPromotionCashbackApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePartnerPromotionCashbackApi.subclasses = BasePartnerPromotionCashbackApi.subclasses + (cls,)
    async def c_reate_partner_promotion_cashback_for_user(
        ...
        user_partner_promotion_cashback: UserPartnerPromotionCashback,
