...
class BaseAdminAdyenReportSettlementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAdyenReportSettlementApi.subclasses = BaseAdminAdyenReportSettlementApi.subclasses + (cls,)
    async def u_pdate_admin_adyen_report_settlement(
        ...
        admin_adyen_report_settlement: AdminAdyenReportSettlement,
