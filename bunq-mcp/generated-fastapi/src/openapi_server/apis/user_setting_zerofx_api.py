...
from openapi_server.apis.user_setting_zerofx_api_base import BaseUserSettingZerofxApi
...
@router.post(
    "/user/{userID}/user-setting-zerofx",
    responses={
        200: {"model": UserSettingZeroFxCreate, "description": "Allow the user to enable or disable ZeroFX for card transactions. apiAdmin:CREATE/UPDATE/LISTING apiApp:CREATE/UPDATE/LISTING apiServiceInternal:CREATE/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-setting-zerofx"],
    summary="",
...
async def c_reate_user_setting_zerofx_for_user(
    ...
    user_setting_zero_fx: UserSettingZeroFx = Body(None, description=""),
    ...
    if not BaseUserSettingZerofxApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserSettingZerofxApi.subclasses[0]().c_reate_user_setting_zerofx_for_user(userID, user_agent, x_bunq_client_authentication, user_setting_zero_fx, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/user-setting-zerofx",
    responses={
        200: {"model": List[UserSettingZeroFxListing], "description": "Allow the user to enable or disable ZeroFX for card transactions. apiAdmin:CREATE/UPDATE/LISTING apiApp:CREATE/UPDATE/LISTING apiServiceInternal:CREATE/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-setting-zerofx"],
    summary="",
...
async def list_all_user_setting_zerofx_for_user(
    ...
    if not BaseUserSettingZerofxApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserSettingZerofxApi.subclasses[0]().list_all_user_setting_zerofx_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/user-setting-zerofx/{itemId}",
    responses={
        200: {"model": UserSettingZeroFxUpdate, "description": "Allow the user to enable or disable ZeroFX for card transactions. apiAdmin:CREATE/UPDATE/LISTING apiApp:CREATE/UPDATE/LISTING apiServiceInternal:CREATE/UPDATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-setting-zerofx"],
    summary="",
...
async def u_pdate_user_setting_zerofx_for_user(
    ...
    if not BaseUserSettingZerofxApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserSettingZerofxApi.subclasses[0]().u_pdate_user_setting_zerofx_for_user(userID, itemId, user_agent, x_bunq_client_authentication, user_setting_zero_fx, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
