...
from openapi_server.apis.address_autocomplete_api_base import BaseAddressAutocompleteApi
...
from openapi_server.models.address_autocomplete import AddressAutocomplete
from openapi_server.models.address_autocomplete_create import AddressAutocompleteCreate
...
@router.post(
    ...
    responses={
        200: {"model": AddressAutocompleteCreate, "description": "Used to complete an address. Non-REST. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_address_autocomplete(
    ...
    address_autocomplete: AddressAutocomplete = Body(None, description=""),
...
) -> AddressAutocompleteCreate:
    """Used to complete an address. Non-REST. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseAddressAutocompleteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAddressAutocompleteApi.subclasses[0]().c_reate_address_autocomplete(user_agent, x_bunq_client_authentication, address_autocomplete, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
