...
class BaseIdentificationVerificationApplicantApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdentificationVerificationApplicantApi.subclasses = BaseIdentificationVerificationApplicantApi.subclasses + (cls,)
    async def c_reate_identification_verification_applicant_for_user(
        ...
        user_identification_verification_applicant: UserIdentificationVerificationApplicant,
