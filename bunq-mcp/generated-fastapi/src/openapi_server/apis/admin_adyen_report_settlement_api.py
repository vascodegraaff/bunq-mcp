...
from openapi_server.apis.admin_adyen_report_settlement_api_base import BaseAdminAdyenReportSettlementApi
...
from openapi_server.models.admin_adyen_report_settlement import AdminAdyenReportSettlement
from openapi_server.models.admin_adyen_report_settlement_update import AdminAdyenReportSettlementUpdate
...
@router.put(
    "/admin-adyen-report-settlement/{itemId}",
    responses={
        200: {"model": AdminAdyenReportSettlementUpdate, "description": "Manage Adyen Reports. apiAdmin:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-adyen-report-settlement"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_admin_adyen_report_settlement(
    ...
    admin_adyen_report_settlement: AdminAdyenReportSettlement = Body(None, description=""),
...
) -> AdminAdyenReportSettlementUpdate:
    """Manage Adyen Reports. apiAdmin:UPDATE"""
    if not BaseAdminAdyenReportSettlementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminAdyenReportSettlementApi.subclasses[0]().u_pdate_admin_adyen_report_settlement(itemId, user_agent, x_bunq_client_authentication, admin_adyen_report_settlement, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
