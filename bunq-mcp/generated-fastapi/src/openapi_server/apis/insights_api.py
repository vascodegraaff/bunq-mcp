...
from openapi_server.apis.insights_api_base import BaseInsightsApi
...
from openapi_server.models.insight_listing import InsightListing
...
@router.get(
    ...
    responses={
        200: {"model": List[InsightListing], "description": "Used to get insights about transactions between given time range. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"},
...
async def list_all_insights_for_user(
    ...
    """Used to get insights about transactions between given time range. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"""
    if not BaseInsightsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInsightsApi.subclasses[0]().list_all_insights_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
