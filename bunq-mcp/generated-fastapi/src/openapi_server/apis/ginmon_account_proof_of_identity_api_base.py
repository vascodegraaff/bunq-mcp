...
class BaseGinmonAccountProofOfIdentityApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonAccountProofOfIdentityApi.subclasses = BaseGinmonAccountProofOfIdentityApi.subclasses + (cls,)
    async def c_reate_ginmon_account_proof_of_identity_for_user_ginmon_account(
        ...
        ginmon_account_proof_of_identity: GinmonAccountProofOfIdentity,
