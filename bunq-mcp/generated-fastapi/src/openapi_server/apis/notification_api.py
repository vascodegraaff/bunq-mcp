...
from openapi_server.models.ppro_notification import PproNotification
from openapi_server.models.ppro_notification_create import PproNotificationCreate
...
@router.post(
    "/notification",
    responses={
        200: {"model": PproNotificationCreate, "description": "The public endpoint for retrieving a notification by PPRO. apiPPro:CREATE"},
...
async def c_reate_notification(
    ...
    ppro_notification: PproNotification = Body(None, description=""),
...
) -> PproNotificationCreate:
    """The public endpoint for retrieving a notification by PPRO. apiPPro:CREATE"""
    if not BaseNotificationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseNotificationApi.subclasses[0]().c_reate_notification(user_agent, x_bunq_client_authentication, ppro_notification, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
