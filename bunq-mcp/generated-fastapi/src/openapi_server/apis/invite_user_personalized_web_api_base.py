...
class BaseInviteUserPersonalizedWebApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInviteUserPersonalizedWebApi.subclasses = BaseInviteUserPersonalizedWebApi.subclasses + (cls,)
    async def u_pdate_invite_user_personalized_web_for_user(
        ...
        invite_user_personalized_web: InviteUserPersonalizedWeb,
