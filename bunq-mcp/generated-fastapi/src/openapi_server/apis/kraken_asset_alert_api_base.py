...
from openapi_server.models.kraken_asset_alert import KrakenAssetAlert
from openapi_server.models.kraken_asset_alert_create import KrakenAssetAlertCreate
from openapi_server.models.kraken_asset_alert_listing import KrakenAssetAlertListing
from openapi_server.models.kraken_asset_alert_read import KrakenAssetAlertRead
from openapi_server.models.kraken_asset_alert_update import KrakenAssetAlertUpdate


class BaseKrakenAssetAlertApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseKrakenAssetAlertApi.subclasses = BaseKrakenAssetAlertApi.subclasses + (cls,)
    async def c_reate_kraken_asset_alert_for_user_kraken_account(
        self,
        userID: StrictInt,
        kraken-accountID: StrictInt,
        ...
        kraken_asset_alert: KrakenAssetAlert,
    ...
    ) -> KrakenAssetAlertCreate:
        """Endpoint for managing alerts for Kraken Assets. apiApp:CREATE/READ/UPDATE/LISTING/DELETE"""
        ...


    async def d_elete_kraken_asset_alert_for_user_kraken_account(
        self,
        userID: StrictInt,
        kraken-accountID: StrictInt,
        itemId: StrictInt,
    ...
    async def list_all_kraken_asset_alert_for_user_kraken_account(
        self,
        userID: StrictInt,
        kraken-accountID: StrictInt,
        user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")],
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> List[KrakenAssetAlertListing]:
        """Endpoint for managing alerts for Kraken Assets. apiApp:CREATE/READ/UPDATE/LISTING/DELETE"""
        ...


    async def r_ead_kraken_asset_alert_for_user_kraken_account(
        self,
        userID: StrictInt,
        kraken-accountID: StrictInt,
        itemId: StrictInt,
        ...
        x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")],
        x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")],
    ) -> KrakenAssetAlertRead:
        """Endpoint for managing alerts for Kraken Assets. apiApp:CREATE/READ/UPDATE/LISTING/DELETE"""
        ...


    async def u_pdate_kraken_asset_alert_for_user_kraken_account(
        self,
        userID: StrictInt,
        kraken-accountID: StrictInt,
        itemId: StrictInt,
