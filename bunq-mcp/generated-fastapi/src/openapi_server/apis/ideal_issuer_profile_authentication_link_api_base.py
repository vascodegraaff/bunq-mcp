...
class BaseIdealIssuerProfileAuthenticationLinkApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdealIssuerProfileAuthenticationLinkApi.subclasses = BaseIdealIssuerProfileAuthenticationLinkApi.subclasses + (cls,)
