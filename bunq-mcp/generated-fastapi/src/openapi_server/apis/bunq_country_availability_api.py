...
from openapi_server.apis.bunq_country_availability_api_base import BaseBunqCountryAvailabilityApi
...
from openapi_server.models.bunq_country_availability_listing import BunqCountryAvailabilityListing
...
@router.get(
    "/bunq-country-availability",
    responses={
        200: {"model": List[BunqCountryAvailabilityListing], "description": "Lists bunq country availability. apiAdmin:LISTING apiServiceInternal:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunq-country-availability"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_bunq_country_availability(
...
) -> List[BunqCountryAvailabilityListing]:
    """Lists bunq country availability. apiAdmin:LISTING apiServiceInternal:LISTING"""
    if not BaseBunqCountryAvailabilityApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqCountryAvailabilityApi.subclasses[0]().list_all_bunq_country_availability(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
