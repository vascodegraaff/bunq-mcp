...
class BaseNotificationCredentialApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNotificationCredentialApi.subclasses = BaseNotificationCredentialApi.subclasses + (cls,)
    async def c_reate_notification_credential_for_user_device(
        ...
        notification_credential: NotificationCredential,
