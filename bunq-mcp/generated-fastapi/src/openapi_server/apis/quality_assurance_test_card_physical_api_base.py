...
class BaseQualityAssuranceTestCardPhysicalApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQualityAssuranceTestCardPhysicalApi.subclasses = BaseQualityAssuranceTestCardPhysicalApi.subclasses + (cls,)
    async def c_reate_quality_assurance_test_card_physical_for_user(
        ...
        quality_assurance_test_card_physical: QualityAssuranceTestCardPhysical,
