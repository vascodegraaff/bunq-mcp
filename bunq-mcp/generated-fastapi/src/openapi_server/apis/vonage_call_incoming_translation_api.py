...
from openapi_server.apis.vonage_call_incoming_translation_api_base import BaseVonageCallIncomingTranslationApi
...
from openapi_server.models.vonage_call_incoming_translation import VonageCallIncomingTranslation
from openapi_server.models.vonage_call_incoming_translation_create import VonageCallIncomingTranslationCreate
...
@router.post(
    "/vonage-call-incoming-translation",
    responses={
        200: {"model": VonageCallIncomingTranslationCreate, "description": "Receives real-time translations for calls happening through Vonage. apiVonage:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["vonage-call-incoming-translation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_vonage_call_incoming_translation(
    ...
    vonage_call_incoming_translation: VonageCallIncomingTranslation = Body(None, description=""),
...
) -> VonageCallIncomingTranslationCreate:
    """Receives real-time translations for calls happening through Vonage. apiVonage:CREATE"""
    if not BaseVonageCallIncomingTranslationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseVonageCallIncomingTranslationApi.subclasses[0]().c_reate_vonage_call_incoming_translation(user_agent, x_bunq_client_authentication, vonage_call_incoming_translation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
