...
from openapi_server.apis.admin_adyen_settlement_api_base import BaseAdminAdyenSettlementApi
...
from openapi_server.models.admin_adyen_settlement import AdminAdyenSettlement
from openapi_server.models.admin_adyen_settlement_update import AdminAdyenSettlementUpdate
...
@router.put(
    "/admin-adyen-settlement/{itemId}",
    responses={
        200: {"model": AdminAdyenSettlementUpdate, "description": "Manage Adyen Settlements. apiAdmin:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-adyen-settlement"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_admin_adyen_settlement(
    ...
    admin_adyen_settlement: AdminAdyenSettlement = Body(None, description=""),
...
) -> AdminAdyenSettlementUpdate:
    """Manage Adyen Settlements. apiAdmin:UPDATE"""
    if not BaseAdminAdyenSettlementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminAdyenSettlementApi.subclasses[0]().u_pdate_admin_adyen_settlement(itemId, user_agent, x_bunq_client_authentication, admin_adyen_settlement, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
