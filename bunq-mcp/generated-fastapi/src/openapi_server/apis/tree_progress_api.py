...
from openapi_server.apis.tree_progress_api_base import BaseTreeProgressApi
...
from openapi_server.models.tree_progress_listing import TreeProgressListing
...
@router.get(
    ...
    responses={
        200: {"model": List[TreeProgressListing], "description": "See how many trees this user has planted. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"},
...
) -> List[TreeProgressListing]:
    """See how many trees this user has planted. apiAdmin:LISTING apiApp:LISTING apiPublic:LISTING apiServiceInternal:LISTING"""
    if not BaseTreeProgressApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTreeProgressApi.subclasses[0]().list_all_tree_progress_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
