...
from openapi_server.apis.nationality_api_base import BaseNationalityApi
...
from openapi_server.models.user_person_nationality import UserPersonNationality
from openapi_server.models.user_person_nationality_create import UserPersonNationalityCreate
...
@router.post(
    "/user/{userID}/nationality",
    responses={
        200: {"model": UserPersonNationalityCreate, "description": "The endpoint to update the nationalities of user person. apiApp:CREATE"},
...
async def c_reate_nationality_for_user(
    ...
    user_person_nationality: UserPersonNationality = Body(None, description=""),
...
) -> UserPersonNationalityCreate:
    """The endpoint to update the nationalities of user person. apiApp:CREATE"""
    if not BaseNationalityApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseNationalityApi.subclasses[0]().c_reate_nationality_for_user(userID, user_agent, x_bunq_client_authentication, user_person_nationality, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
