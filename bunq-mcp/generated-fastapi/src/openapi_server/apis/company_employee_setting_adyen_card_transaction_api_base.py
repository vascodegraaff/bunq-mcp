...
class BaseCompanyEmployeeSettingAdyenCardTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCompanyEmployeeSettingAdyenCardTransactionApi.subclasses = BaseCompanyEmployeeSettingAdyenCardTransactionApi.subclasses + (cls,)
