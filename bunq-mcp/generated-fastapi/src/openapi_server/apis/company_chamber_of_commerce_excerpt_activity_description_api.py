...
from openapi_server.apis.company_chamber_of_commerce_excerpt_activity_description_api_base import BaseCompanyChamberOfCommerceExcerptActivityDescriptionApi
...
from openapi_server.models.company_chamber_of_commerce_excerpt_activity_description_listing import CompanyChamberOfCommerceExcerptActivityDescriptionListing
...
@router.get(
    "/user/{userID}/company-chamber-of-commerce-excerpt-activity-description",
    responses={
        200: {"model": List[CompanyChamberOfCommerceExcerptActivityDescriptionListing], "description": "Get Chamber of commerce activity description id&#39;s that are given in the chamber of commerce excerpt. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["company-chamber-of-commerce-excerpt-activity-description"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_company_chamber_of_commerce_excerpt_activity_description_for_user(
...
) -> List[CompanyChamberOfCommerceExcerptActivityDescriptionListing]:
    """Get Chamber of commerce activity description id&#39;s that are given in the chamber of commerce excerpt. apiApp:LISTING"""
    if not BaseCompanyChamberOfCommerceExcerptActivityDescriptionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyChamberOfCommerceExcerptActivityDescriptionApi.subclasses[0]().list_all_company_chamber_of_commerce_excerpt_activity_description_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
