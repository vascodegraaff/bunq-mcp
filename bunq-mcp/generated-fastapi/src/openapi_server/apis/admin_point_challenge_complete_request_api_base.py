...
class BaseAdminPointChallengeCompleteRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPointChallengeCompleteRequestApi.subclasses = BaseAdminPointChallengeCompleteRequestApi.subclasses + (cls,)
    async def c_reate_admin_point_challenge_complete_request_for_user(
        ...
        admin_point_challenge_complete_request: AdminPointChallengeCompleteRequest,
