...
from openapi_server.apis.swift_message_api_base import BaseSwiftMessageApi
...
from openapi_server.models.swift_message_read import SwiftMessageRead
...
@router.get(
    "/swift-message/{itemId}",
    responses={
        200: {"model": SwiftMessageRead, "description": "Endpoint used by the search API. apiAdmin:READ apiServiceInternal:READ"},
...
async def r_ead_swift_message(
    ...
    if not BaseSwiftMessageApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSwiftMessageApi.subclasses[0]().r_ead_swift_message(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
