...
from openapi_server.apis.bunqme_merchant_request_bancontact_transaction_identifier_api_base import BaseBunqmeMerchantRequestBancontactTransactionIdentifierApi
...
from openapi_server.models.bunq_me_merchant_request_bancontact_transaction_identifier import BunqMeMerchantRequestBancontactTransactionIdentifier
from openapi_server.models.bunq_me_merchant_request_bancontact_transaction_identifier_create import BunqMeMerchantRequestBancontactTransactionIdentifierCreate
...
@router.post(
    "/bunqme-merchant-request-bancontact-transaction-identifier",
    responses={
        200: {"model": BunqMeMerchantRequestBancontactTransactionIdentifierCreate, "description": "View to pass an transaction identifier code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request-bancontact-transaction-identifier"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bunqme_merchant_request_bancontact_transaction_identifier(
    ...
    bunq_me_merchant_request_bancontact_transaction_identifier: BunqMeMerchantRequestBancontactTransactionIdentifier = Body(None, description=""),
...
) -> BunqMeMerchantRequestBancontactTransactionIdentifierCreate:
    """View to pass an transaction identifier code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"""
    if not BaseBunqmeMerchantRequestBancontactTransactionIdentifierApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestBancontactTransactionIdentifierApi.subclasses[0]().c_reate_bunqme_merchant_request_bancontact_transaction_identifier(user_agent, x_bunq_client_authentication, bunq_me_merchant_request_bancontact_transaction_identifier, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
