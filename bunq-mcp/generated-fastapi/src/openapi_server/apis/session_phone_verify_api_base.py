...
class BaseSessionPhoneVerifyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionPhoneVerifyApi.subclasses = BaseSessionPhoneVerifyApi.subclasses + (cls,)
    async def c_reate_session_phone_verify(
        ...
        session_phone_authentication_token_user: SessionPhoneAuthenticationTokenUser,
