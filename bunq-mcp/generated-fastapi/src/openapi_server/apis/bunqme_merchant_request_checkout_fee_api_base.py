...
class BaseBunqmeMerchantRequestCheckoutFeeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestCheckoutFeeApi.subclasses = BaseBunqmeMerchantRequestCheckoutFeeApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request_checkout_fee(
        ...
        bunq_me_merchant_request_checkout_fee: BunqMeMerchantRequestCheckoutFee,
