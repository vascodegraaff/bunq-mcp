...
class BaseIdealMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdealMerchantTransactionApi.subclasses = BaseIdealMerchantTransactionApi.subclasses + (cls,)
    async def c_reate_ideal_merchant_transaction_for_user_monetary_account(
        ...
        ideal_merchant_transaction: IdealMerchantTransaction,
