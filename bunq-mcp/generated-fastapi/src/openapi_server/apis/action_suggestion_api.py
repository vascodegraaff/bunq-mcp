...
from openapi_server.apis.action_suggestion_api_base import BaseActionSuggestionApi
...
@router.post(
    "/user/{userID}/assistant/{assistantID}/action-suggestion",
    responses={
        200: {"model": AssistantActionSuggestionCreate, "description": "Returns Finn’s suggestions on actions for the user to take next. apiAdmin:LISTING/CREATE/READ/UPDATE apiApp:LISTING/CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["action-suggestion"],
    summary="",
...
async def c_reate_action_suggestion_for_user_assistant(
    ...
    assistant_action_suggestion: AssistantActionSuggestion = Body(None, description=""),
    ...
    if not BaseActionSuggestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActionSuggestionApi.subclasses[0]().c_reate_action_suggestion_for_user_assistant(userID, assistantID, user_agent, x_bunq_client_authentication, assistant_action_suggestion, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/assistant/{assistantID}/action-suggestion",
    responses={
        200: {"model": List[AssistantActionSuggestionListing], "description": "Returns Finn’s suggestions on actions for the user to take next. apiAdmin:LISTING/CREATE/READ/UPDATE apiApp:LISTING/CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["action-suggestion"],
    summary="",
...
async def list_all_action_suggestion_for_user_assistant(
    ...
    if not BaseActionSuggestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActionSuggestionApi.subclasses[0]().list_all_action_suggestion_for_user_assistant(userID, assistantID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/assistant/{assistantID}/action-suggestion/{itemId}",
    responses={
        200: {"model": AssistantActionSuggestionRead, "description": "Returns Finn’s suggestions on actions for the user to take next. apiAdmin:LISTING/CREATE/READ/UPDATE apiApp:LISTING/CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["action-suggestion"],
    summary="",
...
async def r_ead_action_suggestion_for_user_assistant(
    ...
    if not BaseActionSuggestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActionSuggestionApi.subclasses[0]().r_ead_action_suggestion_for_user_assistant(userID, assistantID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/assistant/{assistantID}/action-suggestion/{itemId}",
    responses={
        200: {"model": AssistantActionSuggestionUpdate, "description": "Returns Finn’s suggestions on actions for the user to take next. apiAdmin:LISTING/CREATE/READ/UPDATE apiApp:LISTING/CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["action-suggestion"],
    summary="",
...
async def u_pdate_action_suggestion_for_user_assistant(
    ...
    if not BaseActionSuggestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActionSuggestionApi.subclasses[0]().u_pdate_action_suggestion_for_user_assistant(userID, assistantID, itemId, user_agent, x_bunq_client_authentication, assistant_action_suggestion, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
