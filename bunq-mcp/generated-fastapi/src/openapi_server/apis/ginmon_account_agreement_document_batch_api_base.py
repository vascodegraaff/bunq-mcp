...
class BaseGinmonAccountAgreementDocumentBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonAccountAgreementDocumentBatchApi.subclasses = BaseGinmonAccountAgreementDocumentBatchApi.subclasses + (cls,)
    async def c_reate_ginmon_account_agreement_document_batch_for_user(
        ...
        ginmon_account_agreement_document_batch: GinmonAccountAgreementDocumentBatch,
