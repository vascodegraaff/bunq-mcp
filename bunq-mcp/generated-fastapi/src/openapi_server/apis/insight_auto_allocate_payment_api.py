...
from openapi_server.apis.insight_auto_allocate_payment_api_base import BaseInsightAutoAllocatePaymentApi
...
from openapi_server.models.insight_auto_allocate_payment_listing import InsightAutoAllocatePaymentListing
...
@router.get(
    "/user/{userID}/insight-auto-allocate-payment",
    responses={
        200: {"model": List[InsightAutoAllocatePaymentListing], "description": "The insight auto allocate endpoint apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["insight-auto-allocate-payment"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_insight_auto_allocate_payment_for_user(
...
) -> List[InsightAutoAllocatePaymentListing]:
    """The insight auto allocate endpoint apiApp:LISTING"""
    if not BaseInsightAutoAllocatePaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInsightAutoAllocatePaymentApi.subclasses[0]().list_all_insight_auto_allocate_payment_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
