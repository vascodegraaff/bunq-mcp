...
from openapi_server.apis.transaction_monitoring_machine_learning_feature_map_api_base import BaseTransactionMonitoringMachineLearningFeatureMapApi
...
from openapi_server.models.transaction_monitoring_machine_learning_feature_map_listing import TransactionMonitoringMachineLearningFeatureMapListing
...
@router.get(
    "/transaction-monitoring-metadata/{transaction-monitoring-metadataID}/transaction-monitoring-machine-learning-feature-map",
    responses={
        200: {"model": List[TransactionMonitoringMachineLearningFeatureMapListing], "description": "View a transaction monitoring machine learning feature map apiAdmin:LISTING apiServiceInternal:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transaction-monitoring-machine-learning-feature-map"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_transaction_monitoring_machine_learning_feature_map_for_transaction_monitoring_metadata(
...
) -> List[TransactionMonitoringMachineLearningFeatureMapListing]:
    """View a transaction monitoring machine learning feature map apiAdmin:LISTING apiServiceInternal:LISTING"""
    if not BaseTransactionMonitoringMachineLearningFeatureMapApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransactionMonitoringMachineLearningFeatureMapApi.subclasses[0]().list_all_transaction_monitoring_machine_learning_feature_map_for_transaction_monitoring_metadata(transaction-monitoring-metadataID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
