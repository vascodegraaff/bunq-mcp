...
class BaseBudgetScheduleApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBudgetScheduleApi.subclasses = BaseBudgetScheduleApi.subclasses + (cls,)
    async def c_reate_budget_schedule_for_user_monetary_account(
        ...
        monetary_account_budget_schedule: MonetaryAccountBudgetSchedule,
