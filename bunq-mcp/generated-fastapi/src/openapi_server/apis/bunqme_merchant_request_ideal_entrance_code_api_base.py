...
class BaseBunqmeMerchantRequestIdealEntranceCodeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestIdealEntranceCodeApi.subclasses = BaseBunqmeMerchantRequestIdealEntranceCodeApi.subclasses + (cls,)
    async def c_reate_bunqme_merchant_request_ideal_entrance_code(
        ...
        bunq_me_merchant_request_ideal_entrance_code: BunqMeMerchantRequestIdealEntranceCode,
