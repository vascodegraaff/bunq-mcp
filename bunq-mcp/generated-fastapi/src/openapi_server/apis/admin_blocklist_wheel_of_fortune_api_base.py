...
class BaseAdminBlocklistWheelOfFortuneApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminBlocklistWheelOfFortuneApi.subclasses = BaseAdminBlocklistWheelOfFortuneApi.subclasses + (cls,)
    async def c_reate_admin_blocklist_wheel_of_fortune(
        ...
        admin_blocklist_wheel_of_fortune: AdminBlocklistWheelOfFortune,
