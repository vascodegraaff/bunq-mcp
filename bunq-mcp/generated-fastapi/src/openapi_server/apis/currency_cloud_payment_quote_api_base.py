...
class BaseCurrencyCloudPaymentQuoteApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCurrencyCloudPaymentQuoteApi.subclasses = BaseCurrencyCloudPaymentQuoteApi.subclasses + (cls,)
    async def c_reate_currency_cloud_payment_quote_for_user_monetary_account(
        ...
        currency_cloud_payment_quote: CurrencyCloudPaymentQuote,
