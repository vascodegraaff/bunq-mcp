...
from openapi_server.apis.activity_map_place_suggestion_feedback_api_base import BaseActivityMapPlaceSuggestionFeedbackApi
...
from openapi_server.models.activity_map_place_suggestion_feedback import ActivityMapPlaceSuggestionFeedback
from openapi_server.models.activity_map_place_suggestion_feedback_create import ActivityMapPlaceSuggestionFeedbackCreate
...
@router.post(
    "/user/{userID}/activity-map-place-suggestion-feedback",
    responses={
        200: {"model": ActivityMapPlaceSuggestionFeedbackCreate, "description": "Endpoint to send feedback about activity map places suggestions. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["activity-map-place-suggestion-feedback"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_activity_map_place_suggestion_feedback_for_user(
    ...
    activity_map_place_suggestion_feedback: ActivityMapPlaceSuggestionFeedback = Body(None, description=""),
...
) -> ActivityMapPlaceSuggestionFeedbackCreate:
    """Endpoint to send feedback about activity map places suggestions. apiApp:CREATE"""
    if not BaseActivityMapPlaceSuggestionFeedbackApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActivityMapPlaceSuggestionFeedbackApi.subclasses[0]().c_reate_activity_map_place_suggestion_feedback_for_user(userID, user_agent, x_bunq_client_authentication, activity_map_place_suggestion_feedback, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
