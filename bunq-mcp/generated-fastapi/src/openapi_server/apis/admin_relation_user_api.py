...
from openapi_server.apis.admin_relation_user_api_base import BaseAdminRelationUserApi
...
from openapi_server.models.admin_relation_user import AdminRelationUser
from openapi_server.models.admin_relation_user_create import AdminRelationUserCreate
...
@router.post(
    "/user/{userID}/admin-relation-user",
    responses={
        200: {"model": AdminRelationUserCreate, "description": "View endpoint for relation user. apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-relation-user"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_relation_user_for_user(
    ...
    admin_relation_user: AdminRelationUser = Body(None, description=""),
...
) -> AdminRelationUserCreate:
    """View endpoint for relation user. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseAdminRelationUserApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminRelationUserApi.subclasses[0]().c_reate_admin_relation_user_for_user(userID, user_agent, x_bunq_client_authentication, admin_relation_user, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
