...
from openapi_server.apis.session_reset_api_base import BaseSessionResetApi
...
from openapi_server.models.session_reset import SessionReset
from openapi_server.models.session_reset_create import SessionResetCreate
...
@router.post(
    "/session-reset",
    responses={
        200: {"model": SessionResetCreate, "description": "Used to create a new session which is needed to reset a user&#39;s pin. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_session_reset(
    ...
    session_reset: SessionReset = Body(None, description=""),
    ...
    """Used to create a new session which is needed to reset a user&#39;s pin. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseSessionResetApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionResetApi.subclasses[0]().c_reate_session_reset(user_agent, x_bunq_client_authentication, session_reset, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
