...
class BaseTicketFlarumTopicSuggestionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTicketFlarumTopicSuggestionApi.subclasses = BaseTicketFlarumTopicSuggestionApi.subclasses + (cls,)
    async def c_reate_ticket_flarum_topic_suggestion(
        ...
        ticket_flarum_topic_suggestion: TicketFlarumTopicSuggestion,
