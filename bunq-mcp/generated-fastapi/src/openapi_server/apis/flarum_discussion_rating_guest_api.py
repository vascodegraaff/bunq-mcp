...
from openapi_server.apis.flarum_discussion_rating_guest_api_base import BaseFlarumDiscussionRatingGuestApi
...
@router.post(
    ...
    responses={
        200: {"model": FlarumDiscussionRatingPublicGuestCreate, "description": "Rating the quality of Flarum (together.bunq.com) discussions. apiFlarum:LISTING/CREATE/UPDATE apiUserAuthenticationWeb:LISTING/CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["flarum-discussion-rating-guest"],
    summary="",
...
async def c_reate_flarum_discussion_rating_guest(
    ...
    flarum_discussion_rating_public_guest: FlarumDiscussionRatingPublicGuest = Body(None, description=""),
    ...
    if not BaseFlarumDiscussionRatingGuestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFlarumDiscussionRatingGuestApi.subclasses[0]().c_reate_flarum_discussion_rating_guest(user_agent, x_bunq_client_authentication, flarum_discussion_rating_public_guest, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/flarum-discussion-rating-guest",
    responses={
        200: {"model": List[FlarumDiscussionRatingPublicGuestListing], "description": "Rating the quality of Flarum (together.bunq.com) discussions. apiFlarum:LISTING/CREATE/UPDATE apiUserAuthenticationWeb:LISTING/CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["flarum-discussion-rating-guest"],
    summary="",
...
async def list_all_flarum_discussion_rating_guest(
    ...
    if not BaseFlarumDiscussionRatingGuestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFlarumDiscussionRatingGuestApi.subclasses[0]().list_all_flarum_discussion_rating_guest(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/flarum-discussion-rating-guest/{itemId}",
    responses={
        200: {"model": FlarumDiscussionRatingPublicGuestUpdate, "description": "Rating the quality of Flarum (together.bunq.com) discussions. apiFlarum:LISTING/CREATE/UPDATE apiUserAuthenticationWeb:LISTING/CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["flarum-discussion-rating-guest"],
    summary="",
...
async def u_pdate_flarum_discussion_rating_guest(
    ...
    if not BaseFlarumDiscussionRatingGuestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFlarumDiscussionRatingGuestApi.subclasses[0]().u_pdate_flarum_discussion_rating_guest(itemId, user_agent, x_bunq_client_authentication, flarum_discussion_rating_public_guest, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
