...
from openapi_server.apis.transferwise_transfer_requirement_api_base import BaseTransferwiseTransferRequirementApi
...
from openapi_server.models.transferwise_transfer_requirement import TransferwiseTransferRequirement
from openapi_server.models.transferwise_transfer_requirement_create import TransferwiseTransferRequirementCreate
...
@router.post(
    ...
    responses={
        200: {"model": TransferwiseTransferRequirementCreate, "description": "Used to determine the account requirements for Transferwise transfers. apiApp:CREATE apiPublic:CREATE"},
...
async def c_reate_transferwise_transfer_requirement_for_user_transferwise_quote(
    ...
    transferwise_transfer_requirement: TransferwiseTransferRequirement = Body(None, description=""),
    ...
    """Used to determine the account requirements for Transferwise transfers. apiApp:CREATE apiPublic:CREATE"""
    if not BaseTransferwiseTransferRequirementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransferwiseTransferRequirementApi.subclasses[0]().c_reate_transferwise_transfer_requirement_for_user_transferwise_quote(userID, transferwise-quoteID, user_agent, x_bunq_client_authentication, transferwise_transfer_requirement, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
