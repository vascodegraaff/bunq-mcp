...
from openapi_server.apis.lokalise_message_api_base import BaseLokaliseMessageApi
...
from openapi_server.models.lokalise_message import LokaliseMessage
from openapi_server.models.lokalise_message_create import LokaliseMessageCreate
...
@router.post(
    "/lokalise-message",
    responses={
        200: {"model": LokaliseMessageCreate, "description": "Gets webhook messages from Lokalise. apiLokalise:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["lokalise-message"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_lokalise_message(
    ...
    lokalise_message: LokaliseMessage = Body(None, description=""),
...
) -> LokaliseMessageCreate:
    """Gets webhook messages from Lokalise. apiLokalise:CREATE"""
    if not BaseLokaliseMessageApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseLokaliseMessageApi.subclasses[0]().c_reate_lokalise_message(user_agent, x_bunq_client_authentication, lokalise_message, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
