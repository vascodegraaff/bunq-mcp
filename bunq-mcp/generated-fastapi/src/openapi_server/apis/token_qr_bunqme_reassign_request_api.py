...
from openapi_server.apis.token_qr_bunqme_reassign_request_api_base import BaseTokenQrBunqmeReassignRequestApi
...
from openapi_server.models.token_qr_bunq_me_reassign_request import TokenQrBunqMeReassignRequest
from openapi_server.models.token_qr_bunq_me_reassign_request_create import TokenQrBunqMeReassignRequestCreate
...
@router.post(
    "/user/{userID}/token-qr-bunqme-reassign-request",
    responses={
        200: {"model": TokenQrBunqMeReassignRequestCreate, "description": "Using this call you claim a request for payment originally send to an email address or phone number. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-bunqme-reassign-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_bunqme_reassign_request_for_user(
    ...
    token_qr_bunq_me_reassign_request: TokenQrBunqMeReassignRequest = Body(None, description=""),
...
) -> TokenQrBunqMeReassignRequestCreate:
    """Reassign request Response."""
    if not BaseTokenQrBunqmeReassignRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrBunqmeReassignRequestApi.subclasses[0]().c_reate_token_qr_bunqme_reassign_request_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_bunq_me_reassign_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
