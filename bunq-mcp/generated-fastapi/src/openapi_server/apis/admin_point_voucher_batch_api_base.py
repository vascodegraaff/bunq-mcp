...
class BaseAdminPointVoucherBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPointVoucherBatchApi.subclasses = BaseAdminPointVoucherBatchApi.subclasses + (cls,)
    async def c_reate_admin_point_voucher_batch(
        ...
        admin_point_voucher_batch: AdminPointVoucherBatch,
