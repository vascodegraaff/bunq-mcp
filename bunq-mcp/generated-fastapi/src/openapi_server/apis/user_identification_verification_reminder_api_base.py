...
class BaseUserIdentificationVerificationReminderApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserIdentificationVerificationReminderApi.subclasses = BaseUserIdentificationVerificationReminderApi.subclasses + (cls,)
    async def c_reate_user_identification_verification_reminder_for_user(
        ...
        reminder_user_identification_verification: ReminderUserIdentificationVerification,
