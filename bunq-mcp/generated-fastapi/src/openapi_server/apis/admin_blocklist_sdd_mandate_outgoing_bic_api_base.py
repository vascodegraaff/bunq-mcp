...
class BaseAdminBlocklistSddMandateOutgoingBicApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminBlocklistSddMandateOutgoingBicApi.subclasses = BaseAdminBlocklistSddMandateOutgoingBicApi.subclasses + (cls,)
    async def c_reate_admin_blocklist_sdd_mandate_outgoing_bic(
        ...
        admin_blocklist_sdd_mandate_outgoing_bic: AdminBlocklistSddMandateOutgoingBic,
