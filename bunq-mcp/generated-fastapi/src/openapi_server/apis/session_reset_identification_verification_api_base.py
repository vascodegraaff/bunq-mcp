...
class BaseSessionResetIdentificationVerificationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionResetIdentificationVerificationApi.subclasses = BaseSessionResetIdentificationVerificationApi.subclasses + (cls,)
    async def c_reate_session_reset_identification_verification(
        ...
        session_reset_identification_verification: SessionResetIdentificationVerification,
