...
class BaseUserTricountAuthenticationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserTricountAuthenticationApi.subclasses = BaseUserTricountAuthenticationApi.subclasses + (cls,)
    async def c_reate_user_tricount_authentication_for_user(
        ...
        user_tricount_authentication: UserTricountAuthentication,
