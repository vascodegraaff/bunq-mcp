...
class BaseAdminPartnerPromotionPrizeVoucherBatchCancellationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionPrizeVoucherBatchCancellationApi.subclasses = BaseAdminPartnerPromotionPrizeVoucherBatchCancellationApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_prize_voucher_batch_cancellation(
        ...
        admin_partner_promotion_prize_voucher_batch_cancellation: AdminPartnerPromotionPrizeVoucherBatchCancellation,
