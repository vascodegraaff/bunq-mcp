...
class BaseTokenQrLegalGuardianApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrLegalGuardianApi.subclasses = BaseTokenQrLegalGuardianApi.subclasses + (cls,)
    async def c_reate_token_qr_legal_guardian(
        ...
        token_qr_user_legal_guardian: TokenQrUserLegalGuardian,
