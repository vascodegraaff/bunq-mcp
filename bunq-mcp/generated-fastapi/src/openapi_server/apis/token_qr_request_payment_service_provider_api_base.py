...
class BaseTokenQrRequestPaymentServiceProviderApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrRequestPaymentServiceProviderApi.subclasses = BaseTokenQrRequestPaymentServiceProviderApi.subclasses + (cls,)
    async def c_reate_token_qr_request_payment_service_provider_for_user(
        ...
        token_qr_request_payment_service_provider: TokenQrRequestPaymentServiceProvider,
