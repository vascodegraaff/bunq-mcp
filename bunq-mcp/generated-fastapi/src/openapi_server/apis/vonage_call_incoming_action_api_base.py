...
class BaseVonageCallIncomingActionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseVonageCallIncomingActionApi.subclasses = BaseVonageCallIncomingActionApi.subclasses + (cls,)
    async def c_reate_vonage_call_incoming_action(
        ...
        vonage_call_incoming_action: VonageCallIncomingAction,
