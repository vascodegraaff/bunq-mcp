...
class BaseCardDesignIconCategoryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCardDesignIconCategoryApi.subclasses = BaseCardDesignIconCategoryApi.subclasses + (cls,)
    async def c_reate_card_design_icon_category(
        ...
        card_design_icon_category: CardDesignIconCategory,
