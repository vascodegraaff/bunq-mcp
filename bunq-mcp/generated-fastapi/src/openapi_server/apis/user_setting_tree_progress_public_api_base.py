...
class BaseUserSettingTreeProgressPublicApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingTreeProgressPublicApi.subclasses = BaseUserSettingTreeProgressPublicApi.subclasses + (cls,)
    async def c_reate_user_setting_tree_progress_public_for_user(
        ...
        user_setting_tree_progress_public: UserSettingTreeProgressPublic,
