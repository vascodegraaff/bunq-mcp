...
class BaseUserSettingPaymentSuspendedApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingPaymentSuspendedApi.subclasses = BaseUserSettingPaymentSuspendedApi.subclasses + (cls,)
    async def c_reate_user_setting_payment_suspended_for_user(
        ...
        user_setting_payment_suspended: UserSettingPaymentSuspended,
