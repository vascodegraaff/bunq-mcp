...
class BaseAdyenMerchantStoredPaymentMethodApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdyenMerchantStoredPaymentMethodApi.subclasses = BaseAdyenMerchantStoredPaymentMethodApi.subclasses + (cls,)
