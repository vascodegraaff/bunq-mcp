...
class BaseAdminRegistryDeleteRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminRegistryDeleteRequestApi.subclasses = BaseAdminRegistryDeleteRequestApi.subclasses + (cls,)
    async def c_reate_admin_registry_delete_request_for_user(
        ...
        admin_registry_delete_request: AdminRegistryDeleteRequest,
