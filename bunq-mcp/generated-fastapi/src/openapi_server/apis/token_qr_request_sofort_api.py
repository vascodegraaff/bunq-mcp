...
from openapi_server.apis.token_qr_request_sofort_api_base import BaseTokenQrRequestSofortApi
...
from openapi_server.models.token_qr_request_sofort import TokenQrRequestSofort
from openapi_server.models.token_qr_request_sofort_create import TokenQrRequestSofortCreate
...
@router.post(
    ...
    responses={
        200: {"model": TokenQrRequestSofortCreate, "description": "Using this call you can create a SOFORT Request assigned to your User by providing the Token of the request. apiApp:CREATE apiPublic:CREATE"},
...
async def c_reate_token_qr_request_sofort_for_user(
    ...
    token_qr_request_sofort: TokenQrRequestSofort = Body(None, description=""),
    ...
    if not BaseTokenQrRequestSofortApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrRequestSofortApi.subclasses[0]().c_reate_token_qr_request_sofort_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_request_sofort, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
