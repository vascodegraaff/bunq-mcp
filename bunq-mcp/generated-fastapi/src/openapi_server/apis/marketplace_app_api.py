...
from openapi_server.apis.marketplace_app_api_base import BaseMarketplaceAppApi
...
from openapi_server.models.marketplace_app_listing import MarketplaceAppListing
...
@router.get(
    "/user/{userID}/marketplace-app",
    responses={
        200: {"model": List[MarketplaceAppListing], "description": "Used for listing of all internal and external apps. apiApp:LISTING"},
...
async def list_all_marketplace_app_for_user(
    ...
    """Used for listing of all internal and external apps. apiApp:LISTING"""
    if not BaseMarketplaceAppApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMarketplaceAppApi.subclasses[0]().list_all_marketplace_app_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
