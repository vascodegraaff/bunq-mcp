...
from openapi_server.apis.auto_route_api_base import BaseAutoRouteApi
...
from openapi_server.models.savings_auto_route_routing_listing import SavingsAutoRouteRoutingListing
from openapi_server.models.savings_auto_route_routing_read import SavingsAutoRouteRoutingRead
from openapi_server.models.savings_auto_route_routing_user_listing import SavingsAutoRouteRoutingUserListing
...
@router.get(
    "/user/{userID}/auto-route",
    responses={
        200: {"model": List[SavingsAutoRouteRoutingUserListing], "description": "Endpoint to get user&#39;s auto routes for all of their monetary accounts. apiApp:LISTING"},
...
async def list_all_auto_route_for_user(
...
) -> List[SavingsAutoRouteRoutingUserListing]:
    """Endpoint to get user&#39;s auto routes for all of their monetary accounts. apiApp:LISTING"""
    if not BaseAutoRouteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAutoRouteApi.subclasses[0]().list_all_auto_route_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/auto-route",
    responses={
        200: {"model": List[SavingsAutoRouteRoutingListing], "description": "Endpoint for savings auto route routing to a specific monetary account. apiApp:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["auto-route"],
    summary="",
...
async def list_all_auto_route_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[SavingsAutoRouteRoutingListing]:
    """Endpoint for savings auto route routing to a specific monetary account. apiApp:READ/LISTING"""
    if not BaseAutoRouteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAutoRouteApi.subclasses[0]().list_all_auto_route_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/auto-route/{itemId}",
    responses={
        200: {"model": SavingsAutoRouteRoutingRead, "description": "Endpoint for savings auto route routing to a specific monetary account. apiApp:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["auto-route"],
    summary="",
...
async def r_ead_auto_route_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> SavingsAutoRouteRoutingRead:
    """Endpoint for savings auto route routing to a specific monetary account. apiApp:READ/LISTING"""
    if not BaseAutoRouteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAutoRouteApi.subclasses[0]().r_ead_auto_route_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
