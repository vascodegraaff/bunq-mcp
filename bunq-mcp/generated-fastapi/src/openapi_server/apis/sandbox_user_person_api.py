...
from openapi_server.apis.sandbox_user_person_api_base import BaseSandboxUserPersonApi
...
from openapi_server.models.sandbox_user_person_create import SandboxUserPersonCreate
...
@router.post(
    "/sandbox-user-person",
    responses={
        200: {"model": SandboxUserPersonCreate, "description": "Used to create a sandbox userPerson. apiPublic:CREATE"},
...
async def c_reate_sandbox_user_person(
    ...
    """Used to create a sandbox userPerson. apiPublic:CREATE"""
    if not BaseSandboxUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSandboxUserPersonApi.subclasses[0]().c_reate_sandbox_user_person(user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
