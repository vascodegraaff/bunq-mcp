...
from openapi_server.apis.challenge_request_app_api_base import BaseChallengeRequestAppApi
...
from openapi_server.models.master_card_identity_check_challenge_request_app import MasterCardIdentityCheckChallengeRequestApp
from openapi_server.models.master_card_identity_check_challenge_request_app_create import MasterCardIdentityCheckChallengeRequestAppCreate
...
@router.post(
    ...
    responses={
        200: {"model": MasterCardIdentityCheckChallengeRequestAppCreate, "description": "Endpoint for merchants to send a challenge request through the app. apiMasterCardIdentityCheck:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["challenge-request-app"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_challenge_request_app(
    ...
    master_card_identity_check_challenge_request_app: MasterCardIdentityCheckChallengeRequestApp = Body(None, description=""),
...
) -> MasterCardIdentityCheckChallengeRequestAppCreate:
    """Endpoint for merchants to send a challenge request through the app. apiMasterCardIdentityCheck:CREATE"""
    if not BaseChallengeRequestAppApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseChallengeRequestAppApi.subclasses[0]().c_reate_challenge_request_app(user_agent, x_bunq_client_authentication, master_card_identity_check_challenge_request_app, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
