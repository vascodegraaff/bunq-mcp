...
from openapi_server.apis.invite_user_preview_api_base import BaseInviteUserPreviewApi
...
from openapi_server.models.invite_user_preview import InviteUserPreview
from openapi_server.models.invite_user_preview_create import InviteUserPreviewCreate
...
@router.post(
    "/user/{userID}/invite-user-preview",
    responses={
        200: {"model": InviteUserPreviewCreate, "description": "Used for creating a message preview of the invite. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["invite-user-preview"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_invite_user_preview_for_user(
    ...
    invite_user_preview: InviteUserPreview = Body(None, description=""),
...
) -> InviteUserPreviewCreate:
    """Used for creating a message preview of the invite. apiApp:CREATE"""
    if not BaseInviteUserPreviewApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInviteUserPreviewApi.subclasses[0]().c_reate_invite_user_preview_for_user(userID, user_agent, x_bunq_client_authentication, invite_user_preview, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
