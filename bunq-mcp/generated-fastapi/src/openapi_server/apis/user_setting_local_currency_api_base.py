...
class BaseUserSettingLocalCurrencyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingLocalCurrencyApi.subclasses = BaseUserSettingLocalCurrencyApi.subclasses + (cls,)
    async def c_reate_user_setting_local_currency_for_user(
        ...
        user_setting_local_currency: UserSettingLocalCurrency,
