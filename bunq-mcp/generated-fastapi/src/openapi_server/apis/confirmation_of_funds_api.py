...
from openapi_server.apis.confirmation_of_funds_api_base import BaseConfirmationOfFundsApi
...
from openapi_server.models.confirmation_of_funds_create import ConfirmationOfFundsCreate
...
@router.post(
    ...
    responses={
        200: {"model": ConfirmationOfFundsCreate, "description": "Used to confirm availability of funds on an account. apiPublic:CREATE"},
...
async def c_reate_confirmation_of_funds_for_user(
    ...
    confirmation_of_funds: ConfirmationOfFunds = Body(None, description=""),
    ...
    """Used to confirm availability of funds on an account. apiPublic:CREATE"""
    if not BaseConfirmationOfFundsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseConfirmationOfFundsApi.subclasses[0]().c_reate_confirmation_of_funds_for_user(userID, user_agent, x_bunq_client_authentication, confirmation_of_funds, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
