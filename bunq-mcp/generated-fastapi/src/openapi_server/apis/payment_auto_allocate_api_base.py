...
class BasePaymentAutoAllocateApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePaymentAutoAllocateApi.subclasses = BasePaymentAutoAllocateApi.subclasses + (cls,)
    async def c_reate_payment_auto_allocate_for_user_monetary_account(
        ...
        payment_auto_allocate: PaymentAutoAllocate,
