...
class BaseCurrencyConversionQuoteApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCurrencyConversionQuoteApi.subclasses = BaseCurrencyConversionQuoteApi.subclasses + (cls,)
    async def c_reate_currency_conversion_quote_for_user_monetary_account(
        ...
        currency_conversion_quote: CurrencyConversionQuote,
