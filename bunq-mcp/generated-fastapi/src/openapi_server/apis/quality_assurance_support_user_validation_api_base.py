...
class BaseQualityAssuranceSupportUserValidationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQualityAssuranceSupportUserValidationApi.subclasses = BaseQualityAssuranceSupportUserValidationApi.subclasses + (cls,)
