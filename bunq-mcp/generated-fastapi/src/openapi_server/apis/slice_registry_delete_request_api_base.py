...
class BaseSliceRegistryDeleteRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSliceRegistryDeleteRequestApi.subclasses = BaseSliceRegistryDeleteRequestApi.subclasses + (cls,)
    async def c_reate_slice_registry_delete_request_for_user(
        ...
        slice_registry_delete_request: SliceRegistryDeleteRequest,
