...
from openapi_server.apis.quality_assurance_test_card_physical_api_base import BaseQualityAssuranceTestCardPhysicalApi
...
from openapi_server.models.quality_assurance_test_card_physical import QualityAssuranceTestCardPhysical
from openapi_server.models.quality_assurance_test_card_physical_create import QualityAssuranceTestCardPhysicalCreate
...
@router.post(
    "/user/{userID}/quality-assurance-test-card-physical",
    responses={
        200: {"model": QualityAssuranceTestCardPhysicalCreate, "description": "Create test cards, for Quality Assurance purposes. apiQualityAssurance:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["quality-assurance-test-card-physical"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_quality_assurance_test_card_physical_for_user(
    ...
    quality_assurance_test_card_physical: QualityAssuranceTestCardPhysical = Body(None, description=""),
...
) -> QualityAssuranceTestCardPhysicalCreate:
    """Create test cards, for Quality Assurance purposes. apiQualityAssurance:CREATE"""
    if not BaseQualityAssuranceTestCardPhysicalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQualityAssuranceTestCardPhysicalApi.subclasses[0]().c_reate_quality_assurance_test_card_physical_for_user(userID, user_agent, x_bunq_client_authentication, quality_assurance_test_card_physical, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
