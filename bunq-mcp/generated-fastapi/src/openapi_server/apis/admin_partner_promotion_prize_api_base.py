...
class BaseAdminPartnerPromotionPrizeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionPrizeApi.subclasses = BaseAdminPartnerPromotionPrizeApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_prize(
        ...
        admin_partner_promotion_prize: AdminPartnerPromotionPrize,
