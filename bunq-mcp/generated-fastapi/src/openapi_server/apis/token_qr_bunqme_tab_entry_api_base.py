...
class BaseTokenQrBunqmeTabEntryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrBunqmeTabEntryApi.subclasses = BaseTokenQrBunqmeTabEntryApi.subclasses + (cls,)
    async def c_reate_token_qr_bunqme_tab_entry_for_user(
        ...
        token_qr_bunq_me_tab_entry: TokenQrBunqMeTabEntry,
