...
from openapi_server.apis.registry_membership_setting_card_api_base import BaseRegistryMembershipSettingCardApi
...
from openapi_server.models.registry_membership_setting_card_listing import RegistryMembershipSettingCardListing
...
@router.get(
    ...
    responses={
        200: {"model": List[RegistryMembershipSettingCardListing], "description": "View to provide card connected registry. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["registry-membership-setting-card"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_registry_membership_setting_card_for_user(
...
) -> List[RegistryMembershipSettingCardListing]:
    """View to provide card connected registry. apiApp:LISTING"""
    if not BaseRegistryMembershipSettingCardApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRegistryMembershipSettingCardApi.subclasses[0]().list_all_registry_membership_setting_card_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
