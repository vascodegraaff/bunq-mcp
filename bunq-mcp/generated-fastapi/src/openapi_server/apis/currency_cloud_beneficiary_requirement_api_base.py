...
class BaseCurrencyCloudBeneficiaryRequirementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCurrencyCloudBeneficiaryRequirementApi.subclasses = BaseCurrencyCloudBeneficiaryRequirementApi.subclasses + (cls,)
