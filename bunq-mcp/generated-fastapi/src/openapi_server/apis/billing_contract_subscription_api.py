...
from openapi_server.apis.billing_contract_subscription_api_base import BaseBillingContractSubscriptionApi
...
from openapi_server.models.billing_contract_subscription_create import BillingContractSubscriptionCreate
from openapi_server.models.billing_contract_subscription_listing import BillingContractSubscriptionListing
from openapi_server.models.billing_contract_subscription_read import BillingContractSubscriptionRead
...
@router.post(
    ...
    responses={
        200: {"model": BillingContractSubscriptionCreate, "description": "Show the subscription billing contract for the authenticated user. apiAdmin:LISTING apiApp:CREATE/LISTING/READ apiPublic:LISTING apiServiceInternal:LISTING"},
...
async def c_reate_billing_contract_subscription_for_user(
    ...
    billing_contract_subscription: BillingContractSubscription = Body(None, description=""),
...
) -> BillingContractSubscriptionCreate:
    """Show the subscription billing contract for the authenticated user. apiAdmin:LISTING apiApp:CREATE/LISTING/READ apiPublic:LISTING apiServiceInternal:LISTING"""
    if not BaseBillingContractSubscriptionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBillingContractSubscriptionApi.subclasses[0]().c_reate_billing_contract_subscription_for_user(userID, user_agent, x_bunq_client_authentication, billing_contract_subscription, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/billing-contract-subscription",
    responses={
        200: {"model": List[BillingContractSubscriptionListing], "description": "Show the subscription billing contract for the authenticated user. apiAdmin:LISTING apiApp:CREATE/LISTING/READ apiPublic:LISTING apiServiceInternal:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["billing-contract-subscription"],
    summary="",
...
async def list_all_billing_contract_subscription_for_user(
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[BillingContractSubscriptionListing]:
    """Get all subscription billing contract for the authenticated user."""
    if not BaseBillingContractSubscriptionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBillingContractSubscriptionApi.subclasses[0]().list_all_billing_contract_subscription_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/billing-contract-subscription/{itemId}",
    responses={
        200: {"model": BillingContractSubscriptionRead, "description": "Show the subscription billing contract for the authenticated user. apiAdmin:LISTING apiApp:CREATE/LISTING/READ apiPublic:LISTING apiServiceInternal:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["billing-contract-subscription"],
    summary="",
...
async def r_ead_billing_contract_subscription_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> BillingContractSubscriptionRead:
    """Show the subscription billing contract for the authenticated user. apiAdmin:LISTING apiApp:CREATE/LISTING/READ apiPublic:LISTING apiServiceInternal:LISTING"""
    if not BaseBillingContractSubscriptionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBillingContractSubscriptionApi.subclasses[0]().r_ead_billing_contract_subscription_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
