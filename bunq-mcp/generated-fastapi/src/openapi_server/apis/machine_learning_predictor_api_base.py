...
class BaseMachineLearningPredictorApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMachineLearningPredictorApi.subclasses = BaseMachineLearningPredictorApi.subclasses + (cls,)
    async def c_reate_machine_learning_predictor(
        ...
        machine_learning_predictor: MachineLearningPredictor,
