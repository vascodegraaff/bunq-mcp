...
class BaseAdminRegistryRestoreApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminRegistryRestoreApi.subclasses = BaseAdminRegistryRestoreApi.subclasses + (cls,)
    async def c_reate_admin_registry_restore_for_user_registry(
        ...
        admin_registry_restore: AdminRegistryRestore,
