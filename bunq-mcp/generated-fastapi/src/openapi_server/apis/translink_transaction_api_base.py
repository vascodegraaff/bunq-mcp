...
class BaseTranslinkTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTranslinkTransactionApi.subclasses = BaseTranslinkTransactionApi.subclasses + (cls,)
    async def c_reate_translink_transaction_for_user_monetary_account(
        ...
        translink_transaction: TranslinkTransaction,
