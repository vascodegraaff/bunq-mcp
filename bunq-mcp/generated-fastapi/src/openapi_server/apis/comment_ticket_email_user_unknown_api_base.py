...
class BaseCommentTicketEmailUserUnknownApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCommentTicketEmailUserUnknownApi.subclasses = BaseCommentTicketEmailUserUnknownApi.subclasses + (cls,)
    async def c_reate_comment_ticket_email_user_unknown_for_ticket(
        ...
        admin_comment_email_without_alias: AdminCommentEmailWithoutAlias,
