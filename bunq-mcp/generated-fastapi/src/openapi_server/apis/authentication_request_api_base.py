...
class BaseAuthenticationRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAuthenticationRequestApi.subclasses = BaseAuthenticationRequestApi.subclasses + (cls,)
    async def c_reate_authentication_request(
        ...
        master_card_identity_check_authentication_request: MasterCardIdentityCheckAuthenticationRequest,
