...
class BaseAdminCompanyChamberOfCommerceActivityDescriptionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminCompanyChamberOfCommerceActivityDescriptionApi.subclasses = BaseAdminCompanyChamberOfCommerceActivityDescriptionApi.subclasses + (cls,)
    async def c_reate_admin_company_chamber_of_commerce_activity_description(
        ...
        admin_company_chamber_of_commerce_activity_description: AdminCompanyChamberOfCommerceActivityDescription,
