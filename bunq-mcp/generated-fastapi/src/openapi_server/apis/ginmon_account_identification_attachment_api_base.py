...
class BaseGinmonAccountIdentificationAttachmentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseGinmonAccountIdentificationAttachmentApi.subclasses = BaseGinmonAccountIdentificationAttachmentApi.subclasses + (cls,)
