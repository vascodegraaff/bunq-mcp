...
class BaseMixpanelUserSettingCommunicationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMixpanelUserSettingCommunicationApi.subclasses = BaseMixpanelUserSettingCommunicationApi.subclasses + (cls,)
    async def u_pdate_mixpanel_user_setting_communication(
        ...
        mixpanel_user_setting_communication: MixpanelUserSettingCommunication,
