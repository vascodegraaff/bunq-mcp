...
class BaseChallengeRequestBrowserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseChallengeRequestBrowserApi.subclasses = BaseChallengeRequestBrowserApi.subclasses + (cls,)
    async def c_reate_challenge_request_browser(
        ...
        master_card_identity_check_challenge_request_browser: MasterCardIdentityCheckChallengeRequestBrowser,
