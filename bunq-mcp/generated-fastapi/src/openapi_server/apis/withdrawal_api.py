...
from openapi_server.apis.withdrawal_api_base import BaseWithdrawalApi
...
from openapi_server.models.investment_withdrawal import InvestmentWithdrawal
from openapi_server.models.investment_withdrawal_create import InvestmentWithdrawalCreate
...
@router.post(
    "/user/{userID}/monetary-account-investment/{monetary-account-investmentID}/withdrawal",
    responses={
        200: {"model": InvestmentWithdrawalCreate, "description": "Withdrawals made from Investment accounts. apiApp:CREATE"},
...
async def c_reate_withdrawal_for_user_monetary_account_investment(
    ...
    investment_withdrawal: InvestmentWithdrawal = Body(None, description=""),
    ...
    """Withdrawals made from Investment accounts. apiApp:CREATE"""
    if not BaseWithdrawalApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWithdrawalApi.subclasses[0]().c_reate_withdrawal_for_user_monetary_account_investment(userID, monetary-account-investmentID, user_agent, x_bunq_client_authentication, investment_withdrawal, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
