...
class BaseAdminAdyenClearingMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAdyenClearingMerchantTransactionApi.subclasses = BaseAdminAdyenClearingMerchantTransactionApi.subclasses + (cls,)
    async def u_pdate_admin_adyen_clearing_merchant_transaction(
        ...
        admin_adyen_clearing_merchant_transaction: AdminAdyenClearingMerchantTransaction,
