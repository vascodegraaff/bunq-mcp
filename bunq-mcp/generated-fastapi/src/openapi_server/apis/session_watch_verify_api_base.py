...
class BaseSessionWatchVerifyApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionWatchVerifyApi.subclasses = BaseSessionWatchVerifyApi.subclasses + (cls,)
    async def c_reate_session_watch_verify(
        ...
        session_watch_authentication_token_user: SessionWatchAuthenticationTokenUser,
