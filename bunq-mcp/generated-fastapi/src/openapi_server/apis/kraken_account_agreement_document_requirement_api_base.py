...
class BaseKrakenAccountAgreementDocumentRequirementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseKrakenAccountAgreementDocumentRequirementApi.subclasses = BaseKrakenAccountAgreementDocumentRequirementApi.subclasses + (cls,)
