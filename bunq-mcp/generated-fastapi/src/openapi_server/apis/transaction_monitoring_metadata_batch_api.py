...
from openapi_server.apis.transaction_monitoring_metadata_batch_api_base import BaseTransactionMonitoringMetadataBatchApi
...
from openapi_server.models.transaction_monitoring_metadata_batch import TransactionMonitoringMetadataBatch
from openapi_server.models.transaction_monitoring_metadata_batch_create import TransactionMonitoringMetadataBatchCreate
...
@router.post(
    ...
    responses={
        200: {"model": TransactionMonitoringMetadataBatchCreate, "description": "Used to update transaction monitoring metadata instances in a batch. apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["transaction-monitoring-metadata-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_transaction_monitoring_metadata_batch(
    ...
    transaction_monitoring_metadata_batch: TransactionMonitoringMetadataBatch = Body(None, description=""),
...
) -> TransactionMonitoringMetadataBatchCreate:
    """Used to update transaction monitoring metadata instances in a batch. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseTransactionMonitoringMetadataBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransactionMonitoringMetadataBatchApi.subclasses[0]().c_reate_transaction_monitoring_metadata_batch(user_agent, x_bunq_client_authentication, transaction_monitoring_metadata_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
