...
from openapi_server.apis.vonage_call_incoming_action_api_base import BaseVonageCallIncomingActionApi
...
from openapi_server.models.vonage_call_incoming_action import VonageCallIncomingAction
from openapi_server.models.vonage_call_incoming_action_create import VonageCallIncomingActionCreate
...
@router.post(
    "/vonage-call-incoming-action",
    responses={
        200: {"model": VonageCallIncomingActionCreate, "description": "Process events/actions of the incoming calls from Vonage. apiVonage:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["vonage-call-incoming-action"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_vonage_call_incoming_action(
    ...
    vonage_call_incoming_action: VonageCallIncomingAction = Body(None, description=""),
...
) -> VonageCallIncomingActionCreate:
    """Process events/actions of the incoming calls from Vonage. apiVonage:CREATE"""
    if not BaseVonageCallIncomingActionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseVonageCallIncomingActionApi.subclasses[0]().c_reate_vonage_call_incoming_action(user_agent, x_bunq_client_authentication, vonage_call_incoming_action, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
