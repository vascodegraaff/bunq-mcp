...
class BaseAdminPaymentRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPaymentRequestApi.subclasses = BaseAdminPaymentRequestApi.subclasses + (cls,)
    async def c_reate_admin_payment_request(
        ...
        admin_payment_request: AdminPaymentRequest,
