...
class BaseAdminDocumentIdentificationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminDocumentIdentificationApi.subclasses = BaseAdminDocumentIdentificationApi.subclasses + (cls,)
    async def c_reate_admin_document_identification_for_user(
        ...
        admin_document_identification: AdminDocumentIdentification,
