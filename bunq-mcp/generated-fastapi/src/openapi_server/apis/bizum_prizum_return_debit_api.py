...
from openapi_server.apis.bizum_prizum_return_debit_api_base import BaseBizumPrizumReturnDebitApi
...
from openapi_server.models.bizum_prizum_return_debit_create import BizumPrizumReturnDebitCreate
...
@router.post(
    "/bizum-prizum-return-debit",
    responses={
        200: {"model": BizumPrizumReturnDebitCreate, "description": "Endpoint for receiving returns of Bizum Payment Requests via the Prizum protocol. apiBizum:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bizum-prizum-return-debit"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bizum_prizum_return_debit(
...
) -> BizumPrizumReturnDebitCreate:
    """Endpoint for receiving returns of Bizum Payment Requests via the Prizum protocol. apiBizum:CREATE"""
    if not BaseBizumPrizumReturnDebitApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBizumPrizumReturnDebitApi.subclasses[0]().c_reate_bizum_prizum_return_debit(user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
