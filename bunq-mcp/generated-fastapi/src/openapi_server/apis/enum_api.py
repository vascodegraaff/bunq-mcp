...
from openapi_server.apis.enum_api_base import BaseEnumApi
...
from openapi_server.models.enum_listing import EnumListing
...
@router.get(
    "/enum",
    responses={
        200: {"model": List[EnumListing], "description": "Get all enums. apiAdmin:LISTING apiServiceInternal:LISTING"},
...
async def list_all_enum(
    ...
    """Get all enums. apiAdmin:LISTING apiServiceInternal:LISTING"""
    if not BaseEnumApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseEnumApi.subclasses[0]().list_all_enum(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
