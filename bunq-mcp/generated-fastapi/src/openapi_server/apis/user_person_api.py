...
from openapi_server.apis.user_person_api_base import BaseUserPersonApi
...
from openapi_server.models.user_person import UserPerson
from openapi_server.models.user_person_create import UserPersonCreate
from openapi_server.models.user_person_read import UserPersonRead
from openapi_server.models.user_person_update import UserPersonUpdate
...
@router.post(
    "/user-person",
    responses={
        200: {"model": UserPersonCreate, "description": "With UserPerson you can retrieve information regarding the authenticated UserPerson and update specific fields.&lt;br/&gt;&lt;br/&gt;Notification filters can be set on a UserPerson level to receive callbacks. For more information check the &lt;a href&#x3D;\&quot;/api/1/page/callbacks\&quot;&gt;dedicated callbacks page&lt;/a&gt;. apiAdmin:READ/UPDATE apiApp:CREATE/READ/UPDATE apiPublic:READ/UPDATE apiServiceInternal:READ/UPDATE apiDeveloperPortal:CREATE/READ/UPDATE"},
...
async def c_reate_user_person(
    ...
    user_person: UserPerson = Body(None, description=""),
    ...
    """With UserPerson you can retrieve information regarding the authenticated UserPerson and update specific fields.&lt;br/&gt;&lt;br/&gt;Notification filters can be set on a UserPerson level to receive callbacks. For more information check the &lt;a href&#x3D;\&quot;/api/1/page/callbacks\&quot;&gt;dedicated callbacks page&lt;/a&gt;. apiAdmin:READ/UPDATE apiApp:CREATE/READ/UPDATE apiPublic:READ/UPDATE apiServiceInternal:READ/UPDATE apiDeveloperPortal:CREATE/READ/UPDATE"""
    if not BaseUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserPersonApi.subclasses[0]().c_reate_user_person(user_agent, x_bunq_client_authentication, user_person, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user-person/{itemId}",
    responses={
        200: {"model": UserPersonRead, "description": "With UserPerson you can retrieve information regarding the authenticated UserPerson and update specific fields.&lt;br/&gt;&lt;br/&gt;Notification filters can be set on a UserPerson level to receive callbacks. For more information check the &lt;a href&#x3D;\&quot;/api/1/page/callbacks\&quot;&gt;dedicated callbacks page&lt;/a&gt;. apiAdmin:READ/UPDATE apiApp:CREATE/READ/UPDATE apiPublic:READ/UPDATE apiServiceInternal:READ/UPDATE apiDeveloperPortal:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-person"],
    summary="",
...
async def r_ead_user_person(
    ...
    if not BaseUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserPersonApi.subclasses[0]().r_ead_user_person(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user-person/{itemId}",
    responses={
        200: {"model": UserPersonUpdate, "description": "With UserPerson you can retrieve information regarding the authenticated UserPerson and update specific fields.&lt;br/&gt;&lt;br/&gt;Notification filters can be set on a UserPerson level to receive callbacks. For more information check the &lt;a href&#x3D;\&quot;/api/1/page/callbacks\&quot;&gt;dedicated callbacks page&lt;/a&gt;. apiAdmin:READ/UPDATE apiApp:CREATE/READ/UPDATE apiPublic:READ/UPDATE apiServiceInternal:READ/UPDATE apiDeveloperPortal:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user-person"],
    summary="",
...
async def u_pdate_user_person(
    ...
    if not BaseUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseUserPersonApi.subclasses[0]().u_pdate_user_person(itemId, user_agent, x_bunq_client_authentication, user_person, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
