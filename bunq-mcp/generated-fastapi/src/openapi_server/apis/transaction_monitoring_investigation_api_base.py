...
class BaseTransactionMonitoringInvestigationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransactionMonitoringInvestigationApi.subclasses = BaseTransactionMonitoringInvestigationApi.subclasses + (cls,)
    async def c_reate_transaction_monitoring_investigation(
        ...
        transaction_monitoring_investigation: TransactionMonitoringInvestigation,
