...
class BaseAdminUserPartnerPromotionCashbackApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminUserPartnerPromotionCashbackApi.subclasses = BaseAdminUserPartnerPromotionCashbackApi.subclasses + (cls,)
    async def c_reate_admin_user_partner_promotion_cashback_for_user(
        ...
        admin_user_partner_promotion_cashback: AdminUserPartnerPromotionCashback,
