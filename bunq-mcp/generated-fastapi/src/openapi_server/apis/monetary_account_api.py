...
from openapi_server.apis.monetary_account_api_base import BaseMonetaryAccountApi
...
from openapi_server.models.ideal_issuer_profile_monetary_account import IdealIssuerProfileMonetaryAccount
from openapi_server.models.ideal_issuer_profile_monetary_account_create import IdealIssuerProfileMonetaryAccountCreate
from openapi_server.models.monetary_account_listing import MonetaryAccountListing
from openapi_server.models.monetary_account_read import MonetaryAccountRead
...
@router.post(
    "/user/{userID}/ideal-issuer-profile/{ideal-issuer-profileID}/monetary-account",
    responses={
        200: {"model": IdealIssuerProfileMonetaryAccountCreate, "description": "The endpoint to manage monetary accounts linked to the iDEAL issuer profile of a user. apiApp:CREATE"},
...
async def c_reate_monetary_account_for_user_ideal_issuer_profile(
    userID: StrictInt = Path(..., description=""),
    ideal-issuer-profileID: StrictInt = Path(..., description=""),
    ...
    ideal_issuer_profile_monetary_account: IdealIssuerProfileMonetaryAccount = Body(None, description=""),
...
) -> IdealIssuerProfileMonetaryAccountCreate:
    """The endpoint to manage monetary accounts linked to the iDEAL issuer profile of a user. apiApp:CREATE"""
    if not BaseMonetaryAccountApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMonetaryAccountApi.subclasses[0]().c_reate_monetary_account_for_user_ideal_issuer_profile(userID, ideal-issuer-profileID, user_agent, x_bunq_client_authentication, ideal_issuer_profile_monetary_account, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account",
    responses={
        200: {"model": List[MonetaryAccountListing], "description": "Used to show the MonetaryAccounts that you can access. Currently the only MonetaryAccount type is MonetaryAccountBank. See also: monetary-account-bank.&lt;br/&gt;&lt;br/&gt;Notification filters can be set on a monetary account level to receive callbacks. For more information check the &lt;a href&#x3D;\&quot;/api/2/page/callbacks\&quot;&gt;dedicated callbacks page&lt;/a&gt;. apiAdmin:READ/LISTING apiApp:READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiTranslink:READ/LISTING apiQualityAssurance:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["monetary-account"],
    summary="",
...
async def list_all_monetary_account_for_user(
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[MonetaryAccountListing]:
    """Get a collection of all your MonetaryAccounts."""
    if not BaseMonetaryAccountApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMonetaryAccountApi.subclasses[0]().list_all_monetary_account_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{itemId}",
    responses={
        200: {"model": MonetaryAccountRead, "description": "Used to show the MonetaryAccounts that you can access. Currently the only MonetaryAccount type is MonetaryAccountBank. See also: monetary-account-bank.&lt;br/&gt;&lt;br/&gt;Notification filters can be set on a monetary account level to receive callbacks. For more information check the &lt;a href&#x3D;\&quot;/api/2/page/callbacks\&quot;&gt;dedicated callbacks page&lt;/a&gt;. apiAdmin:READ/LISTING apiApp:READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiTranslink:READ/LISTING apiQualityAssurance:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["monetary-account"],
    summary="",
...
async def r_ead_monetary_account_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseMonetaryAccountApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMonetaryAccountApi.subclasses[0]().r_ead_monetary_account_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
