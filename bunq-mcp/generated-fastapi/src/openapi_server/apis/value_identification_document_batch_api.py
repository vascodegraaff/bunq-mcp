...
from openapi_server.apis.value_identification_document_batch_api_base import BaseValueIdentificationDocumentBatchApi
...
from openapi_server.models.user_review_value_identification_document_batch import UserReviewValueIdentificationDocumentBatch
from openapi_server.models.user_review_value_identification_document_batch_create import UserReviewValueIdentificationDocumentBatchCreate
...
@router.post(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-identification-document-batch",
    responses={
        200: {"model": UserReviewValueIdentificationDocumentBatchCreate, "description": "Used to create multiple identification document review values at once. apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["value-identification-document-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_value_identification_document_batch_for_user_review_check(
    ...
    user_review_value_identification_document_batch: UserReviewValueIdentificationDocumentBatch = Body(None, description=""),
...
) -> UserReviewValueIdentificationDocumentBatchCreate:
    """Used to create multiple identification document review values at once. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseValueIdentificationDocumentBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueIdentificationDocumentBatchApi.subclasses[0]().c_reate_value_identification_document_batch_for_user_review_check(userID, reviewID, checkID, user_agent, x_bunq_client_authentication, user_review_value_identification_document_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
