...
class BaseAdminPointAwardRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPointAwardRequestApi.subclasses = BaseAdminPointAwardRequestApi.subclasses + (cls,)
    async def c_reate_admin_point_award_request_for_user(
        ...
        admin_point_award_request: AdminPointAwardRequest,
