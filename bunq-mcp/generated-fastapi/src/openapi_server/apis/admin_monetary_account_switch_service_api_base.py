...
class BaseAdminMonetaryAccountSwitchServiceApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminMonetaryAccountSwitchServiceApi.subclasses = BaseAdminMonetaryAccountSwitchServiceApi.subclasses + (cls,)
