...
class BaseAdyenCardTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdyenCardTransactionApi.subclasses = BaseAdyenCardTransactionApi.subclasses + (cls,)
    async def c_reate_adyen_card_transaction_for_user_monetary_account_adyen_store(
        self,
        userID: StrictInt,
        monetary-accountID: StrictInt,
        adyen-storeID: StrictInt,
        ...
        adyen_card_transaction: AdyenCardTransaction,
