...
from openapi_server.apis.payment_request_api_base import BasePaymentRequestApi
...
from openapi_server.models.translink_payment_request import TranslinkPaymentRequest
from openapi_server.models.translink_payment_request_create import TranslinkPaymentRequestCreate
...
@router.post(
    "/payment-request",
    responses={
        200: {"model": TranslinkPaymentRequestCreate, "description": "Used to retrieve translink payment requests at check-out. apiTranslink:CREATE"},
...
async def c_reate_payment_request(
    ...
    translink_payment_request: TranslinkPaymentRequest = Body(None, description=""),
...
) -> TranslinkPaymentRequestCreate:
    """Used to retrieve translink payment requests at check-out. apiTranslink:CREATE"""
    if not BasePaymentRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePaymentRequestApi.subclasses[0]().c_reate_payment_request(user_agent, x_bunq_client_authentication, translink_payment_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
