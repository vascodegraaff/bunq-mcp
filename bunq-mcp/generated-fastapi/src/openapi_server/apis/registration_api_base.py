...
class BaseRegistrationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseRegistrationApi.subclasses = BaseRegistrationApi.subclasses + (cls,)
    async def c_reate_registration_for_invite_profile_public(
        self,
        invite-profile-publicUUID: StrictStr,
        ...
        invite_profile_public_registration: InviteProfilePublicRegistration,
