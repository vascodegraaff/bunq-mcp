...
class BaseAdminPermissionEndpointGroupApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPermissionEndpointGroupApi.subclasses = BaseAdminPermissionEndpointGroupApi.subclasses + (cls,)
    async def c_reate_admin_permission_endpoint_group_for_user_admin_group(
        self,
        userID: StrictInt,
        admin-groupID: StrictInt,
        ...
        admin_permission_endpoint_group: AdminPermissionEndpointGroup,
