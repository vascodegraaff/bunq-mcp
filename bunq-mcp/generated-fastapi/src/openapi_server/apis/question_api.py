...
from openapi_server.apis.question_api_base import BaseQuestionApi
...
from openapi_server.models.assistant_message_question import AssistantMessageQuestion
from openapi_server.models.assistant_message_question_create import AssistantMessageQuestionCreate
from openapi_server.models.assistant_message_question_listing import AssistantMessageQuestionListing
from openapi_server.models.assistant_message_question_read import AssistantMessageQuestionRead
...
@router.post(
    "/user/{userID}/assistant/{assistantID}/conversation/{conversationID}/question",
    responses={
        200: {"model": AssistantMessageQuestionCreate, "description": "Endpoint to ask questions to your personal assistant within a conversation. apiAdmin:CREATE/READ/LISTING apiApp:CREATE/READ/LISTING"},
...
async def c_reate_question_for_user_assistant_conversation(
    ...
    assistant_message_question: AssistantMessageQuestion = Body(None, description=""),
...
) -> AssistantMessageQuestionCreate:
    """Endpoint to ask questions to your personal assistant within a conversation. apiAdmin:CREATE/READ/LISTING apiApp:CREATE/READ/LISTING"""
    if not BaseQuestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQuestionApi.subclasses[0]().c_reate_question_for_user_assistant_conversation(userID, assistantID, conversationID, user_agent, x_bunq_client_authentication, assistant_message_question, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/assistant/{assistantID}/conversation/{conversationID}/question",
    responses={
        200: {"model": List[AssistantMessageQuestionListing], "description": "Endpoint to ask questions to your personal assistant within a conversation. apiAdmin:CREATE/READ/LISTING apiApp:CREATE/READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["question"],
    summary="",
...
async def list_all_question_for_user_assistant_conversation(
    userID: StrictInt = Path(..., description=""),
    assistantID: StrictInt = Path(..., description=""),
    conversationID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[AssistantMessageQuestionListing]:
    """Endpoint to ask questions to your personal assistant within a conversation. apiAdmin:CREATE/READ/LISTING apiApp:CREATE/READ/LISTING"""
    if not BaseQuestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQuestionApi.subclasses[0]().list_all_question_for_user_assistant_conversation(userID, assistantID, conversationID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/assistant/{assistantID}/conversation/{conversationID}/question/{itemId}",
    responses={
        200: {"model": AssistantMessageQuestionRead, "description": "Endpoint to ask questions to your personal assistant within a conversation. apiAdmin:CREATE/READ/LISTING apiApp:CREATE/READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["question"],
    summary="",
...
async def r_ead_question_for_user_assistant_conversation(
    userID: StrictInt = Path(..., description=""),
    assistantID: StrictInt = Path(..., description=""),
    conversationID: StrictInt = Path(..., description=""),
    ...
    if not BaseQuestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQuestionApi.subclasses[0]().r_ead_question_for_user_assistant_conversation(userID, assistantID, conversationID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
