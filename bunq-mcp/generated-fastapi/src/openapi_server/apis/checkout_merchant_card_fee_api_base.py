...
class BaseCheckoutMerchantCardFeeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCheckoutMerchantCardFeeApi.subclasses = BaseCheckoutMerchantCardFeeApi.subclasses + (cls,)
    async def c_reate_checkout_merchant_card_fee_for_user(
        ...
        checkout_merchant_card_fee: CheckoutMerchantCardFee,
