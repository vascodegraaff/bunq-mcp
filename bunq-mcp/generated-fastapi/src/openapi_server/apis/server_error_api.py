...
from openapi_server.apis.server_error_api_base import BaseServerErrorApi
...
from openapi_server.models.server_error_create import ServerErrorCreate
...
@router.post(
    "/server-error",
    responses={
        200: {"model": ServerErrorCreate, "description": "An endpoint that will always throw an error. apiAdmin:CREATE apiApp:CREATE apiPublic:CREATE apiServiceInternal:CREATE apiQualityAssurance:CREATE"},
...
async def c_reate_server_error(
    ...
    """An endpoint that will always throw an error. apiAdmin:CREATE apiApp:CREATE apiPublic:CREATE apiServiceInternal:CREATE apiQualityAssurance:CREATE"""
    if not BaseServerErrorApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseServerErrorApi.subclasses[0]().c_reate_server_error(user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
