...
from openapi_server.apis.identification_verification_report_api_base import BaseIdentificationVerificationReportApi
...
from openapi_server.models.user_identification_verification_report_read import UserIdentificationVerificationReportRead
...
@router.get(
    "/user/{userID}/identification-verification/{identification-verificationID}/identification-verification-report/{itemId}",
    responses={
        200: {"model": UserIdentificationVerificationReportRead, "description": "Endpoint for creating Identification Verification checks at Onfido. apiAdmin:READ apiServiceInternal:READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["identification-verification-report"],
    summary="",
    response_model_by_alias=True,
)
async def r_ead_identification_verification_report_for_user_identification_verification(
    ...
    """Endpoint for creating Identification Verification checks at Onfido. apiAdmin:READ apiServiceInternal:READ"""
    if not BaseIdentificationVerificationReportApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIdentificationVerificationReportApi.subclasses[0]().r_ead_identification_verification_report_for_user_identification_verification(userID, identification-verificationID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
