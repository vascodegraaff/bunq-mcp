...
from openapi_server.apis.wheel_of_fortune_prize_result_api_base import BaseWheelOfFortunePrizeResultApi
...
@router.get(
    "/user/{userID}/wheel-of-fortune-prize-result",
    responses={
        200: {"model": List[WheelOfFortunePrizeResultListing], "description": "Endpoint to view Wheel of Fortune prize result in current Wheel of Fortune round. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["wheel-of-fortune-prize-result"],
    summary="",
...
async def list_all_wheel_of_fortune_prize_result_for_user(
    ...
    if not BaseWheelOfFortunePrizeResultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWheelOfFortunePrizeResultApi.subclasses[0]().list_all_wheel_of_fortune_prize_result_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
