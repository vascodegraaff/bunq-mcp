...
class BaseSessionServerAdminRetoolUserSwitchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionServerAdminRetoolUserSwitchApi.subclasses = BaseSessionServerAdminRetoolUserSwitchApi.subclasses + (cls,)
    async def c_reate_session_server_admin_retool_user_switch(
        ...
        session_server_admin_retool_user_switch: SessionServerAdminRetoolUserSwitch,
