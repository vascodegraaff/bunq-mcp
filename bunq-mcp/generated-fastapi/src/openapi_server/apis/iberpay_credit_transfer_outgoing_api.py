...
from openapi_server.apis.iberpay_credit_transfer_outgoing_api_base import BaseIberpayCreditTransferOutgoingApi
...
@router.get(
    "/iberpay-credit-transfer-outgoing/{itemId}",
    responses={
    ...
    tags=["iberpay-credit-transfer-outgoing"],
    summary="",
    response_model_by_alias=True,
)
async def r_ead_iberpay_credit_transfer_outgoing(
    ...
    if not BaseIberpayCreditTransferOutgoingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIberpayCreditTransferOutgoingApi.subclasses[0]().r_ead_iberpay_credit_transfer_outgoing(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
