...
from openapi_server.apis.ip_lookup_api_base import BaseIpLookupApi
...
from openapi_server.models.ip_lookup import IpLookup
from openapi_server.models.ip_lookup_create import IpLookupCreate
...
@router.post(
    "/ip-lookup",
    responses={
        200: {"model": IpLookupCreate, "description": "Look up information by IP. apiBunqMe:CREATE apiBunqTo:CREATE apiApp:CREATE"},
...
async def c_reateip_lookup(
    ...
    ip_lookup: IpLookup = Body(None, description=""),
    ...
    """Look up information by IP. apiBunqMe:CREATE apiBunqTo:CREATE apiApp:CREATE"""
    if not BaseIpLookupApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIpLookupApi.subclasses[0]().c_reateip_lookup(user_agent, x_bunq_client_authentication, ip_lookup, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
