...
class BaseSessionPhoneTokenApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionPhoneTokenApi.subclasses = BaseSessionPhoneTokenApi.subclasses + (cls,)
    async def c_reate_session_phone_token(
        ...
        session_phone_login_token: SessionPhoneLoginToken,
