...
class BaseFinancialSituationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseFinancialSituationApi.subclasses = BaseFinancialSituationApi.subclasses + (cls,)
    async def c_reate_financial_situation_for_user_birdee_customer(
        ...
        birdee_customer_financial_situation: BirdeeCustomerFinancialSituation,
