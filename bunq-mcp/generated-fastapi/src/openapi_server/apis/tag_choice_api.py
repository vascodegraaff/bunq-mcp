...
from openapi_server.apis.tag_choice_api_base import BaseTagChoiceApi
...
from openapi_server.models.tag_choice import TagChoice
from openapi_server.models.tag_choice_create import TagChoiceCreate
from openapi_server.models.tag_choice_read import TagChoiceRead
from openapi_server.models.tag_choice_update import TagChoiceUpdate
...
@router.post(
    "/tag-choice",
    responses={
        200: {"model": TagChoiceCreate, "description": "Endpoint for changing tag choices. apiAdmin:READ/CREATE/UPDATE apiServiceInternal:READ/CREATE/UPDATE"},
...
async def c_reate_tag_choice(
    ...
    tag_choice: TagChoice = Body(None, description=""),
    ...
    """Endpoint for changing tag choices. apiAdmin:READ/CREATE/UPDATE apiServiceInternal:READ/CREATE/UPDATE"""
    if not BaseTagChoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTagChoiceApi.subclasses[0]().c_reate_tag_choice(user_agent, x_bunq_client_authentication, tag_choice, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/tag-choice/{itemId}",
    responses={
        200: {"model": TagChoiceRead, "description": "Endpoint for changing tag choices. apiAdmin:READ/CREATE/UPDATE apiServiceInternal:READ/CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["tag-choice"],
    summary="",
...
async def r_ead_tag_choice(
    ...
    if not BaseTagChoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTagChoiceApi.subclasses[0]().r_ead_tag_choice(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/tag-choice/{itemId}",
    responses={
        200: {"model": TagChoiceUpdate, "description": "Endpoint for changing tag choices. apiAdmin:READ/CREATE/UPDATE apiServiceInternal:READ/CREATE/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["tag-choice"],
    summary="",
...
async def u_pdate_tag_choice(
    ...
    if not BaseTagChoiceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTagChoiceApi.subclasses[0]().u_pdate_tag_choice(itemId, user_agent, x_bunq_client_authentication, tag_choice, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
