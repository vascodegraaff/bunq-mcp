...
class BaseSupportAnnouncementTextApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSupportAnnouncementTextApi.subclasses = BaseSupportAnnouncementTextApi.subclasses + (cls,)
    async def c_reate_support_announcement_text(
        ...
        support_announcement_text: SupportAnnouncementText,
