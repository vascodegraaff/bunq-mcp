...
class BaseSofortMerchantTransactionPollApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSofortMerchantTransactionPollApi.subclasses = BaseSofortMerchantTransactionPollApi.subclasses + (cls,)
    async def c_reate_sofort_merchant_transaction_poll(
        ...
        sofort_merchant_transaction_poll: SofortMerchantTransactionPoll,
