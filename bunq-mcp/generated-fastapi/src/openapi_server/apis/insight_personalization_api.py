...
from openapi_server.apis.insight_personalization_api_base import BaseInsightPersonalizationApi
...
from openapi_server.models.insight_personalization import InsightPersonalization
from openapi_server.models.insight_personalization_create import InsightPersonalizationCreate
...
@router.post(
    "/user/{userID}/event/{eventID}/insight-personalization",
    responses={
        200: {"model": InsightPersonalizationCreate, "description": "Used to allow users to personalize categories for their transactions. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["insight-personalization"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_insight_personalization_for_user_event(
    ...
    insight_personalization: InsightPersonalization = Body(None, description=""),
...
) -> InsightPersonalizationCreate:
    """Used to allow users to personalize categories for their transactions. apiApp:CREATE"""
    if not BaseInsightPersonalizationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInsightPersonalizationApi.subclasses[0]().c_reate_insight_personalization_for_user_event(userID, eventID, user_agent, x_bunq_client_authentication, insight_personalization, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
