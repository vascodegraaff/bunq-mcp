...
class BaseProprietaryInformationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseProprietaryInformationApi.subclasses = BaseProprietaryInformationApi.subclasses + (cls,)
    async def c_reate_proprietary_information(
        ...
        master_card_identity_check_proprietary_information: MasterCardIdentityCheckProprietaryInformation,
