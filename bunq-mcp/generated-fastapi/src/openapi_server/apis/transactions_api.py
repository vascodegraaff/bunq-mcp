...
from openapi_server.apis.transactions_api_base import BaseTransactionsApi
...
from openapi_server.models.ideal_issuer_provider_transaction_read import IdealIssuerProviderTransactionRead
...
@router.get(
    "/transactions/{itemId}",
    responses={
        200: {"model": IdealIssuerProviderTransactionRead, "description": "Endpoint used by iDEAL Access Point to fetch information about an iDEAL issuer transaction. apiIdealIssuerProvider:READ"},
...
) -> IdealIssuerProviderTransactionRead:
    """Endpoint used by iDEAL Access Point to fetch information about an iDEAL issuer transaction. apiIdealIssuerProvider:READ"""
    if not BaseTransactionsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransactionsApi.subclasses[0]().r_ead_transactions(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
