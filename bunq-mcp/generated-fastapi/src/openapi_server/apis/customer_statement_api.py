...
from openapi_server.apis.customer_statement_api_base import BaseCustomerStatementApi
...
from openapi_server.models.export_statement import ExportStatement
from openapi_server.models.export_statement_create import ExportStatementCreate
from openapi_server.models.export_statement_listing import ExportStatementListing
from openapi_server.models.export_statement_read import ExportStatementRead
...
@router.post(
    ...
    responses={
        200: {"model": ExportStatementCreate, "description": "Used to create new and read existing statement exports. Statement exports can be created in either CSV, MT940 or PDF file format. apiAdmin:CREATE/READ/LISTING/DELETE apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE apiServiceInternal:CREATE/READ/LISTING/DELETE apiRetool:CREATE/READ/LISTING/DELETE"},
...
async def c_reate_customer_statement_for_user_monetary_account(
    ...
    export_statement: ExportStatement = Body(None, description=""),
    ...
    """Used to create new and read existing statement exports. Statement exports can be created in either CSV, MT940 or PDF file format. apiAdmin:CREATE/READ/LISTING/DELETE apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE apiServiceInternal:CREATE/READ/LISTING/DELETE apiRetool:CREATE/READ/LISTING/DELETE"""
    if not BaseCustomerStatementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomerStatementApi.subclasses[0]().c_reate_customer_statement_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, export_statement, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/monetary-account/{monetary-accountID}/customer-statement/{itemId}",
    responses={
        200: {"model": object, "description": "Used to create new and read existing statement exports. Statement exports can be created in either CSV, MT940 or PDF file format. apiAdmin:CREATE/READ/LISTING/DELETE apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE apiServiceInternal:CREATE/READ/LISTING/DELETE apiRetool:CREATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["customer-statement"],
    summary="",
...
async def d_elete_customer_statement_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseCustomerStatementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomerStatementApi.subclasses[0]().d_elete_customer_statement_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/customer-statement",
    responses={
        200: {"model": List[ExportStatementListing], "description": "Used to create new and read existing statement exports. Statement exports can be created in either CSV, MT940 or PDF file format. apiAdmin:CREATE/READ/LISTING/DELETE apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE apiServiceInternal:CREATE/READ/LISTING/DELETE apiRetool:CREATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["customer-statement"],
    summary="",
...
async def list_all_customer_statement_for_user_monetary_account(
    ...
    if not BaseCustomerStatementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomerStatementApi.subclasses[0]().list_all_customer_statement_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/customer-statement/{itemId}",
    responses={
        200: {"model": ExportStatementRead, "description": "Used to create new and read existing statement exports. Statement exports can be created in either CSV, MT940 or PDF file format. apiAdmin:CREATE/READ/LISTING/DELETE apiApp:CREATE/READ/LISTING/DELETE apiPublic:CREATE/READ/LISTING/DELETE apiServiceInternal:CREATE/READ/LISTING/DELETE apiRetool:CREATE/READ/LISTING/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["customer-statement"],
    summary="",
...
async def r_ead_customer_statement_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseCustomerStatementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCustomerStatementApi.subclasses[0]().r_ead_customer_statement_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
