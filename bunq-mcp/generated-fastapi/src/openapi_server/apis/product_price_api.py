...
from openapi_server.apis.product_price_api_base import BaseProductPriceApi
...
from openapi_server.models.billing_product_price import BillingProductPrice
from openapi_server.models.billing_product_price_create import BillingProductPriceCreate
...
@router.post(
    "/user/{userID}/product-price",
    responses={
        200: {"model": BillingProductPriceCreate, "description": "Used to view the price of billing products. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_product_price_for_user(
    ...
    billing_product_price: BillingProductPrice = Body(None, description=""),
...
) -> BillingProductPriceCreate:
    """Used to view the price of billing products. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseProductPriceApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseProductPriceApi.subclasses[0]().c_reate_product_price_for_user(userID, user_agent, x_bunq_client_authentication, billing_product_price, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
