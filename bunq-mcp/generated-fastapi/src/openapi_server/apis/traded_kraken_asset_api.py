...
from openapi_server.apis.traded_kraken_asset_api_base import BaseTradedKrakenAssetApi
...
from openapi_server.models.user_traded_kraken_asset_listing import UserTradedKrakenAssetListing
...
@router.get(
    "/user/{userID}/traded-kraken-asset",
    responses={
        200: {"model": List[UserTradedKrakenAssetListing], "description": "Get the crypto trades me and my friends have made recently. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["traded-kraken-asset"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_traded_kraken_asset_for_user(
...
) -> List[UserTradedKrakenAssetListing]:
    """Get the crypto trades me and my friends have made recently. apiApp:LISTING"""
    if not BaseTradedKrakenAssetApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTradedKrakenAssetApi.subclasses[0]().list_all_traded_kraken_asset_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
