...
class BaseBlocklistMastercardMerchantApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBlocklistMastercardMerchantApi.subclasses = BaseBlocklistMastercardMerchantApi.subclasses + (cls,)
    async def c_reate_blocklist_mastercard_merchant_for_user(
        ...
        user_blocklist_master_card_merchant: UserBlocklistMasterCardMerchant,
