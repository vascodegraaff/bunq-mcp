...
from openapi_server.apis.token_qr_bunqme_fundraiser_profile_entry_api_base import BaseTokenQrBunqmeFundraiserProfileEntryApi
...
from openapi_server.models.token_qr_bunq_me_fundraiser_profile_entry import TokenQrBunqMeFundraiserProfileEntry
from openapi_server.models.token_qr_bunq_me_fundraiser_profile_entry_create import TokenQrBunqMeFundraiserProfileEntryCreate
...
@router.post(
    "/user/{userID}/token-qr-bunqme-fundraiser-profile-entry",
    responses={
        200: {"model": TokenQrBunqMeFundraiserProfileEntryCreate, "description": "Usage of this endpoint (by scanning a QR code) results in a bunq.me fundraiser profile. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-bunqme-fundraiser-profile-entry"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_bunqme_fundraiser_profile_entry_for_user(
    ...
    token_qr_bunq_me_fundraiser_profile_entry: TokenQrBunqMeFundraiserProfileEntry = Body(None, description=""),
...
) -> TokenQrBunqMeFundraiserProfileEntryCreate:
    """Usage of this endpoint (by scanning a QR code) results in a bunq.me fundraiser profile. apiApp:CREATE"""
    if not BaseTokenQrBunqmeFundraiserProfileEntryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrBunqmeFundraiserProfileEntryApi.subclasses[0]().c_reate_token_qr_bunqme_fundraiser_profile_entry_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_bunq_me_fundraiser_profile_entry, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
