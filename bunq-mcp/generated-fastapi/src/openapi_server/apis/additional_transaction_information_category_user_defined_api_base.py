...
class BaseAdditionalTransactionInformationCategoryUserDefinedApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdditionalTransactionInformationCategoryUserDefinedApi.subclasses = BaseAdditionalTransactionInformationCategoryUserDefinedApi.subclasses + (cls,)
    async def c_reate_additional_transaction_information_category_user_defined_for_user(
        ...
        additional_transaction_information_category_user_defined: AdditionalTransactionInformationCategoryUserDefined,
