...
from openapi_server.apis.sandbox_user_company_api_base import BaseSandboxUserCompanyApi
...
from openapi_server.models.sandbox_user_company_create import SandboxUserCompanyCreate
...
@router.post(
    ...
    responses={
        200: {"model": SandboxUserCompanyCreate, "description": "Used to create a sandbox userCompany. apiPublic:CREATE"},
...
async def c_reate_sandbox_user_company(
    ...
    """Used to create a sandbox userCompany. apiPublic:CREATE"""
    if not BaseSandboxUserCompanyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSandboxUserCompanyApi.subclasses[0]().c_reate_sandbox_user_company(user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
