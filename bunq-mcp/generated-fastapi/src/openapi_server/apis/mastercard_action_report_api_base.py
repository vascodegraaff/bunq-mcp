...
class BaseMastercardActionReportApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMastercardActionReportApi.subclasses = BaseMastercardActionReportApi.subclasses + (cls,)
    async def c_reate_mastercard_action_report_for_user(
        ...
        master_card_action_report: MasterCardActionReport,
