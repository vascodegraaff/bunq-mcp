...
from openapi_server.apis.child_api_base import BaseChildApi
...
from openapi_server.models.child_create import ChildCreate
...
@router.post(
    "/user/{userID}/child",
    responses={
        200: {"model": ChildCreate, "description": " apiApp:CREATE"},
...
async def c_reate_child_for_user(
    ...
    child: Child = Body(None, description=""),
    ...
    """ apiApp:CREATE"""
    if not BaseChildApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseChildApi.subclasses[0]().c_reate_child_for_user(userID, user_agent, x_bunq_client_authentication, child, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
