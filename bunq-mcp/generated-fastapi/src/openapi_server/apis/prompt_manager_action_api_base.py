...
class BasePromptManagerActionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePromptManagerActionApi.subclasses = BasePromptManagerActionApi.subclasses + (cls,)
    async def c_reate_prompt_manager_action_for_user(
        ...
        prompt_manager_action: PromptManagerAction,
