...
class BasePaysafecashTransactionWebhookApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePaysafecashTransactionWebhookApi.subclasses = BasePaysafecashTransactionWebhookApi.subclasses + (cls,)
    async def c_reate_paysafecash_transaction_webhook(
        ...
        paysafecash_transaction_confirmation: PaysafecashTransactionConfirmation,
