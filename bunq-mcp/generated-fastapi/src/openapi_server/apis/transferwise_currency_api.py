...
from openapi_server.apis.transferwise_currency_api_base import BaseTransferwiseCurrencyApi
...
from openapi_server.models.transferwise_currency_listing import TransferwiseCurrencyListing
...
@router.get(
    ...
    responses={
        200: {"model": List[TransferwiseCurrencyListing], "description": "Used to get a list of supported currencies for Transferwise. apiApp:LISTING apiPublic:LISTING"},
...
) -> List[TransferwiseCurrencyListing]:
    """Used to get a list of supported currencies for Transferwise. apiApp:LISTING apiPublic:LISTING"""
    if not BaseTransferwiseCurrencyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTransferwiseCurrencyApi.subclasses[0]().list_all_transferwise_currency_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
