...
class BaseTokenConfirmationLoginApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenConfirmationLoginApi.subclasses = BaseTokenConfirmationLoginApi.subclasses + (cls,)
    async def c_reate_token_confirmation_login(
        ...
        token_confirmation_login: TokenConfirmationLogin,
