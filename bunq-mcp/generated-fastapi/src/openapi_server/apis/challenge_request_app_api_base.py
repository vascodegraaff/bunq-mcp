...
class BaseChallengeRequestAppApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseChallengeRequestAppApi.subclasses = BaseChallengeRequestAppApi.subclasses + (cls,)
    async def c_reate_challenge_request_app(
        ...
        master_card_identity_check_challenge_request_app: MasterCardIdentityCheckChallengeRequestApp,
