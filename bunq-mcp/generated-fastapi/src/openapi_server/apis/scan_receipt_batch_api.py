...
from openapi_server.apis.scan_receipt_batch_api_base import BaseScanReceiptBatchApi
...
from openapi_server.models.scan_receipt_batch import ScanReceiptBatch
from openapi_server.models.scan_receipt_batch_create import ScanReceiptBatchCreate
...
@router.post(
    "/user/{userID}/scan-receipt-batch",
    responses={
        200: {"model": ScanReceiptBatchCreate, "description": "The endpoint to handle scan receipt attachments and link to a payment of the user if a transaction is found. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["scan-receipt-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_scan_receipt_batch_for_user(
    ...
    scan_receipt_batch: ScanReceiptBatch = Body(None, description=""),
...
) -> ScanReceiptBatchCreate:
    """The endpoint to handle scan receipt attachments and link to a payment of the user if a transaction is found. apiApp:CREATE"""
    if not BaseScanReceiptBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseScanReceiptBatchApi.subclasses[0]().c_reate_scan_receipt_batch_for_user(userID, user_agent, x_bunq_client_authentication, scan_receipt_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
