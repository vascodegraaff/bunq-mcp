...
from openapi_server.apis.quality_assurance_test_user_company_api_base import BaseQualityAssuranceTestUserCompanyApi
...
from openapi_server.models.quality_assurance_test_user_company import QualityAssuranceTestUserCompany
from openapi_server.models.quality_assurance_test_user_company_create import QualityAssuranceTestUserCompanyCreate
...
@router.post(
    "/quality-assurance-test-user-company",
    responses={
        200: {"model": QualityAssuranceTestUserCompanyCreate, "description": "Create test users, for Quality Assurance purposes. apiQualityAssurance:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["quality-assurance-test-user-company"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_quality_assurance_test_user_company(
    ...
    quality_assurance_test_user_company: QualityAssuranceTestUserCompany = Body(None, description=""),
...
) -> QualityAssuranceTestUserCompanyCreate:
    """Create test users, for Quality Assurance purposes. apiQualityAssurance:CREATE"""
    if not BaseQualityAssuranceTestUserCompanyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQualityAssuranceTestUserCompanyApi.subclasses[0]().c_reate_quality_assurance_test_user_company(user_agent, x_bunq_client_authentication, quality_assurance_test_user_company, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
