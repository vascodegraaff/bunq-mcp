...
class BaseBillingContractSubscriptionAvailableApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBillingContractSubscriptionAvailableApi.subclasses = BaseBillingContractSubscriptionAvailableApi.subclasses + (cls,)
