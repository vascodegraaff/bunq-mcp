...
from openapi_server.apis.feature_announcement_api_base import BaseFeatureAnnouncementApi
...
from openapi_server.models.feature_announcement_read import FeatureAnnouncementRead
...
@router.get(
    ...
    responses={
        200: {"model": FeatureAnnouncementRead, "description": "view for updating the feature display. apiAdmin:READ apiApp:READ apiPublic:READ apiServiceInternal:READ"},
...
async def r_ead_feature_announcement_for_user(
    ...
    """view for updating the feature display. apiAdmin:READ apiApp:READ apiPublic:READ apiServiceInternal:READ"""
    if not BaseFeatureAnnouncementApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFeatureAnnouncementApi.subclasses[0]().r_ead_feature_announcement_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
