...
class BaseCompanyDirectorMigrationRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCompanyDirectorMigrationRequestApi.subclasses = BaseCompanyDirectorMigrationRequestApi.subclasses + (cls,)
    async def c_reate_company_director_migration_request_for_user(
        ...
        company_director_migration_request: CompanyDirectorMigrationRequest,
