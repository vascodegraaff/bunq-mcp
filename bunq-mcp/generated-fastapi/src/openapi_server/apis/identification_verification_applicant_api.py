...
from openapi_server.apis.identification_verification_applicant_api_base import BaseIdentificationVerificationApplicantApi
...
from openapi_server.models.user_identification_verification_applicant import UserIdentificationVerificationApplicant
from openapi_server.models.user_identification_verification_applicant_create import UserIdentificationVerificationApplicantCreate
...
@router.post(
    "/user/{userID}/identification-verification-applicant",
    responses={
        200: {"model": UserIdentificationVerificationApplicantCreate, "description": "Endpoint for creating a new applicant required for the Onfido SDK V3. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["identification-verification-applicant"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_identification_verification_applicant_for_user(
    ...
    user_identification_verification_applicant: UserIdentificationVerificationApplicant = Body(None, description=""),
...
) -> UserIdentificationVerificationApplicantCreate:
    """Endpoint for creating a new applicant required for the Onfido SDK V3. apiApp:CREATE"""
    if not BaseIdentificationVerificationApplicantApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIdentificationVerificationApplicantApi.subclasses[0]().c_reate_identification_verification_applicant_for_user(userID, user_agent, x_bunq_client_authentication, user_identification_verification_applicant, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
