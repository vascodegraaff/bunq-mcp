...
class BaseIdentificationVerificationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseIdentificationVerificationApi.subclasses = BaseIdentificationVerificationApi.subclasses + (cls,)
    async def c_reate_identification_verification_for_user(
        ...
        user_identification_verification: UserIdentificationVerification,
