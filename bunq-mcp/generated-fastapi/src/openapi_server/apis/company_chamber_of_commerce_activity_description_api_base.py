...
class BaseCompanyChamberOfCommerceActivityDescriptionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCompanyChamberOfCommerceActivityDescriptionApi.subclasses = BaseCompanyChamberOfCommerceActivityDescriptionApi.subclasses + (cls,)
