...
class BaseExportStatementCardPdfApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseExportStatementCardPdfApi.subclasses = BaseExportStatementCardPdfApi.subclasses + (cls,)
    async def c_reate_export_statement_card_pdf_for_user_card(
        ...
        export_statement_card_pdf: ExportStatementCardPdf,
