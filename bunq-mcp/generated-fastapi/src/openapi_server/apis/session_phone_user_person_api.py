...
from openapi_server.apis.session_phone_user_person_api_base import BaseSessionPhoneUserPersonApi
...
from openapi_server.models.session_phone_user_person import SessionPhoneUserPerson
from openapi_server.models.session_phone_user_person_create import SessionPhoneUserPersonCreate
...
@router.post(
    "/session-phone-user-person",
    responses={
        200: {"model": SessionPhoneUserPersonCreate, "description": "Used to log in a new user with a phone. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["session-phone-user-person"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_session_phone_user_person(
    ...
    session_phone_user_person: SessionPhoneUserPerson = Body(None, description=""),
...
) -> SessionPhoneUserPersonCreate:
    """Used to log in a new user with a phone. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseSessionPhoneUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionPhoneUserPersonApi.subclasses[0]().c_reate_session_phone_user_person(user_agent, x_bunq_client_authentication, session_phone_user_person, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
