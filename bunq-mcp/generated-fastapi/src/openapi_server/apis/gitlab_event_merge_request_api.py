...
from openapi_server.apis.gitlab_event_merge_request_api_base import BaseGitlabEventMergeRequestApi
...
from openapi_server.models.gitlab_event_merge_request import GitlabEventMergeRequest
from openapi_server.models.gitlab_event_merge_request_create import GitlabEventMergeRequestCreate
...
@router.post(
    ...
    responses={
        200: {"model": GitlabEventMergeRequestCreate, "description": "This endpoint is used to hand internal developer Merge Request Events. apiGitLab:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["gitlab-event-merge-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_gitlab_event_merge_request(
    ...
    gitlab_event_merge_request: GitlabEventMergeRequest = Body(None, description=""),
...
) -> GitlabEventMergeRequestCreate:
    """This endpoint is used to hand internal developer Merge Request Events. apiGitLab:CREATE"""
    if not BaseGitlabEventMergeRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGitlabEventMergeRequestApi.subclasses[0]().c_reate_gitlab_event_merge_request(user_agent, x_bunq_client_authentication, gitlab_event_merge_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
