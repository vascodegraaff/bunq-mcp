...
from openapi_server.apis.bunqme_merchant_request_checkout_session_identifier_api_base import BaseBunqmeMerchantRequestCheckoutSessionIdentifierApi
...
from openapi_server.models.bunq_me_merchant_request_checkout_session_identifier import BunqMeMerchantRequestCheckoutSessionIdentifier
from openapi_server.models.bunq_me_merchant_request_checkout_session_identifier_create import BunqMeMerchantRequestCheckoutSessionIdentifierCreate
...
@router.post(
    ...
    responses={
        200: {"model": BunqMeMerchantRequestCheckoutSessionIdentifierCreate, "description": "View to pass a session identifier code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request-checkout-session-identifier"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bunqme_merchant_request_checkout_session_identifier(
    ...
    bunq_me_merchant_request_checkout_session_identifier: BunqMeMerchantRequestCheckoutSessionIdentifier = Body(None, description=""),
...
) -> BunqMeMerchantRequestCheckoutSessionIdentifierCreate:
    """View to pass a session identifier code, in which case the associated transaction status will be polled nearly immediately. apiBunqMe:CREATE"""
    if not BaseBunqmeMerchantRequestCheckoutSessionIdentifierApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestCheckoutSessionIdentifierApi.subclasses[0]().c_reate_bunqme_merchant_request_checkout_session_identifier(user_agent, x_bunq_client_authentication, bunq_me_merchant_request_checkout_session_identifier, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
