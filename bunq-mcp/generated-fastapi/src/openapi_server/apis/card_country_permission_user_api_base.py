...
class BaseCardCountryPermissionUserApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCardCountryPermissionUserApi.subclasses = BaseCardCountryPermissionUserApi.subclasses + (cls,)
    async def c_reate_card_country_permission_user_for_user(
        ...
        card_country_permission_user: CardCountryPermissionUser,
