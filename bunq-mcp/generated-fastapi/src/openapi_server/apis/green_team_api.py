...
from openapi_server.apis.green_team_api_base import BaseGreenTeamApi
...
from openapi_server.models.green_team_listing import GreenTeamListing
...
@router.get(
    "/user/{userID}/green-team",
    responses={
        200: {"model": List[GreenTeamListing], "description": "Retrieve the Green Team membership information of a user. apiApp:LISTING"},
...
async def list_all_green_team_for_user(
...
) -> List[GreenTeamListing]:
    """Retrieve the Green Team membership information of a user. apiApp:LISTING"""
    if not BaseGreenTeamApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseGreenTeamApi.subclasses[0]().list_all_green_team_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
