...
class BaseUserPartnerPromotionPrizeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserPartnerPromotionPrizeApi.subclasses = BaseUserPartnerPromotionPrizeApi.subclasses + (cls,)
    async def c_reate_user_partner_promotion_prize_for_user(
        ...
        user_partner_promotion_prize: UserPartnerPromotionPrize,
