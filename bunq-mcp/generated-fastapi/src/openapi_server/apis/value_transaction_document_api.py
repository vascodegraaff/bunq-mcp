...
from openapi_server.apis.value_transaction_document_api_base import BaseValueTransactionDocumentApi
...
from openapi_server.models.user_review_value_transaction_document import UserReviewValueTransactionDocument
from openapi_server.models.user_review_value_transaction_document_update import UserReviewValueTransactionDocumentUpdate
...
@router.put(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-transaction-document/{itemId}",
    responses={
        200: {"model": UserReviewValueTransactionDocumentUpdate, "description": "Endpoint for updating UserReviewValueTransactionDocument. apiApp:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["value-transaction-document"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_value_transaction_document_for_user_review_check(
    ...
    user_review_value_transaction_document: UserReviewValueTransactionDocument = Body(None, description=""),
...
) -> UserReviewValueTransactionDocumentUpdate:
    """Endpoint for updating UserReviewValueTransactionDocument. apiApp:UPDATE"""
    if not BaseValueTransactionDocumentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueTransactionDocumentApi.subclasses[0]().u_pdate_value_transaction_document_for_user_review_check(userID, reviewID, checkID, itemId, user_agent, x_bunq_client_authentication, user_review_value_transaction_document, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
