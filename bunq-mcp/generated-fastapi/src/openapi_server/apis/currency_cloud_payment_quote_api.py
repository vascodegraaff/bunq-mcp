...
from openapi_server.apis.currency_cloud_payment_quote_api_base import BaseCurrencyCloudPaymentQuoteApi
...
from openapi_server.models.currency_cloud_payment_quote import CurrencyCloudPaymentQuote
from openapi_server.models.currency_cloud_payment_quote_create import CurrencyCloudPaymentQuoteCreate
...
@router.post(
    ...
    responses={
        200: {"model": CurrencyCloudPaymentQuoteCreate, "description": "Endpoint for managing currency conversions. apiApp:CREATE apiPublic:CREATE"},
...
async def c_reate_currency_cloud_payment_quote_for_user_monetary_account(
    ...
    currency_cloud_payment_quote: CurrencyCloudPaymentQuote = Body(None, description=""),
    ...
    """Endpoint for managing currency conversions. apiApp:CREATE apiPublic:CREATE"""
    if not BaseCurrencyCloudPaymentQuoteApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCurrencyCloudPaymentQuoteApi.subclasses[0]().c_reate_currency_cloud_payment_quote_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, currency_cloud_payment_quote, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
