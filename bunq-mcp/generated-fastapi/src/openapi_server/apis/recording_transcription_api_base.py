...
class BaseRecordingTranscriptionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseRecordingTranscriptionApi.subclasses = BaseRecordingTranscriptionApi.subclasses + (cls,)
    async def c_reate_recording_transcription_for_vonage_call_incoming(
        ...
        vonage_call_incoming_recording_transcription: VonageCallIncomingRecordingTranscription,
