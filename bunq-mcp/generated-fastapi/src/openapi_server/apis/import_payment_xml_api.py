...
from openapi_server.apis.import_payment_xml_api_base import BaseImportPaymentXmlApi
...
from openapi_server.models.import_payment_xml import ImportPaymentXml
from openapi_server.models.import_payment_xml_create import ImportPaymentXmlCreate
...
@router.post(
    "/user/{userID}/import-payment-xml",
    responses={
        200: {"model": ImportPaymentXmlCreate, "description": "This endpoint fetches payment details from XML PAIN files. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["import-payment-xml"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_import_payment_xml_for_user(
    ...
    import_payment_xml: ImportPaymentXml = Body(None, description=""),
...
) -> ImportPaymentXmlCreate:
    """This endpoint fetches payment details from XML PAIN files. apiApp:CREATE"""
    if not BaseImportPaymentXmlApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseImportPaymentXmlApi.subclasses[0]().c_reate_import_payment_xml_for_user(userID, user_agent, x_bunq_client_authentication, import_payment_xml, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
