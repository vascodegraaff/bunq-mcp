...
class BaseChargebackApi:
    ...
    async def c_reate_chargeback_for_mastercard_action_mastercard_mastercom_claim(
        ...
        master_card_mastercom_chargeback: MasterCardMastercomChargeback,
