...
class BaseInstantPaymentCreditTransferOutgoingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInstantPaymentCreditTransferOutgoingApi.subclasses = BaseInstantPaymentCreditTransferOutgoingApi.subclasses + (cls,)
