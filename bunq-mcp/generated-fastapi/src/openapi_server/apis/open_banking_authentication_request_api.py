...
from openapi_server.apis.open_banking_authentication_request_api_base import BaseOpenBankingAuthenticationRequestApi
...
from openapi_server.models.open_banking_authentication_request import OpenBankingAuthenticationRequest
from openapi_server.models.open_banking_authentication_request_create import OpenBankingAuthenticationRequestCreate
from openapi_server.models.open_banking_authentication_request_read import OpenBankingAuthenticationRequestRead
...
@router.post(
    "/user/{userID}/open-banking-authentication-request",
    responses={
        200: {"model": OpenBankingAuthenticationRequestCreate, "description": "Create Open Banking Aiia authentication request. apiApp:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["open-banking-authentication-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_open_banking_authentication_request_for_user(
    ...
    open_banking_authentication_request: OpenBankingAuthenticationRequest = Body(None, description=""),
...
) -> OpenBankingAuthenticationRequestCreate:
    """Create Open Banking Aiia authentication request. apiApp:CREATE/READ"""
    if not BaseOpenBankingAuthenticationRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOpenBankingAuthenticationRequestApi.subclasses[0]().c_reate_open_banking_authentication_request_for_user(userID, user_agent, x_bunq_client_authentication, open_banking_authentication_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/open-banking-authentication-request/{itemId}",
    responses={
        200: {"model": OpenBankingAuthenticationRequestRead, "description": "Create Open Banking Aiia authentication request. apiApp:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["open-banking-authentication-request"],
    summary="",
...
async def r_ead_open_banking_authentication_request_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseOpenBankingAuthenticationRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseOpenBankingAuthenticationRequestApi.subclasses[0]().r_ead_open_banking_authentication_request_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
