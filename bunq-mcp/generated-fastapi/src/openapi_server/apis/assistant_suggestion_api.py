...
from openapi_server.apis.assistant_suggestion_api_base import BaseAssistantSuggestionApi
...
from openapi_server.models.assistant_suggestion import AssistantSuggestion
from openapi_server.models.assistant_suggestion_create import AssistantSuggestionCreate
...
@router.post(
    "/user/{userID}/assistant/{assistantID}/assistant-suggestion",
    responses={
        200: {"model": AssistantSuggestionCreate, "description": "Endpoint for assistant suggestions. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["assistant-suggestion"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_assistant_suggestion_for_user_assistant(
    ...
    assistant_suggestion: AssistantSuggestion = Body(None, description=""),
...
) -> AssistantSuggestionCreate:
    """Endpoint for assistant suggestions. apiApp:CREATE"""
    if not BaseAssistantSuggestionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantSuggestionApi.subclasses[0]().c_reate_assistant_suggestion_for_user_assistant(userID, assistantID, user_agent, x_bunq_client_authentication, assistant_suggestion, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
