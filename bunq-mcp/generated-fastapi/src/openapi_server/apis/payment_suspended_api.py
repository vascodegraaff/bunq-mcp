...
from openapi_server.apis.payment_suspended_api_base import BasePaymentSuspendedApi
...
@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/payment-suspended/{itemId}",
    responses={
        200: {"model": object, "description": "Suspended payments. apiAdmin:READ apiApp:READ"},
...
async def r_ead_payment_suspended_for_user_monetary_account(
    ...
    """Suspended payments. apiAdmin:READ apiApp:READ"""
    if not BasePaymentSuspendedApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePaymentSuspendedApi.subclasses[0]().r_ead_payment_suspended_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
