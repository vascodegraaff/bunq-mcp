...
class BaseQuestionnaireAnswerBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQuestionnaireAnswerBatchApi.subclasses = BaseQuestionnaireAnswerBatchApi.subclasses + (cls,)
    async def c_reate_questionnaire_answer_batch_for_user_birdee_customer(
        ...
        birdee_customer_questionnaire_answer_batch: BirdeeCustomerQuestionnaireAnswerBatch,
