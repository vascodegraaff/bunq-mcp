...
class BaseAdminAdyenSettlementApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAdyenSettlementApi.subclasses = BaseAdminAdyenSettlementApi.subclasses + (cls,)
    async def u_pdate_admin_adyen_settlement(
        ...
        admin_adyen_settlement: AdminAdyenSettlement,
