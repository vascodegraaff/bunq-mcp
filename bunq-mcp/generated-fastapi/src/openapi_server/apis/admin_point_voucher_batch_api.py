...
from openapi_server.apis.admin_point_voucher_batch_api_base import BaseAdminPointVoucherBatchApi
...
from openapi_server.models.admin_point_voucher_batch import AdminPointVoucherBatch
from openapi_server.models.admin_point_voucher_batch_create import AdminPointVoucherBatchCreate
...
@router.post(
    "/admin-point-voucher-batch",
    responses={
        200: {"model": AdminPointVoucherBatchCreate, "description": "Endpoint to create batch of vouchers. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-point-voucher-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_point_voucher_batch(
    ...
    admin_point_voucher_batch: AdminPointVoucherBatch = Body(None, description=""),
...
) -> AdminPointVoucherBatchCreate:
    """Endpoint to create batch of vouchers. apiAdmin:CREATE"""
    if not BaseAdminPointVoucherBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPointVoucherBatchApi.subclasses[0]().c_reate_admin_point_voucher_batch(user_agent, x_bunq_client_authentication, admin_point_voucher_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
