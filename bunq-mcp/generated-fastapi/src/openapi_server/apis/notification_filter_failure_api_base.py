...
class BaseNotificationFilterFailureApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseNotificationFilterFailureApi.subclasses = BaseNotificationFilterFailureApi.subclasses + (cls,)
    async def c_reate_notification_filter_failure_for_user(
        ...
        notification_filter_failure: NotificationFilterFailure,
