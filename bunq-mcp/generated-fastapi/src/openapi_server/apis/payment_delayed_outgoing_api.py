...
from openapi_server.apis.payment_delayed_outgoing_api_base import BasePaymentDelayedOutgoingApi
...
from openapi_server.models.payment_delayed_outgoing import PaymentDelayedOutgoing
from openapi_server.models.payment_delayed_outgoing_update import PaymentDelayedOutgoingUpdate
...
@router.put(
    "/user/{userID}/monetary-account/{monetary-accountID}/payment-delayed-outgoing/{itemId}",
    responses={
        200: {"model": PaymentDelayedOutgoingUpdate, "description": "Payments that are not processed yet. apiAdmin:UPDATE apiApp:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["payment-delayed-outgoing"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_payment_delayed_outgoing_for_user_monetary_account(
    ...
    payment_delayed_outgoing: PaymentDelayedOutgoing = Body(None, description=""),
...
) -> PaymentDelayedOutgoingUpdate:
    """Payments that are not processed yet. apiAdmin:UPDATE apiApp:UPDATE"""
    if not BasePaymentDelayedOutgoingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePaymentDelayedOutgoingApi.subclasses[0]().u_pdate_payment_delayed_outgoing_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, payment_delayed_outgoing, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
