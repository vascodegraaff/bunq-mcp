...
from openapi_server.apis.quality_assurance_test_user_person_api_base import BaseQualityAssuranceTestUserPersonApi
...
from openapi_server.models.quality_assurance_test_user_person import QualityAssuranceTestUserPerson
from openapi_server.models.quality_assurance_test_user_person_create import QualityAssuranceTestUserPersonCreate
...
@router.post(
    ...
    responses={
        200: {"model": QualityAssuranceTestUserPersonCreate, "description": "Create test users, for Quality Assurance purposes. apiQualityAssurance:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["quality-assurance-test-user-person"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_quality_assurance_test_user_person(
    ...
    quality_assurance_test_user_person: QualityAssuranceTestUserPerson = Body(None, description=""),
...
) -> QualityAssuranceTestUserPersonCreate:
    """Create test users, for Quality Assurance purposes. apiQualityAssurance:CREATE"""
    if not BaseQualityAssuranceTestUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQualityAssuranceTestUserPersonApi.subclasses[0]().c_reate_quality_assurance_test_user_person(user_agent, x_bunq_client_authentication, quality_assurance_test_user_person, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
