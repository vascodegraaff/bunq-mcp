...
from openapi_server.apis.assignment_api_base import BaseAssignmentApi
...
from openapi_server.models.user_review_assignment import UserReviewAssignment
from openapi_server.models.user_review_assignment_create import UserReviewAssignmentCreate
...
@router.post(
    "/user/{userID}/review/{reviewID}/assignment",
    responses={
        200: {"model": UserReviewAssignmentCreate, "description": "Endpoint for assigning all pending checks in a user review to a user. apiAdmin:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_assignment_for_user_review(
    ...
    user_review_assignment: UserReviewAssignment = Body(None, description=""),
...
) -> UserReviewAssignmentCreate:
    """Endpoint for assigning all pending checks in a user review to a user. apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseAssignmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssignmentApi.subclasses[0]().c_reate_assignment_for_user_review(userID, reviewID, user_agent, x_bunq_client_authentication, user_review_assignment, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
