...
from openapi_server.apis.session_registry_request_api_base import BaseSessionRegistryRequestApi
...
from openapi_server.models.session_registry_request import SessionRegistryRequest
from openapi_server.models.session_registry_request_create import SessionRegistryRequestCreate
...
@router.post(
    ...
    responses={
        200: {"model": SessionRegistryRequestCreate, "description": "Used to request a confirmation link to be used to login Registry access. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["session-registry-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_session_registry_request(
    ...
    session_registry_request: SessionRegistryRequest = Body(None, description=""),
...
) -> SessionRegistryRequestCreate:
    """Used to request a confirmation link to be used to login Registry access. apiApp:CREATE"""
    if not BaseSessionRegistryRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionRegistryRequestApi.subclasses[0]().c_reate_session_registry_request(user_agent, x_bunq_client_authentication, session_registry_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
