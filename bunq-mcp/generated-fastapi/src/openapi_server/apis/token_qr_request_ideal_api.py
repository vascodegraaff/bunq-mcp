...
from openapi_server.apis.token_qr_request_ideal_api_base import BaseTokenQrRequestIdealApi
...
from openapi_server.models.token_qr_request_ideal import TokenQrRequestIdeal
from openapi_server.models.token_qr_request_ideal_create import TokenQrRequestIdealCreate
...
@router.post(
    ...
    responses={
        200: {"model": TokenQrRequestIdealCreate, "description": "Using this call you create a request for payment from an external token provided with an ideal transaction. Make sure your iDEAL payments are compliant with the iDEAL standards, by following the following manual: https:/www.bunq.com/terms-idealstandards. It&#39;s very important to keep these points in mind when you are using the endpoint to make iDEAL payments from your application. apiApp:CREATE apiPublic:CREATE"},
...
async def c_reate_token_qr_request_ideal_for_user(
    ...
    token_qr_request_ideal: TokenQrRequestIdeal = Body(None, description=""),
    ...
    if not BaseTokenQrRequestIdealApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrRequestIdealApi.subclasses[0]().c_reate_token_qr_request_ideal_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_request_ideal, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
