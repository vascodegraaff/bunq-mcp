...
class BaseMonetaryAccountLightApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMonetaryAccountLightApi.subclasses = BaseMonetaryAccountLightApi.subclasses + (cls,)
    async def c_reate_monetary_account_light_for_user(
        ...
        monetary_account_light: MonetaryAccountLight,
