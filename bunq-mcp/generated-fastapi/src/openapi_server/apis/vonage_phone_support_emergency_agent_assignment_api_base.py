...
class BaseVonagePhoneSupportEmergencyAgentAssignmentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseVonagePhoneSupportEmergencyAgentAssignmentApi.subclasses = BaseVonagePhoneSupportEmergencyAgentAssignmentApi.subclasses + (cls,)
