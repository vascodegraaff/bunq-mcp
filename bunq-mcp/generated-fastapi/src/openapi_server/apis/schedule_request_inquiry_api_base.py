...
class BaseScheduleRequestInquiryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseScheduleRequestInquiryApi.subclasses = BaseScheduleRequestInquiryApi.subclasses + (cls,)
    async def c_reate_schedule_request_inquiry_for_user_monetary_account(
        ...
        schedule_request_inquiry: ScheduleRequestInquiry,
