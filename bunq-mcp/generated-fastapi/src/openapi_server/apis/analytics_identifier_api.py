...
from openapi_server.apis.analytics_identifier_api_base import BaseAnalyticsIdentifierApi
...
from openapi_server.models.analytics_identifier import AnalyticsIdentifier
from openapi_server.models.analytics_identifier_create import AnalyticsIdentifierCreate
...
@router.post(
    "/user/{userID}/device/{deviceID}/analytics-identifier",
    responses={
        200: {"model": AnalyticsIdentifierCreate, "description": "Endpoint to manage analytics identifiers. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["analytics-identifier"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_analytics_identifier_for_user_device(
    ...
    analytics_identifier: AnalyticsIdentifier = Body(None, description=""),
...
) -> AnalyticsIdentifierCreate:
    """Endpoint to manage analytics identifiers. apiApp:CREATE"""
    if not BaseAnalyticsIdentifierApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAnalyticsIdentifierApi.subclasses[0]().c_reate_analytics_identifier_for_user_device(userID, deviceID, user_agent, x_bunq_client_authentication, analytics_identifier, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
