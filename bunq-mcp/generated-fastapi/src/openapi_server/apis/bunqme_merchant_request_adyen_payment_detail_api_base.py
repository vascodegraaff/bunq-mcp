...
class BaseBunqmeMerchantRequestAdyenPaymentDetailApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBunqmeMerchantRequestAdyenPaymentDetailApi.subclasses = BaseBunqmeMerchantRequestAdyenPaymentDetailApi.subclasses + (cls,)
    async def u_pdate_bunqme_merchant_request_adyen_payment_detail(
        ...
        bunq_me_merchant_request_adyen_payment_detail: BunqMeMerchantRequestAdyenPaymentDetail,
