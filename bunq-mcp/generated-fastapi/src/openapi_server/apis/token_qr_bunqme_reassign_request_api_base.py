...
class BaseTokenQrBunqmeReassignRequestApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTokenQrBunqmeReassignRequestApi.subclasses = BaseTokenQrBunqmeReassignRequestApi.subclasses + (cls,)
    async def c_reate_token_qr_bunqme_reassign_request_for_user(
        ...
        token_qr_bunq_me_reassign_request: TokenQrBunqMeReassignRequest,
