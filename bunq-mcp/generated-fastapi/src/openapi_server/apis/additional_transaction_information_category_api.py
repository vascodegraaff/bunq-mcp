...
from openapi_server.apis.additional_transaction_information_category_api_base import BaseAdditionalTransactionInformationCategoryApi
...
from openapi_server.models.additional_transaction_information_category_listing import AdditionalTransactionInformationCategoryListing
...
@router.get(
    ...
    responses={
        200: {"model": List[AdditionalTransactionInformationCategoryListing], "description": "Get the available categories. apiApp:LISTING apiPublic:LISTING"},
...
async def list_all_additional_transaction_information_category_for_user(
...
) -> List[AdditionalTransactionInformationCategoryListing]:
    """Get the available categories. apiApp:LISTING apiPublic:LISTING"""
    if not BaseAdditionalTransactionInformationCategoryApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdditionalTransactionInformationCategoryApi.subclasses[0]().list_all_additional_transaction_information_category_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
