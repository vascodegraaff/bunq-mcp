...
class BaseQualityAssurancePaymentIncomingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQualityAssurancePaymentIncomingApi.subclasses = BaseQualityAssurancePaymentIncomingApi.subclasses + (cls,)
    async def c_reate_quality_assurance_payment_incoming(
        ...
        quality_assurance_payment_incoming: QualityAssurancePaymentIncoming,
