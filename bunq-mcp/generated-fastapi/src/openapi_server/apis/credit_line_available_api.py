...
from openapi_server.apis.credit_line_available_api_base import BaseCreditLineAvailableApi
...
from openapi_server.models.credit_line_available_listing import CreditLineAvailableListing
...
@router.get(
    "/user/{userID}/credit-line-available",
    responses={
        200: {"model": List[CreditLineAvailableListing], "description": "To determine whether CreditLine is available for you and your companies. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["credit-line-available"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_credit_line_available_for_user(
...
) -> List[CreditLineAvailableListing]:
    """To determine whether CreditLine is available for you and your companies. apiApp:LISTING"""
    if not BaseCreditLineAvailableApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCreditLineAvailableApi.subclasses[0]().list_all_credit_line_available_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
