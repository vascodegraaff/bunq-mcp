...
class BaseAdminMonetaryAccountExternalSavingsApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminMonetaryAccountExternalSavingsApi.subclasses = BaseAdminMonetaryAccountExternalSavingsApi.subclasses + (cls,)
