...
class BaseAdyenCheckoutMerchantFeeApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdyenCheckoutMerchantFeeApi.subclasses = BaseAdyenCheckoutMerchantFeeApi.subclasses + (cls,)
    async def c_reate_adyen_checkout_merchant_fee_for_user(
        ...
        adyen_checkout_merchant_transaction_fee: AdyenCheckoutMerchantTransactionFee,
