...
from openapi_server.apis.insight_vat_api_base import BaseInsightVatApi
...
from openapi_server.models.insight_vat_listing import InsightVatListing
...
@router.get(
    "/user/{userID}/insight-vat",
    responses={
        200: {"model": List[InsightVatListing], "description": "The insight endpoint for VAT. apiApp:LISTING"},
...
async def list_all_insight_vat_for_user(
...
) -> List[InsightVatListing]:
    """The insight endpoint for VAT. apiApp:LISTING"""
    if not BaseInsightVatApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseInsightVatApi.subclasses[0]().list_all_insight_vat_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
