...
class BaseSessionServerAdminRetoolApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSessionServerAdminRetoolApi.subclasses = BaseSessionServerAdminRetoolApi.subclasses + (cls,)
    async def c_reate_session_server_admin_retool(
        ...
        session_server_admin_retool: SessionServerAdminRetool,
