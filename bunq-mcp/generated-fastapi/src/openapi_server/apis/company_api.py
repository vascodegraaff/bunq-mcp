...
from openapi_server.apis.company_api_base import BaseCompanyApi
...
from openapi_server.models.company_create import CompanyCreate
from openapi_server.models.company_listing import CompanyListing
from openapi_server.models.company_read import CompanyRead
from openapi_server.models.company_update import CompanyUpdate
...
@router.post(
    "/user/{userID}/company",
    responses={
        200: {"model": CompanyCreate, "description": "Create and manage companies. apiAdmin:READ/LISTING/UPDATE apiApp:CREATE/READ/LISTING/UPDATE apiPublic:CREATE/READ/LISTING/UPDATE apiServiceInternal:READ/LISTING/UPDATE apiProcess:READ/UPDATE"},
...
async def c_reate_company_for_user(
    ...
    company: Company = Body(None, description=""),
    ...
    """Create and manage companies. apiAdmin:READ/LISTING/UPDATE apiApp:CREATE/READ/LISTING/UPDATE apiPublic:CREATE/READ/LISTING/UPDATE apiServiceInternal:READ/LISTING/UPDATE apiProcess:READ/UPDATE"""
    if not BaseCompanyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyApi.subclasses[0]().c_reate_company_for_user(userID, user_agent, x_bunq_client_authentication, company, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/company",
    responses={
        200: {"model": List[CompanyListing], "description": "Create and manage companies. apiAdmin:READ/LISTING/UPDATE apiApp:CREATE/READ/LISTING/UPDATE apiPublic:CREATE/READ/LISTING/UPDATE apiServiceInternal:READ/LISTING/UPDATE apiProcess:READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["company"],
    summary="",
...
async def list_all_company_for_user(
    ...
    if not BaseCompanyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyApi.subclasses[0]().list_all_company_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/company/{itemId}",
    responses={
        200: {"model": CompanyRead, "description": "Create and manage companies. apiAdmin:READ/LISTING/UPDATE apiApp:CREATE/READ/LISTING/UPDATE apiPublic:CREATE/READ/LISTING/UPDATE apiServiceInternal:READ/LISTING/UPDATE apiProcess:READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["company"],
    summary="",
...
async def r_ead_company_for_user(
    userID: StrictInt = Path(..., description=""),
    ...
    if not BaseCompanyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyApi.subclasses[0]().r_ead_company_for_user(userID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/company/{itemId}",
    responses={
        200: {"model": CompanyUpdate, "description": "Create and manage companies. apiAdmin:READ/LISTING/UPDATE apiApp:CREATE/READ/LISTING/UPDATE apiPublic:CREATE/READ/LISTING/UPDATE apiServiceInternal:READ/LISTING/UPDATE apiProcess:READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["company"],
    summary="",
...
async def u_pdate_company_for_user(
    userID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    ...
    if not BaseCompanyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseCompanyApi.subclasses[0]().u_pdate_company_for_user(userID, itemId, user_agent, x_bunq_client_authentication, company, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
