...
class BasePaymentServiceProviderIssuerTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePaymentServiceProviderIssuerTransactionApi.subclasses = BasePaymentServiceProviderIssuerTransactionApi.subclasses + (cls,)
    async def c_reate_payment_service_provider_issuer_transaction_for_user(
        ...
        payment_service_provider_issuer_transaction: PaymentServiceProviderIssuerTransaction,
