...
from openapi_server.models.identity_verification_message_incode_watchlist import IdentityVerificationMessageIncodeWatchlist
from openapi_server.models.identity_verification_message_incode_watchlist_create import IdentityVerificationMessageIncodeWatchlistCreate
...
@router.post(
    "/watchlist",
    responses={
        200: {"model": IdentityVerificationMessageIncodeWatchlistCreate, "description": "The endpoint to receive watchlist update notifications from Incode. apiIncode:CREATE"},
...
async def c_reate_watchlist(
    ...
    identity_verification_message_incode_watchlist: IdentityVerificationMessageIncodeWatchlist = Body(None, description=""),
...
) -> IdentityVerificationMessageIncodeWatchlistCreate:
    """The endpoint to receive watchlist update notifications from Incode. apiIncode:CREATE"""
    if not BaseWatchlistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseWatchlistApi.subclasses[0]().c_reate_watchlist(user_agent, x_bunq_client_authentication, identity_verification_message_incode_watchlist, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
