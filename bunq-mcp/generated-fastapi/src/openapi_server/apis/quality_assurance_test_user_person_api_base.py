...
class BaseQualityAssuranceTestUserPersonApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQualityAssuranceTestUserPersonApi.subclasses = BaseQualityAssuranceTestUserPersonApi.subclasses + (cls,)
    async def c_reate_quality_assurance_test_user_person(
        ...
        quality_assurance_test_user_person: QualityAssuranceTestUserPerson,
