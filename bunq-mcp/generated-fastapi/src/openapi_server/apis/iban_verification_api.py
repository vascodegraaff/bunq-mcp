...
from openapi_server.apis.iban_verification_api_base import BaseIbanVerificationApi
...
from openapi_server.models.iban_verification import IbanVerification
from openapi_server.models.iban_verification_create import IbanVerificationCreate
...
@router.post(
    "/user/{userID}/iban-verification",
    responses={
        200: {"model": IbanVerificationCreate, "description": "Endpoint to verify whether an iban belongs to a certain name. apiApp:CREATE"},
...
async def c_reate_iban_verification_for_user(
    ...
    iban_verification: IbanVerification = Body(None, description=""),
...
) -> IbanVerificationCreate:
    """Endpoint to verify whether an iban belongs to a certain name. apiApp:CREATE"""
    if not BaseIbanVerificationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIbanVerificationApi.subclasses[0]().c_reate_iban_verification_for_user(userID, user_agent, x_bunq_client_authentication, iban_verification, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
