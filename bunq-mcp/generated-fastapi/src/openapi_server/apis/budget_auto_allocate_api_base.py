...
class BaseBudgetAutoAllocateApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBudgetAutoAllocateApi.subclasses = BaseBudgetAutoAllocateApi.subclasses + (cls,)
    async def c_reate_budget_auto_allocate_for_user_monetary_account(
        ...
        monetary_account_budget_auto_allocate: MonetaryAccountBudgetAutoAllocate,
