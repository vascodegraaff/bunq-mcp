...
from openapi_server.apis.ticket_assignment_api_base import BaseTicketAssignmentApi
...
from openapi_server.models.ticket_assignment_create import TicketAssignmentCreate
...
@router.post(
    "/user/{userID}/ticket-assignment",
    responses={
        200: {"model": TicketAssignmentCreate, "description": "Endpoint checks if tickets exist and allows a user to request a ticket be assigned to him apiAdmin:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_ticket_assignment_for_user(
    ...
    """Endpoint checks if tickets exist and allows a user to request a ticket be assigned to him apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseTicketAssignmentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTicketAssignmentApi.subclasses[0]().c_reate_ticket_assignment_for_user(userID, user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
