...
from openapi_server.apis.admin_partner_promotion_deal_voucher_batch_api_base import BaseAdminPartnerPromotionDealVoucherBatchApi
...
from openapi_server.models.admin_partner_promotion_deal_voucher_batch import AdminPartnerPromotionDealVoucherBatch
from openapi_server.models.admin_partner_promotion_deal_voucher_batch_create import AdminPartnerPromotionDealVoucherBatchCreate
...
@router.post(
    "/admin-partner-promotion-deal-voucher-batch",
    responses={
        200: {"model": AdminPartnerPromotionDealVoucherBatchCreate, "description": "Endpoint to create batch of vouchers. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-partner-promotion-deal-voucher-batch"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_partner_promotion_deal_voucher_batch(
    ...
    admin_partner_promotion_deal_voucher_batch: AdminPartnerPromotionDealVoucherBatch = Body(None, description=""),
...
) -> AdminPartnerPromotionDealVoucherBatchCreate:
    """Endpoint to create batch of vouchers. apiAdmin:CREATE"""
    if not BaseAdminPartnerPromotionDealVoucherBatchApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPartnerPromotionDealVoucherBatchApi.subclasses[0]().c_reate_admin_partner_promotion_deal_voucher_batch(user_agent, x_bunq_client_authentication, admin_partner_promotion_deal_voucher_batch, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
