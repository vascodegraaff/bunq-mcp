...
class BaseUserSettingAttachmentIndexApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingAttachmentIndexApi.subclasses = BaseUserSettingAttachmentIndexApi.subclasses + (cls,)
    async def c_reate_user_setting_attachment_index_for_user(
        ...
        user_setting_attachment_index: UserSettingAttachmentIndex,
