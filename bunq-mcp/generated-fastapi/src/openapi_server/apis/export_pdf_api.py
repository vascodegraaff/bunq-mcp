...
from openapi_server.apis.export_pdf_api_base import BaseExportPdfApi
...
@router.get(
    "/user/{userID}/registry/{registryID}/export-pdf",
    responses={
        200: {"model": List[object], "description": "Retrieve a PDF export of a registry apiAdmin:LISTING apiApp:LISTING"},
...
async def list_all_export_pdf_for_user_registry(
    ...
    """Retrieve a PDF export of a registry apiAdmin:LISTING apiApp:LISTING"""
    if not BaseExportPdfApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseExportPdfApi.subclasses[0]().list_all_export_pdf_for_user_registry(userID, registryID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
