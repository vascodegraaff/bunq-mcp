...
class BasePrimaryAccountNumberApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePrimaryAccountNumberApi.subclasses = BasePrimaryAccountNumberApi.subclasses + (cls,)
    async def c_reate_primary_account_number_for_user_card(
        ...
        card_primary_account_number: CardPrimaryAccountNumber,
