...
class BaseAdminPartnerPromotionCashbackApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminPartnerPromotionCashbackApi.subclasses = BaseAdminPartnerPromotionCashbackApi.subclasses + (cls,)
    async def c_reate_admin_partner_promotion_cashback(
        ...
        admin_partner_promotion_cashback: AdminPartnerPromotionCashback,
