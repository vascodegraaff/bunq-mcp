...
from openapi_server.apis.point_challenge_public_api_base import BasePointChallengePublicApi
...
from openapi_server.models.point_challenge_public_listing import PointChallengePublicListing
...
@router.get(
    "/point-challenge-public",
    responses={
        200: {"model": List[PointChallengePublicListing], "description": "Endpoint to retrieve point challenges. apiApp:LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["point-challenge-public"],
    summary="",
    response_model_by_alias=True,
)
async def list_all_point_challenge_public(
...
) -> List[PointChallengePublicListing]:
    """Endpoint to retrieve point challenges. apiApp:LISTING"""
    if not BasePointChallengePublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BasePointChallengePublicApi.subclasses[0]().list_all_point_challenge_public(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
