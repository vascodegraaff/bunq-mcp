...
class BaseSofortMerchantTransactionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseSofortMerchantTransactionApi.subclasses = BaseSofortMerchantTransactionApi.subclasses + (cls,)
    async def c_reate_sofort_merchant_transaction_for_user_monetary_account(
        ...
        sofort_merchant_transaction: SofortMerchantTransaction,
