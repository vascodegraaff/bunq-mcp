...
class BaseCommentDowJonesCheckApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCommentDowJonesCheckApi.subclasses = BaseCommentDowJonesCheckApi.subclasses + (cls,)
    async def c_reate_comment_dow_jones_check_for_dow_jones_check(
        self,
        dow-jones-checkID: StrictInt,
        ...
        admin_comment_dow_jones_check: AdminCommentDowJonesCheck,
