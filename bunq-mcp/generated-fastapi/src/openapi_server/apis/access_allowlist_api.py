...
from openapi_server.apis.access_allowlist_api_base import BaseAccessAllowlistApi
...
from openapi_server.models.admin_user_admin_access_allowlist import AdminUserAdminAccessAllowlist
from openapi_server.models.admin_user_admin_access_allowlist_create import AdminUserAdminAccessAllowlistCreate
...
@router.post(
    "/user-admin/{user-adminID}/access-allowlist",
    responses={
        200: {"model": AdminUserAdminAccessAllowlistCreate, "description": "Creates a temporary access to a specific user’s resources for an admin user. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["access-allowlist"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_access_allowlist_for_user_admin(
    ...
    admin_user_admin_access_allowlist: AdminUserAdminAccessAllowlist = Body(None, description=""),
...
) -> AdminUserAdminAccessAllowlistCreate:
    """Creates a temporary access to a specific user’s resources for an admin user. apiAdmin:CREATE"""
    if not BaseAccessAllowlistApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAccessAllowlistApi.subclasses[0]().c_reate_access_allowlist_for_user_admin(user-adminID, user_agent, x_bunq_client_authentication, admin_user_admin_access_allowlist, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
