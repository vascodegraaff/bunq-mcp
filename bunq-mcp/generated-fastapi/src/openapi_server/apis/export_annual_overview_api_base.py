...
class BaseExportAnnualOverviewApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseExportAnnualOverviewApi.subclasses = BaseExportAnnualOverviewApi.subclasses + (cls,)
    async def c_reate_export_annual_overview_for_user(
        ...
        export_annual_overview: ExportAnnualOverview,
