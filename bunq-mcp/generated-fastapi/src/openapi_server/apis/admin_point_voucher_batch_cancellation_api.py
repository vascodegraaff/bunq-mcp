...
from openapi_server.apis.admin_point_voucher_batch_cancellation_api_base import BaseAdminPointVoucherBatchCancellationApi
...
from openapi_server.models.admin_point_voucher_batch_cancellation import AdminPointVoucherBatchCancellation
from openapi_server.models.admin_point_voucher_batch_cancellation_create import AdminPointVoucherBatchCancellationCreate
...
@router.post(
    ...
    responses={
        200: {"model": AdminPointVoucherBatchCancellationCreate, "description": "Endpoint to cancel batch of vouchers. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-point-voucher-batch-cancellation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_point_voucher_batch_cancellation(
    ...
    admin_point_voucher_batch_cancellation: AdminPointVoucherBatchCancellation = Body(None, description=""),
...
) -> AdminPointVoucherBatchCancellationCreate:
    """Endpoint to cancel batch of vouchers. apiAdmin:CREATE"""
    if not BaseAdminPointVoucherBatchCancellationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminPointVoucherBatchCancellationApi.subclasses[0]().c_reate_admin_point_voucher_batch_cancellation(user_agent, x_bunq_client_authentication, admin_point_voucher_batch_cancellation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
