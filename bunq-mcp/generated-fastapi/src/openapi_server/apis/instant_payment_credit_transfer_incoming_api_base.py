...
class BaseInstantPaymentCreditTransferIncomingApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInstantPaymentCreditTransferIncomingApi.subclasses = BaseInstantPaymentCreditTransferIncomingApi.subclasses + (cls,)
