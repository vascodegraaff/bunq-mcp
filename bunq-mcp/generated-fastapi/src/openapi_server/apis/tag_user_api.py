...
from openapi_server.apis.tag_user_api_base import BaseTagUserApi
...
@router.post(
    "/user/{userID}/tag-user",
    responses={
        200: {"model": TagUserCreate, "description": "Show the tags set for a user, or creates new tags for a user. apiAdmin:CREATE/LISTING apiServiceInternal:CREATE/LISTING"},
...
async def c_reate_tag_user_for_user(
    ...
    tag_user: TagUser = Body(None, description=""),
    ...
    if not BaseTagUserApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTagUserApi.subclasses[0]().c_reate_tag_user_for_user(userID, user_agent, x_bunq_client_authentication, tag_user, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/tag-user",
    responses={
        200: {"model": List[TagUserListing], "description": "Show the tags set for a user, or creates new tags for a user. apiAdmin:CREATE/LISTING apiServiceInternal:CREATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["tag-user"],
    summary="",
...
async def list_all_tag_user_for_user(
    ...
    if not BaseTagUserApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTagUserApi.subclasses[0]().list_all_tag_user_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
