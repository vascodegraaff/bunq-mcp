...
class BaseOpvragenProductApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseOpvragenProductApi.subclasses = BaseOpvragenProductApi.subclasses + (cls,)
    async def c_reate_opvragen_product(
        ...
        government_referral_portal_external_search_by_product: GovernmentReferralPortalExternalSearchByProduct,
