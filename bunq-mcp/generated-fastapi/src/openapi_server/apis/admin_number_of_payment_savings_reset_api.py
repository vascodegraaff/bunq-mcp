...
from openapi_server.apis.admin_number_of_payment_savings_reset_api_base import BaseAdminNumberOfPaymentSavingsResetApi
...
from openapi_server.models.admin_user_number_of_payment_savings_reset_create import AdminUserNumberOfPaymentSavingsResetCreate
...
@router.post(
    "/user/{userID}/admin-number-of-payment-savings-reset",
    responses={
        200: {"model": AdminUserNumberOfPaymentSavingsResetCreate, "description": "Reset the number of savings payments for the user. apiAdmin:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-number-of-payment-savings-reset"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_admin_number_of_payment_savings_reset_for_user(
...
) -> AdminUserNumberOfPaymentSavingsResetCreate:
    """Reset the number of savings payments for the user. apiAdmin:CREATE"""
    if not BaseAdminNumberOfPaymentSavingsResetApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminNumberOfPaymentSavingsResetApi.subclasses[0]().c_reate_admin_number_of_payment_savings_reset_for_user(userID, user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
