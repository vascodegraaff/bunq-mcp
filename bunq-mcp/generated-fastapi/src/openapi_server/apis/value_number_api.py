...
from openapi_server.apis.value_number_api_base import BaseValueNumberApi
...
from openapi_server.models.user_review_value_number import UserReviewValueNumber
from openapi_server.models.user_review_value_number_update import UserReviewValueNumberUpdate
...
@router.put(
    "/user/{userID}/review/{reviewID}/check/{checkID}/value-number/{itemId}",
    responses={
        200: {"model": UserReviewValueNumberUpdate, "description": "Endpoint for updating UserReviewValueNumber. apiApp:UPDATE"},
...
async def u_pdate_value_number_for_user_review_check(
    ...
    user_review_value_number: UserReviewValueNumber = Body(None, description=""),
...
) -> UserReviewValueNumberUpdate:
    """Endpoint for updating UserReviewValueNumber. apiApp:UPDATE"""
    if not BaseValueNumberApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseValueNumberApi.subclasses[0]().u_pdate_value_number_for_user_review_check(userID, reviewID, checkID, itemId, user_agent, x_bunq_client_authentication, user_review_value_number, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
