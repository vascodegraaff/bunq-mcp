...
from openapi_server.models.admin_billing import AdminBilling
from openapi_server.models.admin_billing_create import AdminBillingCreate
...
@router.post(
    "/user/{userID}/billing",
    responses={
        200: {"model": AdminBillingCreate, "description": "Charge a user for a service apiAdmin:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_billing_for_user(
    ...
    admin_billing: AdminBilling = Body(None, description=""),
    ...
    """Charge a user for a service apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseBillingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBillingApi.subclasses[0]().c_reate_billing_for_user(userID, user_agent, x_bunq_client_authentication, admin_billing, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
