...
from openapi_server.apis.sofort_merchant_transaction_api_base import BaseSofortMerchantTransactionApi
...
from openapi_server.models.sofort_merchant_transaction import SofortMerchantTransaction
from openapi_server.models.sofort_merchant_transaction_create import SofortMerchantTransactionCreate
from openapi_server.models.sofort_merchant_transaction_listing import SofortMerchantTransactionListing
from openapi_server.models.sofort_merchant_transaction_read import SofortMerchantTransactionRead
...
@router.post(
    ...
    responses={
        200: {"model": SofortMerchantTransactionCreate, "description": "View for requesting Sofort transactions and polling their status. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiQualityAssurance:CREATE/READ/LISTING"},
...
async def c_reate_sofort_merchant_transaction_for_user_monetary_account(
    ...
    sofort_merchant_transaction: SofortMerchantTransaction = Body(None, description=""),
...
) -> SofortMerchantTransactionCreate:
    """View for requesting Sofort transactions and polling their status. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiQualityAssurance:CREATE/READ/LISTING"""
    if not BaseSofortMerchantTransactionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSofortMerchantTransactionApi.subclasses[0]().c_reate_sofort_merchant_transaction_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, sofort_merchant_transaction, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/sofort-merchant-transaction",
    responses={
        200: {"model": List[SofortMerchantTransactionListing], "description": "View for requesting Sofort transactions and polling their status. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiQualityAssurance:CREATE/READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["sofort-merchant-transaction"],
    summary="",
...
async def list_all_sofort_merchant_transaction_for_user_monetary_account(
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[SofortMerchantTransactionListing]:
    """View for requesting Sofort transactions and polling their status. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiQualityAssurance:CREATE/READ/LISTING"""
    if not BaseSofortMerchantTransactionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSofortMerchantTransactionApi.subclasses[0]().list_all_sofort_merchant_transaction_for_user_monetary_account(userID, monetary-accountID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account/{monetary-accountID}/sofort-merchant-transaction/{itemId}",
    responses={
        200: {"model": SofortMerchantTransactionRead, "description": "View for requesting Sofort transactions and polling their status. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiQualityAssurance:CREATE/READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["sofort-merchant-transaction"],
    summary="",
...
async def r_ead_sofort_merchant_transaction_for_user_monetary_account(
    userID: StrictInt = Path(..., description=""),
    monetary-accountID: StrictInt = Path(..., description=""),
    ...
    if not BaseSofortMerchantTransactionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSofortMerchantTransactionApi.subclasses[0]().r_ead_sofort_merchant_transaction_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
