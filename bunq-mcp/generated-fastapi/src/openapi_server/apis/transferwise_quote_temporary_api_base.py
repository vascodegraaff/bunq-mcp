...
class BaseTransferwiseQuoteTemporaryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseTransferwiseQuoteTemporaryApi.subclasses = BaseTransferwiseQuoteTemporaryApi.subclasses + (cls,)
    async def c_reate_transferwise_quote_temporary_for_user(
        ...
        transferwise_quote_temporary: TransferwiseQuoteTemporary,
