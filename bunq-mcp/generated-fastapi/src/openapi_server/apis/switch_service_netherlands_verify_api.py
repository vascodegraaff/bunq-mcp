...
from openapi_server.apis.switch_service_netherlands_verify_api_base import BaseSwitchServiceNetherlandsVerifyApi
...
from openapi_server.models.bank_switch_service_netherlands_verify import BankSwitchServiceNetherlandsVerify
from openapi_server.models.bank_switch_service_netherlands_verify_create import BankSwitchServiceNetherlandsVerifyCreate
...
@router.post(
    ...
    responses={
        200: {"model": BankSwitchServiceNetherlandsVerifyCreate, "description": "This endpoint is used to retrieve a switch service entry of an IBAN. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["switch-service-netherlands-verify"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_switch_service_netherlands_verify(
    ...
    bank_switch_service_netherlands_verify: BankSwitchServiceNetherlandsVerify = Body(None, description=""),
...
) -> BankSwitchServiceNetherlandsVerifyCreate:
    """This endpoint is used to retrieve a switch service entry of an IBAN. apiApp:CREATE"""
    if not BaseSwitchServiceNetherlandsVerifyApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSwitchServiceNetherlandsVerifyApi.subclasses[0]().c_reate_switch_service_netherlands_verify(user_agent, x_bunq_client_authentication, bank_switch_service_netherlands_verify, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
