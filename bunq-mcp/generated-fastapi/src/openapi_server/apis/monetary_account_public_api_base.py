...
class BaseMonetaryAccountPublicApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMonetaryAccountPublicApi.subclasses = BaseMonetaryAccountPublicApi.subclasses + (cls,)
    async def c_reate_monetary_account_public(
        ...
        monetary_account_public: MonetaryAccountPublic,
