...
class BaseAccessAllowlistApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAccessAllowlistApi.subclasses = BaseAccessAllowlistApi.subclasses + (cls,)
    async def c_reate_access_allowlist_for_user_admin(
        ...
        admin_user_admin_access_allowlist: AdminUserAdminAccessAllowlist,
