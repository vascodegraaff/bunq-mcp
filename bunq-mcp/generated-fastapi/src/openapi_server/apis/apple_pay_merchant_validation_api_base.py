...
class BaseApplePayMerchantValidationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseApplePayMerchantValidationApi.subclasses = BaseApplePayMerchantValidationApi.subclasses + (cls,)
    async def c_reate_apple_pay_merchant_validation(
        ...
        apple_pay_merchant_validation: ApplePayMerchantValidation,
