...
from openapi_server.apis.location_event_api_base import BaseLocationEventApi
...
@router.get(
    "/user/{userID}/location-event",
    responses={
        200: {"model": List[object], "description": "Location events of the user apiApp:LISTING"},
...
async def list_all_location_event_for_user(
    ...
    """Location events of the user apiApp:LISTING"""
    if not BaseLocationEventApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseLocationEventApi.subclasses[0]().list_all_location_event_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
