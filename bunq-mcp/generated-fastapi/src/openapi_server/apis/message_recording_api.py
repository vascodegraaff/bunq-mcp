...
from openapi_server.apis.message_recording_api_base import BaseMessageRecordingApi
...
from openapi_server.models.chat_message_recording import ChatMessageRecording
from openapi_server.models.chat_message_recording_create import ChatMessageRecordingCreate
...
@router.post(
    "/user/{userID}/chat-conversation/{chat-conversationID}/message-recording",
    responses={
        200: {"model": ChatMessageRecordingCreate, "description": "Endpoint for the type of chat message that carries a recording. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_message_recording_for_user_chat_conversation(
    ...
    chat_message_recording: ChatMessageRecording = Body(None, description=""),
...
) -> ChatMessageRecordingCreate:
    """Endpoint for the type of chat message that carries a recording. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseMessageRecordingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMessageRecordingApi.subclasses[0]().c_reate_message_recording_for_user_chat_conversation(userID, chat-conversationID, user_agent, x_bunq_client_authentication, chat_message_recording, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
