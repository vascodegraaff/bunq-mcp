...
from openapi_server.apis.birdee_investment_portfolio_api_base import BaseBirdeeInvestmentPortfolioApi
...
from openapi_server.models.birdee_investment_portfolio import BirdeeInvestmentPortfolio
from openapi_server.models.birdee_investment_portfolio_create import BirdeeInvestmentPortfolioCreate
from openapi_server.models.birdee_investment_portfolio_read import BirdeeInvestmentPortfolioRead
from openapi_server.models.birdee_investment_portfolio_update import BirdeeInvestmentPortfolioUpdate
...
@router.post(
    "/user/{userID}/monetary-account-investment/{monetary-account-investmentID}/birdee-investment-portfolio",
    responses={
        200: {"model": BirdeeInvestmentPortfolioCreate, "description": "Endpoint for interacting with the investment portfolio opened at Birdee. apiApp:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["birdee-investment-portfolio"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_birdee_investment_portfolio_for_user_monetary_account_investment(
    ...
    birdee_investment_portfolio: BirdeeInvestmentPortfolio = Body(None, description=""),
...
) -> BirdeeInvestmentPortfolioCreate:
    """Endpoint for interacting with the investment portfolio opened at Birdee. apiApp:CREATE/READ/UPDATE"""
    if not BaseBirdeeInvestmentPortfolioApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBirdeeInvestmentPortfolioApi.subclasses[0]().c_reate_birdee_investment_portfolio_for_user_monetary_account_investment(userID, monetary-account-investmentID, user_agent, x_bunq_client_authentication, birdee_investment_portfolio, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/monetary-account-investment/{monetary-account-investmentID}/birdee-investment-portfolio/{itemId}",
    responses={
        200: {"model": BirdeeInvestmentPortfolioRead, "description": "Endpoint for interacting with the investment portfolio opened at Birdee. apiApp:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["birdee-investment-portfolio"],
    summary="",
...
async def r_ead_birdee_investment_portfolio_for_user_monetary_account_investment(
    userID: StrictInt = Path(..., description=""),
    monetary-account-investmentID: StrictInt = Path(..., description=""),
    ...
    if not BaseBirdeeInvestmentPortfolioApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBirdeeInvestmentPortfolioApi.subclasses[0]().r_ead_birdee_investment_portfolio_for_user_monetary_account_investment(userID, monetary-account-investmentID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/monetary-account-investment/{monetary-account-investmentID}/birdee-investment-portfolio/{itemId}",
    responses={
        200: {"model": BirdeeInvestmentPortfolioUpdate, "description": "Endpoint for interacting with the investment portfolio opened at Birdee. apiApp:CREATE/READ/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["birdee-investment-portfolio"],
    summary="",
...
async def u_pdate_birdee_investment_portfolio_for_user_monetary_account_investment(
    userID: StrictInt = Path(..., description=""),
    monetary-account-investmentID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> BirdeeInvestmentPortfolioUpdate:
    """Endpoint for interacting with the investment portfolio opened at Birdee. apiApp:CREATE/READ/UPDATE"""
    if not BaseBirdeeInvestmentPortfolioApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBirdeeInvestmentPortfolioApi.subclasses[0]().u_pdate_birdee_investment_portfolio_for_user_monetary_account_investment(userID, monetary-account-investmentID, itemId, user_agent, x_bunq_client_authentication, birdee_investment_portfolio, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
