...
class BaseExportStatementCardCsvApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseExportStatementCardCsvApi.subclasses = BaseExportStatementCardCsvApi.subclasses + (cls,)
    async def c_reate_export_statement_card_csv_for_user_card(
        ...
        export_statement_card_csv: ExportStatementCardCsv,
