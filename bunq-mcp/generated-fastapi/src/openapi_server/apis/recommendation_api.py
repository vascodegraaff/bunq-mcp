...
from openapi_server.models.travel_assistant_recommendation_create import TravelAssistantRecommendationCreate
from openapi_server.models.travel_assistant_recommendation_update import TravelAssistantRecommendationUpdate
...
@router.post(
    "/user/{userID}/travel-assistant-country/{travel-assistant-countryID}/recommendation",
    responses={
        200: {"model": TravelAssistantRecommendationCreate, "description": "Travel assistant recommendation about anything you want. apiAdmin:CREATE/UPDATE/DELETE"},
...
async def c_reate_recommendation_for_user_travel_assistant_country(
    userID: StrictInt = Path(..., description=""),
    travel-assistant-countryID: StrictInt = Path(..., description=""),
    ...
    travel_assistant_recommendation: TravelAssistantRecommendation = Body(None, description=""),
...
) -> TravelAssistantRecommendationCreate:
    """Travel assistant recommendation about anything you want. apiAdmin:CREATE/UPDATE/DELETE"""
    if not BaseRecommendationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRecommendationApi.subclasses[0]().c_reate_recommendation_for_user_travel_assistant_country(userID, travel-assistant-countryID, user_agent, x_bunq_client_authentication, travel_assistant_recommendation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.delete(
    "/user/{userID}/travel-assistant-country/{travel-assistant-countryID}/recommendation/{itemId}",
    responses={
        200: {"model": object, "description": "Travel assistant recommendation about anything you want. apiAdmin:CREATE/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["recommendation"],
    summary="",
...
async def d_elete_recommendation_for_user_travel_assistant_country(
    userID: StrictInt = Path(..., description=""),
    travel-assistant-countryID: StrictInt = Path(..., description=""),
    ...
    if not BaseRecommendationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRecommendationApi.subclasses[0]().d_elete_recommendation_for_user_travel_assistant_country(userID, travel-assistant-countryID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/travel-assistant-country/{travel-assistant-countryID}/recommendation/{itemId}",
    responses={
        200: {"model": TravelAssistantRecommendationUpdate, "description": "Travel assistant recommendation about anything you want. apiAdmin:CREATE/UPDATE/DELETE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["recommendation"],
    summary="",
...
async def u_pdate_recommendation_for_user_travel_assistant_country(
    userID: StrictInt = Path(..., description=""),
    travel-assistant-countryID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> TravelAssistantRecommendationUpdate:
    """Travel assistant recommendation about anything you want. apiAdmin:CREATE/UPDATE/DELETE"""
    if not BaseRecommendationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRecommendationApi.subclasses[0]().u_pdate_recommendation_for_user_travel_assistant_country(userID, travel-assistant-countryID, itemId, user_agent, x_bunq_client_authentication, travel_assistant_recommendation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
