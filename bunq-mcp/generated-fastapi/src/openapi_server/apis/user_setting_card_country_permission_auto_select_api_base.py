...
class BaseUserSettingCardCountryPermissionAutoSelectApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseUserSettingCardCountryPermissionAutoSelectApi.subclasses = BaseUserSettingCardCountryPermissionAutoSelectApi.subclasses + (cls,)
    async def c_reate_user_setting_card_country_permission_auto_select_for_user(
        ...
        user_setting_card_country_permission_auto_select: UserSettingCardCountryPermissionAutoSelect,
