...
from openapi_server.apis.sim_virtual_message_installation_api_base import BaseSimVirtualMessageInstallationApi
...
from openapi_server.models.sim_virtual_message_installation import SimVirtualMessageInstallation
from openapi_server.models.sim_virtual_message_installation_create import SimVirtualMessageInstallationCreate
...
@router.post(
    ...
    responses={
        200: {"model": SimVirtualMessageInstallationCreate, "description": "Webhook endpoint to let 1Global notify us about eSIM installations and deletions. apiOneGlobal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["sim-virtual-message-installation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_sim_virtual_message_installation(
    ...
    sim_virtual_message_installation: SimVirtualMessageInstallation = Body(None, description=""),
...
) -> SimVirtualMessageInstallationCreate:
    """Webhook endpoint to let 1Global notify us about eSIM installations and deletions. apiOneGlobal:CREATE"""
    if not BaseSimVirtualMessageInstallationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSimVirtualMessageInstallationApi.subclasses[0]().c_reate_sim_virtual_message_installation(user_agent, x_bunq_client_authentication, sim_virtual_message_installation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
