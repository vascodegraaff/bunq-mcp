...
class BaseConfirmationOfFundsApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseConfirmationOfFundsApi.subclasses = BaseConfirmationOfFundsApi.subclasses + (cls,)
    async def c_reate_confirmation_of_funds_for_user(
        ...
        confirmation_of_funds: ConfirmationOfFunds,
