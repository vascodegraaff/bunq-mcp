...
from openapi_server.apis.bunqme_merchant_request_api_base import BaseBunqmeMerchantRequestApi
...
from openapi_server.models.bunq_me_merchant_request import BunqMeMerchantRequest
from openapi_server.models.bunq_me_merchant_request_create import BunqMeMerchantRequestCreate
from openapi_server.models.bunq_me_merchant_request_read import BunqMeMerchantRequestRead
...
@router.post(
    ...
    responses={
        200: {"model": BunqMeMerchantRequestCreate, "description": "Endpoint to initiate (and poll) the status of the merchant payment for a Request. apiBunqMe:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_bunqme_merchant_request(
    ...
    bunq_me_merchant_request: BunqMeMerchantRequest = Body(None, description=""),
...
) -> BunqMeMerchantRequestCreate:
    """Endpoint to initiate (and poll) the status of the merchant payment for a Request. apiBunqMe:CREATE/READ"""
    if not BaseBunqmeMerchantRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestApi.subclasses[0]().c_reate_bunqme_merchant_request(user_agent, x_bunq_client_authentication, bunq_me_merchant_request, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/bunqme-merchant-request/{itemId}",
    responses={
        200: {"model": BunqMeMerchantRequestRead, "description": "Endpoint to initiate (and poll) the status of the merchant payment for a Request. apiBunqMe:CREATE/READ"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["bunqme-merchant-request"],
    summary="",
...
async def r_ead_bunqme_merchant_request(
    ...
    if not BaseBunqmeMerchantRequestApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeMerchantRequestApi.subclasses[0]().r_ead_bunqme_merchant_request(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
