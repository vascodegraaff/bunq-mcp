...
class BaseMastercardTokenConnectProvisionApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMastercardTokenConnectProvisionApi.subclasses = BaseMastercardTokenConnectProvisionApi.subclasses + (cls,)
    async def c_reate_mastercard_token_connect_provision_for_user_card(
        ...
        master_card_token_connect_provision: MasterCardTokenConnectProvision,
