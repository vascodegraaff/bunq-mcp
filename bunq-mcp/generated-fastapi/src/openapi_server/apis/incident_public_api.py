...
from openapi_server.apis.incident_public_api_base import BaseIncidentPublicApi
...
from openapi_server.models.incident_public_listing import IncidentPublicListing
...
@router.get(
    "/incident-public",
    responses={
        200: {"model": List[IncidentPublicListing], "description": "Check for incidents from a public place, like the www.bunq.com website. apiApp:LISTING"},
...
async def list_all_incident_public(
...
) -> List[IncidentPublicListing]:
    """Check for incidents from a public place, like the www.bunq.com website. apiApp:LISTING"""
    if not BaseIncidentPublicApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIncidentPublicApi.subclasses[0]().list_all_incident_public(user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
