...
from openapi_server.apis.quality_assurance_payment_incoming_api_base import BaseQualityAssurancePaymentIncomingApi
...
from openapi_server.models.quality_assurance_payment_incoming import QualityAssurancePaymentIncoming
from openapi_server.models.quality_assurance_payment_incoming_create import QualityAssurancePaymentIncomingCreate
...
@router.post(
    ...
    responses={
        200: {"model": QualityAssurancePaymentIncomingCreate, "description": "Create an incoming payment, for Quality Assurance purposes. apiQualityAssurance:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["quality-assurance-payment-incoming"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_quality_assurance_payment_incoming(
    ...
    quality_assurance_payment_incoming: QualityAssurancePaymentIncoming = Body(None, description=""),
...
) -> QualityAssurancePaymentIncomingCreate:
    """Create an incoming payment, for Quality Assurance purposes. apiQualityAssurance:CREATE"""
    if not BaseQualityAssurancePaymentIncomingApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseQualityAssurancePaymentIncomingApi.subclasses[0]().c_reate_quality_assurance_payment_incoming(user_agent, x_bunq_client_authentication, quality_assurance_payment_incoming, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
