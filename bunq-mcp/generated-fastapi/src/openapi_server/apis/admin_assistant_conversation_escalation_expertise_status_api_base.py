...
class BaseAdminAssistantConversationEscalationExpertiseStatusApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminAssistantConversationEscalationExpertiseStatusApi.subclasses = BaseAdminAssistantConversationEscalationExpertiseStatusApi.subclasses + (cls,)
