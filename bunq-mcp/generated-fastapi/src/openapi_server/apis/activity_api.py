...
from openapi_server.apis.activity_api_base import BaseActivityApi
...
from openapi_server.models.activity_listing import ActivityListing
...
@router.get(
    ...
    responses={
        200: {"model": List[ActivityListing], "description": "Used to view the activity of a user. apiAdmin:LISTING apiApp:LISTING apiServiceInternal:LISTING"},
...
async def list_all_activity_for_user(
    ...
    """Used to view the activity of a user. apiAdmin:LISTING apiApp:LISTING apiServiceInternal:LISTING"""
    if not BaseActivityApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseActivityApi.subclasses[0]().list_all_activity_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
