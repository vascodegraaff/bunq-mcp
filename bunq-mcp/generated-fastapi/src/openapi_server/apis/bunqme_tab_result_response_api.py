...
from openapi_server.apis.bunqme_tab_result_response_api_base import BaseBunqmeTabResultResponseApi
...
from openapi_server.models.bunq_me_tab_result_response_read import BunqMeTabResultResponseRead
...
@router.get(
    ...
    responses={
        200: {"model": BunqMeTabResultResponseRead, "description": "Used to view bunq.me TabResultResponse objects belonging to a tab. A TabResultResponse is an object that holds details on a tab which has been paid from the provided monetary account. apiApp:READ apiPublic:READ"},
...
async def r_ead_bunqme_tab_result_response_for_user_monetary_account(
    ...
    """Used to view bunq.me TabResultResponse objects belonging to a tab. A TabResultResponse is an object that holds details on a tab which has been paid from the provided monetary account. apiApp:READ apiPublic:READ"""
    if not BaseBunqmeTabResultResponseApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeTabResultResponseApi.subclasses[0]().r_ead_bunqme_tab_result_response_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
