...
from openapi_server.apis.adyen_terminal_message_in_api_base import BaseAdyenTerminalMessageInApi
...
from openapi_server.models.adyen_terminal_message_in import AdyenTerminalMessageIn
from openapi_server.models.adyen_terminal_message_in_create import AdyenTerminalMessageInCreate
...
@router.post(
    "/adyen-terminal-message-in",
    responses={
        200: {"model": AdyenTerminalMessageInCreate, "description": "Receives messages from Adyen Terminal API. apiAdyen:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["adyen-terminal-message-in"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_adyen_terminal_message_in(
    ...
    adyen_terminal_message_in: AdyenTerminalMessageIn = Body(None, description=""),
...
) -> AdyenTerminalMessageInCreate:
    """Receives messages from Adyen Terminal API. apiAdyen:CREATE"""
    if not BaseAdyenTerminalMessageInApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdyenTerminalMessageInApi.subclasses[0]().c_reate_adyen_terminal_message_in(user_agent, x_bunq_client_authentication, adyen_terminal_message_in, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
