...
class BaseAdminUserApprovalIdentificationDocumentApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminUserApprovalIdentificationDocumentApi.subclasses = BaseAdminUserApprovalIdentificationDocumentApi.subclasses + (cls,)
