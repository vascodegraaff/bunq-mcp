...
class BaseVonageCallIncomingTranslationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseVonageCallIncomingTranslationApi.subclasses = BaseVonageCallIncomingTranslationApi.subclasses + (cls,)
    async def c_reate_vonage_call_incoming_translation(
        ...
        vonage_call_incoming_translation: VonageCallIncomingTranslation,
