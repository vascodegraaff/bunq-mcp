...
from openapi_server.apis.session_browser_user_person_api_base import BaseSessionBrowserUserPersonApi
...
from openapi_server.models.session_browser_user_person import SessionBrowserUserPerson
from openapi_server.models.session_browser_user_person_create import SessionBrowserUserPersonCreate
...
@router.post(
    "/session-browser-user-person",
    responses={
        200: {"model": SessionBrowserUserPersonCreate, "description": "Create a new browser session for a UserPerson. apiApp:CREATE apiDeveloperPortal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["session-browser-user-person"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_session_browser_user_person(
    ...
    session_browser_user_person: SessionBrowserUserPerson = Body(None, description=""),
...
) -> SessionBrowserUserPersonCreate:
    """Create a new browser session for a UserPerson. apiApp:CREATE apiDeveloperPortal:CREATE"""
    if not BaseSessionBrowserUserPersonApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionBrowserUserPersonApi.subclasses[0]().c_reate_session_browser_user_person(user_agent, x_bunq_client_authentication, session_browser_user_person, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
