...
class BaseAdminNumberOfPaymentSavingsResetApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminNumberOfPaymentSavingsResetApi.subclasses = BaseAdminNumberOfPaymentSavingsResetApi.subclasses + (cls,)
