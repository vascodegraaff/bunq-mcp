...
class BaseQualityAssuranceUserTagApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseQualityAssuranceUserTagApi.subclasses = BaseQualityAssuranceUserTagApi.subclasses + (cls,)
    async def c_reate_quality_assurance_user_tag_for_user(
        ...
        quality_assurance_user_tag: QualityAssuranceUserTag,
