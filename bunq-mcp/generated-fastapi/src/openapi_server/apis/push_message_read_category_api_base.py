...
class BasePushMessageReadCategoryApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePushMessageReadCategoryApi.subclasses = BasePushMessageReadCategoryApi.subclasses + (cls,)
    async def c_reate_push_message_read_category_for_user(
        ...
        push_message_read_category: PushMessageReadCategory,
