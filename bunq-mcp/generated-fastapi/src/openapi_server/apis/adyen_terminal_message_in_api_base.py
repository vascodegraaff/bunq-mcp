...
class BaseAdyenTerminalMessageInApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdyenTerminalMessageInApi.subclasses = BaseAdyenTerminalMessageInApi.subclasses + (cls,)
    async def c_reate_adyen_terminal_message_in(
        ...
        adyen_terminal_message_in: AdyenTerminalMessageIn,
