...
from openapi_server.apis.repayment_api_base import BaseRepaymentApi
...
from openapi_server.models.credit_line_repayment_listing import CreditLineRepaymentListing
from openapi_server.models.credit_line_repayment_read import CreditLineRepaymentRead
from openapi_server.models.credit_line_repayment_update import CreditLineRepaymentUpdate
...
@router.get(
    "/user/{userID}/credit-line/{credit-lineID}/repayment",
    responses={
        200: {"model": List[CreditLineRepaymentListing], "description": "Manage repayments for a credit line. apiAdmin:READ/LISTING apiApp:READ/LISTING/UPDATE"},
...
async def list_all_repayment_for_user_credit_line(
...
) -> List[CreditLineRepaymentListing]:
    """Manage repayments for a credit line. apiAdmin:READ/LISTING apiApp:READ/LISTING/UPDATE"""
    if not BaseRepaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRepaymentApi.subclasses[0]().list_all_repayment_for_user_credit_line(userID, credit-lineID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/credit-line/{credit-lineID}/repayment/{itemId}",
    responses={
        200: {"model": CreditLineRepaymentRead, "description": "Manage repayments for a credit line. apiAdmin:READ/LISTING apiApp:READ/LISTING/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["repayment"],
    summary="",
...
async def r_ead_repayment_for_user_credit_line(
    userID: StrictInt = Path(..., description=""),
    credit-lineID: StrictInt = Path(..., description=""),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> CreditLineRepaymentRead:
    """Manage repayments for a credit line. apiAdmin:READ/LISTING apiApp:READ/LISTING/UPDATE"""
    if not BaseRepaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRepaymentApi.subclasses[0]().r_ead_repayment_for_user_credit_line(userID, credit-lineID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/credit-line/{credit-lineID}/repayment/{itemId}",
    responses={
        200: {"model": CreditLineRepaymentUpdate, "description": "Manage repayments for a credit line. apiAdmin:READ/LISTING apiApp:READ/LISTING/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["repayment"],
    summary="",
...
async def u_pdate_repayment_for_user_credit_line(
    userID: StrictInt = Path(..., description=""),
    credit-lineID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> CreditLineRepaymentUpdate:
    """Manage repayments for a credit line. apiAdmin:READ/LISTING apiApp:READ/LISTING/UPDATE"""
    if not BaseRepaymentApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseRepaymentApi.subclasses[0]().u_pdate_repayment_for_user_credit_line(userID, credit-lineID, itemId, user_agent, x_bunq_client_authentication, body, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
