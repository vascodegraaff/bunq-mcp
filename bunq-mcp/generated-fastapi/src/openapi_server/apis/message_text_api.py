...
from openapi_server.apis.message_text_api_base import BaseMessageTextApi
...
from openapi_server.models.chat_message_text import ChatMessageText
from openapi_server.models.chat_message_text_create import ChatMessageTextCreate
...
@router.post(
    ...
    responses={
        200: {"model": ChatMessageTextCreate, "description": "Endpoint for the type of chat message that carries text. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
...
async def c_reate_message_text_for_user_chat_conversation(
    ...
    chat_message_text: ChatMessageText = Body(None, description=""),
...
) -> ChatMessageTextCreate:
    """Add a new text message to a specific conversation."""
    if not BaseMessageTextApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseMessageTextApi.subclasses[0]().c_reate_message_text_for_user_chat_conversation(userID, chat-conversationID, user_agent, x_bunq_client_authentication, chat_message_text, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
