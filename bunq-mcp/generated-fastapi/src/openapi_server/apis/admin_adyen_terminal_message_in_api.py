...
from openapi_server.apis.admin_adyen_terminal_message_in_api_base import BaseAdminAdyenTerminalMessageInApi
...
from openapi_server.models.admin_adyen_terminal_message_in import AdminAdyenTerminalMessageIn
from openapi_server.models.admin_adyen_terminal_message_in_update import AdminAdyenTerminalMessageInUpdate
...
@router.put(
    "/admin-adyen-terminal-message-in/{itemId}",
    responses={
        200: {"model": AdminAdyenTerminalMessageInUpdate, "description": "Manage Adyen Terminal Messages (Webhooks). apiAdmin:UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["admin-adyen-terminal-message-in"],
    summary="",
    response_model_by_alias=True,
)
async def u_pdate_admin_adyen_terminal_message_in(
    ...
    admin_adyen_terminal_message_in: AdminAdyenTerminalMessageIn = Body(None, description=""),
...
) -> AdminAdyenTerminalMessageInUpdate:
    """Manage Adyen Terminal Messages (Webhooks). apiAdmin:UPDATE"""
    if not BaseAdminAdyenTerminalMessageInApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAdminAdyenTerminalMessageInApi.subclasses[0]().u_pdate_admin_adyen_terminal_message_in(itemId, user_agent, x_bunq_client_authentication, admin_adyen_terminal_message_in, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
