...
from openapi_server.models.user_listing import UserListing
...
@router.get(
    "/user",
    responses={
        200: {"model": List[UserListing], "description": "Using this call you can retrieve information of the user you are logged in as. This includes your user id, which is referred to in endpoints. apiAdmin:READ/LISTING apiApp:READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiProcess:READ/LISTING apiTranslink:READ/LISTING apiBird:READ apiQualityAssurance:READ apiDeveloperPortal:READ/LISTING"},
...
@router.get(
    "/user/{itemId}",
    responses={
        200: {"model": UserRead, "description": "Using this call you can retrieve information of the user you are logged in as. This includes your user id, which is referred to in endpoints. apiAdmin:READ/LISTING apiApp:READ/LISTING apiPublic:READ/LISTING apiServiceInternal:READ/LISTING apiProcess:READ/LISTING apiTranslink:READ/LISTING apiBird:READ apiQualityAssurance:READ apiDeveloperPortal:READ/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["user"],
    summary="",
...
async def r_ead_user(
    ...
    return await BaseUserApi.subclasses[0]().r_ead_user(itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
