...
class BaseAdminMastercardActionRefundApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseAdminMastercardActionRefundApi.subclasses = BaseAdminMastercardActionRefundApi.subclasses + (cls,)
    async def c_reate_admin_mastercard_action_refund_for_mastercard_action(
        ...
        admin_master_card_action_refund: AdminMasterCardActionRefund,
