...
from openapi_server.apis.token_qr_idin_issuer_claim_user_api_base import BaseTokenQrIdinIssuerClaimUserApi
...
from openapi_server.models.token_qr_idin_issuer_claim import TokenQrIdinIssuerClaim
from openapi_server.models.token_qr_idin_issuer_claim_create import TokenQrIdinIssuerClaimCreate
...
@router.post(
    "/user/{userID}/token-qr-idin-issuer-claim-user",
    responses={
        200: {"model": TokenQrIdinIssuerClaimCreate, "description": "Endpoint to claim iDIN Issuer Transaction by scanning a QR code. apiApp:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["token-qr-idin-issuer-claim-user"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_token_qr_idin_issuer_claim_user_for_user(
    ...
    token_qr_idin_issuer_claim: TokenQrIdinIssuerClaim = Body(None, description=""),
...
) -> TokenQrIdinIssuerClaimCreate:
    """Endpoint to claim iDIN Issuer Transaction by scanning a QR code. apiApp:CREATE"""
    if not BaseTokenQrIdinIssuerClaimUserApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseTokenQrIdinIssuerClaimUserApi.subclasses[0]().c_reate_token_qr_idin_issuer_claim_user_for_user(userID, user_agent, x_bunq_client_authentication, token_qr_idin_issuer_claim, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
