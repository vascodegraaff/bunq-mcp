...
class BaseCreditLineApplicationApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseCreditLineApplicationApi.subclasses = BaseCreditLineApplicationApi.subclasses + (cls,)
    async def c_reate_credit_line_application_for_user(
        ...
        credit_line_application: CreditLineApplication,
