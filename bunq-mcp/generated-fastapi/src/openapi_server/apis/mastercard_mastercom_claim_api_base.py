...
class BaseMastercardMastercomClaimApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseMastercardMastercomClaimApi.subclasses = BaseMastercardMastercomClaimApi.subclasses + (cls,)
    async def c_reate_mastercard_mastercom_claim_for_mastercard_action(
        ...
        master_card_mastercom_claim: MasterCardMastercomClaim,
