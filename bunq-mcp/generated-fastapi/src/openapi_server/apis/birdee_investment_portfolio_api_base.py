...
class BaseBirdeeInvestmentPortfolioApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseBirdeeInvestmentPortfolioApi.subclasses = BaseBirdeeInvestmentPortfolioApi.subclasses + (cls,)
    async def c_reate_birdee_investment_portfolio_for_user_monetary_account_investment(
        self,
        userID: StrictInt,
        monetary-account-investmentID: StrictInt,
