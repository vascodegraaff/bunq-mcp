...
class BaseInviteUserPersonalizedBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseInviteUserPersonalizedBatchApi.subclasses = BaseInviteUserPersonalizedBatchApi.subclasses + (cls,)
    async def c_reate_invite_user_personalized_batch_for_user(
        ...
        invite_user_personalized_batch: InviteUserPersonalizedBatch,
