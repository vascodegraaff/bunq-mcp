...
from openapi_server.apis.session_challenge_api_base import BaseSessionChallengeApi
...
from openapi_server.models.session_challenge import SessionChallenge
from openapi_server.models.session_challenge_create import SessionChallengeCreate
...
@router.post(
    "/session-challenge",
    responses={
        200: {"model": SessionChallengeCreate, "description": "View for creating challenges in SRP-6a handshakes. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["session-challenge"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_session_challenge(
    ...
    session_challenge: SessionChallenge = Body(None, description=""),
...
) -> SessionChallengeCreate:
    """View for creating challenges in SRP-6a handshakes. apiAdmin:CREATE apiApp:CREATE apiServiceInternal:CREATE"""
    if not BaseSessionChallengeApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSessionChallengeApi.subclasses[0]().c_reate_session_challenge(user_agent, x_bunq_client_authentication, session_challenge, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
