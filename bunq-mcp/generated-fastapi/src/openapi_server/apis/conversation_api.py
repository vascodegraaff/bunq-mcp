...
from openapi_server.models.assistant_conversation import AssistantConversation
from openapi_server.models.assistant_conversation_create import AssistantConversationCreate
from openapi_server.models.assistant_conversation_listing import AssistantConversationListing
from openapi_server.models.assistant_conversation_read import AssistantConversationRead
from openapi_server.models.assistant_conversation_update import AssistantConversationUpdate
...
@router.post(
    "/user/{userID}/assistant/{assistantID}/conversation",
    responses={
        200: {"model": AssistantConversationCreate, "description": "Endpoint to retrieve Assistant Conversations. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING/UPDATE"},
...
async def c_reate_conversation_for_user_assistant(
    ...
    assistant_conversation: AssistantConversation = Body(None, description=""),
    ...
    """Endpoint to retrieve Assistant Conversations. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING/UPDATE"""
    if not BaseConversationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseConversationApi.subclasses[0]().c_reate_conversation_for_user_assistant(userID, assistantID, user_agent, x_bunq_client_authentication, assistant_conversation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/assistant/{assistantID}/conversation",
    responses={
        200: {"model": List[AssistantConversationListing], "description": "Endpoint to retrieve Assistant Conversations. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["conversation"],
    summary="",
...
async def list_all_conversation_for_user_assistant(
    userID: StrictInt = Path(..., description=""),
    assistantID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    ...
    x_bunq_client_request_id: Annotated[Optional[StrictStr], Field(description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer.")] = Header(None, description="This header must specify an ID with each request that is unique for the logged in user. There are no restrictions for the format of this ID. However, the server will respond with an error when the same ID is used again on the same DeviceServer."),
    x_bunq_geolocation: Annotated[Optional[StrictStr], Field(description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued.")] = Header(None, description="This header must specify the geolocation of the device. The format of this value is longitude latitude altitude radius country. The country is expected to be formatted of an ISO 3166-1 alpha-2 country code. When no geolocation is available or known the header must still be included but can be zero valued."),
) -> List[AssistantConversationListing]:
    """Endpoint to retrieve Assistant Conversations. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING/UPDATE"""
    if not BaseConversationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseConversationApi.subclasses[0]().list_all_conversation_for_user_assistant(userID, assistantID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/assistant/{assistantID}/conversation/{itemId}",
    responses={
        200: {"model": AssistantConversationRead, "description": "Endpoint to retrieve Assistant Conversations. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["conversation"],
    summary="",
...
async def r_ead_conversation_for_user_assistant(
    userID: StrictInt = Path(..., description=""),
    assistantID: StrictInt = Path(..., description=""),
    ...
    if not BaseConversationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseConversationApi.subclasses[0]().r_ead_conversation_for_user_assistant(userID, assistantID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.put(
    "/user/{userID}/assistant/{assistantID}/conversation/{itemId}",
    responses={
        200: {"model": AssistantConversationUpdate, "description": "Endpoint to retrieve Assistant Conversations. apiAdmin:READ/LISTING apiApp:CREATE/READ/LISTING/UPDATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["conversation"],
    summary="",
...
async def u_pdate_conversation_for_user_assistant(
    userID: StrictInt = Path(..., description=""),
    assistantID: StrictInt = Path(..., description=""),
    itemId: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    ...
    if not BaseConversationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseConversationApi.subclasses[0]().u_pdate_conversation_for_user_assistant(userID, assistantID, itemId, user_agent, x_bunq_client_authentication, assistant_conversation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
