...
from openapi_server.apis.idin_issuer_transaction_confirmation_api_base import BaseIdinIssuerTransactionConfirmationApi
...
from openapi_server.models.idin_issuer_transaction_confirmation import IdinIssuerTransactionConfirmation
from openapi_server.models.idin_issuer_transaction_confirmation_create import IdinIssuerTransactionConfirmationCreate
...
@router.post(
    "/user/{userID}/idin-issuer-transaction-confirmation",
    responses={
        200: {"model": IdinIssuerTransactionConfirmationCreate, "description": "Endpoint to claim iDIN Issuer Transaction by scanning a QR code. apiApp:CREATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["idin-issuer-transaction-confirmation"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_idin_issuer_transaction_confirmation_for_user(
    ...
    idin_issuer_transaction_confirmation: IdinIssuerTransactionConfirmation = Body(None, description=""),
...
) -> IdinIssuerTransactionConfirmationCreate:
    """Endpoint to claim iDIN Issuer Transaction by scanning a QR code. apiApp:CREATE/LISTING"""
    if not BaseIdinIssuerTransactionConfirmationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIdinIssuerTransactionConfirmationApi.subclasses[0]().c_reate_idin_issuer_transaction_confirmation_for_user(userID, user_agent, x_bunq_client_authentication, idin_issuer_transaction_confirmation, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)


@router.get(
    "/user/{userID}/idin-issuer-transaction-confirmation",
    responses={
        200: {"model": List[object], "description": "Endpoint to claim iDIN Issuer Transaction by scanning a QR code. apiApp:CREATE/LISTING"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["idin-issuer-transaction-confirmation"],
    summary="",
...
async def list_all_idin_issuer_transaction_confirmation_for_user(
    userID: StrictInt = Path(..., description=""),
    user_agent: Annotated[StrictStr, Field(description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header.")] = Header(None, description="The User-Agent header field should contain information about the user agent originating the request. There are no restrictions on the value of this header."),
    x_bunq_client_authentication: Annotated[StrictStr, Field(description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call")] = Header(None, description="The authentication token is used to authenticate the source of the API call. It is required by all API calls except for POST /v1/installation. It is important to note that the device and session calls are using the token from the response of the installation call, while all the other calls use the token from the response of the session-server call"),
    cache_control: Annotated[Optional[StrictStr], Field(description="The standard HTTP Cache-Control header is required for all signed requests.")] = Header(None, description="The standard HTTP Cache-Control header is required for all signed requests."),
    ...
    if not BaseIdinIssuerTransactionConfirmationApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseIdinIssuerTransactionConfirmationApi.subclasses[0]().list_all_idin_issuer_transaction_confirmation_for_user(userID, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
