...
from openapi_server.models.partner_signup_check24 import PartnerSignupCheck24
from openapi_server.models.partner_signup_check24_create import PartnerSignupCheck24Create


class BasePartnerSignupCheck24Api:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BasePartnerSignupCheck24Api.subclasses = BasePartnerSignupCheck24Api.subclasses + (cls,)
    async def c_reate_partner_signup_check24(
        self,
        ...
        partner_signup_check24: PartnerSignupCheck24,
        ...
        """Used to create partner signup models for Check24."""
        ...
