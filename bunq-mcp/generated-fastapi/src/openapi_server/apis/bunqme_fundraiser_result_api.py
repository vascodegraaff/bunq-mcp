...
from openapi_server.apis.bunqme_fundraiser_result_api_base import BaseBunqmeFundraiserResultApi
...
from openapi_server.models.bunq_me_fundraiser_result_read import BunqMeFundraiserResultRead
...
@router.get(
    ...
    responses={
        200: {"model": BunqMeFundraiserResultRead, "description": "bunq.me fundraiser result containing all payments. apiAdmin:READ apiApp:READ apiPublic:READ apiServiceInternal:READ"},
...
async def r_ead_bunqme_fundraiser_result_for_user_monetary_account(
    ...
    """bunq.me fundraiser result containing all payments. apiAdmin:READ apiApp:READ apiPublic:READ apiServiceInternal:READ"""
    if not BaseBunqmeFundraiserResultApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseBunqmeFundraiserResultApi.subclasses[0]().r_ead_bunqme_fundraiser_result_for_user_monetary_account(userID, monetary-accountID, itemId, user_agent, x_bunq_client_authentication, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
