...
from openapi_server.apis.support_promotion_api_base import BaseSupportPromotionApi
...
from openapi_server.models.support_promotion import SupportPromotion
from openapi_server.models.support_promotion_create import SupportPromotionCreate
...
@router.post(
    "/user/{userID}/support-promotion",
    responses={
        200: {"model": SupportPromotionCreate, "description": "The view endpoint for creating card promotion (batches). apiAdmin:CREATE apiServiceInternal:CREATE"},
        400: {"model": CREATE1brn400Response, "description": "This is how the error response looks like for 4XX response codes"},
    },
    tags=["support-promotion"],
    summary="",
    response_model_by_alias=True,
)
async def c_reate_support_promotion_for_user(
    ...
    support_promotion: SupportPromotion = Body(None, description=""),
...
) -> SupportPromotionCreate:
    """The view endpoint for creating card promotion (batches). apiAdmin:CREATE apiServiceInternal:CREATE"""
    if not BaseSupportPromotionApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseSupportPromotionApi.subclasses[0]().c_reate_support_promotion_for_user(userID, user_agent, x_bunq_client_authentication, support_promotion, cache_control, x_bunq_language, x_bunq_region, x_bunq_client_request_id, x_bunq_geolocation)
