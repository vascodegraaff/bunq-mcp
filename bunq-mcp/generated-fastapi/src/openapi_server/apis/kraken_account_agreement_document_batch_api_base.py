...
class BaseKrakenAccountAgreementDocumentBatchApi:
    subclasses: ClassVar[Tuple] = ()

    def __init_subclass__(cls, **kwargs):
        super().__init_subclass__(**kwargs)
        BaseKrakenAccountAgreementDocumentBatchApi.subclasses = BaseKrakenAccountAgreementDocumentBatchApi.subclasses + (cls,)
    async def c_reate_kraken_account_agreement_document_batch_for_user(
        ...
        kraken_account_agreement_document_batch: KrakenAccountAgreementDocumentBatch,
