...
class PaymentBatchAnchoredPayment(BaseModel):
    ...
    """ # noqa: E501
    payment: Optional[List[Payment]] = Field(default=None, alias="Payment")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentBatchAnchoredPayment from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentBatchAnchoredPayment from a dict"""
        if obj is None:
            return None
